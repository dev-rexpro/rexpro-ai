...
var require_pyodide_worker_001 = __commonJS({
  "_app/immutable/workers/pyodide.worker-DDg6GT8V.js"(exports, module) {
    var oe = Object.defineProperty;
    var o = (e, t) => oe(e, "name", { value: t, configurable: true }), A = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (t, r) => (typeof require < "u" ? require : t)[r] }) : e)(function(e) {
    ...
    o(L, "_getter");
    var E = ["isConstructor", "isEval", "isNative", "isToplevel"], P = ["columnNumber", "lineNumber"], k = ["fileName", "functionName", "source"], ae = ["args"], ce = ["evalOrigin"], R = E.concat(P, k, ae, ce);
    function p(e) {
...
`).filter(function(n) {
    ...
    var de = new le();
    var $ = de;
    var g = typeof process == "object" && typeof process.versions == "object" && typeof process.versions.node == "string" && !process.browser, T = g && typeof module < "u" && typeof module.exports < "u" && typeof A < "u" && typeof __dirname < "u", j = g && !T, ue = typeof Deno < "u", H = !g && !ue, V = H && typeof window == "object" && typeof document == "object" && typeof document.createElement == "function" && "sessionStorage" in window && typeof importScripts != "function", z = H && typeof importScripts == "function" && typeof self == "object";
    ...
    var J, D, Y, q, U;
    async function C() {
      if (!g || (J = (await import("./chunks/Dhvy_jtL.js")).default, q = await import("./chunks/Dhvy_jtL.js"), U = await import("./chunks/Dhvy_jtL.js"), Y = (await import("./chunks/Dhvy_jtL.js")).default, D = await import("./chunks/Dhvy_jtL.js"), M = D.sep, typeof A < "u")) return;
      let e = q, t = await import("./chunks/Dhvy_jtL.js"), r = await import("./chunks/Dhvy_jtL.js"), s = await import("./chunks/Dhvy_jtL.js"), a = { fs: e, crypto: t, ws: r, child_process: s };
    ...
    async function X() {
      ...
      if (g && !t.startsWith("file://") && (t = `file://${t}`), j) {
        let s = await import("./chunks/Dhvy_jtL.js");
        return (await import("./chunks/Dhvy_jtL.js")).fileURLToPath(s.dirname(t));
      }
    ...
    function we(e) {
      return function(t) {
        ...
        try {
          ...
          /* @__PURE__ */ console.error(`Error occurred while making a home directory '${e}':`), /* @__PURE__ */ console.error(s), /* @__PURE__ */ console.error(`Using '${r}' for a home directory instead`), e = r;
        }
        t.FS.chdir(e);
      };
    }
    ...
    function Ie(e) {
      ...
      return async (r) => {
        ...
        try {
          ...
          /* @__PURE__ */ console.error("Error occurred while installing the standard library:"), /* @__PURE__ */ console.error(n);
        } finally {
    ...
    async function at(e = {}) {
      ...
      if (r.packageBaseUrl = _(r.packageBaseUrl), r.cdnUrl = _(r.packageBaseUrl ?? `https://cdn.jsdelivr.net/pyodide/v${B}/full/`), !e.lockFileContents) {
        ...
        r.lockFileContents = G(f), r.packageBaseUrl ?? (r.packageBaseUrl = Q(f));
      }
      r.indexURL = t, r.packageCacheDir && (r.packageCacheDir = _(N(r.packageCacheDir)));
      let s = { fullStdLib: false, jsglobals: globalThis, stdin: globalThis.prompt ? globalThis.prompt : void 0, args: [], env: {}, packages: [], packageCacheDir: r.packageBaseUrl, enableRunUntilComplete: true, checkAPIVersion: true, BUILD_ID: "cc7a4bb4c6f36f12592fef0934292b5fddb0e313ca5dc4a5a9519bb7610c67e3" }, a = Object.assign(s, r);
      (_a = a.env).HOME ?? (_a.HOME = "/home/pyodide"), (_b = a.env).PYTHONINSPECT ?? (_b.PYTHONINSPECT = "1");
      let n = ne(a), i = n.API;
...
export default require_pyodide_worker_001();
