...
const AI = "IA";
const All = "Todos";
const Always = "Siempre";
const Amazing = "Emocionante";
const Analytics = "Analíticas";
const Analyzed = "Analizado";
const Android = "Android";
const Anyone = "Cualquiera";
const April = "Abril";
const Archive = "Archivar";
const Artifacts = "Artefactos";
const Asc = "Asc";
const Ask = "Preguntar";
...
const Channel = "Canal";
const Channels = "Canal";
const Character = "Carácter";
const Chat = "Chat";
const chats = "chats";
const Chats = "Chats";
const Ciphers = "Cifrado";
const Citation = "Cita";
const Citations = "Citas";
const Clone = "Clonar";
const Close = "Cerrar";
const cloud = "nube";
const Collapse = "Plegar";
const Collection = "Colección";
const Collections = "Colecciones";
const Color = "Color";
const ComfyUI = "ComfyUI";
const command = "comando";
const Command = "Comando";
const Comment = "Comentario";
const Completions = "Cumplimientos";
const Config = "Config";
const Configuration = "Configuración";
...
const Default = "Predeterminado";
const Defaults = "Predeterminados";
const Delete = "Borrar";
const Deleted = "Borrado";
const Desc = "Desc";
const Description = "Descripción";
const Deselect = "Deseleccionar";
const Dictate = "Dictar";
...
const Eject = "Expulsar";
const ElevenLabs = "ElevenLabs";
const Email = "Email";
const Embedding = "Incrustación";
const Emoji = "";
const Emojis = "Emoticonos";
const Enabled = "Habilitado";
const Enhance = "Mejorar";
const Ephemeral = "Efímero";
const ERROR = "ERROR";
...
const Folders = "Carpetas";
const Form = "Formulario";
const Forward = "Reenviar";
const Fr_day_of_week = "los viernes";
const Functions = "Funciones";
const Gemini = "Gemini";
const Gender = "Género";
const General = "General";
const Generate = "Generar";
const Global = "Global";
const Google = "Google";
const Gravatar = "Gravatar";
const Grid = "Cuadrícula";
...
const Home = "Inicio";
const Host = "Host";
const Hourly = "Horario";
const HTML = "HTML";
const ID = "ID";
const Image = "Imagen";
const Images = "Imágenes";
...
const Integration = "Integración";
const Integrations = "Integraciones";
const Interface = "Interfaz";
const Italic = "Cursiva";
const January = "Enero";
const July = "Julio";
const June = "Junio";
const Key = "Clave";
...
const LDAP = "LDAP";
const Leaderboard = "Tabla Clasificatoria";
const Legacy = "Heredado";
const lexical = "léxica";
const License = "Licencia";
const Light = "Claro";
const List = "Lista";
const Live = "En Directo";
...
const Mo_day_of_week = "los lunes";
const Model = "Modelo";
...
const Personalization = "Personalización";
const Pin = "Fijar";
const Pinned = "Fijado";
const Pipe = "Tubo";
const Pipelines = "Tuberías";
const Playground = "Zona de Pruebas";
const Port = "Puerto";
const Ports = "Puertos";
const Preview = "Previsualización";
const Private = "Privado";
const Profile = "Perfil";
const Prompt = "Indicador";
const Prompts = "Indicadores";
const Provider = "Proveedor";
const Public = "Público";
const Querying = "Consultando";
const Rating = "Calificación";
const Read = "Leer";
const Reason = "Razonamiento";
...
const RESULT = "Resultado";
const Retrieval = "Recuperación";
const Role = "Rol";
const RTL = "RTL";
const Run = "Ejecutar";
const Running = "Ejecutando";
const Sa_day_of_week = "los_sabados";
const Save = "Guardar";
const Saved = "Guardado";
const Schedule = "Programar";
const Search = "Buscar";
const Searching = "Buscando";
const Seed = "Semilla";
const Select = "Seleccionar";
const semantic = "semántica";
const Send = "Enviar";
const September = "Septiembre";
const Session = "Sesión";
const Setting = "Ajuste";
const Settings = "Ajustes";
const Share = "Compartir";
const Show = "Mostrar";
const Single = "Individual";
...
const Th_day_of_week = "los jueves";
const Theme = "Tema";
const Thought = "Pensando";
const Thread = "Hilo";
const Tika = "Tika";
const Tiktoken = "Tiktoken";
const Time = "Tiempo";
const Timeout = "Tiempo de espera";
const Title = "Título";
const TLS = "TLS";
const Today = "Hoy";
const Token = "Token";
...
const Tu_day_of_week = "los martes";
const Type = "Tipo";
const UI = "IU";
const Underline = "Subrayado";
const Unknown = "Desconocido";
const Unmute = "Desilenciar";
const Unpin = "Desfijar";
...
const Voice = "Voz";
const Warning = "Aviso";
const We_day_of_week = "los miércoles";
const Web = "Web";
...
const Won = "Ganó";
const Workspace = "Espacio de Trabajo";
const Write = "Escribir";
const Yahoo = "Yahoo";
const Yandex = "Yandex";
...
const translation = {
  ...
  "(e.g. `sh rexpro.sh --api --api-auth username_password`)": "(p.ej. `sh rexpro.sh --api --api-auth username_password`)",
  "(e.g. `sh rexpro.sh --api`)": "(p.ej. `sh rexpro.sh --api`)",
  "(latest)": "(la última)",
  ...
  "{{count}} selected_many": "{{count}} múltiples seleccionados",
  "{{count}} selected_other": "{{count}} otros seleccionados",
  ...
  "{{model}} download has been canceled": "La descarga de {{model}} se ha cancelado",
  ...
  "Access updated": "Permisos actualizados",
  ...
  "Add Terminal Connection": "Añadir Conexión de Terminal",
  "Add text content": "Añade contenido de texto",
  "Add to favorites": "Añade a favoritos",
  "Add User": "Añadir Usuario",
  "Add User Group": "Añadir grupo de usuarios",
  "Add webpage": "Añadir página Web",
  "Add your Open Terminal URL and API key in Settings → Integrations.": "Añadir la URL y la clave API de OpenTerminal en Configuración → Integraciones",
  ...
  "Additional feedback comments": "Comentarios adicionales de la opinión",
  "Additional Parameters": "Parámetros Adicionales",
  "Adds filenames, titles, sections, and snippets into the BM25 text to improve lexical recall.": "Añade nombres de archivos, títulos, secciones o fragmentos para mejorar la búsqueda léxica con BM25.",
  ...
  "Allow public write access": "Permitir acceso público a escritura",
  "Allow Rate Response": "Permitir Calificar Respuesta",
  "Allow Regenerate Response": "Permitir Regenerar Respuesta",
  "Allow Sharing With Users": "Permitir Compartir con Usuarios",
  ...
  "Allow Web Upload": "Permitir Subir Web",
  "Allowed Endpoints": "Endpoints Permitidos",
  "Allowed File Extensions": "Extensiones de Archivo Permitidas",
  "Allowed file extensions for upload. Separate multiple extensions with commas. Leave empty for all file types.": "Extensiones de archivos permitidas para subir. Si son varias separalas con comas. Dejar vacío para permitir subir archivos con cualquier extensión.",
  ...
  "API Base URL for Datalab Marker service. Defaults to: https://www.datalab.to/api/v1/marker": "URL Base de la API de Datalab Marker service. La Predeterminada es: https://www.datalab.to/api/v1/marker",
  "API Key": "Clave API",
  ...
  "API Type": "Tipo de la API",
  "API Version": "Versión de la API",
  "API Version is required": "La Versión de la API es necesaria",
  "Application DN": "Aplicación DN",
  "Application DN Password": "Contraseña Aplicación DN",
  ...
  "Are you sure you want to archive all chats? This action cannot be undone.": "¿Estás seguro que quieres archivar todos los chats? (¡esta acción NO se puede deshacer!)",
  "Are you sure you want to clear all memories? This action cannot be undone.": "¿Estás seguro de que quieres borrar todas las memorias? (¡esta acción NO se puede deshacer!)",
  'Are you sure you want to delete "{{NAME}}"?': '¿Estás seguro de que quieres eliminar "{{NAME}}"?',
  "Are you sure you want to delete **{{modelName}}**?": "¿Estás seguro de que quieres eliminar **{{modelName}}**?",
  ...
  "Are you sure you want to delete this?": "¿Estás seguro que desea eliminar esto?",
  ...
  "At time of event": "En el momento del evento",
  ...
  Automatic1111,
  "AUTOMATIC1111 Api Auth String": "Auth API para AUTOMATIC1111",
  ...
  "Automation title": "Título de la Automatización",
  "Automation triggered": "Automatización activada",
  "Automation updated": "Automatización actualizada",
  Automations,
  ...
  Back,
  "Bad Response": "Respuesta Errónea",
  Banners,
  ...
  "Bocha Search API Key": "Clave de la API de Bocha Search",
  Bold,
  ...
  Brave,
  "Brave Search API Key": "Clave de la API de Brave Search",
  "Break down complex requests into trackable steps": "Desglosar las peticiones complejas en pasos rastreables",
  ...
  Calendars,
  "Calendars Public Sharing": "Compartir Calendarios Publicamente",
  Call,
  ...
  Camera,
  Cancel,
  "Cancel download of {{model}}": "Cancelar descarga de {{model}}",
  ...
  "Change folder icon": "Cambiar icono de la carpeta",
  "Change Password": "Cambiar Contraseña",
  "Change User Role": "Cambiar Rol del Usuario",
  Channel,
  ...
  "Channel name must be less than 128 characters": "El nombre del Canal debe ser menor de 128 caracteres.",
  ...
  "Chat Bubble UI": "IU del Chat tipo Burbuja",
  ...
  chats,
  Chats,
  "Chats Public Sharing": "Compartir Chats Publicamente",
  ...
  "Chunks smaller than this threshold will be merged with neighboring chunks when possible. Set to 0 to disable merging.": "Los fragmentos menores a este umbral se fusionarán con los fragmentos vecinos cuando sea posible. Establézcalo en 0 para deshabilitar la fusión.",
  Ciphers,
  Citation,
  Citations,
  ...
  "Click here to select a csv file.": "Pulsa aquí para seleccionar un archivo de Valores Separados por Comas (.csv)",
  "Click here to select a py file.": "Pulsa aquí para seleccionar un archivo Python (.py)",
  ...
  "Click to connect": "Pulsar para conectar",
  ...
  "Close chat controls": "Cerrar controles del chat",
  "Close citation modal": "Cerrar modal Citaciones",
  "Close Configure Connection Modal": "Cerrar modal Configurar la Conexión",
  "Close feedback": "Cerrar opiniones",
  ...
  "Confirm Prompt from Embed": "Confirma Indicador desde la Incrustación",
  ...
  "Connection lost. Reconnecting...": "Conexxión perdida, reconectando...",
  "Connection successful": "Conexión realizada",
  "Connection Type": "Tipo de Conexión",
  Connections,
  "Connections saved successfully": "Conexiones guardadas correctamente",
  ...
  "Contact Admin for rexpro Access": "Contacta con Admin para obtener acceso a rexpro",
  Content,
  "Content Extraction Engine": "Motor para la Extracción de Contenido",
  "Content lengths (character counts only)": "Longitud del contenido (solo recuento de caracteres)",
  ...
  "CORS must be properly configured by the provider to allow requests from rexpro-ai.": "El protocolo CORS debe estar configurado correctamente por el proveedor para permitir solicitudes desde rexpro-ai.",
  "Could not read file.": "No se ha podido leer el archivo",
  CPU,
  Create,
  ...
  "Create and manage scheduled automations": "Crear y gestionar automatizaciones programadas",
  ...
  "Create Note": "Crear Nota",
  "Create scheduled prompts that run automatically on a recurring basis.": "Crea indicadores programados para que se ejecuten automáticamente de forma recurrente.",
  ...
  Custom,
  "Custom color": "Color personalzado",
  ...
  December,
  "Decrease UI Scale": "Reducir la Escala de la IU",
  Deepgram,
  Default,
  ...
  "Deleted {{ok}} of {{total}} items": "Borrados {{ok}} de {{total}} elementos",
  ...
  "Discover how to use rexpro-ai and seek support from the community.": "Descubre cómo usar rexpro-ai y busca Soporte Comunitario.",
  ...
  "Do you want to sync your usage stats with rexpro-ai Community?": "¿Quieres sincronizar tus estadísticas de uso con rexpro-ai Community?",
  Docling,
  "Docling Parameters": "Parámetros de Docling",
  ...
  "Drop files here to upload": "Arrastra archivos aquí para subirlos",
  DuckDuckGo,
  "e.g. '30s','10m'. Valid time units are 's', 'm', 'h'.": "p.ej. '30s','10m'. Unidades de tiempo válidas son 's', 'm', 'h'.",
  "e.g. 'low', 'medium', 'high'": "p.ej. 'bajo`, 'medio', 'alto'",
  ...
  "Edit Terminal Connection": "Editar Conexión del Terminal",
  ...
  Enhance,
  "Enrich Hybrid Search Text": "Texto Enriquecido en la Búqueda Híbrida",
  ...
  'Enter additional headers in JSON format (e.g. {"X-Custom-Header": "value"}': 'Ingresar encabezados adicionales en formato JSON (ej. {"X-Custom-Header": "value"})',
  ...
  "Enter Bing Search V7 Subscription Key": "Ingresar la Clave de Suscripción de Bing Search V7",
  "Enter Bocha Search API Key": "Ingresar la Clave API de Bocha Search",
  "Enter Brave Search API Key": "Ingresar la Clave API de Brave Search",
  "Enter certificate path": "Ingresar la ruta del certificado",
  "Enter Chunk Min Size Target": "Introduce el Tamaño Mínimo de Fragmento",
  ...
  "Enter External Web Loader API Key": "Ingresar Clave API del Cargador Web Externo",
  "Enter External Web Loader URL": "Ingresar URL del Cargador Web Externo",
  "Enter External Web Search API Key": "Ingresar Clave API del Buscador Web Externo",
  "Enter External Web Search URL": "Ingresar URL del Buscador Web Externo",
  ...
  "Enter Firecrawl Timeout": "Ingresar Tiempo de Espera para Firecrawl",
  ...
  "Enter Jina API Base URL": "Ingresar URL Base de la API de Jina",
  ...
  "Enter PaddleOCR-vl API Base URL": "Ingresar URL Base de la API de PaddleOCR-vl",
  "Enter PaddleOCR-vl API Token": "Ingresar Clave (token) de la API de PaddleOCR-vl",
  ...
  "Enter prompt here.": "Ingresar indicador aquí.",
  ...
  "Enter SearchApi API Key": "Ingresar Clave API de SearchApi",
  "Enter SearchApi Engine": "Ingresar Motor de SearchApi",
  "Enter Searxng Query URL": "Ingresar URL de la consulta Searxng",
  "Enter Searxng search language": "Ingresar idioma de busqueda para Searxng",
  "Enter Seed": "Ingresar Semilla",
  "Enter SerpApi API Key": "Ingresar Clave API de SerpApi",
  "Enter SerpApi Engine": "Ingresar Motor de SerpApi",
  "Enter Serper API Key": "Ingresar Clave API de Serper",
  "Enter Serply API Key": "Ingresar Clave API de Serply",
  "Enter Serpstack API Key": "Ingresar Clave API de Serpstack",
  ...
  "Enter the prompt instructions for this automation...": "Ingresar las instrucciones del indicador para la automatización...",
  "Enter the public URL of your rexpro. This URL will be used to generate links in the notifications.": "Ingresar URL pública de rexpro. Esta URL se usará para generar enlaces en las notificaciones.",
  ...
  "Enter You.com API Key": "Ingresar clave AI de You.com",
  ...
  "Error deleting model: {{error}}": "Error borrando el modelo: {{error}}",
  ...
  "Exceeded the number of seats in your license. Please contact support to increase the number of seats.": "Excedido el número de clientes de tu licencia. Por favor, contacta con soporte para aumentar el número de clientes.",
  Exclude,
  ...
  "Failed to delete calendar": "Fallo al borrar el calendario",
  "Failed to delete note": "Fallo al eliminar nota",
  "Failed to disconnect": "Fallo al desconectar",
  ...
  "Failed to load DOCX file. Please try downloading it instead.": "Fallo al cargar el archivo DOCX. Por favor, en su lugar intente descargarlo",
  ...
  "Failed to load PPTX file. Please try downloading it instead.": "Fallo al cargar el archivo PPTX. Por favor, en su lugar intente descargarlo",
  ...
  "Failed to save policy: {{error}}": "Fallo al guardar las normas: {{error}}",
  "Failed to save terminal servers": "Fallo al guardar los servidores de terminal",
  ...
  Female,
  "Fetch URL Content Length Limit": "Longitud límite al extraer contenido de una URL",
  File,
  "File added successfully.": "Archivo añadido correctamente.",
  "File attached to chat": "Adjuntar archivo al chat",
  "File browser": "Navegador de ficheros",
  ...
  "Firecrawl Timeout (s)": "Tiempo de Espera (s) para Firecrawl",
  ...
  "Follow up: {{question}}": "Seguimiento: {{question}}",
  ...
  "Function imported successfully": "Función importada correctamente",
  ...
  "Gemini Endpoint Method": "Método del Endpoint de Gemini",
  Gender,
  General,
  Generate,
  ...
  "Get started": "Empezar",
  "Get started with {{REXPRO_NAME}}": "Empezar con {{REXPRO_NAME}}",
  Global,
  ...
  "Idle Timeout": "Tiempo de espera por inactividad",
  ...
  Inactive,
  Include,
  "Include `--api-auth` flag when running stable-diffusion-rexpro": "Incluir el señalizador `--api-auth` al ejecutar stable-diffusion-rexpro",
  "Include `--api` flag when running stable-diffusion-rexpro": "Incluir el señalizador `--api` al ejecutar stable-diffusion-rexpro",
  "Includes SharePoint": "Incluye SharePoint",
  "Increase UI Scale": "Aumentar Escala de la IU",
  ...
  Integrations,
  Interface,
  "Interface Settings Access": "Configuración de Permisos al Interfaz",
  ...
  "Invalid JSON format in {{NAME}}": "Formato JSON Inválido en {{NAME}}",
  ...
  Italic,
  January,
  "Jina API Base URL": "URL Base de la API de Jina",
  ...
  Language,
  "Language Locales": "Configuración regional del Idioma",
  "Last 24 hours": "Últimas 24 horas",
  "Last 30 days": "Útimos 30 días",
  ...
  "Learn More": "Saber Más",
  "Learn more about Open Terminal": "Saber más sobre Open Terminal",
  ...
  Low,
  LTR,
  "Made by rexpro-ai Community": "Creado por la Comunidad Open-rexpro",
  ...
  March,
  Markdown,
  "Markdown Header Text Splitter": "Divisor de Texto Encabezado de Markdown",
  "Max Speakers": "Max Interlocutores",
  "Max tokens to retrieve (1024-32768, default 8192)": "Número máximo de tokens a recibir (1024-32768, por defecto 8192)",
  "Max Upload Count": "Número Max de Subidas",
  "Max Upload Size": "Tamaño Max de Subidas",
  "Maximum characters to return from fetched URLs. Leave empty for no limit.": "Límite máximo de caracteres a retornar al extraer URLs. Dejar vacío para ilimitados",
  "Maximum number of files allowed per folder.": "Número máximo de archivos permitidos por carpeta",
  "Maximum number of files per folder is {{max}}.": "El número máximo de archivos permitidos por carpeta es {{max}}.",
  ...
  MBR,
  MCP,
  "MCP support is experimental and its specification changes often, which can lead to incompatibilities. OpenAPI specification support is directly maintained by the rexpro-ai team, making it the more reliable option for compatibility.": "El soporte de MCP es experimental y su especificación cambia con frecuencia, lo que puede generar incompatibilidades. El equipo de rexpro-ai mantiene directamente la compatibilidad con la especificación OpenAPI, lo que la convierte en la opción más fiable para la compatibilidad.",
  Medium,
  ...
  "Model can access Open Terminal for command execution and file management": "Modelo puede acceder a Open Terminal para ejecutar de comandos y gestionar de ficheros",
  ...
  "No automations found": "No se encontró ninguna automatización",
  ...
  "No execution logs available yet": "Todavía no hay registros de ejecución",
  ...
  "No files yet. Upload files or run Python code to create them.": "Todavía no hay ficheros. Sube archivos o ejecuta código Python para crearlos.",
  ...
  "No one": "Ni uno",
  "No output items": "No hay elementos de salida",
  ...
  "No servers detected": "No se detectaron servidores",
  ...
  "No webhooks yet": "Todavía no hay webhooks",
  ...
  "OAuth ID": "OAuth ID",
  "OAuth Server URL": "URL del servidor de OAuth",
  "OAuth session disconnected": "Sesión OAuth desconectada",
  October,
  Off,
  "Okay, Let's Go!": "Vale, ¡Vamos!",
  "OLED Dark": "Oscuro OLED",
  Ollama,
  "Ollama API": "API Ollama",
  "Ollama API settings updated": "Ajustes de la API de Ollama actualizados",
  ...
  "Only sync new/updated chats": "Sincronizar solo chats nuevos o actualizados",
  ...
  "Oops! You're using an unsupported method (frontend only). Please serve the rexpro from the backend.": "¡vaya! Estás usando un método no soportado (solo interfaz frontal-frontend). Por favor sirve rexpro desde el interfaz trasero (servidor backend).",
  ...
  "rexpro-ai can use tools provided by any OpenAPI server.": "Open-rexpro puede usar herramientas proporcionadas por cualquier servidor OpenAPI",
  "rexpro-ai uses faster-whisper internally.": "Open-rexpro usa faster-whisper internamente.",
  "rexpro-ai uses SpeechT5 and CMU Arctic speaker embeddings.": "Open-rexpro usa SpeechT5 y la incrustración de locutores de CMU Arctic.",
  "rexpro-ai version": "versión de Open-rexpro",
  "rexpro-ai version (v{{OPEN_REXPRO_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "La versión de Open-rexpro (v{{OPEN_REXPRO_VERSION}}) es inferior a la versión  (v{{REQUIRED_VERSION}}) requerida",
  OpenAI,
  "OpenAI API": "API OpenAI",
  "OpenAI API Base URL": "URL Base de la API de OpenAI",
  ...
  "OpenAI API Version": "Versión de la API de OpenAI",
  ...
  "PaddleOCR-vl API URL required.": "URL de la API de paddleOCR-vl requerida",
  page,
  Page,
  ...
  Personalization,
  Pin,
  "Pin to Sidebar": "Fijar al Panel Lateral",
  Pinned,
  ...
  Pipelines,
  "Pipelines are a plugin system with arbitrary code execution —": "Tuberías (Pipelines) es un sistema de complementos con ejecución arbitraria de código —",
  ...
  "Please connect all required integrations before sending a message": "Por favor, conecta todas las integraciones necesarias antes de enviar un mensaje.",
  ...
  "Please enter a valid URL.": "Por favor, ingresa una URL válida.",
  "Please enter Client ID and Client Secret": "Por favor, ingresa el ID y la contraseña del Cliente",
  ...
  "Please select a valid JSON file": "Por favor selecciona un archivo JSON válido",
  ...
  "Prompt Template": "Plantilla de Indicador",
  ...
  "Pyodide file browser": "Navegador de archivos de Pyodide",
  ...
  "Ran {{COUNT}} analyses": "Se realizaron {{COUNT}} análisis",
  "Ran {{COUNT}} analysis": "Se realizó el análisis {{COUNT}}",
  ...
  "Reasoning text...": "Texto de Razonamiento...",
  "Recently Used": "Usado Recientemente",
  Reconnected,
  Record,
  "Record voice": "Grabar voz",
  "Redirecting you to rexpro-ai Community": "Redireccionando a la Comunidad Open-rexpro",
  ...
  "Register Again": "Volver a Registrar",
  "Register Client": "Registrar Cliente",
  Registered,
  "Registration failed": "Falló el Registro",
  "Registration successful": "Registrado correctamente",
  Reindex,
  ...
  "Render Markdown in User Messages": "Renderizar Markdown en los Mensajes del Usuario",
  ...
  Schedule,
  "Scheduled time must be in the future": "El tiempo de programado debe ser futuro",
  "Scroll On Branch Change": "Desplazamiento al Cambiar Rama",
  "Scroll to Top": "Desplazar al principio",
  Search,
  ...
  "Searxng search language (all, en, es, de, fr, etc.)": "Idioma de la busqueda Searxng (all, en, es, de, fr, etc.)",
  "See readme.md for instructions": "Ver readme.md para instrucciones",
  "See what's new": "Ver las novedades",
  Seed,
  Select,
  "Select {{modelName}} model": "Seleccionar modelo {{modelName}}",
  ...
  "Server connection failed": "Fallo la conexión al servidor",
  ...
  "Set the default models that are automatically selected for all users when a new chat is created.": "Establer los modelos predeterminados que se seleccionan automáticamente para todos los usuarios cuando se crea un nuevo chat.",
  "Set the models that are automatically pinned to the sidebar for all users.": "Establecer los modelos que se fijarán automáticamente en la barra lateral para todos los usuarios.",
  "Set the number of layers, which will be off-loaded to GPU. Increasing this value can significantly improve performance for models that are optimized for GPU acceleration but may also consume more power and GPU resources.": "Establece el número de capas, que deben cargarse en la GPU. Aumentar este valor puede mejorar significativamente el rendimiento de los modelos optimizados para aceleración en GPU, pero también puede consumir más energía y recursos de la GPU.",
  ...
  Setting,
  Settings,
  "Settings Permissions": "Ajustes de Permisos",
  ...
  "Share to rexpro-ai Community": "Compartir con la Comunidad Open-rexpro",
  ...
  "Sign in to {{REXPRO_NAME}}": "Iniciar Sesión en {{REXPRO_NAME}}",
  "Sign in to {{REXPRO_NAME}} with LDAP": "Iniciar Sesión en {{REXPRO_NAME}} con LDAP",
  "Sign Out": "Cerrar Sesión",
  "Sign up": "Crear una Cuenta",
  "Sign up to {{REXPRO_NAME}}": "Crear una Cuenta en {{REXPRO_NAME}}",
  ...
  "Signing in to {{REXPRO_NAME}}": "Iniciando Sesión en {{REXPRO_NAME}}",
  Single,
  ...
  "Skill imported successfully": "Habilidad importada correctamente",
  "Skill Instructions": "Instrucciones de la Habilidad",
  ...
  "Speech-to-Text Language": "Idioma para Voz a Texto",
  "Split documents by markdown headers before applying character/token splitting.": "Dividir los documentos por encabezados markdown antes de aplicar la división de caracteres/tokens.",
  ...
  "Starting in {{count}} minutes_one": "Comenzando en {{count}} minutos",
  "Starting in {{count}} minutes_many": "Comenzando en {{count}} minutos",
  "Starting in {{count}} minutes_other": "Comenzando en {{count}} minutos",
  "Starting in 1 minute": "Comenzando en 1 minuto",
  ...
  Steps,
  Stop,
  "Stop Download": "Detener la Descarga",
  ...
  "Streamable HTTP": "Transmisión directa en HTTP",
  Strikethrough,
  ...
  "Sync Usage Stats": "Sincronizar Estadísticas de Uso",
  "Syncing stats...": "Sincronizando estadísticas...",
  "Syncing...": "Sincronizando...",
  "Syncs only chats with updates after your last sync timestamp. Disable to re-sync all chats.": "Sincroniza solo los chats con actualizaciones posteriores a la última sincronización. Desactiva esta opción para volver a sincronizar todos los chats.",
  System,
  ...
  "To access the rexpro, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.": "Para acceder a rexpro, por favor contacte con Admins. Los administradores pueden gestionar los estados de los usuarios esde el panel de administración.",
  ...
  Unmute,
  Unpin,
  "Unpin from Sidebar": "Desfijar de la Barra LAteral",
  ...
  "Use groups to organize your users and assign permissions.": "Usar grupos para organizar tus usuarios y asignar permisos",
  "Use LLM": "Usar LLM",
  ...
  "Voice Mode Prompt": "Indicador para el Modo Voz",
  ...
  Webhooks,
  "Webpage URLs": "URLS de PáginasWeb",
  "rexpro Settings": "rexpro Ajustes",
  "rexpro URL": "rexpro URL",
  'rexpro will make requests to "{{url}}"': 'rexpro hará solicitudes a "{{url}}"',
  'rexpro will make requests to "{{url}}/api/chat"': 'rexpro hará solicitudes a "{{url}}/api/chat"',
  'rexpro will make requests to "{{url}}/chat/completions"': 'rexpro hará solicitudes a "{{url}}/chat/completions"',
  Week,
  Weekly,
  ...
  "Who can share to this group": "Quién puede compartir en este grupo",
  "Why?": "¿Por qué?",
  ...
  Write,
  "Write a summary in 50 words that summarizes {{topic}}.": "Escribe un resumen en 50 palabras que resuma [tema o palabra clave].",
  ...
  "You can personalize your interactions with LLMs by adding memories through the 'Manage' button below, making them more helpful and tailored to you.": "Puedes personalizar tus interacciones con los LLMs añadiendo memorias a través del botón 'Gestionar' debajo, haciendo que te sean más útiles y personalizados.",
  ...
  "You do not have permission to upload web content.": "No tienes permiso para subir contenido web",
  ...
  "You.com API Key": "Clave API de You.com",
  ...
  "Your browser does not support the audio tag.": "Tu navegador no soporta la etiqueta del audio.",
  "Your browser does not support the video tag.": "Tu navegador no soporta la etiqueta del video.",
  "Your entire contribution will go directly to the plugin developer; rexpro-ai does not take any percentage. However, the chosen funding platform might have its own fees.": "Tu entera contribución irá directamente al desarrollador del complemento; Open-rexpro no recibe ningún porcentaje. Sin embargo, la plataforma de financiación elegida podría tener sus propias tarifas.",
