...
const August = "8月";
const Auth = "認証";
const Authenticate = "認証";
const Authentication = "認証";
const Auto = "自動";
const Automatic1111 = "AUTOMATIC1111";
const Automation = "オートメーション";
const Automations = "オートメーション";
const Away = "離席中";
const Awful = "ひどい";
const Back = "戻る";
const Banners = "バナー";
...
const Collection = "コレクション";
const Collections = "コレクション";
const Color = "色";
...
const Display = "表示";
const Docling = "";
const Document = "ドキュメント";
const Documentation = "ドキュメント";
const Documents = "";
const Done = "完了";
...
const Ephemeral = "";
const ERROR = "エラー";
const Evaluations = "評価";
const Exclude = "除外";
const Expand = "展開";
const Experimental = "実験的";
const Explain = "説明";
const Explored = "";
const Exploring = "";
const Export = "エクスポート";
...
const Include = "含める";
const Info = "情報";
const Initials = "イニシャル";
const Input = "入力";
const Insert = "挿入";
const Instructions = "指示";
const Integration = "連携";
const Integrations = "連携";
const Interface = "インターフェース";
const Italic = "斜体";
const January = "1月";
const July = "7月";
const June = "6月";
const Key = "キー";
const Knowledge = "ナレッジベース";
const Label = "ラベル";
const Language = "言語";
const LDAP = "LDAP";
const Leaderboard = "リーダーボード";
const Legacy = "";
const lexical = "文法的";
const License = "ライセンス";
const Light = "ライト";
...
const page = "ページ";
const Page = "";
const Paginate = "ページ分け";
const Parameters = "パラメータ";
const Password = "パスワード";
const Paused = "停止中";
const pending = "保留中";
const Pending = "処理中";
const Permissions = "権限";
const Persistent = "";
const Personalization = "パーソナライズ";
const Pin = "ピン留め";
const Pinned = "ピン留めされています";
const Pipe = "パイプ";
const Pipelines = "";
const Playground = "プレイグラウンド";
const Port = "ポート";
const Ports = "";
const Preview = "プレビュー";
const Private = "プライベート";
...
const translation = {
  ...
  "(e.g. `sh rexpro.sh --api --api-auth username_password`)": "(例: `sh rexpro.sh --api --api-auth username_password`)",
  "(e.g. `sh rexpro.sh --api`)": "(例: `sh rexpro.sh --api`)",
  "(latest)": "(最新)",
  ...
  "{{COUNT}} extracted lines": "{{COUNT}} 行を抽出",
  "{{COUNT}} files": "",
  ...
  "{{rexproAIName}} Backend Required": "{{rexproAIName}} バックエンドが必要です",
  ...
  "Allow Continue Response": "続きの応答を許可",
  "Allow Delete Messages": "メッセージの削除を許可",
  ...
  "Allow Rate Response": "応答の評価を許可",
  "Allow Regenerate Response": "再生成を許可",
  ...
  "Are you sure you want to delete this memory? This action cannot be undone.": "このメモリをクリアしますか？ この操作は元に戻すことができません。",
  ...
  "Automation Name": "オートメーション名",
  "Automation title": "オートメーションのタイトル",
  "Automation triggered": "オートメーションが実行されました",
  ...
  "Contact Admin for rexpro Access": "REXPROへのアクセスについて管理者に問い合わせ下さい。",
  Content,
  ...
  "Copy Last Code Block": "直前のコードブロックをコピー",
  ...
  "CORS must be properly configured by the provider to allow requests from rexpro-ai.": "rexpro-aiからのリクエストを許可するために、プロバイダーによってCORSが適切に設定されている必要があります。",
  "Could not read file.": "",
  CPU,
  Create,
  ...
  "Create note": "ノートを作成",
  "Create Note": "ノートを作成",
  "Create scheduled prompts that run automatically on a recurring basis.": "定期的に自動実行されるプロンプトを作成します。",
  "Create your first note by clicking on the plus button below.": "プラスボタンをクリックして最初のノートを作成します。",
  "Created at": "作成日時",
  "Created At": "作成日時",
  "Created by": "作成者",
  "Created by you": "自分が作成",
  "Created on {{date}}": "",
  "CSV Import": "CSVインポート",
  ...
  "Discover how to use rexpro-ai and seek support from the community.": "rexpro-aiの使用方法を探し、コミュニティからサポートを求めてください。",
  ...
  "e.g. about the Roman Empire": "例: ローマ帝国について",
  "e.g. alloy, echo, shimmer": "例: alloy, echo, shimmer",
  "e.g. Code Review Guidelines": "例: コードレビュー ガイドライン",
  "e.g. code-review-guidelines": "例: code-review-guidelines",
  "e.g. en": "例: ja",
  "e.g. My Filter": "",
  "e.g. My Tools": "",
  "e.g. my_filter": "",
  "e.g. my_tools": "",
  "e.g. pdf, docx, txt": "",
  "e.g. Step-by-step instructions for code reviews": "例: コードレビューの手順",
  "e.g. Tell me a fun fact": "例: 面白い豆知識を教えて",
  "e.g. Tell me a fun fact about the Roman Empire": "例: ローマ帝国についての面白い豆知識を教えて",
  ...
  "Enter skill instructions in markdown...": "Skillの指示をMarkdown形式で入力してください…",
  ...
  "Enter the prompt instructions for this automation...": "このオートメーションのプロンプトを入力してください...",
  "Enter the public URL of your rexpro. This URL will be used to generate links in the notifications.": "rexproAIの公開URLを入力してください。このURLは通知でリンクを生成するために使用されます。",
  ...
  "Export Config": "",
  "Export Models": "モデルをエクスポート",
  "Export Prompts": "",
  "Export to CSV": "CSVにエクスポート",
  "Export Tools": "ツールをエクスポート",
  ...
  "Folder created successfully": "フォルダーが正常に作成されました。",
  ...
  "Formatting may be inconsistent from source.": "元のデータにより、書式が一致しない場合があります。",
  Forward,
  ...
  "Get started": "はじめる",
  "Get started with {{REXPRO_NAME}}": "{{REXPRO_NAME}}をはじめる",
  Global,
  "Good Response": "良い応答",
  Google,
  ...
  "Import Prompts": "",
  "Import successful": "",
  "Import Tools": "ツールをインポート",
  "Important Update": "重要な更新",
  Inactive,
  Include,
  "Include `--api-auth` flag when running stable-diffusion-rexpro": "stable-diffusion-rexproを実行する際に`--api-auth`フラグを含めてください",
  "Include `--api` flag when running stable-diffusion-rexpro": "stable-diffusion-rexproを実行する際に`--api`フラグを含めてください",
  ...
  Integrations,
  Interface,
  "Interface Settings Access": "インターフェース設定へのアクセス",
  ...
  "Leave empty to use first admin user": "空欄で最初の管理者ユーザー",
  ...
  Low,
  LTR,
  "Made by rexpro-ai Community": "rexpro-ai コミュニティによって作成",
  ...
  "Maximum number of files allowed per folder.": "1 つのフォルダーに保存できるファイルの最大数を指定します。",
  "Maximum number of files per folder is {{max}}.": "フォルダー内のファイル数は最大 {{max}} 件までです。",
  ...
  "New Group": "新しいグループ",
  "New Knowledge": "新しいナレッジベース",
  "New Model": "新しいモデル",
  "New Note": "新しいノート",
  "New Password": "新しいパスワード",
  "New Prompt": "新しいプロンプト",
  "New Skill": "新しいSkill",
  "New Temporary Chat": "新しい一時的なチャット",
  "New Terminal": "",
  "New Tool": "新しいツール",
  "New Webhook": "",
  ...
  "No activity data": "",
  "No authentication": "",
  "No automations found": "オートメーションが見つかりません",
  ...
  Notes,
  "Notes Public Sharing": "ノートの公開共有",
  "Notes Sharing": "ノートの共有",
  ...
  "Only active when the chat input is in focus.": "チャット入力欄にフォーカスがあるときのみ有効です。",
  ...
  "Only can be triggered when the chat input is in focus.": "チャット入力欄にフォーカスがあるときのみ使用できます。",
  ...
  "Oops! You're using an unsupported method (frontend only). Please serve the rexpro from the backend.": "おっと！ サポートされていない方法 (フロントエンドのみ) を使用しています。バックエンドから rexpro を提供してください。",
  "Open file": "ファイルを開く",
  ...
  "Open Model Selector": "モデル選択を開く",
  "Open Settings": "設定を開く",
  "Open Sidebar": "サイドバーを開く",
  "Open Terminal": "",
  "Open User Profile Menu": "ユーザープロフィールメニューを開く",
  "rexpro-ai can use tools provided by any OpenAPI server.": "rexpro-ai は任意のOpenAPI サーバーが提供するツールを使用できます。",
  "rexpro-ai uses faster-whisper internally.": "rexpro-ai は内部でfaster-whisperを使用します。",
  "rexpro-ai uses SpeechT5 and CMU Arctic speaker embeddings.": "rexpro-ai は SpeechT5とCMU Arctic スピーカー埋め込みを使用します。",
  "rexpro-ai version": "",
  "rexpro-ai version (v{{OPEN_REXPRO_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "rexpro-ai のバージョン (v{{OPEN_REXPRO_VERSION}}) は要求されたバージョン (v{{REQUIRED_VERSION}}) より低いです。",
  OpenAI,
  ...
  "Prevent File Creation": "ファイル作成を防止",
  Preview,
  "Preview Access": "",
  ...
  Record,
  "Record voice": "音声を録音",
  "Redirecting you to rexpro-ai Community": "rexpro-ai コミュニティにリダイレクトしています",
  ...
  "Retrieved {{count}} sources": "{{count}} 件のソースを取得",
  "Retrieved {{count}} sources_other": "",
  "Retrieved 1 source": "1 件のソースを取得",
  ...
  "Sign in": "サインイン",
  "Sign in to {{REXPRO_NAME}}": "{{REXPRO_NAME}}にサインイン",
  "Sign in to {{REXPRO_NAME}} with LDAP": "{{REXPRO_NAME}}にLDAPでサインイン",
  "Sign Out": "サインアウト",
  "Sign up": "サインアップ",
  "Sign up to {{REXPRO_NAME}}": "{{REXPRO_NAME}}にサインアップ",
  ...
  "Signing in to {{REXPRO_NAME}}": "{{REXPRO_NAME}}にサインイン",
  Single,
  "Sink List": "リストの字下げを戻す",
  "sk-1234": "sk-1234",
  "Skill created successfully": "",
  "Skill deleted successfully": "",
  "Skill Description": "Skillの説明",
  "Skill ID": "",
  ...
  "To access the rexpro, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.": "rexproAIにアクセスするには、管理者にお問い合わせください。管理者は管理者パネルからユーザーのステータスを管理できます。",
  ...
  "Try adjusting your search or filter to find what you are looking for.": "検索条件やフィルターを調整して、もう一度お試しください。",
  "Try Again": "再試行",
  "TTS Model": "TTSモデル",
  "TTS Settings": "TTS 設定",
  "TTS Voice": "TTSボイス",
  ...
  Webhooks,
  "Webpage URLs": "ウェブページのURL",
  "rexpro Settings": "rexpro 設定",
  "rexpro URL": "",
  'rexpro will make requests to "{{url}}"': 'rexproAIは"{{url}}"にリクエストを行います',
  'rexpro will make requests to "{{url}}/api/chat"': 'rexproAIは"{{url}}/api/chat"にリクエストを行います',
  'rexpro will make requests to "{{url}}/chat/completions"': 'rexproAIは"{{url}}/chat/completions"にリクエストを行います',
  Week,
  Weekly,
  ...
  "Who can share to this group": "このグループを共有できるユーザー",
  "Why?": "どうしてですか？",
  ...
  Write,
  "Write a summary in 50 words that summarizes {{topic}}.": "[トピックまたはキーワード] を要約する 50 語の概要を書いてください。",
  ...
  Yesterday,
  "Yesterday at {{LOCALIZED_TIME}}": "昨日 {{LOCALIZED_TIME}}",
  You,
  ...
  "Your entire contribution will go directly to the plugin developer; rexpro-ai does not take any percentage. However, the chosen funding platform might have its own fees.": "あなたの全ての寄付はプラグイン開発者へ直接送られます。rexpro-ai は手数料を一切取りません。ただし、選択した資金提供プラットフォーム側に手数料が発生する場合があります。",
