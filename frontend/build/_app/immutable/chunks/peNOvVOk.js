const About = "Tungkol sa";
const Access = "";
const Account = "Account";
const Action = "Aksyon";
const Actions = "Mga Aksyon";
const Activate = "";
const Active = "Aktibo";
const Activity = "Aktibidad";
const Add = "Idagdag";
const admin = "";
const Admin = "";
const Advanced = "";
...
const Bing = "";
const Bio = "";
const Bold = "Naka-bold";
const Brave = "";
const Calendar = "Kalendaryo";
const Calendars = "Mga Kalendaryo";
const Call = "Tawag";
const Camera = "";
const Cancel = "Kanselahin";
const Capabilities = "";
const Capture = "";
const Channel = "";
const Channels = "Mga Channel";
const Character = "";
const Chat = "Chat";
const chats = "";
const Chats = "Mga Chat";
const Ciphers = "";
const Citation = "";
const Citations = "";
const Clone = "";
...
const command = "";
const Command = "";
const Comment = "Komento";
const Completions = "";
const Config = "";
const Configuration = "";
const Configure = "";
const Confirm = "Kumpirmahin";
const Connections = "Mga Koneksyon";
const Content = "Nilalaman";
const Controls = "";
const Copied = "";
const Copy = "Kopyahin";
const CPU = "";
const Create = "Lumikha";
const Custom = "";
const Daily = "Araw-araw";
const Dark = "Madilim";
const Database = "";
const Day = "Araw";
const December = "Disyembre";
const Deepgram = "";
const Default = "";
const Defaults = "";
const Delete = "Burahin";
const Deleted = "Nabura";
const Desc = "";
const Description = "Paglalarawan";
const Deselect = "";
const Dictate = "";
const Direct = "";
const Disabled = "Naka-disable";
const Display = "";
const Docling = "";
const Document = "Dokumento";
const Documentation = "";
const Documents = "Mga Dokumento";
const Done = "Tapos";
...
const Embedding = "";
const Emoji = "";
const Emojis = "Mga Emoji";
const Enabled = "Pinagana";
const Enhance = "";
const Ephemeral = "";
const ERROR = "";
const Evaluations = "";
const Exclude = "";
const Expand = "Palawakin";
const Experimental = "";
const Explain = "";
const Explored = "";
const Exploring = "";
const Export = "I-export";
const External = "";
const Features = "";
const February = "Pebrero";
const Feedback = "Puna";
const Female = "Babae";
const File = "";
const Filename = "";
const Files = "";
const Filter = "Salain";
const Filters = "Mga Filter";
const Folder = "";
const Folders = "";
const Form = "";
const Forward = "Ipasa";
const Fr_day_of_week = "Biyernes";
const Functions = "";
const Gemini = "";
const Gender = "Kasarian";
const General = "Pangkalahatan";
const Generate = "";
const Global = "";
const Google = "";
const Gravatar = "";
...
const Height = "";
const Help = "Tulong";
const Hidden = "Nakatago";
const Hide = "Itago";
const High = "";
const History = "Kasaysayan";
const Home = "Tahanan";
const Host = "";
const Hourly = "Bawat Oras";
const HTML = "";
const ID = "";
const Image = "Larawan";
const Images = "Mga Larawan";
const Import = "I-import";
const Inactive = "Hindi Aktibo";
const Include = "";
const Info = "Impormasyon";
const Initials = "";
const Input = "";
const Insert = "";
const Instructions = "Mga Tagubilin";
const Integration = "";
const Integrations = "";
const Interface = "";
const Italic = "";
...
const Legacy = "";
const lexical = "";
const License = "Lisensya";
const Light = "Maliwanag";
const List = "Listahan";
const Live = "";
const Loaded = "";
const Loader = "";
const local = "lokal";
const Local = "Lokal";
const Location = "Lokasyon";
const Lost = "";
const Low = "";
const LTR = "";
const Male = "Lalaki";
const Manage = "Pamahalaan";
const March = "Marso";
const Markdown = "";
const May = "Mayo";
const MBR = "";
...
const Medium = "";
const members = "";
const Members = "Mga Miyembro";
const Memories = "Mga Alaala";
const Memory = "Alaala";
const Message = "Mensahe";
const messages = "";
const Messages = "Mga Mensahe";
const min = "";
const MinerU = "";
const MistralAI = "";
const Mo_day_of_week = "Lunes";
const Model = "Modelo";
const Models = "Mga Modelo";
const Mojeek = "";
const Month = "Buwan";
const Monthly = "Buwanin";
const More = "Higit Pa";
const Move = "Ilipat";
const Mute = "";
const Muted = "";
const Name = "Pangalan";
const Native = "";
const Never = "Hindi Kailanman";
const New = "Bago";
const None = "Wala";
const Note = "Tala";
const Notes = "Mga Tala";
const Notifications = "Mga Abiso";
const November = "Nobyembre";
const OAuth = "";
const October = "Oktubre";
const Off = "Naka-off";
const Ollama = "";
const On = "Naka-on";
const Once = "";
...
const OpenAPI = "";
const optional = "";
const Optional = "Opsyonal";
const or = "";
const Other = "Iba pa";
const Output = "";
const OUTPUT = "";
const Overview = "Pangkalahatang-tanaw";
const page = "";
const Page = "Pahina";
const Paginate = "";
const Parameters = "";
const Password = "";
const Paused = "Naka-pause";
const pending = "";
const Pending = "Nakabinbin";
const Permissions = "Mga Pahintulot";
const Persistent = "";
const Personalization = "Personalisasyon";
const Pin = "I-pin";
const Pinned = "Naka-pin";
const Pipe = "";
const Pipelines = "";
const Playground = "";
const Port = "";
const Ports = "";
const Preview = "";
const Private = "Pribado";
const Profile = "";
const Prompt = "";
const Prompts = "";
const Provider = "";
const Public = "Pampubliko";
const Querying = "";
const Rating = "";
const Read = "Basahin";
const Reason = "";
...
const Refresh = "I-refresh";
const Regenerate = "";
const Registered = "";
const Reindex = "";
const Releases = "";
const Relevance = "";
const Reminder = "Paalala";
const Remove = "Alisin";
const Rename = "Palitan ng Pangalan";
const Repeats = "";
const Reply = "Sumagot";
const required = "";
const Reset = "I-reset";
const Response = "Tugon";
const Responses = "";
const Restart = "";
const Result = "Resulta";
const RESULT = "";
const Retrieval = "";
const Role = "Tungkulin";
const RTL = "";
const Run = "Patakbuhin";
const Running = "";
const Sa_day_of_week = "Sabado";
const Save = "I-save";
const Saved = "Nai-save";
const Schedule = "Iskedyul";
const Search = "Maghanap";
const Searching = "Naghahanap";
const Seed = "";
const Select = "Pumili";
const semantic = "";
const Send = "Ipadala";
const September = "Setyembre";
const Session = "";
const Setting = "";
const Settings = "Mga Setting";
const Share = "Ibahagi";
const Show = "Ipakita";
const Single = "";
const Skills = "";
...
const Source = "";
const State = "";
const Status = "Katayuan";
const Steps = "";
const Stop = "Itigil";
const Storage = "Imbakan";
const Strikethrough = "";
const Su_day_of_week = "Linggo";
const Subtitle = "";
const Success = "";
const Suggested = "";
const Support = "Suporta";
const Sync = "I-sync";
const System = "Sistema";
const Tag = "";
const Tags = "Mga Tag";
const Tasks = "Mga Gawain";
const Temperature = "";
const Terminal = "";
const Th_day_of_week = "Huwebes";
const Theme = "Tema";
const Thought = "";
const Thread = "";
const Tika = "";
...
const tokens = "";
const Tokens = "";
const Tools = "Mga Tool";
const Top = "";
const Transformers = "";
const Tu_day_of_week = "Martes";
const Type = "Uri";
const UI = "";
const Underline = "Naka-salungguhit";
const Unknown = "Hindi Kilala";
const Unmute = "";
const Unpin = "I-unpin";
const Untagged = "";
const Untitled = "";
const Update = "I-update";
const Updated = "Na-update";
const Upload = "Mag-upload";
const URL = "";
const Usage = "Paggamit";
const Use = "";
const user = "";
const User = "Gumagamit";
const Username = "";
const users = "";
const Users = "Mga Gumagamit";
const Valves = "";
const variable = "";
const Version = "Bersyon";
const Visibility = "";
const Visible = "Nakikita";
const Vision = "";
const Visual = "";
const Voice = "Boses";
const Warning = "Babala";
const We_day_of_week = "Miyerkules";
const Web = "";
const Webhooks = "";
const Week = "";
const Weekly = "Linggu-linggo";
const When = "";
const Width = "";
const Wikipedia = "";
const Won = "";
...
const translation = {
  ...
  "Delete function?": "",
  "Delete Memory?": "",
  "Delete Message": "Burahin ang Mensahe",
  "Delete message?": "",
  "Delete Model": "",
  "Delete note?": "",
  "Delete prompt?": "",
  ...
  Hourly,
  "Hourly Messages": "",
  "How can I help you today?": "Paano kita matutulungan ngayon?",
  ...
  Language,
  "Language Locales": "",
  "Last 24 hours": "Nakalipas na 24 na oras",
  "Last 30 days": "Nakalipas na 30 araw",
  "Last 7 days": "Nakalipas na 7 araw",
  "Last 90 days": "Nakalipas na 90 araw",
  ...
  "Notes Sharing": "",
  "Notification Sound": "Tunog ng Abiso",
  ...
  "Reasoning Tags": "",
  "Reasoning text...": "",
  "Recently Used": "Kamakailan Ginamit",
  Reconnected,
  Record,
  "Record voice": "",
  "Redirecting you to rexpro-ai Community": "",
  ...
  "Searching the web": "Naghahanap sa web",
  "Searxng Query URL": "",
  ...
  "Start a new conversation": "Magsimula ng bagong usapan",
  ...
  user,
  User,
  "User Activity": "Aktibidad ng Gumagamit",
  ...
  "Version deleted": "",
  "View Replies": "Tingnan ang mga Sagot",
  ...
  "What are you working on?": "Ano ang ginagawa mo?",
  "What is NOT shared:": "",
  "What is shared:": "",
  "What's New in": "",
  "What's on your mind?": "Anong naiisip mo?",
  When,
  ...
  "Write something...": "Sumulat ng isang bagay...",
  ...
  "You're now logged in.": "Naka-log in ka na.",
