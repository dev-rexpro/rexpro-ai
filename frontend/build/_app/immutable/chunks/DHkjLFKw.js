const About = "بارے میں";
const Access = "";
const Account = "اکاؤنٹ";
const Action = "";
const Actions = "اعمال";
const Activate = "";
const Active = "فعال";
...
const Anyone = "";
const April = "اپریل";
const Archive = "آرکائیو";
const Artifacts = "نوادرات";
const Asc = "";
const Ask = "";
const Assistant = "اسسٹنٹ";
const Audio = "آڈیو";
const August = "اگست";
const Auth = "";
const Authenticate = "";
...
const Auto = "";
const Automatic1111 = "آٹو میٹک1111";
const Automation = "";
const Automations = "";
const Away = "غیر حاضر";
const Awful = "";
...
const Capabilities = "صلاحیتیں";
const Capture = "";
const Channel = "";
const Channels = "";
const Character = "کردار";
const Chat = "چیٹ";
const chats = "";
const Chats = "بات چیت";
const Ciphers = "";
const Citation = "حوالہ";
const Citations = "";
const Clone = "نقل کریں";
const Close = "بند کریں";
const cloud = "";
const Collapse = "";
const Collection = "کلیکشن";
const Collections = "";
const Color = "";
const ComfyUI = "کومفی یو آئی";
const command = "";
const Command = "کمانڈ";
const Comment = "";
const Completions = "تکمیل";
const Config = "";
const Configuration = "";
const Configure = "";
const Confirm = "تصدیق کریں";
const Connections = "کنکشنز";
const Content = "مواد";
const Controls = "کنٹرولز";
const Copied = "کاپی کیا گیا";
const Copy = "نقل کریں";
const CPU = "";
const Create = "";
const Custom = "حسب ضرورت";
const Daily = "";
const Dark = "ڈارک";
const Database = "ڈیٹا بیس";
const Day = "";
const December = "دسمبر";
const Deepgram = "";
const Default = "پہلے سے طے شدہ";
const Defaults = "";
const Delete = "حذف کریں";
const Deleted = "";
const Desc = "";
const Description = "تفصیل";
const Deselect = "";
const Dictate = "";
const Direct = "";
const Disabled = "غیر فعال";
const Display = "";
const Docling = "";
const Document = "دستاویز";
const Documentation = "دستاویزات";
const Documents = "";
const Done = "ہو گیا";
const Download = "ڈاؤن لوڈ کریں";
const Draw = "ڈرائنگ کریں";
const DuckDuckGo = "";
const Edit = "ترمیم کریں";
const edited = "";
const Edited = "";
const Editing = "";
const Eject = "";
const ElevenLabs = "الیون لیبز";
const Email = "ای میل";
const Embedding = "";
const Emoji = "";
const Emojis = "";
const Enabled = "فعال کردیا گیا ہے";
const Enhance = "";
const Ephemeral = "";
const ERROR = "غلطی";
const Evaluations = "تشخیصات";
const Exclude = "خارج کریں";
const Expand = "";
const Experimental = "تجرباتی";
const Explain = "";
const Explored = "";
const Exploring = "";
const Export = "برآمد کریں";
const External = "";
const Features = "";
const February = "فروری";
const Feedback = "";
const Female = "";
const File = "فائل";
const Filename = "";
...
const Lost = "گم شدہ";
const Low = "";
const LTR = "بائیں سے دائیں";
const Male = "";
const Manage = "مینیج کریں";
const March = "مارچ";
const Markdown = "";
const May = "مئی";
const MBR = "";
...
const Never = "";
const New = "";
const None = "کوئی نہیں";
const Note = "";
const Notes = "نوٹس";
const Notifications = "اطلاعات";
const November = "نومبر";
const OAuth = "";
const October = "اکتوبر";
const Off = "بند";
const Ollama = "اولامہ";
const On = "چالو";
const Once = "";
const OneDrive = "";
const OpenAI = "اوپن اے آئی";
const OpenAPI = "";
const optional = "";
const Optional = "";
const or = "یا";
...
const Paused = "";
const pending = "زیر التواء";
const Pending = "";
const Permissions = "";
const Persistent = "";
const Personalization = "شخصی ترتیبات";
const Pin = "پن";
const Pinned = "پن کیا گیا";
const Pipe = "";
const Pipelines = "";
const Playground = "کھیل کا میدان";
const Port = "";
const Ports = "";
const Preview = "";
const Private = "";
...
const Prompt = "";
const Prompts = "پرومپٹس";
const Provider = "";
const Public = "";
const Querying = "";
const Rating = "درجہ بندی";
const Read = "";
const Reason = "";
const Reconnected = "";
const Record = "";
const Refresh = "";
const Regenerate = "دوبارہ تخلیق کریں";
const Registered = "";
const Reindex = "";
const Releases = "";
const Relevance = "موزونیت";
const Reminder = "";
const Remove = "ہٹا دیں";
const Rename = "تبدیل نام کریں";
const Repeats = "";
const Reply = "";
const required = "";
const Reset = "ری سیٹ";
...
const RTL = "آر ٹی ایل";
const Run = "چلائیں";
const Running = "چل رہا ہے";
const Sa_day_of_week = "";
const Save = "محفوظ کریں";
const Saved = "محفوظ شدہ";
const Schedule = "";
const Search = "تلاش کریں";
const Searching = "";
const Seed = "بیج";
const Select = "";
const semantic = "";
const Send = "بھیجیں";
const September = "ستمبر";
const Session = "";
const Setting = "";
const Settings = "ترتیبات";
const Share = "اشتراک کریں";
const Show = "دکھائیں";
const Single = "";
const Skills = "";
const Sonar = "";
...
const Subtitle = "";
const Success = "کامیابی";
const Suggested = "تجویز کردہ";
const Support = "مدد کریں";
const Sync = "";
const System = "سسٹم";
const Tag = "";
const Tags = "";
const Tasks = "";
const Temperature = "درجہ حرارت";
const Terminal = "";
...
const Type = "ٹائپ کریں";
const UI = "صارف انٹرفیس";
const Underline = "";
const Unknown = "";
const Unmute = "";
const Unpin = "ان پن کریں";
const Untagged = "غیر مہر شدہ";
const Untitled = "";
const Update = "اپ ڈیٹ کریں";
const Updated = "اپ ڈیٹ کیا گیا";
const Upload = "اپ لوڈ کریں";
const URL = "";
const Usage = "";
const Use = "";
const user = "صارف";
...
const Wikipedia = "";
const Won = "جیتا";
const Workspace = "ورک اسپیس";
const Write = "";
const Yahoo = "";
const Yandex = "";
const Yesterday = "کل";
const You = "آپ";
const YouTube = "یوٹیوب";
const translation = {
  "-1 for no limit, or a positive integer for a specific limit": "",
  "'s', 'm', 'h', 'd', 'w' or '-1' for no expiration.": "'s', 'm', 'h', 'd', 'w' یا '1-' مستقل کے لیے",
  "(e.g. `sh rexpro.sh --api --api-auth username_password`)": "(مثال کے طور پر: `sh rexpro.sh --api --api-auth username_password`)",
  "(e.g. `sh rexpro.sh --api`)": "(مثال کے طور پر: `sh rexpro.sh --api`)",
  "(latest)": "(تازہ ترین)",
  ...
  "{{rexproAIName}} Backend Required": "{{rexproAIName}} بیک اینڈ درکار ہے",
  ...
  "Contact Admin for rexpro Access": "ویب یو آئی رسائی کے لیے ایڈمن سے رابطہ کریں",
  Content,
  ...
  "Enter URL (e.g. http://localhost:11434)": "یو آر ایل درج کریں (مثلاً http://localhost:11434)",
  "Enter value": "",
  ...
  Inactive,
  Include,
  "Include `--api-auth` flag when running stable-diffusion-rexpro": "`--api-auth` پرچم کو چلانے کے وقت شامل کریں stable-diffusion-rexpro",
  "Include `--api` flag when running stable-diffusion-rexpro": "اسٹیبل-ڈیفیوژن-ویب یو آئی چلانے کے دوران `--api` فلیگ شامل کریں",
  ...
  Low,
  LTR,
  "Made by rexpro-ai Community": "اوپن ویب یو آئی کمیونٹی کی جانب سے تیار کردہ",
  ...
  "Oops! You're using an unsupported method (frontend only). Please serve the rexpro from the backend.": "اوہ! آپ ایک غیر معاون طریقہ استعمال کر رہے ہیں (صرف فرنٹ اینڈ) براہ کرم ویب یو آئی کو بیک اینڈ سے پیش کریں",
  ...
  "rexpro-ai uses faster-whisper internally.": "اوپن ویب یو آئی اندرونی طور پر فاسٹر وِسپر استعمال کرتا ہے",
  "rexpro-ai uses SpeechT5 and CMU Arctic speaker embeddings.": "",
  "rexpro-ai version": "",
  "rexpro-ai version (v{{OPEN_REXPRO_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "اوپن rexpro ورژن (v{{OPEN_REXPRO_VERSION}}) مطلوبہ ورژن (v{{REQUIRED_VERSION}}) سے کم ہے",
  OpenAI,
  ...
  "Redirecting you to rexpro-ai Community": "آپ کو اوپن ویب یو آئی کمیونٹی کی طرف ری ڈائریکٹ کیا جا رہا ہے",
  ...
  "Share to rexpro-ai Community": "اوپن ویب یوآئی کمیونٹی کے ساتھ شیئر کریں\n",
  ...
  "Sign in to {{REXPRO_NAME}}": "{{REXPRO_NAME}} میں سائن ان کریں",
  "Sign in to {{REXPRO_NAME}} with LDAP": "",
  "Sign Out": "سائن آؤٹ کریں",
  "Sign up": "سائن اپ کریں",
  "Sign up to {{REXPRO_NAME}}": "{{REXPRO_NAME}} میں سائن اپ کریں",
  ...
  "Signing in to {{REXPRO_NAME}}": "{{REXPRO_NAME}} میں سائن اِن کر رہے ہیں",
  Single,
  "Sink List": "",
  "sk-1234": "",
  ...
  "To access the rexpro, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.": "ویب یو آئی تک رسائی حاصل کرنے کے لیے براہ کرم منتظم سے رابطہ کریں ایڈمنز صارف کی حالت کو ایڈمن پینل سے منظم کر سکتے ہیں",
  ...
  Webhooks,
  "Webpage URLs": "",
  "rexpro Settings": "ویب UI ترتیبات",
  "rexpro URL": "",
  ...
  Write,
  "Write a summary in 50 words that summarizes {{topic}}.": "موضوع یا کلیدی لفظ کا خلاصہ 50 الفاظ میں لکھیں",
