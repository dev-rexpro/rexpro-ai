import { d as APP_NAME } from "./CGP7Xb4V.js";
...
const REXPRO_NAME = writable(APP_NAME);
const REXPRO_VERSION = writable(null);
const REXPRO_DEPLOYMENT_ID = writable(null);
const config = writable(void 0);
const user = writable(void 0);
const isApp = writable(false);
const appInfo = writable(null);
const MODEL_DOWNLOAD_POOL = writable({});
const mobile = writable(false);
const socket = writable(null);
const socketConnected = writable(true);
const activeChatIds = writable(/* @__PURE__ */ new Set());
...
const terminalServers = writable([]);
const pyodideWorker = writable(null);
const banners = writable([]);
const settings = writable({});
const audioQueue = writable(null);
const chatRequestQueues = writable({});
const sidebarWidth = writable(260);
...
const showFileNavDir = writable(null);
...
export {
  ...
  pyodideWorker as F,
  showFileNavDir as G,
  temporaryChatEnabled as H,
  toolServers as I,
  terminalServers as J,
  showControls as K,
  showFileNavPath as L,
  showEmbeds as M,
  embed as N,
  artifactCode as O,
  showArtifacts as P,
  ...
  sidebarWidth as _,
  mobile as a,
  scrollPaginationEnabled as a0,
  selectedTerminalId as a1,
  showCallOverlay as a2,
  artifactContents as a3,
  chatRequestQueues as a4,
  showSidebar as b,
  config as c,
  ...
  functions as f,
  chatId as g,
  showArchivedChats as h,
  channels as i,
  emojiShortCodes as j,
  socket as k,
  showShortcuts as l,
  models as m,
  showSettings as n,
  channelId as o,
  pinnedNotes as p,
  playingNotificationSound as q,
  isLastActiveTab as r,
  settings as s,
  tools as t,
  user as u,
  isApp as v,
