const About = "Giới thiệu";
const Access = "Truy cập";
const Account = "Tài khoản";
const Action = "";
const Actions = "Tác vụ";
...
const AI = "";
const All = "Tất cả";
const Always = "Luôn luôn";
const Amazing = "Tuyệt vời";
const Analytics = "";
const Analyzed = "Đã phân tích";
const Android = "";
const Anyone = "";
const April = "Tháng 4";
const Archive = "Lưu trữ";
const Artifacts = "Kết quả tạo ra";
const Asc = "";
const Ask = "Hỏi";
const Assistant = "Trợ lý";
const Audio = "Âm thanh";
const August = "Tháng 8";
const Auth = "Xác thực";
const Authenticate = "Xác thực";
const Authentication = "Xác thực";
const Auto = "";
...
const Calendars = "";
const Call = "Gọi";
const Camera = "Máy ảnh";
const Cancel = "Hủy bỏ";
const Capabilities = "Năng lực";
const Capture = "Chụp";
const Channel = "";
const Channels = "Kênh";
const Character = "Nhân vật";
const Chat = "Trò chuyện";
const chats = "";
const Chats = "Chat";
const Ciphers = "Bộ mã hóa";
const Citation = "Trích dẫn";
const Citations = "";
const Clone = "Nhân bản";
const Close = "Đóng";
const cloud = "";
const Collapse = "Thu gọn";
const Collection = "Tổng hợp mọi tài liệu";
const Collections = "";
const Color = "Màu sắc";
...
const Command = "Lệnh";
const Comment = "";
const Completions = "Hoàn thành";
const Config = "";
const Configuration = "";
const Configure = "Cấu hình";
const Confirm = "Xác nhận";
const Connections = "Kết nối";
const Content = "Nội dung";
const Controls = "Điều khiển";
const Copied = "Đã sao chép";
const Copy = "Sao chép";
const CPU = "";
const Create = "Tạo";
const Custom = "Tùy chỉnh";
const Daily = "";
const Dark = "Tối";
const Database = "Cơ sở dữ liệu";
const Day = "";
const December = "Tháng 12";
const Deepgram = "";
const Default = "Mặc định";
const Defaults = "";
const Delete = "Xóa";
const Deleted = "";
const Desc = "";
...
const Emoji = "";
const Emojis = "";
const Enabled = "Đã bật";
const Enhance = "";
const Ephemeral = "";
const ERROR = "LỖI";
const Evaluations = "Đánh giá";
const Exclude = "Loại trừ";
const Expand = "Mở rộng";
const Experimental = "Thử nghiệm";
const Explain = "Giải thích";
const Explored = "";
const Exploring = "";
const Export = "Xuất khẩu";
const External = "Bên ngoài";
const Features = "Tính năng";
const February = "Tháng 2";
const Feedback = "";
const Female = "";
const File = "Tệp";
const Filename = "";
...
const Gemini = "Gemini";
const Gender = "";
const General = "Cài đặt chung";
const Generate = "";
const Global = "Toàn hệ thống";
const Google = "";
const Gravatar = "";
const Grid = "";
const Grokipedia = "";
...
const Import = "";
const Inactive = "";
const Include = "Bao gồm";
const Info = "Thông tin";
const Initials = "";
const Input = "";
const Insert = "";
const Instructions = "";
const Integration = "Tích hợp";
const Integrations = "";
const Interface = "Giao diện";
const Italic = "";
const January = "Tháng 1";
const July = "Tháng 7";
const June = "Tháng 6";
const Key = "Khóa";
const Knowledge = "Kiến thức";
const Label = "Nhãn";
const Language = "Ngôn ngữ";
const LDAP = "LDAP";
const Leaderboard = "Bảng xếp hạng";
const Legacy = "";
const lexical = "";
const License = "Giấy phép";
const Light = "Sáng";
const List = "";
const Live = "";
const Loaded = "";
const Loader = "Trình tải";
const local = "";
const Local = "Cục bộ";
const Location = "";
const Lost = "Thua";
...
const Note = "";
const Notes = "Ghi chú";
const Notifications = "Thông báo trên máy tính (Notification)";
const November = "Tháng 11";
const OAuth = "";
const October = "Tháng 10";
const Off = "Tắt";
const Ollama = "Ollama";
const On = "Bật";
const Once = "";
...
const Paused = "";
const pending = "đang chờ phê duyệt";
const Pending = "";
const Permissions = "Quyền";
const Persistent = "";
const Personalization = "Cá nhân hóa";
const Pin = "Ghim";
const Pinned = "Đã ghim";
const Pipe = "";
const Pipelines = "";
const Playground = "Thử nghiệm (Playground)";
const Port = "Cổng";
const Ports = "";
const Preview = "";
const Private = "Riêng tư";
const Profile = "Hồ sơ";
const Prompt = "Prompt";
const Prompts = "Prompt";
const Provider = "";
const Public = "Công khai";
const Querying = "";
const Rating = "Đánh giá";
const Read = "Đọc";
const Reason = "";
const Reconnected = "";
const Record = "";
const Refresh = "";
const Regenerate = "Tạo sinh lại câu trả lời";
const Registered = "";
const Reindex = "";
const Releases = "";
const Relevance = "Mức độ liên quan";
const Reminder = "";
const Remove = "Xóa";
const Rename = "Đổi tên";
const Repeats = "";
const Reply = "";
const required = "";
const Reset = "Xóa toàn bộ";
const Response = "";
const Responses = "";
const Restart = "";
const Result = "Kết quả";
const RESULT = "Kết quả";
const Retrieval = "Truy xuất";
const Role = "Vai trò";
const RTL = "RTL";
const Run = "Thực hiện";
...
const Suggested = "Gợi ý một số mẫu prompt";
...
const Tags = "Thẻ";
const Tasks = "Tác vụ";
const Temperature = "Mức độ sáng tạo";
const Terminal = "";
...
const Usage = "";
const Use = "";
const user = "Người sử dụng";
const User = "Người dùng";
const Username = "Tên đăng nhập";
const users = "";
const Users = "Người sử dụng";
const Valves = "Valves";
const variable = "biến";
const Version = "Phiên bản";
const Visibility = "Hiển thị";
const Visible = "";
const Vision = "";
const Visual = "";
const Voice = "Giọng nói";
const Warning = "Cảnh báo";
...
const translation = {
  ...
  "(e.g. `sh rexpro.sh --api --api-auth username_password`)": "(vd: `sh rexpro.sh --api --api-auth tên_người_dùng_mật_khẩu`)",
  "(e.g. `sh rexpro.sh --api`)": "(vd: `sh rexpro.sh --api`)",
  "(latest)": "(mới nhất)",
  ...
  "{{rexproAIName}} Backend Required": "{{rexproAIName}} Yêu cầu Backend",
  ...
  "Add a tag...": "",
  "Add Access": "",
  "Add Arena Model": "Thêm Mô hình Arena",
  ...
  "archived-chat-export": "xuất-chat-lưu-trữ",
  ...
  "Attribute for Mail": "Thuộc tính cho Mail",
  "Attribute for Username": "Thuộc tính cho Tên người dùng",
  Audio,
  August,
  Auth,
  Authenticate,
  ...
  Automatic1111,
  "AUTOMATIC1111 Api Auth String": "Chuỗi xác thực API AUTOMATIC1111",
  ...
  "Click here for filter guides.": "Nhấn vào đây để xem hướng dẫn về bộ lọc.",
  ...
  "Click here to learn more about faster-whisper and see the available models.": "Nhấn vào đây để tìm hiểu thêm về faster-whisper và xem các mô hình có sẵn.",
  "Click here to see available models.": "Nhấn vào đây để xem các mô hình có sẵn.",
  ...
  "Code Execution Timeout": "Thời gian chờ Thực thi Mã",
  "Code formatted successfully": "Mã được định dạng thành công",
  "Code Interpreter": "Trình thông dịch Mã",
  "Code Interpreter Engine": "Engine Trình thông dịch Mã",
  "Code Interpreter Prompt Template": "Mẫu Prompt Trình thông dịch Mã",
  ...
  Color,
  ComfyUI,
  "ComfyUI API Key": "Khóa API ComfyUI",
  ...
  "Contact Admin for rexpro Access": "Liên hệ với Quản trị viên để được cấp quyền truy cập",
  Content,
  ...
  "CORS must be properly configured by the provider to allow requests from rexpro-ai.": "CORS phải được cấu hình đúng bởi nhà cung cấp để cho phép các yêu cầu từ rexpro-ai.",
  "Could not read file.": "",
  CPU,
  Create,
  ...
  "Default permissions": "Quyền mặc định",
  "Default permissions updated successfully": "Đã cập nhật quyền mặc định thành công",
  "Default Prompt Suggestions": "Đề xuất prompt mặc định",
  "Default to 389 or 636 if TLS is enabled": "Mặc định là 389 hoặc 636 nếu TLS được bật",
  "Default to ALL": "Mặc định là TẤT CẢ",
  ...
  "Discover how to use rexpro-ai and seek support from the community.": "Khám phá cách sử dụng rexpro-ai và tìm kiếm sự hỗ trợ từ cộng đồng.",
  ...
  ElevenLabs,
  Email,
  "Embark on adventures": "Bắt đầu những cuộc phiêu lưu",
  Embedding,
  ...
  "Enable Memory Locking (mlock) to prevent model data from being swapped out of RAM. This option locks the model's working set of pages into RAM, ensuring that they will not be swapped out to disk. This can help maintain performance by avoiding page faults and ensuring fast data access.": "Bật Khóa Bộ nhớ (mlock) để ngăn dữ liệu mô hình bị hoán đổi ra khỏi RAM. Tùy chọn này khóa tập trang làm việc của mô hình vào RAM, đảm bảo rằng chúng sẽ không bị hoán đổi ra đĩa. Điều này có thể giúp duy trì hiệu suất bằng cách tránh lỗi trang và đảm bảo truy cập dữ liệu nhanh chóng.",
  "Enable Memory Mapping (mmap) to load model data. This option allows the system to use disk storage as an extension of RAM by treating disk files as if they were in RAM. This can improve model performance by allowing for faster data access. However, it may not work correctly with all systems and can consume a significant amount of disk space.": "Bật Ánh xạ Bộ nhớ (mmap) để tải dữ liệu mô hình. Tùy chọn này cho phép hệ thống sử dụng bộ nhớ đĩa như một phần mở rộng của RAM bằng cách coi các tệp đĩa như thể chúng ở trong RAM. Điều này có thể cải thiện hiệu suất mô hình bằng cách cho phép truy cập dữ liệu nhanh hơn. Tuy nhiên, nó có thể không hoạt động chính xác với tất cả các hệ thống và có thể tiêu tốn một lượng đáng kể dung lượng đĩa.",
  ...
  "Enter Bing Search V7 Endpoint": "Nhập Endpoint Bing Search V7",
  "Enter Bing Search V7 Subscription Key": "Nhập Khóa đăng ký Bing Search V7",
  "Enter Bocha Search API Key": "Nhập Khóa API Bocha Search",
  "Enter Brave Search API Key": "Nhập API key cho Brave Search",
  "Enter certificate path": "Nhập đường dẫn chứng chỉ",
  ...
  "Enter Jupyter URL": "Nhập URL Jupyter",
  ...
  "Enter SearchApi API Key": "Nhập Khóa API SearchApi",
  "Enter SearchApi Engine": "Nhập Engine SearchApi",
  "Enter Searxng Query URL": "Nhập Query URL cho Searxng",
  "Enter Searxng search language": "",
  "Enter Seed": "Nhập Seed",
  "Enter SerpApi API Key": "Nhập Khóa API SerpApi",
  "Enter SerpApi Engine": "Nhập Engine SerpApi",
  ...
  "Enter the public URL of your rexpro. This URL will be used to generate links in the notifications.": "Nhập URL công khai của rexpro của bạn. URL này sẽ được sử dụng để tạo liên kết trong các thông báo.",
  ...
  "Example: mail": "Ví dụ: mail",
  "Example: ou=users,dc=foo,dc=example": "Ví dụ: ou=users,dc=foo,dc=example",
  "Example: sAMAccountName or uid or userPrincipalName": "Ví dụ: sAMAccountName hoặc uid hoặc userPrincipalName",
  "Exceeded the number of seats in your license. Please contact support to increase the number of seats.": "Đã vượt quá số lượng chỗ ngồi trong giấy phép của bạn. Vui lòng liên hệ bộ phận hỗ trợ để tăng số lượng chỗ ngồi.",
  Exclude,
  "Execute code": "",
  ...
  "Get started": "Bắt đầu",
  "Get started with {{REXPRO_NAME}}": "Bắt đầu với {{REXPRO_NAME}}",
  Global,
  ...
  "Image Max Compression Size": "Kích thước Nén Ảnh Tối đa",
  ...
  Inactive,
  Include,
  "Include `--api-auth` flag when running stable-diffusion-rexpro": "Bao gồm cờ `--api-auth` khi chạy stable-diffusion-rexpro",
  "Include `--api` flag when running stable-diffusion-rexpro": "Bao gồm flag `--api` khi chạy stable-diffusion-rexpro",
  ...
  "Kokoro.js (Browser)": "Kokoro.js (Trình duyệt)",
  "Kokoro.js Dtype": "Kiểu dữ liệu Kokoro.js",
  Label,
  ...
  "Leave empty for unlimited": "Để trống nếu không giới hạn",
  'Leave empty to include all models from "{{url}}" endpoint': "",
  'Leave empty to include all models from "{{url}}/api/tags" endpoint': 'Để trống để bao gồm tất cả các mô hình từ điểm cuối "{{url}}/api/tags"',
  'Leave empty to include all models from "{{url}}/models" endpoint': 'Để trống để bao gồm tất cả các mô hình từ điểm cuối "{{url}}/models"',
  "Leave empty to include all models or select specific models": "Để trống để bao gồm tất cả các mô hình hoặc chọn các mô hình cụ thể",
  ...
  Low,
  LTR,
  "Made by rexpro-ai Community": "Được tạo bởi Cộng đồng rexpro-ai",
  ...
  "Manage Ollama": "Quản lý Ollama",
  "Manage Ollama API Connections": "Quản lý Kết nối API Ollama",
  ...
  "Ollama API settings updated": "Đã cập nhật cài đặt API Ollama",
  ...
  "Oops! There are files still uploading. Please wait for the upload to complete.": "Ối! Vẫn còn tệp đang tải lên. Vui lòng đợi quá trình tải lên hoàn tất.",
  "Oops! There was an error in the previous response.": "Ối! Đã xảy ra lỗi trong phản hồi trước đó.",
  "Oops! You're using an unsupported method (frontend only). Please serve the rexpro from the backend.": "Rất tiếc! Bạn đang sử dụng một phương thức không được hỗ trợ (chỉ dành cho frontend). Vui lòng cung cấp phương thức cho rexpro từ phía backend.",
  "Open file": "Mở tệp",
  ...
  "rexpro-ai uses faster-whisper internally.": "rexpro-ai sử dụng faster-whisper bên trong.",
  "rexpro-ai uses SpeechT5 and CMU Arctic speaker embeddings.": "rexpro-ai sử dụng SpeechT5 và các embedding giọng nói CMU Arctic.",
  "rexpro-ai version": "",
  "rexpro-ai version (v{{OPEN_REXPRO_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "Phiên bản rexpro-ai (v{{OPEN_REXPRO_VERSION}}) hiện thấp hơn phiên bản bắt buộc (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "Prompt created successfully": "Đã tạo prompt thành công",
  "Prompt Name": "",
  "Prompt Suggestions": "",
  "Prompt Template": "",
  "Prompt updated successfully": "Đã cập nhật prompt thành công",
  Prompts,
  "Prompts Access": "Truy cập Prompt",
  "Prompts Public Sharing": "Chia sẻ Công khai Prompt",
  "Prompts Sharing": "",
  Provider,
  Public,
  ...
  Record,
  "Record voice": "Ghi âm",
  "Redirecting you to rexpro-ai Community": "Đang chuyển hướng bạn đến Cộng đồng rexpro-ai",
  ...
  "SearchApi API Key": "Khóa API SearchApi",
  ...
  "Send now": "",
  "Sends `stream_options: { include_usage: true }` in the request.\nSupported providers will return token usage information in the response when set.": "Gửi `stream_options: { include_usage: true }` trong yêu cầu.\nCác nhà cung cấp được hỗ trợ sẽ trả về thông tin sử dụng token trong phản hồi khi được đặt.",
  September,
  "SerpApi API Key": "Khóa API SerpApi",
  "SerpApi Engine": "Engine SerpApi",
  ...
  "Set the number of layers, which will be off-loaded to GPU. Increasing this value can significantly improve performance for models that are optimized for GPU acceleration but may also consume more power and GPU resources.": "Đặt số lượng lớp sẽ được chuyển tải sang GPU. Tăng giá trị này có thể cải thiện đáng kể hiệu suất cho các mô hình được tối ưu hóa cho tăng tốc GPU nhưng cũng có thể tiêu thụ nhiều năng lượng và tài nguyên GPU hơn.",
  "Set the number of worker threads used for computation. This option controls how many threads are used to process incoming requests concurrently. Increasing this value can improve performance under high concurrency workloads but may also consume more CPU resources.": "Đặt số lượng luồng công nhân được sử dụng để tính toán. Tùy chọn này kiểm soát số lượng luồng được sử dụng để xử lý đồng thời các yêu cầu đến. Tăng giá trị này có thể cải thiện hiệu suất dưới tải công việc đồng thời cao nhưng cũng có thể tiêu thụ nhiều tài nguyên CPU hơn.",
  "Set Voice": "Đặt Giọng nói",
  "Set whisper model": "Đặt mô hình whisper",
  "Set your status": "",
  "Sets a flat bias against tokens that have appeared at least once. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 0.9) will be more lenient. At 0, it is disabled.": "Đặt một thiên vị phẳng chống lại các token đã xuất hiện ít nhất một lần. Giá trị cao hơn (ví dụ: 1.5) sẽ phạt sự lặp lại mạnh hơn, trong khi giá trị thấp hơn (ví dụ: 0.9) sẽ khoan dung hơn. Tại 0, nó bị vô hiệu hóa.",
  "Sets a scaling bias against tokens to penalize repetitions, based on how many times they have appeared. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 0.9) will be more lenient. At 0, it is disabled.": "Đặt một thiên vị tỷ lệ chống lại các token để phạt sự lặp lại, dựa trên số lần chúng đã xuất hiện. Giá trị cao hơn (ví dụ: 1.5) sẽ phạt sự lặp lại mạnh hơn, trong khi giá trị thấp hơn (ví dụ: 0.9) sẽ khoan dung hơn. Tại 0, nó bị vô hiệu hóa.",
  "Sets how far back for the model to look back to prevent repetition.": "Đặt khoảng cách mà mô hình nhìn lại để ngăn chặn sự lặp lại.",
  "Sets the random number seed to use for generation. Setting this to a specific number will make the model generate the same text for the same prompt.": "Đặt hạt giống số ngẫu nhiên để sử dụng cho việc tạo. Đặt giá trị này thành một số cụ thể sẽ làm cho mô hình tạo ra cùng một văn bản cho cùng một prompt.",
  "Sets the size of the context window used to generate the next token.": "Đặt kích thước của cửa sổ ngữ cảnh được sử dụng để tạo token tiếp theo.",
  ...
  "Share to rexpro-ai Community": "Chia sẻ đến Cộng đồng rexpro-ai",
  ...
  "Sign in": "Đăng nhập",
  "Sign in to {{REXPRO_NAME}}": "Đăng nhập vào {{REXPRO_NAME}}",
  "Sign in to {{REXPRO_NAME}} with LDAP": "Đăng nhập vào {{REXPRO_NAME}} bằng LDAP",
  "Sign Out": "Đăng xuất",
  "Sign up": "Đăng ký",
  "Sign up to {{REXPRO_NAME}}": "Đăng ký {{REXPRO_NAME}}",
  ...
  "Signing in to {{REXPRO_NAME}}": "Đang đăng nhập vào {{REXPRO_NAME}}",
  Single,
  "Sink List": "",
  "sk-1234": "sk-1234",
  ...
  "Sync Complete!": "",
  "Sync directory": "Đồng bộ thư mục",
  "Sync Failed": "",
  "Sync Usage Stats": "",
  "Syncing stats...": "",
  "Syncing...": "",
  ...
  "Title Generation": "Tạo Tiêu đề",
  "Title Generation Prompt": "Prompt tạo tiêu đề",
  "Title is required": "",
  TLS,
  "To access the available model names for downloading,": "Để truy cập tên các mô hình có sẵn để tải xuống,",
  "To access the GGUF models available for downloading,": "Để truy cập các mô hình GGUF có sẵn để tải xuống,",
  "To access the rexpro, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.": "Để truy cập vui lòng liên hệ với quản trị viên.",
  ...
  "Tool ID": "ID Tool",
  "Tool imported successfully": "Đã nhập tool thành công",
  "Tool Name": "Tên Tool",
  "Tool Servers": "Máy chủ Tool",
  ...
  "Updated At": "Cập nhật lúc",
  "Upgrade to a licensed plan for enhanced capabilities, including custom theming and branding, and dedicated support.": "Nâng cấp lên gói cấp phép để có các khả năng nâng cao, bao gồm chủ đề và thương hiệu tùy chỉnh, và hỗ trợ chuyên dụng.",
  Upload,
  ...
  "Web Search Query Generation": "Tạo Truy vấn Tìm kiếm Web",
  "Webhook Name": "",
  "Webhook URL": "Webhook URL",
  Webhooks,
  "Webpage URLs": "",
  "rexpro Settings": "Cài đặt rexpro",
  "rexpro URL": "URL rexpro",
  'rexpro will make requests to "{{url}}"': 'rexpro sẽ thực hiện yêu cầu đến "{{url}}"',
  'rexpro will make requests to "{{url}}/api/chat"': 'rexpro sẽ thực hiện yêu cầu đến "{{url}}/api/chat"',
  'rexpro will make requests to "{{url}}/chat/completions"': 'rexpro sẽ thực hiện yêu cầu đến "{{url}}/chat/completions"',
  Week,
  Weekly,
  ...
  Write,
  "Write a summary in 50 words that summarizes {{topic}}.": "Viết một tóm tắt trong vòng 50 từ cho [chủ đề hoặc từ khóa].",
  ...
  "You cannot upload an empty file.": "Bạn không thể tải lên một tệp trống.",
  ...
  "You do not have permission to upload files.": "Bạn không có quyền tải lên tệp.",
  ...
  "Your entire contribution will go directly to the plugin developer; rexpro-ai does not take any percentage. However, the chosen funding platform might have its own fees.": "Toàn bộ đóng góp của bạn sẽ được chuyển trực tiếp đến nhà phát triển plugin; rexpro-ai không lấy bất kỳ tỷ lệ phần trăm nào. Tuy nhiên, nền tảng được chọn tài trợ có thể có phí riêng.",
