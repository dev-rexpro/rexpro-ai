...
var _document, _subscribe, _name, _key, _variant, _prefix;
import { K as block, M as EFFECT_TRANSPARENT, bp as ATTACHMENT_KEY, k as get, v as user_derived, b3 as state, a3 as proxy, w as set, bG as createSubscriber, bH as on, bI as hasContext, i as getContext, bF as setContext, ak as user_pre_effect, al as user_effect, u as untrack } from "./B-Kw_l3V.js";
import { B as BranchManager } from "./DWHK2A9K.js";
import { k as clsx } from "./B9yCN616.js";
...
class ActiveElement {
  constructor(options = {}) {
    ...
    const { window: window2 = defaultWindow, document = window2 == null ? void 0 : window2.document } = options;
...
function getDataTransitionAttrs(state2) {
  if (state2 === "starting")
