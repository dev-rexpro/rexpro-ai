...
const version = "f7c04c6df7cd5fc78686829e718239071991d3f8";
class HttpError {
  /**
   * @param {number} status
...
const base = ((_a = globalThis.__sveltekit_1edqoz1) == null ? void 0 : _a.base) ?? "";
const assets = ((_b = globalThis.__sveltekit_1edqoz1) == null ? void 0 : _b.assets) ?? base ?? "";
...
async function start(_app, _target, hydrate) {
  var _a2, _b2, _c2, _d2;
  if (globalThis.__sveltekit_1edqoz1.data) {
    const { q = {}, p = {}, l = {}, f = {} } = globalThis.__sveltekit_1edqoz1.data;
