...
const August = "august";
const Auth = "";
const Authenticate = "Godkjenn";
const Authentication = "Godkjenning";
const Auto = "";
...
const Camera = "Kamera";
const Cancel = "Avbryt";
const Capabilities = "Muligheter";
const Capture = "Opptak";
const Channel = "";
...
const Citation = "Kildehenvisning";
const Citations = "";
const Clone = "Klon";
const Close = "Lukk";
const cloud = "";
...
const Comment = "";
const Completions = "Fullføringer";
const Config = "";
const Configuration = "";
const Configure = "Konfigurer";
const Confirm = "Bekreft";
const Connections = "Tilkoblinger";
...
const Email = "E-postadresse";
const Embedding = "";
const Emoji = "";
const Emojis = "";
const Enabled = "Aktivert";
const Enhance = "";
const Ephemeral = "";
const ERROR = "FEIL";
const Evaluations = "Vurderinger";
const Exclude = "Utelukk";
const Expand = "";
const Experimental = "Eksperimentell";
const Explain = "";
const Explored = "";
const Exploring = "";
const Export = "Eksporter";
const External = "";
const Features = "Funksjoner";
...
const Functions = "Funksjoner";
const Gemini = "Gemini";
const Gender = "";
const General = "Generelt";
const Generate = "";
const Global = "Globalt";
const Google = "";
const Gravatar = "";
const Grid = "";
const Grokipedia = "";
...
const Integration = "";
const Integrations = "";
const Interface = "Grensesnitt";
const Italic = "";
const January = "januar";
const July = "juli";
const June = "juni";
const Key = "Nøkkel";
const Knowledge = "Kunnskap";
const Label = "Etikett";
const Language = "Språk";
const LDAP = "LDAP";
const Leaderboard = "Ledertavle";
const Legacy = "";
const lexical = "";
const License = "Lisens";
const Light = "Lys";
const List = "";
const Live = "";
const Loaded = "";
...
const Muted = "";
const Name = "Navn";
const Native = "Opprinnelig";
const Never = "";
const New = "";
const None = "Ingen";
const Note = "";
const Notes = "Notater";
const Notifications = "Varsler";
...
const Paused = "";
const pending = "avventer";
const Pending = "";
const Permissions = "Tillatelser";
const Persistent = "";
const Personalization = "Tilpassing";
const Pin = "Fest";
const Pinned = "Festet";
const Pipe = "";
const Pipelines = "";
const Playground = "Lekeplass";
const Port = "Port";
const Ports = "";
const Preview = "";
const Private = "";
...
const Prompts = "Ledetekster";
const Provider = "";
const Public = "";
const Querying = "";
const Rating = "Vurdering";
const Read = "Les";
const Reason = "";
const Reconnected = "";
const Record = "";
const Refresh = "";
const Regenerate = "Generer på nytt";
const Registered = "";
const Reindex = "";
const Releases = "";
...
const Subtitle = "";
const Success = "Suksess";
const Suggested = "Foreslått";
const Support = "Bidra";
const Sync = "";
const System = "System";
const Tag = "";
const Tags = "";
const Tasks = "Oppgaver";
...
const Unmute = "";
const Unpin = "Løsne";
const Untagged = "Ikke merket";
const Untitled = "";
const Update = "Oppdater";
const Updated = "Oppdatert";
...
const translation = {
  ...
  "(e.g. `sh rexpro.sh --api --api-auth username_password`)": "(f.eks. `sh rexpro.sh --api --api-auth brukernavn_passord`)",
  ...
  "{{rexproAIName}} Backend Required": "Backend til {{rexproAIName}} kreves",
  ...
  "Attribute for Mail": "Attributt for e-post",
  ...
  "Click here to see available models.": "Klikk her for å se tilgjengelige modeller.",
  ...
  "Code Execution Timeout": "Tidsavbrudd for kodekjøring",
  ...
  Color,
  ComfyUI,
  "ComfyUI API Key": "API-nøkkel for ComfyUI",
  ...
  "Contact Admin for rexpro Access": "Kontakt administrator for å få tilgang til rexpro",
  Content,
  ...
  "CORS must be properly configured by the provider to allow requests from rexpro-ai.": "CORS må være riktig konfigurert av leverandøren for å kunne godkjenne forespørsler fra rexpro-ai.",
  "Could not read file.": "",
  CPU,
  Create,
  ...
  "Discover how to use rexpro-ai and seek support from the community.": "Finn ut hvordan du bruker rexpro-ai, og få støtte fra fellesskapet.",
  ...
  "Enter Bocha Search API Key": "Aktiver API-nøkkel for Bocha Search",
  ...
  "Enter SerpApi API Key": "Angi API-nøkkel for SerpApi",
  "Enter SerpApi Engine": "Angi motor for SerpApi",
  ...
  "Enter the public URL of your rexpro. This URL will be used to generate links in the notifications.": "Angi den offentlige URL-adressen til rexpro. Denne URL-adressen vil bli brukt til å generere koblinger i varslene.",
  ...
  "Image Edit": "",
  "Image Edit Engine": "",
  "Image Generation": "Bildegenering",
  "Image Generation Engine": "Bildegenereringsmotor",
  "Image Max Compression Size": "Maks komprimeringsstørrelse for bilder",
  ...
  Inactive,
  Include,
  "Include `--api-auth` flag when running stable-diffusion-rexpro": "Inkluder flagget --api-auth når du kjører stable-diffusion-rexpro",
  "Include `--api` flag when running stable-diffusion-rexpro": "Inkluder flagget --api når du kjører stable-diffusion-rexpro",
  ...
  Low,
  LTR,
  "Made by rexpro-ai Community": "Laget av rexpro-ai-fellesskapet",
  ...
  "Oops! You're using an unsupported method (frontend only). Please serve the rexpro from the backend.": "Oi! Du bruker en ikke-støttet metode (bare frontend). Du må kjøre rexpro fra backend.",
  "Open file": "Åpne fil",
  ...
  "rexpro-ai uses faster-whisper internally.": "rexpro-ai bruker faster-whisper internt.",
  "rexpro-ai uses SpeechT5 and CMU Arctic speaker embeddings.": "rexpro-ai bruker SpeechT5 og CMU Arctic-høytalerinnbygginger",
  "rexpro-ai version": "",
  "rexpro-ai version (v{{OPEN_REXPRO_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "rexpro-ai-versjonen (v{{OPEN_REXPRO_VERSION}}) er lavere enn den påkrevde versjonen (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "Redirecting you to rexpro-ai Community": "Omdirigerer deg til rexpro-ai-fellesskapet",
  ...
  "Search Skills": "",
  "Search skills...": "",
  "Search the internet": "Søk på Internett",
  ...
  September,
  "SerpApi API Key": "Angi API-nøkkel for SerpApi",
  "SerpApi Engine": "Motor for SerpApi",
  ...
  "Set the number of layers, which will be off-loaded to GPU. Increasing this value can significantly improve performance for models that are optimized for GPU acceleration but may also consume more power and GPU resources.": "Angi antall nivå som skal avlastes til GPU-en. Hvis du øker denne verdien, kan du forbedre ytelsen betydelig for modeller som er optimalisert for GPU-akselerasjon, men det kan også føre til økt strøm- og GPU-bruk.",
  ...
  "Share to rexpro-ai Community": "Del med rexpro-ai-fellesskapet",
  ...
  "Sign in": "Logg inn",
  "Sign in to {{REXPRO_NAME}}": "Logg på {{REXPRO_NAME}}",
  "Sign in to {{REXPRO_NAME}} with LDAP": "Logg på {{REXPRO_NAME}} med LDAP",
  "Sign Out": "Logg ut",
  "Sign up": "Registrer deg",
  "Sign up to {{REXPRO_NAME}}": "Registrer deg for {{REXPRO_NAME}}",
  ...
  "Signing in to {{REXPRO_NAME}}": "Logger på {{REXPRO_NAME}}",
  Single,
  "Sink List": "",
  "sk-1234": "sk-1234",
  ...
  "To access the rexpro, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.": "Hvis du vil ha tilgang til rexpro, må du kontakte administrator. Administratorer kan behandle brukeres status fra Admin-panelet.",
  ...
  "Updated At": "Oppdatert",
  "Upgrade to a licensed plan for enhanced capabilities, including custom theming and branding, and dedicated support.": "Oppgrader til en lisensplan for å få flere funksjoner, inkludert tilpasset temaer og merkevarebygging, og dedikert kundestøtte.",
  Upload,
  ...
  "Web Search Query Generation": "Genering av spørringer for nettsøk",
  "Webhook Name": "",
  "Webhook URL": "Webhook URL",
  Webhooks,
  "Webpage URLs": "",
  "rexpro Settings": "Innstillinger for rexpro",
  "rexpro URL": "URL for rexpro",
  'rexpro will make requests to "{{url}}"': "",
  'rexpro will make requests to "{{url}}/api/chat"': 'rexpro vil rette forespørsler til "{{url}}/api/chat"',
  'rexpro will make requests to "{{url}}/chat/completions"': 'rexpro vil rette forespørsler til "{{url}}/chat/completions"',
  Week,
  Weekly,
  ...
  Write,
  "Write a summary in 50 words that summarizes {{topic}}.": "Skriv inn et sammendrag på 50 ord som oppsummerer [emne eller nøkkelord].",
