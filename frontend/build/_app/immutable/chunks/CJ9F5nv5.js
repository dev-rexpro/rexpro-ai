...
const Action = "Acció";
const Actions = "Accions";
const Activate = "Activar";
const Active = "Actiu";
const Activity = "Activitat";
const Add = "Afegir";
const admin = "administrador";
const Admin = "Administrador";
const Advanced = "Avançat";
const AI = "IA";
const All = "Tots";
const Always = "Sempre";
const Amazing = "Al·lucinant";
const Analytics = "Analítica";
const Analyzed = "Analitzat";
const Android = "Android";
const Anyone = "Algú";
const April = "Abril";
const Archive = "Arxiu";
const Artifacts = "Artefactes";
const Asc = "Ascendent";
const Ask = "Preguntar";
...
const Authentication = "Autenticació";
const Auto = "Automàtic";
const Automatic1111 = "Automatic1111";
const Automation = "Automatització";
const Automations = "Automatització";
const Away = "Absent";
const Awful = "Terrible";
const Back = "Enrere";
...
const Calendars = "Calendaris";
const Call = "Trucada";
const Camera = "Càmera";
const Cancel = "Cancel·lar";
const Capabilities = "Capacitats";
const Capture = "Captura";
const Channel = "Canal";
const Channels = "Canals";
const Character = "Personatge";
const Chat = "Xat";
const chats = "xats";
const Chats = "Xats";
const Ciphers = "Xifradors";
const Citation = "Cita";
const Citations = "Cites";
const Clone = "Clonar";
const Close = "Tancar";
const cloud = "núvol";
const Collapse = "Col·lapsar";
const Collection = "Col·lecció";
const Collections = "Col·lecccions";
const Color = "Color";
const ComfyUI = "ComfyUI";
const command = "comanda";
const Command = "Comanda";
const Comment = "Comentari";
const Completions = "Completaments";
const Config = "Configuració";
const Configuration = "Configuració";
const Configure = "Configurar";
const Confirm = "Confirmar";
const Connections = "Connexions";
const Content = "Contingut";
const Controls = "Controls";
const Copied = "Copiat";
const Copy = "Copiar";
const CPU = "CPU";
const Create = "Crear";
const Custom = "Personalitzat";
const Daily = "Cada dia";
const Dark = "Fosc";
const Database = "Base de dades";
const Day = "Dia";
const December = "Desembre";
const Deepgram = "Deepgram";
const Default = "Per defecte";
const Defaults = "Valors per defecte";
const Delete = "Eliminar";
const Deleted = "Eliminat";
const Desc = "Descendent";
const Description = "Descripció";
const Deselect = "Deseleccionar";
const Dictate = "Dictar";
const Direct = "Directe";
const Disabled = "Deshabilitat";
...
const edited = "editat";
const Edited = "Editat";
const Editing = "Editant";
const Eject = "Expulsar";
const ElevenLabs = "ElevenLabs";
const Email = "Correu electrònic";
const Embedding = "Incrustació";
const Emoji = "";
const Emojis = "Emojis";
const Enabled = "Habilitat";
const Enhance = "Millorar";
const Ephemeral = "Efímer";
const ERROR = "ERROR";
const Evaluations = "Avaluacions";
const Exclude = "Excloure";
const Expand = "Expandir";
const Experimental = "Experimental";
const Explain = "Explicar";
const Explored = "Explorat";
const Exploring = "Explorant";
const Export = "Exportar";
const External = "Extern";
const Features = "Característiques";
const February = "Febrer";
const Feedback = "Retorn";
const Female = "Dona";
const File = "Arxiu";
const Filename = "Nom de l'arxiu";
const Files = "Arxius";
const Filter = "Filtre";
const Filters = "Filtres";
const Folder = "Carpeta";
const Folders = "Carpetes";
const Form = "Formulari";
const Forward = "Endavant";
const Fr_day_of_week = "Divendres";
const Functions = "Funcions";
const Gemini = "Gemini";
const Gender = "Gènere";
...
const Home = "Inici";
const Host = "Servidor";
const Hourly = "Cada hora";
const HTML = "HTML";
const ID = "ID";
const Image = "Imatge";
const Images = "Imatges";
const Import = "Importar";
const Inactive = "No actiu";
const Include = "Incloure";
const Info = "Informació";
const Initials = "Inicials";
const Input = "Entrada";
const Insert = "Inserir";
const Instructions = "Instruccions";
const Integration = "Integració";
const Integrations = "Integracions";
const Interface = "Interfície";
const Italic = "Cursiva";
const January = "Gener";
const July = "Juliol";
const June = "Juny";
const Key = "Clau";
const Knowledge = "Coneixement";
const Label = "Etiqueta";
const Language = "Idioma";
const LDAP = "LDAP";
const Leaderboard = "Tauler de classificació";
const Legacy = "Llegat";
const lexical = "lèxic";
const License = "Llicència";
const Light = "Clar";
const List = "Llista";
const Live = "Live";
const Loaded = "Carregat";
const Loader = "Carregador";
const local = "local";
const Local = "Local";
const Location = "Ubicació";
const Lost = "Perdut";
const Low = "Baix";
const LTR = "LTR";
const Male = "Home";
...
const Members = "Membres";
const Memories = "Memòries";
const Memory = "Memòria";
const Message = "Missatge";
const messages = "missatges";
const Messages = "Missatges";
const min = "mínim";
const MinerU = "MinerU";
const MistralAI = "MistralAI";
const Mo_day_of_week = "Dilluns";
const Model = "Model";
const Models = "Models";
const Mojeek = "Mojeek";
const Month = "Mes";
const Monthly = "Cada mes";
const More = "Més";
const Move = "Moure";
const Mute = "Silencia";
const Muted = "Silenciat";
const Name = "Nom";
const Native = "Natiu";
const Never = "Mai";
const New = "Nou";
...
const Note = "Nota";
const Notes = "Notes";
const Notifications = "Notificacions";
const November = "Novembre";
const OAuth = "OAuth";
const October = "Octubre";
const Off = "Desactivat";
const Ollama = "Ollama";
const On = "Activat";
const Once = "Una vegada";
...
const Personalization = "Personalització";
const Pin = "Fixar";
const Pinned = "Fixat";
const Pipe = "Canonada";
const Pipelines = "Pipelines";
const Playground = "Zona de jocs";
const Port = "Port";
const Ports = "Ports";
const Preview = "Previsualització";
const Private = "Privat";
const Profile = "Perfil";
const Prompt = "Indicació";
const Prompts = "Indicacions";
const Provider = "Proveïdor";
const Public = "Públic";
const Querying = "Consultes";
const Rating = "Valoració";
const Read = "Llegit";
const Reason = "Raó";
const Reconnected = "Reconnectat";
const Record = "Enregistrar";
const Refresh = "Refrescar";
const Regenerate = "Regenerar";
const Registered = "Registrat";
const Reindex = "Reindexar";
const Releases = "Versions";
const Relevance = "Rellevància";
const Reminder = "Recordatori";
const Remove = "Eliminar";
const Rename = "Canviar el nom";
const Repeats = "Repeticions";
const Reply = "Respondre";
const required = "necessari";
const Reset = "Restableix";
const Response = "Resposta";
const Responses = "Respostes";
...
const RTL = "RTL";
const Run = "Executar";
const Running = "S'està executant";
const Sa_day_of_week = "Dissabte";
const Save = "Desar";
const Saved = "Desat";
const Schedule = "Programar";
const Search = "Cercar";
const Searching = "Cercant";
const Seed = "Llavor";
const Select = "Escollir";
const semantic = "semàntic";
const Send = "Enviar";
const September = "Setembre";
const Session = "Sessió";
const Setting = "Preferència";
const Settings = "Preferències";
const Share = "Compartir";
const Show = "Mostrar";
const Single = "Únic";
const Skills = "Habilitats";
const Sonar = "Sonar";
const Sort = "Ordenar";
const Source = "Font";
const State = "Estat";
...
const Steps = "Passos";
const Stop = "Atura";
const Storage = "Emmagatzematge";
const Strikethrough = "Ratllat";
const Su_day_of_week = "Diumenge";
const Subtitle = "Subtítol";
const Success = "Èxit";
const Suggested = "Suggerit";
const Support = "Dona suport";
const Sync = "Sincronitzar";
...
const Th_day_of_week = "Dijous";
const Theme = "Tema";
const Thought = "Pensament";
const Thread = "Fil";
const Tika = "Tika";
const Tiktoken = "Tiktoken";
const Time = "Temps";
const Timeout = "Temps d'espera";
const Title = "Títol";
const TLS = "TLS";
const Today = "Avui";
const Token = "Token";
...
const Tools = "Eines";
const Top = "A dalt";
const Transformers = "Transformadors";
const Tu_day_of_week = "Dimarts";
const Type = "Tipus";
const UI = "UI";
const Underline = "Subratllat";
const Unknown = "Desconegut";
const Unmute = "No silenciar";
const Unpin = "Alliberar";
const Untagged = "Sense etiquetes";
const Untitled = "Sense títol";
const Update = "Actualitzar";
const Updated = "Actualitzat";
const Upload = "Pujar";
const URL = "URL";
const Usage = "Ús";
const Use = "Ús";
...
const Version = "Versió";
const Visibility = "Visibilitat";
const Visible = "Visible";
const Vision = "Visió";
const Visual = "Visual";
const Voice = "Veu";
const Warning = "Avís";
const We_day_of_week = "Dimecres";
const Web = "Web";
const Webhooks = "Webhooks";
const Week = "Setmana";
const Weekly = "Cada setmana";
const When = "Quan";
const Width = "amplada";
const Wikipedia = "Wikipedia";
const Won = "Ha guanyat";
const Workspace = "Espai de treball";
const Write = "Escriure";
const Yahoo = "Yahoo";
const Yandex = "Yandex";
const Yesterday = "Ahir";
const You = "Tu";
...
const translation = {
  ...
  "(e.g. `sh rexpro.sh --api --api-auth username_password`)": "(p. ex. `sh rexpro.sh --api --api-auth username_password`)",
  "(e.g. `sh rexpro.sh --api`)": "(p. ex. `sh rexpro.sh --api`)",
  "(latest)": "(últim)",
  ...
  "{{COUNT}}m_time_ago": "{{COUNT}}m",
  "{{COUNT}}w_time_ago": "{{COUNT}}s",
  ...
  "{{rexproAIName}} Backend Required": "El Backend de {{rexproAIName}} és necessari",
  ...
  "Access updated": "Accés actualitzat",
  ...
  "Allow Web Upload": "Permetre la pujada web",
  ...
  "API Keys": "Claus de l'API",
  "API Mode": "Mode API",
  "API Timeout": "Temps d'espera de l'API",
  "API Type": "Tipus d'API",
  ...
  "At time of event": "Al moment de l'esdeveniment",
  ...
  Calendar,
  "Calendar created": "Calendari creat",
  "Calendar deleted": "Calendari eliminat",
  "Calendar name": "Nom del calendari",
  Calendars,
  "Calendars Public Sharing": "Compartició pública de calendaris",
  Call,
  "Call feature is not supported when using Web STT engine": "La funció de trucada no s'admet quan s'utilitza el motor Web STT",
  Camera,
  Cancel,
  "Cancel download of {{model}}": "Cancel·la la descàrrega de {{model}}",
  "Cannot create an empty note.": "No es pot crear una nota buida.",
  "Cannot delete the production version": "No es pot eliminar la versió en producció",
  Capabilities,
  Capture,
  "Capture Audio": "Capturar àudio",
  "Certificate Path": "Camí del certificat",
  "Change folder icon": "Canviar la icona de la carpeta",
  ...
  chats,
  Chats,
  "Chats Public Sharing": "Compartició pública delx xats",
  ...
  "Chunks smaller than this threshold will be merged with neighboring chunks when possible. Set to 0 to disable merging.": "Els fragments més petits que aquest llindar es fusionaran amb els fragments veïns sempre que sigui possible. Establiu-ho a 0 per desactivar la fusió.",
  Ciphers,
  Citation,
  Citations,
  ...
  "Connection lost. Reconnecting...": "Connexió perduda. Reconnectant...",
  ...
  "Contact Admin for rexpro Access": "Posa't en contacte amb l'administrador per accedir a rexpro",
  Content,
  ...
  Copy,
  "Copy API Key": "Copiar la clau API",
  "Copy content": "Copiar el contingut",
  ...
  "Create and manage scheduled automations": "Crear i gestionar les automatitzacions programades",
  ...
  "Delete Version": "Eliminar la versió",
  Deleted,
  ...
  "Describe the image...": "Descriu la imatge",
  ...
  Disabled,
  "Disconnect OAuth": "Desconnectar OAuth",
  ...
  "Discover how to use rexpro-ai and seek support from the community.": "Descobreix com utilitzar rexpro-ai i demana suport a la comunitat.",
  ...
  "Do you want to sync your usage stats with rexpro-ai Community?": "Vols sincronitzar les estadístiques d'ús amb la rexpro-ai Community?",
  Docling,
  ...
  "e.g. alloy, echo, shimmer": "p. ex. aliatge, eco, brillantor",
  "e.g. Code Review Guidelines": "p. ex. guies de comentaris al codi",
  "e.g. code-review-guidelines": "p. ex. guies-de-comentaris-al-codi",
  "e.g. en": "p. ex. en",
  ...
  "Enable Message Queue": "Activar la cua de missatges",
  ...
  "Enter Chunk Min Size Target": "Introdueix la mida mínima del bloc objectiu",
  ...
  "Enter Firecrawl Timeout": "Introdueix el temps d'espera per a Firecrawl",
  ...
  "Enter Jina API Base URL": "Introdueix la URL base de Jina",
  ...
  "Enter Searxng search language": "Entra la llengua de cerca de Searxng",
  ...
  "Enter skill instructions in markdown...": "Introdueix les instruccions de l'habilitat en format markdown...",
  ...
  "Enter the public URL of your rexpro. This URL will be used to generate links in the notifications.": "Entra la URL pública de rexpro. Aquesta URL s'utilitzarà per generar els enllaços en les notificacions.",
  ...
  "Enter timeout in seconds": "Entra el temps d'espera en segons",
  ...
  "Enter Yandex Web Search API Key": "Introdueix la clau API per a la cerca web Yandex",
  "Enter Yandex Web Search URL": "Introdueix la URL per a la cerca web Yandex",
  "Enter You.com API Key": "Introdueix la clau API de You.com",
  ...
  "Failed to delete calendar": "No s'ha pogut eliminar el calendari",
  "Failed to delete note": "No s'ha pogut eliminar la nota",
  "Failed to disconnect": "No s'ha pogut desconnectar",
  ...
  February,
  Feedback,
  "Feedback Activity": "Activitat de retorn",
  ...
  "Firecrawl Timeout (s)": "Temps d'espera de Firecrawl (s)",
  ...
  "Folder created successfully": "Carpeta creada correctament",
  ...
  Folders,
  "Follow up": "Seguir",
  "Follow Up Generation": "Generació d'indicacions de continuació",
  "Follow Up Generation Prompt": "Indicació per a la generació d'indicacions de continuació",
  "Follow up: {{question}}": "Continuació: {{question}}",
  "Follow-Up Auto-Generation": "Generació automàtica d'indicacions de continuació",
  "Followed instructions perfectly": "S'han seguit les instruccions perfectament",
  "for placeholders": "per a marcadors de posició",
  ...
  "Generated images will appear here": "Les imatges generadoes apareixeran aquí",
  "Generating search query": "Generant consulta",
  "Generating...": "Generant...",
  "Get current time and perform date/time calculations": "Obtenir l'hora actual i realitzar càlculs de data i hora",
  "Get information on {{name}} in the UI": "Obtenir informació de {{name}} a l'interficie d'usuari",
  "Get started": "Començar",
  "Get started with {{REXPRO_NAME}}": "Comença amb {{REXPRO_NAME}}",
  Global,
  ...
  Help,
  "Help the community discover great models": "Ajuda la comunitat a descobrir models",
  ...
  Inactive,
  Include,
  "Include `--api-auth` flag when running stable-diffusion-rexpro": "Inclou `--api-auth` quan executis stable-diffusion-rexpro",
  "Include `--api` flag when running stable-diffusion-rexpro": "Inclou `--api` quan executis stable-diffusion-rexpro",
  ...
  Italic,
  January,
  "Jina API Base URL": "URL Base de l'API Jina",
  ...
  "Keep Follow-Up Prompts in Chat": "Mantenir els missatges de continuació en el xat",
  ...
  "Leave empty to use first admin user": "Deixa-ho buit per utilitzar el primer usuari administrador",
  "Leave empty to use the default config, or enter a valid json (see https://yandex.cloud/en/docs/search-api/api-ref/WebSearch/search#yandex.cloud.searchapi.v2.WebSearchRequest)": "Deixa-ho en blanc per utilitzar la configuració predeterminada o introdueix un JSON vàlid (mira https://yandex.cloud/en/docs/search-api/api-ref/WebSearch/search#yandex.cloud.searchapi.v2.WebSearchRequest)",
  ...
  Low,
  LTR,
  "Made by rexpro-ai Community": "Creat per la Comunitat rexpro-ai",
  ...
  Male,
  Manage,
  "Manage Connections": "Gestionar les connexions",
  "Manage Direct Connections": "Gestionar les connexions directes",
  "Manage Files": "Gestionar els arxius",
  ...
  March,
  Markdown,
  "Markdown Header Text Splitter": "Divisor de text de capçalera de Markdown",
  ...
  MBR,
  MCP,
  "MCP support is experimental and its specification changes often, which can lead to incompatibilities. OpenAPI specification support is directly maintained by the rexpro-ai team, making it the more reliable option for compatibility.": "El suport per a MCP és experimental i la seva especificació canvia sovint, cosa que pot provocar incompatibilitats. El suport per a l'especificació d'OpenAPI el manté directament l'equip d'rexpro-ai, cosa que el converteix en l'opció més fiable per a la compatibilitat.",
  Medium,
  ...
  Message,
  "Message counts and response timestamps": "Recompte de missatges i marques de temps de resposta",
  "Message counts are based on assistant responses.": "El recompte de missatges es basa en les respostes de l'assistent.",
  ...
  "Message text...": "Text del missatge...",
  messages,
  Messages,
  ...
  "Model can access Open Terminal for command execution and file management": "El model pot accedir a Open Terminal per a l'execució d'ordres i la gestió de fitxers",
  ...
  "Model names and usage frequency": "Noms de models i freqüència d'ús",
  "Model not found": "No s'ha trobat el model",
  ...
  "Name is required": "El nom és necessari",
  ...
  "No files yet. Upload files or run Python code to create them.": "Encara no hi ha fitxers. Puja fitxers o executa codi Python per crear-los.",
  ...
  "No one": "Ningú",
  "No output items": "No hi ha element de sortida",
  ...
  "No servers detected": "No s'han detectat servidors",
  ...
  "No webhooks yet": "No hi ha webhooks encara",
  ...
  "OAuth ID": "ID OAuth",
  "OAuth Server URL": "URL del servidor OAuth",
  "OAuth session disconnected": "Sessió OAuth desconnectada",
  October,
  Off,
  ...
  "Only sync new/updated chats": "Sincronitza només els xats nous/actualitzats",
  ...
  "Oops! You're using an unsupported method (frontend only). Please serve the rexpro from the backend.": "Ui! Estàs utilitzant un mètode no suportat (només frontend). Si us plau, serveix la rexpro des del backend.",
  ...
  "rexpro-ai can use tools provided by any OpenAPI server.": "rexpro-ai pot utilitzar eines de servidors OpenAPI.",
  "rexpro-ai uses faster-whisper internally.": "rexpro-ai utilitza faster-whisper internament.",
  "rexpro-ai uses SpeechT5 and CMU Arctic speaker embeddings.": "rexpro-ai utilitza incrustacions de SpeechT5 i CMU Arctic.",
  "rexpro-ai version": "Versió d'rexpro-ai",
  "rexpro-ai version (v{{OPEN_REXPRO_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "La versió d'rexpro-ai (v{{OPEN_REXPRO_VERSION}}) és inferior a la versió requerida (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "PaddleOCR-vl API URL required.": "URL de l'API PaddleOCR-vl necessària",
  page,
  Page,
  ...
  Personalization,
  Pin,
  "Pin to Sidebar": "Fixar a la barra lateral",
  Pinned,
  ...
  "Prompt Name": "Nom de la indicació",
  "Prompt Suggestions": "Suggerencies d'indicació",
  "Prompt Template": "Plantilla d'indicació",
  ...
  "Pyodide file browser": "Navegador de fitxers Pyodide",
  ...
  "Read-Only Access": "Accés de només lectura",
  Reason,
  ...
  "Redirecting you to rexpro-ai Community": "Redirigint-te a la comunitat rexpro-ai",
  ...
  "Render Markdown in Previews": "Renderitzar el Markdown a les previsualitzacions",
  "Render Markdown in User Messages": "Renderitzar el Markdown dels missatges de l'usuari",
  ...
  "Retrieved {{count}} sources_one": "S'ha obtingut {{count}} font",
  "Retrieved {{count}} sources_many": "S'han obtingut {{count}} fonts",
  "Retrieved {{count}} sources_other": "S'han obtingut {{count}} fonts",
  ...
  "Search, view, and manage user notes": "Cerca, mostra i gestiona les notes d'usuari",
  ...
  "Searxng search language (all, en, es, de, fr, etc.)": "Idioma de cerca de cerca (all, en, es, de, fr, etc.)",
  "See readme.md for instructions": "Consulta l'arxiu readme.md per obtenir instruccions",
  "See what's new": "Veure què hi ha de nou",
  Seed,
  Select,
  "Select {{modelName}} model": "Selecciona el model {{modelName}}",
  ...
  "Selected Models": "Models seleccionats",
  semantic,
  Send,
  ...
  "Set as Production": "Establir com a producció",
  ...
  "Set the default models that are automatically selected for all users when a new chat is created.": "Defineix els models predeterminats que es seleccionen automàticament per a tots els usuaris quan es crea un xat nou.",
  "Set the models that are automatically pinned to the sidebar for all users.": "Defineix els models que es fixen automàticament a la barra lateral per a tots els usuaris.",
  ...
  "Share to rexpro-ai Community": "Compartir amb la comunitat rexpro-ai",
  "Share your background and interests": "Compartir la teva informació i interessos",
  "Shared Chats": "Xats compartits",
  ...
  "Sign in to {{REXPRO_NAME}}": "Iniciar sessió a {{REXPRO_NAME}}",
  "Sign in to {{REXPRO_NAME}} with LDAP": "Iniciar sessió a {{REXPRO_NAME}} amb LDAP",
  "Sign Out": "Tancar sessió",
  "Sign up": "Registrar-se",
  "Sign up to {{REXPRO_NAME}}": "Registrar-se a {{REXPRO_NAME}}",
  ...
  "Signing in to {{REXPRO_NAME}}": "Iniciant sessió a {{REXPRO_NAME}}",
  Single,
  ...
  "Skill Description": "Descipció de l'habilitat",
  "Skill ID": "ID de l'habilitat",
  "Skill imported successfully": "L'habilitat s'ha importat correctament",
  "Skill Instructions": "Instruccions de l'habilitat",
  "Skill Name": "Nom de l'habilitat",
  "Skill updated successfully": "Habilitat actualitzada correctament",
  Skills,
  "Skills Access": "Accés a les habilitats",
  ...
  "Speech-to-Text Language": "Llengua de Veu-a-Text",
  "Split documents by markdown headers before applying character/token splitting.": "Divideix els documents per capçaleres de markdown abans d'aplicar la divisió de caràcters/tokens.",
  ...
  "Starting in 1 minute": "Començant en 1 minut",
  "Starting kernel...": "Iniciant el kernel...",
  "Starting now": "Començant ara",
  State,
  Status,
  ...
  "Sync Usage Stats": "Mostra la estadístiques d'ús",
  "Syncing stats...": "Sincronitzant les estadístiques...",
  "Syncing...": "Sincronitzant",
  "Syncs only chats with updates after your last sync timestamp. Disable to re-sync all chats.": "Sincronitza només els xats amb actualitzacions posteriors a la data i hora de l'última sincronització. Desactiva-ho per tornar a sincronitzar tots els xats.",
  System,
  ...
  "Title is required": "El tìtol és necessari",
  TLS,
  ...
  "To access the rexpro, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.": "Per accedir a la rexpro, poseu-vos en contacte amb l'administrador. Els administradors poden gestionar els estats dels usuaris des del tauler d'administració.",
  ...
  Unmute,
  Unpin,
  "Unpin from Sidebar": "No fixis a la barra lateral",
  ...
  Webhooks,
  "Webpage URLs": "URLs de la pàgina",
  "rexpro Settings": "Preferències de rexpro",
  "rexpro URL": "URL de rexpro",
  'rexpro will make requests to "{{url}}"': 'rexpro farà peticions a "{{url}}"',
  'rexpro will make requests to "{{url}}/api/chat"': 'rexpro farà peticions a "{{url}}/api/chat"',
  'rexpro will make requests to "{{url}}/chat/completions"': 'rexpro farà peticions a "{{url}}/chat/completions"',
  Week,
  Weekly,
  ...
  "Who can share to this group": "Qui pot compartir amb aquest grup",
  "Why?": "Per què?",
  ...
  Write,
  "Write a summary in 50 words that summarizes {{topic}}.": "Escriu un resum en 50 paraules que resumeixi [tema o paraula clau].",
  ...
  Yahoo,
  Yandex,
  "Yandex Web Search API Key": "Clau API de la cerca web Yandex",
  "Yandex Web Search config": "Configuració de la cerca web Yandex",
  "Yandex Web Search URL": "URL de la cerca web Yandex",
  Yesterday,
  ...
  "You do not have permission to edit this model": "No tens permís per editar aquest model",
  "You do not have permission to edit this prompt.": "No tens permís per editar aquesta indicació",
  "You do not have permission to edit this skill.": "No tens permís per editar aquesta habilitat",
  "You do not have permission to edit this tool": "No tens permís per editar aquesta eina",
  "You do not have permission to make this public": "No tens permís per fer això públic",
