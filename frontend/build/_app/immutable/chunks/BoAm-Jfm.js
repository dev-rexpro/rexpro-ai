const About = "Névjegy";
const Access = "Hozzáférés";
const Account = "Fiók";
const Action = "";
const Actions = "Műveletek";
const Activate = "Aktiválás";
const Active = "Aktív";
const Activity = "";
const Add = "Hozzáadás";
const admin = "admin";
...
const All = "Mind";
const Always = "Mindig";
const Amazing = "Csodálatos";
const Analytics = "";
const Analyzed = "Elemezve";
const Android = "";
const Anyone = "";
const April = "Április";
const Archive = "Archiválás";
const Artifacts = "Műtermékek";
const Asc = "";
const Ask = "Kérdezz";
const Assistant = "Asszisztens";
const Audio = "Hang";
const August = "Augusztus";
const Auth = "Hitelesítés";
const Authenticate = "Hitelesítés";
const Authentication = "Hitelesítés";
const Auto = "Automatikus";
...
const Bold = "";
const Brave = "";
const Calendar = "Naptár";
const Calendars = "";
const Call = "Hívás";
const Camera = "Kamera";
const Cancel = "Mégse";
const Capabilities = "Képességek";
const Capture = "Rögzítés";
const Channel = "";
const Channels = "Csatornák";
const Character = "Karakter";
const Chat = "Beszélgetés";
const chats = "";
const Chats = "Beszélgetések";
const Ciphers = "Titkosítási algoritmusok";
const Citation = "Idézet";
const Citations = "";
const Clone = "Klónozás";
const Close = "Bezárás";
const cloud = "";
const Collapse = "Összecsukás";
const Collection = "Gyűjtemény";
const Collections = "";
const Color = "Szín";
const ComfyUI = "ComfyUI";
const command = "";
const Command = "Parancs";
const Comment = "";
const Completions = "Kiegészítések";
const Config = "";
const Configuration = "";
const Configure = "Konfigurálás";
const Confirm = "Megerősítés";
const Connections = "Kapcsolatok";
const Content = "Tartalom";
const Controls = "Vezérlők";
const Copied = "Másolva";
const Copy = "Másolás";
const CPU = "";
const Create = "Létrehozás";
const Custom = "Egyéni";
const Daily = "";
const Dark = "Sötét";
const Database = "Adatbázis";
const Day = "";
const December = "December";
const Deepgram = "";
const Default = "Alapértelmezett";
const Defaults = "";
const Delete = "Törlés";
const Deleted = "";
const Desc = "";
...
const Deselect = "";
const Dictate = "";
const Direct = "Közvetlen";
const Disabled = "Letiltva";
const Display = "Megjelenítés";
const Docling = "Docling";
const Document = "Dokumentum";
...
const Email = "Email";
const Embedding = "Beágyazás";
const Emoji = "";
const Emojis = "";
const Enabled = "Engedélyezve";
const Enhance = "";
const Ephemeral = "";
const ERROR = "HIBA";
const Evaluations = "Értékelések";
const Exclude = "Kizárás";
const Expand = "Kibontás";
const Experimental = "Kísérleti";
const Explain = "Magyarázat";
const Explored = "";
const Exploring = "";
const Export = "Exportálás";
const External = "Külső";
const Features = "Funkciók";
...
const Files = "Fájlok";
const Filter = "";
const Filters = "Szűrők";
const Folder = "";
const Folders = "";
const Form = "Űrlap";
const Forward = "";
const Fr_day_of_week = "";
const Functions = "Funkciók";
const Gemini = "Gemini";
const Gender = "";
const General = "Általános";
const Generate = "";
const Global = "Globális";
const Google = "";
const Gravatar = "";
const Grid = "";
const Grokipedia = "";
...
const Import = "";
const Inactive = "";
const Include = "Tartalmaz";
const Info = "Információ";
const Initials = "";
const Input = "";
const Insert = "";
const Instructions = "";
const Integration = "Integráció";
const Integrations = "";
const Interface = "Felület";
const Italic = "";
const January = "Január";
const July = "Július";
const June = "Június";
const Key = "Kulcs";
const Knowledge = "Tudásbázis";
const Label = "Címke";
const Language = "Nyelv";
const LDAP = "LDAP";
const Leaderboard = "Ranglista";
const Legacy = "";
const lexical = "";
const License = "Licenc";
const Light = "Világos";
const List = "";
const Live = "";
const Loaded = "";
const Loader = "Betöltő";
const local = "";
const Local = "Helyi";
const Location = "";
const Lost = "Elveszett";
const Low = "";
const LTR = "LTR";
const Male = "";
const Manage = "Kezelés";
const March = "Március";
const Markdown = "";
const May = "Május";
const MBR = "";
...
const None = "Nincs";
const Note = "";
const Notes = "Jegyzetek";
const Notifications = "Értesítések";
...
const Other = "Egyéb";
const Output = "";
const OUTPUT = "KIMENET";
const Overview = "Áttekintés";
const page = "oldal";
const Page = "";
const Paginate = "";
const Parameters = "";
...
const Paused = "";
const pending = "függőben";
const Pending = "";
const Permissions = "Engedélyek";
const Persistent = "";
const Personalization = "Személyre szabás";
const Pin = "Rögzítés";
const Pinned = "Rögzítve";
const Pipe = "";
const Pipelines = "";
const Playground = "Játszótér";
const Port = "Port";
const Ports = "";
const Preview = "";
const Private = "Privát";
const Profile = "Profil";
const Prompt = "Prompt";
const Prompts = "Promptok";
const Provider = "";
const Public = "Nyilvános";
const Querying = "";
const Rating = "Értékelés";
const Read = "Olvasás";
const Reason = "";
const Reconnected = "";
const Record = "";
const Refresh = "";
const Regenerate = "Újragenerálás";
const Registered = "";
const Reindex = "";
const Releases = "";
...
const Rename = "Átnevezés";
const Repeats = "";
const Reply = "";
const required = "";
const Reset = "Visszaállítás";
const Response = "";
const Responses = "";
const Restart = "";
const Result = "Eredmény";
const RESULT = "Eredmény";
const Retrieval = "Visszakeresés";
const Role = "Szerep";
const RTL = "RTL";
const Run = "Futtatás";
const Running = "Fut";
...
const Saved = "Mentve";
const Schedule = "";
const Search = "Keresés";
const Searching = "";
const Seed = "Seed";
const Select = "";
const semantic = "";
const Send = "Küldés";
const September = "Szeptember";
const Session = "";
const Setting = "";
const Settings = "Beállítások";
...
const Status = "";
const Steps = "";
const Stop = "Leállítás";
const Storage = "";
const Strikethrough = "";
const Su_day_of_week = "";
const Subtitle = "";
const Success = "Siker";
const Suggested = "Javasolt";
const Support = "Támogatás";
const Sync = "";
const System = "Rendszer";
const Tag = "";
const Tags = "Címkék";
const Tasks = "Feladatok";
const Temperature = "Hőmérséklet";
const Terminal = "";
...
const tokens = "";
const Tokens = "";
const Tools = "Eszközök";
const Top = "";
const Transformers = "Transformerek";
const Tu_day_of_week = "";
const Type = "Típus";
const UI = "Felhasználói felület";
const Underline = "";
const Unknown = "";
const Unmute = "";
const Unpin = "Rögzítés feloldása";
const Untagged = "Címkézetlen";
const Untitled = "";
const Update = "Frissítés";
const Updated = "Frissítve";
const Upload = "Feltöltés";
const URL = "URL";
const Usage = "";
const Use = "";
const user = "felhasználó";
const User = "Felhasználó";
const Username = "Felhasználónév";
const users = "";
const Users = "Felhasználók";
const Valves = "Szelepek";
const variable = "változó";
const Version = "Verzió";
const Visibility = "Láthatóság";
const Visible = "";
const Vision = "";
const Visual = "";
const Voice = "Hang";
...
const Wikipedia = "";
const Won = "Nyert";
const Workspace = "Munkaterület";
const Write = "Írás";
const Yahoo = "";
const Yandex = "";
const Yesterday = "Tegnap";
const You = "Ön";
...
const translation = {
  ...
  "(e.g. `sh rexpro.sh --api --api-auth username_password`)": "(pl. `sh rexpro.sh --api --api-auth username_password`)",
  "(e.g. `sh rexpro.sh --api`)": "(pl. `sh rexpro.sh --api`)",
  "(latest)": "(legújabb)",
  ...
  "{{rexproAIName}} Backend Required": "{{rexproAIName}} Backend szükséges",
  ...
  "archived-chat-export": "archivált csevegés exportálása",
  ...
  "Attribute for Mail": "Email attribútum",
  "Attribute for Username": "Felhasználónév attribútum",
  Audio,
  August,
  Auth,
  Authenticate,
  ...
  "Click here for filter guides.": "Kattints ide a szűrő útmutatókért.",
  ...
  "Click here to see available models.": "Kattints ide az elérhető modellek megtekintéséhez.",
  ...
  "Code Execution Timeout": "Kód végrehajtási időtúllépés",
  "Code formatted successfully": "Kód sikeresen formázva",
  "Code Interpreter": "Kód értelmező",
  "Code Interpreter Engine": "Kód értelmező motor",
  "Code Interpreter Prompt Template": "Kód értelmező prompt sablon",
  ...
  Color,
  ComfyUI,
  "ComfyUI API Key": "ComfyUI API kulcs",
  ...
  "Confirm your new password": "Erősítsd meg az új jelszavad",
  ...
  "Contact Admin for rexpro Access": "Lépj kapcsolatba az adminnal a rexpro hozzáférésért",
  Content,
  ...
  "CORS must be properly configured by the provider to allow requests from rexpro-ai.": "A CORS-t megfelelően kell konfigurálnia a szolgáltatónak, hogy engedélyezze az rexpro-ai-ból érkező kéréseket.",
  "Could not read file.": "",
  CPU,
  Create,
  ...
  "Default permissions": "Alapértelmezett engedélyek",
  "Default permissions updated successfully": "Alapértelmezett engedélyek sikeresen frissítve",
  "Default Prompt Suggestions": "Alapértelmezett prompt javaslatok",
  "Default to 389 or 636 if TLS is enabled": "Alapértelmezés szerint 389 vagy 636, ha a TLS engedélyezve van",
  "Default to ALL": "Alapértelmezés szerint MIND",
  ...
  "Discover how to use rexpro-ai and seek support from the community.": "Fedezd fel, hogyan használd az rexpro-ai-t és kérj támogatást a közösségtől.",
  ...
  ElevenLabs,
  Email,
  "Embark on adventures": "Vágj bele kalandokba",
  Embedding,
  ...
  "Enable Memory Mapping (mmap) to load model data. This option allows the system to use disk storage as an extension of RAM by treating disk files as if they were in RAM. This can improve model performance by allowing for faster data access. However, it may not work correctly with all systems and can consume a significant amount of disk space.": "Engedélyezd a memória leképezést (mmap) a modell adatainak betöltéséhez. Ez az opció lehetővé teszi a rendszer számára, hogy a lemeztárolót a RAM kiterjesztéseként használja, a lemezfájlokat RAM-ban lévőként kezelve. Ez javíthatja a modell teljesítményét a gyorsabb adathozzáférés révén. Azonban nem minden rendszerrel működik megfelelően és jelentős lemezterületet foglalhat.",
  ...
  "Enter Bing Search V7 Endpoint": "Add meg a Bing Search V7 végpontot",
  "Enter Bing Search V7 Subscription Key": "Add meg a Bing Search V7 előfizetési kulcsot",
  "Enter Bocha Search API Key": "Add meg a Bocha Search API kulcsot",
  "Enter Brave Search API Key": "Add meg a Brave Search API kulcsot",
  "Enter certificate path": "Add meg a tanúsítvány útvonalát",
  ...
  "Enter Jupyter URL": "Add meg a Jupyter URL-t",
  ...
  "Enter Seed": "Add meg a seed értéket",
  "Enter SerpApi API Key": "Add meg a SerpApi API kulcsot",
  "Enter SerpApi Engine": "Add meg a SerpApi motort",
  ...
  "Enter the public URL of your rexpro. This URL will be used to generate links in the notifications.": "Add meg a rexpro nyilvános URL-jét. Ez az URL lesz használva az értesítésekben lévő linkek generálásához.",
  ...
  "Enter Your Name": "",
  "Enter your new password": "Add meg az új jelszavad",
  ...
  "Example: mail": "Példa: email",
  "Example: ou=users,dc=foo,dc=example": "Példa: ou=users,dc=foo,dc=example",
  "Example: sAMAccountName or uid or userPrincipalName": "Példa: sAMAccountName vagy uid vagy userPrincipalName",
  "Exceeded the number of seats in your license. Please contact support to increase the number of seats.": "Túllépted a licencben lévő helyek számát. Kérjük, vedd fel a kapcsolatot a támogatással a helyek számának növeléséhez.",
  Exclude,
  "Execute code": "",
  ...
  "Get started with {{REXPRO_NAME}}": "Kezdj neki a {{REXPRO_NAME}}-val",
  Global,
  ...
  "Image Edit": "",
  "Image Edit Engine": "",
  "Image Generation": "Képgenerálás",
  "Image Generation Engine": "Képgenerálási motor",
  "Image Max Compression Size": "Kép maximális tömörítési mérete",
  ...
  Inactive,
  Include,
  "Include `--api-auth` flag when running stable-diffusion-rexpro": "Add hozzá a `--api-auth` kapcsolót a stable-diffusion-rexpro futtatásakor",
  "Include `--api` flag when running stable-diffusion-rexpro": "Add hozzá a `--api` kapcsolót a stable-diffusion-rexpro futtatásakor",
  ...
  "Kokoro.js (Browser)": "Kokoro.js (Böngésző)",
  ...
  "Learn more about OpenAPI tool servers.": "Tudj meg többet az OpenAPI eszköszerverekről.",
  ...
  'Leave empty to include all models from "{{url}}/api/tags" endpoint': 'Hagyja üresen, hogy az összes modellt tartalmazza a "{{url}}/api/tags" végpontból',
  'Leave empty to include all models from "{{url}}/models" endpoint': 'Hagyja üresen, hogy az összes modellt tartalmazza a "{{url}}/models" végpontból',
  ...
  Low,
  LTR,
  "Made by rexpro-ai Community": "Az rexpro-ai közösség által készítve",
  ...
  "Manage Ollama": "Ollama kezelése",
  "Manage Ollama API Connections": "Ollama API kapcsolatok kezelése",
  ...
  "Ollama API settings updated": "Ollama API beállítások frissítve",
  ...
  "Oops! You're using an unsupported method (frontend only). Please serve the rexpro from the backend.": "Hoppá! Nem támogatott módszert használ (csak frontend). Kérjük, szolgálja ki a rexpro-t a backend-ről.",
  ...
  "rexpro-ai can use tools provided by any OpenAPI server.": "Az rexpro-ai bármely OpenAPI szerver által biztosított eszközöket használhat.",
  "rexpro-ai uses faster-whisper internally.": "Az rexpro-ai belsőleg a faster-whispert használja.",
  "rexpro-ai uses SpeechT5 and CMU Arctic speaker embeddings.": "Az rexpro-ai a SpeechT5-öt és a CMU Arctic hangszóró beágyazásokat használja.",
  "rexpro-ai version": "",
  "rexpro-ai version (v{{OPEN_REXPRO_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "Az rexpro-ai verzió (v{{OPEN_REXPRO_VERSION}}) alacsonyabb, mint a szükséges verzió (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "Prompt created successfully": "Prompt sikeresen létrehozva",
  "Prompt Name": "",
  "Prompt Suggestions": "",
  "Prompt Template": "",
  "Prompt updated successfully": "Prompt sikeresen frissítve",
  Prompts,
  "Prompts Access": "Promptok hozzáférése",
  "Prompts Public Sharing": "Promptok nyilvános megosztása",
  "Prompts Sharing": "",
  Provider,
  Public,
  ...
  "Redirecting you to rexpro-ai Community": "Átirányítás az rexpro-ai közösséghez",
  ...
  "Search Skills": "",
  "Search skills...": "",
  "Search the internet": "Keresés az interneten",
  ...
  September,
  "SerpApi API Key": "SerpApi API kulcs",
  ...
  "Set as Production": "",
  "Set embedding model": "Beágyazási modell beállítása",
  ...
  "Sets how far back for the model to look back to prevent repetition.": "Beállítja, hogy a modell mennyire nézzen vissza az ismétlések elkerülése érdekében.",
  "Sets the random number seed to use for generation. Setting this to a specific number will make the model generate the same text for the same prompt.": "Beállítja a generáláshoz használt véletlenszám seed-et. Egy adott szám megadása esetén a modell ugyanazt a szöveget generálja ugyanarra a prompt-ra.",
  "Sets the size of the context window used to generate the next token.": "Beállítja a következő token generálásához használt kontextusablak méretét.",
  ...
  "Share to rexpro-ai Community": "Megosztás az rexpro-ai közösséggel",
  ...
  "Sign in to {{REXPRO_NAME}}": "Bejelentkezés ide: {{REXPRO_NAME}}",
  "Sign in to {{REXPRO_NAME}} with LDAP": "Bejelentkezés ide: {{REXPRO_NAME}} LDAP-val",
  "Sign Out": "Kijelentkezés",
  "Sign up": "Regisztráció",
  "Sign up to {{REXPRO_NAME}}": "Regisztráció ide: {{REXPRO_NAME}}",
  ...
  "Signing in to {{REXPRO_NAME}}": "Bejelentkezés ide: {{REXPRO_NAME}}",
  Single,
  "Sink List": "",
  "sk-1234": "sk-1234",
  ...
  "To access the rexpro, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.": "A rexpro eléréséhez kérjük, forduljon az adminisztrátorhoz. Az adminisztrátorok az Admin Panelen keresztül kezelhetik a felhasználói státuszokat.",
  ...
  "Tool Description": "Eszköz leírása",
  "Tool ID": "Eszköz azonosító",
  "Tool imported successfully": "Eszköz sikeresen importálva",
  "Tool Name": "Eszköz neve",
  "Tool Servers": "Eszközszerverek",
  ...
  Top,
  "Top K": "Top K",
  "Top K Reranker": "Top K újrarangsoroló",
  Transformers,
  ...
  "Updated At": "Frissítve ekkor",
  "Upgrade to a licensed plan for enhanced capabilities, including custom theming and branding, and dedicated support.": "Frissítsen licencelt csomagra a bővített képességekért, beleértve az egyéni témázást és márkázást, valamint dedikált támogatást.",
  Upload,
  ...
  "Web Search Query Generation": "Webes keresési lekérdezés generálása",
  "Webhook Name": "",
  "Webhook URL": "Webhook URL",
  Webhooks,
  "Webpage URLs": "",
  "rexpro Settings": "rexpro beállítások",
  "rexpro URL": "rexpro URL",
  'rexpro will make requests to "{{url}}"': 'A rexpro kéréseket küld a "{{url}}" címre',
  'rexpro will make requests to "{{url}}/api/chat"': 'A rexpro kéréseket küld a "{{url}}/api/chat" címre',
  'rexpro will make requests to "{{url}}/chat/completions"': 'A rexpro kéréseket küld a "{{url}}/chat/completions" címre',
  Week,
  Weekly,
  ...
  Write,
  "Write a summary in 50 words that summarizes {{topic}}.": "Írjon egy 50 szavas összefoglalót a [téma vagy kulcsszó]-ról.",
  ...
  "You do not have permission to upload files.": "Nincs jogosultsága fájlok feltöltésére.",
  ...
  "Your entire contribution will go directly to the plugin developer; rexpro-ai does not take any percentage. However, the chosen funding platform might have its own fees.": "A teljes hozzájárulása közvetlenül a bővítmény fejlesztőjéhez kerül; az rexpro-ai nem vesz le százalékot. Azonban a választott támogatási platformnak lehetnek saját díjai.",
