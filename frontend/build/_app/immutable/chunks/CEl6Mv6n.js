...
var CFB = /* @__PURE__ */ function _CFB() {
  ...
  function use_zlib(zlib) {
    try {
      ...
      /* @__PURE__ */ console.error("cannot use native zlib: " + (e.message || e));
    }
  }
  ...
  function warn_or_throw(wrn, msg) {
    if (wrn) {
      if (typeof console !== "undefined") /* @__PURE__ */ console.error(msg);
...
var DBF = /* @__PURE__ */ function() {
  ...
  function dbf_to_aoa(buf, opts) {
    ...
    while (d.l < hend && d[d.l] != 13) {
      ...
      switch (field.type) {
        case "B":
          if ((!vfp || field.len != 8) && opts.WTF) /* @__PURE__ */ console.log("Skipping " + field.name + ":" + field.type);
          break;
        case "G":
        case "P":
          if (opts.WTF) /* @__PURE__ */ console.log("Skipping " + field.name + ":" + field.type);
          break;
        case "+":
        case "0":
        case "@":
      ...
      switch (cc) {
        ...
        case 3:
          if (blob.l < blob.length) {
            /* @__PURE__ */ console.error("WK1 premature formula end");
            return;
          }
          break;
        case 4:
        ...
        default:
          if (cc < 32 && BinOpTab[cc]) {
            ...
            if (argc > out.length) {
              /* @__PURE__ */ console.error("WK1 bad formula parse 0x" + cc.toString(16) + ":|" + out.join("|") + "|");
              return;
            }
            var args = out.slice(-argc);
            out.length -= argc;
            out.push(FuncTab[cc][0] + "(" + args.join(",") + ")");
          } else if (cc <= 7) return /* @__PURE__ */ console.error("WK1 invalid opcode " + cc.toString(16));
          else if (cc <= 24) return /* @__PURE__ */ console.error("WK1 unsupported op " + cc.toString(16));
          else if (cc <= 30) return /* @__PURE__ */ console.error("WK1 invalid opcode " + cc.toString(16));
          else if (cc <= 115) return /* @__PURE__ */ console.error("WK1 unsupported function opcode " + cc.toString(16));
          else return /* @__PURE__ */ console.error("WK1 unrecognized opcode " + cc.toString(16));
      }
    }
    if (out.length == 1) o[1].f = "" + out[0];
    else /* @__PURE__ */ console.error("WK1 bad formula parse |" + out.join("|") + "|");
  }
    ...
    if (R && R.f) {
      ...
      switch (RecordType) {
        ...
        case 18:
          ...
          break;
        case 19:
          if (val !== 0 && opts.WTF) /* @__PURE__ */ console.error("Password verifier: " + val);
          break;
        case 133:
          {
      ...
      if (!R) /* @__PURE__ */ console.error("Missing Info for XLS Record 0x" + RecordType.toString(16));
      blob.l += length;
    }
  }
...
function write_biff_buf(wb, opts) {
  for (var i = 0; i <= wb.SheetNames.length; ++i) {
    ...
    var range = decode_range(ws["!ref"]);
    if (range.e.c > 255) {
      if (typeof console != "undefined" && console.error) /* @__PURE__ */ console.error("Worksheet '" + wb.SheetNames[i] + "' extends beyond column IV (255).  Data may be lost.");
    }
  }
  var o = opts || {};
  switch (o.biff || 2) {
...
function parse_numbers_iwa(cfb) {
  ...
  cfb.FileIndex.forEach(function(s) {
    ...
    try {
      ...
      return /* @__PURE__ */ console.log("?? " + s.content.length + " " + (e.message || e));
    }
    var packets;
    try {
      packets = parse_iwa_file(o);
    } catch (e) {
      return /* @__PURE__ */ console.log("## " + (e.message || e));
    }
...
function write_numbers_iwa(wb, opts) {
  ...
  if (wb.SheetNames.length > 1)
    /* @__PURE__ */ console.error("The Numbers writer currently writes only the first table");
  var range = decode_range(ws["!ref"]);
  ...
  if (trunc)
    /* @__PURE__ */ console.error("The Numbers writer is currently limited to ".concat(encode_range(range)));
