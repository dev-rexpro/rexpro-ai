...
const translation = {
  ...
  "Attribute for Mail": "Attribut pour le courriel",
  ...
  "Code Interpreter": "Interpreteur de code",
  "Code Interpreter Engine": "Moteur de l'interpreteur de code",
  ...
  "Continue with Email": "Continuer avec le courriel",
  ...
  "Enter SerpApi API Key": "Entrez la clé API SerPAI",
  "Enter SerpApi Engine": "Entrez le moteur SerApi",
  ...
  "Function imported successfully": "Import de la fonction réalisé",
  ...
  Inactive,
  Include,
  "Include `--api-auth` flag when running stable-diffusion-rexpro": "Inclure le drapeau `--api-auth` lors de l'exécution de stable-diffusion-rexpro",
  "Include `--api` flag when running stable-diffusion-rexpro": "Inclure le drapeau `--api` lorsque vous exécutez stable-diffusion-rexpro",
  ...
  September,
  "SerpApi API Key": "Clé d'API SerpAPI",
  ...
  "The LDAP attribute that maps to the mail that users use to sign in.": "L'attribut LDAP qui correspond au courriel que les utilisateurs utilisent pour se connecter.",
