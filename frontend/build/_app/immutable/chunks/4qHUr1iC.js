...
import { t as toPropertyKey$3 } from "./DPvaCmkl.js";
...
var hostReportErrors$1 = function(a2, b) {
  try {
    arguments.length === 1 ? /* @__PURE__ */ console.error(a2) : /* @__PURE__ */ console.error(a2, b);
  } catch (error) {
  }
};
  ...
  loadImage(href) {
    ...
    return _asyncToGenerator(function* () {
      try {
        ...
        /* @__PURE__ */ console.error('Error while loading image "'.concat(href, '":'), err);
      }
      _this.loaded = true;
    })();
  }
  ...
  load(fontFamily, url) {
    ...
    return _asyncToGenerator(function* () {
      try {
        ...
        /* @__PURE__ */ console.error('Error while loading font "'.concat(url, '":'), err);
      }
      _this.loaded = true;
    })();
  }
