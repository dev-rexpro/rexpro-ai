const About = "Про програму";
const Access = "Доступ";
const Account = "Обліковий запис";
const Action = "";
const Actions = "Дії";
const Activate = "Активувати";
const Active = "Активний";
const Activity = "";
const Add = "Додати";
const admin = "адмін";
const Admin = "Адмін";
...
const All = "Усі";
const Always = "Завжди";
const Amazing = "Чудово";
const Analytics = "";
const Analyzed = "Проаналізовано";
const Android = "";
const Anyone = "";
const April = "Квітень";
const Archive = "Архів";
const Artifacts = "Артефакти";
const Asc = "";
const Ask = "Запитати";
const Assistant = "Асистент";
const Audio = "Аудіо";
const August = "Серпень";
const Auth = "";
const Authenticate = "Автентифікувати";
const Authentication = "Аутентифікація";
const Auto = "";
const Automatic1111 = "Automatic1111";
const Automation = "";
const Automations = "";
const Away = "Відсутній";
const Awful = "Жахливо";
const Back = "Назад";
const Banners = "Прапори";
const Bearer = "";
const before = "до того, як";
const Beta = "Beta";
const Bing = "";
const Bio = "";
const Bold = "";
...
const Capabilities = "Можливості";
const Capture = "Захоплення";
const Channel = "";
const Channels = "Канали";
const Character = "Персонаж";
const Chat = "Чат";
const chats = "";
const Chats = "Чати";
const Ciphers = "Шифри";
const Citation = "Цитування";
const Citations = "";
const Clone = "Клонувати";
const Close = "Закрити";
const cloud = "";
const Collapse = "Згорнути";
const Collection = "Колекція";
const Collections = "";
const Color = "Колір";
...
const Comment = "";
const Completions = "Завершення";
const Config = "";
const Configuration = "";
const Configure = "Налаштувати";
const Confirm = "Підтвердити";
const Connections = "З'єднання";
const Content = "Зміст";
const Controls = "Керування";
const Copied = "Скопійовано";
const Copy = "Копіювати";
const CPU = "";
const Create = "Створити";
const Custom = "Налаштувати";
const Daily = "";
const Dark = "Темна";
const Database = "База даних";
const Day = "";
...
const Email = "Ел. пошта";
const Embedding = "Вбудовування";
const Emoji = "";
const Emojis = "";
const Enabled = "Увімкнено";
const Enhance = "";
const Ephemeral = "";
const ERROR = "ПОМИЛКА";
const Evaluations = "Оцінювання";
const Exclude = "Виключити";
const Expand = "Розгорнути";
const Experimental = "Експериментальне";
const Explain = "Пояснити";
const Explored = "";
const Exploring = "";
const Export = "Експорт";
const External = "Зовнішній";
const Features = "Особливості";
...
const Functions = "Функції";
const Gemini = "Gemini";
const Gender = "";
const General = "Загальні";
const Generate = "";
const Global = "Глоб.";
const Google = "";
const Gravatar = "";
...
const Headers = "";
const Height = "";
const Help = "Допоможіть";
const Hidden = "";
const Hide = "Приховати";
const High = "";
const History = "";
const Home = "Головна";
const Host = "Хост";
...
const Import = "";
const Inactive = "";
const Include = "Включити";
const Info = "Інфо";
const Initials = "";
const Input = "";
const Insert = "";
const Instructions = "";
const Integration = "Інтеграція";
const Integrations = "";
const Interface = "Інтерфейс";
const Italic = "";
const January = "Січень";
const July = "Липень";
const June = "Червень";
const Key = "Ключ";
const Knowledge = "Знання";
const Label = "Мітка";
const Language = "Мова";
const LDAP = "LDAP";
const Leaderboard = "Таблиця лідерів";
const Legacy = "";
const lexical = "";
...
const Live = "";
const Loaded = "";
const Loader = "Завантажувач";
const local = "";
const Local = "Локальний";
const Location = "";
const Lost = "Втрачене";
const Low = "";
const LTR = "LTR";
const Male = "";
const Manage = "Керувати";
...
const None = "Нема";
const Note = "";
const Notes = "Примітки";
const Notifications = "Сповіщення";
...
const Paused = "";
const pending = "на розгляді";
const Pending = "";
const Permissions = "Дозволи";
const Persistent = "";
const Personalization = "Персоналізація";
const Pin = "Зачепити";
const Pinned = "Зачеплено";
const Pipe = "";
const Pipelines = "";
const Playground = "Майданчик";
const Port = "Порт";
const Ports = "";
const Preview = "";
const Private = "Приватний";
const Profile = "Профіль";
const Prompt = "Підказка";
const Prompts = "Промти";
const Provider = "";
const Public = "Публічний";
const Querying = "";
const Rating = "Оцінка";
const Read = "Читати";
const Reason = "";
...
const Record = "";
const Refresh = "";
const Regenerate = "Регенерувати";
const Registered = "";
const Reindex = "";
const Releases = "";
const Relevance = "Актуальність";
const Reminder = "";
const Remove = "Видалити";
const Rename = "Переназвати";
const Repeats = "";
const Reply = "";
const required = "";
const Reset = "Скидання";
const Response = "";
const Responses = "";
const Restart = "";
const Result = "Результат";
const RESULT = "Результат";
const Retrieval = "Пошук";
const Role = "Роль";
const RTL = "RTL";
const Run = "Запустити";
const Running = "Виконується";
const Sa_day_of_week = "";
const Save = "Зберегти";
const Saved = "Збережено";
const Schedule = "";
const Search = "Пошук";
const Searching = "";
const Seed = "Сід";
...
const Subtitle = "";
const Success = "Успіх";
const Suggested = "Запропоновано";
const Support = "Підтримати";
const Sync = "";
...
const tokens = "";
const Tokens = "";
const Tools = "Інструменти";
const Top = "";
const Transformers = "Трансформери";
const Tu_day_of_week = "";
const Type = "Тип";
const UI = "Користувацький інтерфейс";
const Underline = "";
const Unknown = "";
const Unmute = "";
const Unpin = "Відчепити";
const Untagged = "Без тегів";
const Untitled = "";
const Update = "Оновлення";
const Updated = "Оновлено";
const Upload = "Завантажити";
const URL = "URL";
const Usage = "";
const Use = "";
...
const Valves = "Клапани";
const variable = "змінна";
const Version = "Версія";
const Visibility = "Видимість";
const Visible = "";
const Vision = "";
const Visual = "";
const Voice = "Голос";
...
const Width = "";
const Wikipedia = "";
const Won = "Переможець";
const Workspace = "Робочий простір";
const Write = "Писати";
const Yahoo = "";
const Yandex = "";
...
const translation = {
  ...
  "(e.g. `sh rexpro.sh --api --api-auth username_password`)": "(напр. `sh rexpro.sh --api --api-auth username_password`)",
  "(e.g. `sh rexpro.sh --api`)": "(напр. `sh rexpro.sh --api`)",
  "(latest)": "(остання)",
  ...
  "{{rexproAIName}} Backend Required": "Необхідно підключення бекенду {{rexproAIName}}",
  ...
  "Contact Admin for rexpro Access": "Зверніться до адміна для отримання доступу до rexpro",
  Content,
  ...
  "CORS must be properly configured by the provider to allow requests from rexpro-ai.": "CORS має бути правильно налаштований постачальником, щоб дозволити запити з rexpro-ai.",
  "Could not read file.": "",
  CPU,
  Create,
  ...
  "Discover how to use rexpro-ai and seek support from the community.": "Дізнайтесь, як використовувати rexpro-ai, та звертайтесь за підтримкою до спільноти.",
  ...
  "Enter the public URL of your rexpro. This URL will be used to generate links in the notifications.": "Введіть публічний URL вашого rexpro. Цей URL буде використовуватися для генерування посилань у сповіщеннях.",
  ...
  "Get started": "Почати",
  "Get started with {{REXPRO_NAME}}": "Почати з {{REXPRO_NAME}}",
  Global,
  ...
  Inactive,
  Include,
  "Include `--api-auth` flag when running stable-diffusion-rexpro": "Включіть прапорець `--api-auth` під час запуску stable-diffusion-rexpro",
  "Include `--api` flag when running stable-diffusion-rexpro": "Включіть прапор `--api` при запуску stable-diffusion-rexpro",
  ...
  Low,
  LTR,
  "Made by rexpro-ai Community": "Зроблено спільнотою rexpro-ai",
  ...
  "Oops! You're using an unsupported method (frontend only). Please serve the rexpro from the backend.": "Упс! Ви використовуєте непідтримуваний метод (тільки для фронтенду). Будь ласка, обслуговуйте rexpro з бекенду.",
  ...
  "rexpro-ai uses faster-whisper internally.": "rexpro-ai використовує faster-whisper внутрішньо.",
  "rexpro-ai uses SpeechT5 and CMU Arctic speaker embeddings.": "rexpro-ai використовує вбудовування голосів SpeechT5 та CMU Arctic.",
  "rexpro-ai version": "",
  "rexpro-ai version (v{{OPEN_REXPRO_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "rexpro-ai версія (v{{OPEN_REXPRO_VERSION}}) нижча за необхідну версію (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "Prompts Public Sharing": "Публічний обмін промтами",
  "Prompts Sharing": "",
  Provider,
  Public,
  ...
  "Redirecting you to rexpro-ai Community": "Перенаправляємо вас до спільноти rexpro-ai",
  ...
  "Share to rexpro-ai Community": "Поділитися зі спільнотою rexpro-ai",
  ...
  "Sign in": "Увійти",
  "Sign in to {{REXPRO_NAME}}": "Увійти в {{REXPRO_NAME}}",
  "Sign in to {{REXPRO_NAME}} with LDAP": "Увійти до {{REXPRO_NAME}} за допомогою LDAP",
  "Sign Out": "Вийти",
  "Sign up": "Зареєструватися",
  "Sign up to {{REXPRO_NAME}}": "Зареєструватися в {{REXPRO_NAME}}",
  ...
  "Signing in to {{REXPRO_NAME}}": "Увійти в {{REXPRO_NAME}}",
  Single,
  "Sink List": "",
  "sk-1234": "sk-1234",
  ...
  "To access the rexpro, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.": "Щоб отримати доступ до веб-інтерфейсу, зверніться до адміністратора. Адміністратори можуть керувати статусами користувачів з Панелі адміністратора.",
  ...
  Webhooks,
  "Webpage URLs": "",
  "rexpro Settings": "Налаштування rexpro",
  "rexpro URL": "rexpro URL",
  'rexpro will make requests to "{{url}}"': "",
  'rexpro will make requests to "{{url}}/api/chat"': 'rexpro надсилатиме запити до "{{url}}/api/chat"',
  'rexpro will make requests to "{{url}}/chat/completions"': 'rexpro надсилатиме запити до "{{url}}/chat/completions"',
  Week,
  Weekly,
  ...
  Write,
  "Write a summary in 50 words that summarizes {{topic}}.": "Напишіть стислий зміст у 50 слів, який узагальнює [тема або ключове слово].",
