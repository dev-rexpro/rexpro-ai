const About = "შესახებ";
const Access = "წვდომა";
const Account = "ანგარიში";
const Action = "ქმედება";
const Actions = "ქმედებები";
const Activate = "აქტივაცია";
const Active = "აქტიური";
const Activity = "";
const Add = "დამატება";
const admin = "ადმინისტრატორი";
const Admin = "ადმინი";
const Advanced = "";
const AI = "AI";
const All = "ყველა";
const Always = "ყოველთვის";
const Amazing = "გადასარევია";
const Analytics = "ანალიტიკა";
const Analyzed = "გაანაზლიებულია";
const Android = "Android";
const Anyone = "";
const April = "აპრილი";
const Archive = "დაარქივება";
const Artifacts = "არტეფაქტები";
const Asc = "";
const Ask = "კითხვა";
const Assistant = "დამხმარე";
const Audio = "აუდიო";
const August = "აგვისტო";
const Auth = "ავთენტ";
const Authenticate = "ავთენტიკაცია";
const Authentication = "ავთენტიკაცია";
const Auto = "ავტო";
const Automatic1111 = "Automatic1111";
const Automation = "";
const Automations = "";
const Away = "გაცდენილი";
const Awful = "საშინელი";
const Back = "უკან";
const Banners = "ბანერები";
const Bearer = "Bearer";
const before = "მითითებულ დრომდე";
const Beta = "ბეტა";
const Bing = "";
const Bio = "ბიო";
const Bold = "სქელი";
const Brave = "";
const Calendar = "კალენდარი";
const Calendars = "";
const Call = "ზარი";
const Camera = "კამერა";
const Cancel = "გაუქმება";
const Capabilities = "შესაძლებლობები";
const Capture = "ჩაჭერა";
const Channel = "არხი";
const Channels = "არხები";
const Character = "სიმბოლო";
const Chat = "ჩატი";
const chats = "";
const Chats = "საუბრები";
const Ciphers = "შიფრები";
const Citation = "ციტატა";
const Citations = "ციტატები";
const Clone = "კლონი";
const Close = "დახურვა";
const cloud = "";
const Collapse = "აკეცვა";
const Collection = "კოლექცია";
const Collections = "";
const Color = "ფერი";
const ComfyUI = "ComfyUI";
const command = "";
const Command = "ბრძანება";
const Comment = "კომენტარი";
const Completions = "დასრულებები";
const Config = "";
const Configuration = "";
const Configure = "მორგება";
const Confirm = "დადასტურება";
const Connections = "კავშირები";
const Content = "შემცველობა";
const Controls = "მმართველები";
const Copied = "დაკოპირდა";
const Copy = "კოპირება";
const CPU = "";
const Create = "შექმნა";
const Custom = "ხელით";
const Daily = "";
const Dark = "მუქი";
const Database = "მონაცემთა ბაზა";
const Day = "";
const December = "დეკემბერი";
const Deepgram = "Deepgram";
const Default = "ნაგულისხმევი";
const Defaults = "";
const Delete = "წაშლა";
const Deleted = "";
const Desc = "";
const Description = "აღწერა";
const Deselect = "";
const Dictate = "კარნახი";
const Direct = "პირდაპირი";
const Disabled = "გამორთული";
const Display = "ჩვენება";
const Docling = "Docling";
const Document = "დოკუმენტი";
const Documentation = "დოკუმენტაცია";
const Documents = "";
const Done = "დასრულებული";
const Download = "გადმოწერა";
const Draw = "ხატვა";
const DuckDuckGo = "";
const Edit = "ჩასწორება";
const edited = "ჩასწორებულია";
const Edited = "ჩასწორებულია";
const Editing = "ჩასწორება";
const Eject = "გამოღება";
const ElevenLabs = "ElevenLabs";
const Email = "ელფოსტა";
const Embedding = "ჩაშენება";
const Emoji = "";
const Emojis = "";
const Enabled = "ჩართულია";
const Enhance = "გაუმჯობესება";
const Ephemeral = "";
const ERROR = "ERROR";
const Evaluations = "შეფასებები";
const Exclude = "გამორიცხვა";
const Expand = "გაფართოება";
const Experimental = "ექსპერიმენტული";
const Explain = "ახსნა";
const Explored = "";
const Exploring = "";
const Export = "გატანა";
const External = "გარე";
const Features = "მახასიათებლები";
const February = "თებერვალი";
const Feedback = "";
const Female = "მდედრობითი";
const File = "ფაილი";
const Filename = "";
const Files = "ფაილი";
const Filter = "ფილტრი";
const Filters = "ფილტრები";
const Folder = "საქაღალდე";
const Folders = "საქაღალდეები";
const Form = "ფორმა";
const Forward = "";
const Fr_day_of_week = "";
const Functions = "ფუნქციები";
const Gemini = "მარჩბივი";
const Gender = "სქესი";
const General = "ზოგადი";
const Generate = "გენერაცია";
const Global = "გლობალური";
const Google = "";
const Gravatar = "გრავატარი";
const Grid = "";
const Grokipedia = "";
const groups = "";
const Groups = "ჯგუფები";
const H1 = "H1";
const H2 = "H2";
const H3 = "H3";
const Headers = "თავსართები";
const Height = "სიმაღლე";
const Help = "დახმარება";
const Hidden = "";
const Hide = "დამალვა";
const High = "მაღალი";
const History = "";
...
const HTML = "HTML";
const ID = "ID";
const Image = "გამოსახულება";
const Images = "";
const Import = "შემოტანა";
const Inactive = "";
const Include = "ჩართვა";
const Info = "ინფორმაცია";
const Initials = "ინიციალები";
const Input = "შეყვანა";
const Insert = "ჩასმა";
const Instructions = "";
const Integration = "ინტეგრაცია";
const Integrations = "ინტეგრაციები";
const Interface = "ინტერფეისი";
const Italic = "კურსივი";
const January = "იანვარი";
const July = "ივლისი";
const June = "ივნისი";
const Key = "გასაღები";
const Knowledge = "ცოდნა";
const Label = "ჭდე";
const Language = "ენა";
const LDAP = "LDAP";
const Leaderboard = "ლიდერების დაფა";
const Legacy = "მოძველებული";
const lexical = "ლექსიკური";
const License = "ლიცენზია";
const Light = "ღია";
const List = "";
const Live = "";
const Loaded = "";
const Loader = "ჩამტვირთავი";
const local = "";
const Local = "ლოკალური";
const Location = "";
const Lost = "წაგება";
const Low = "დაბალი";
const LTR = "LTR";
const Male = "მამრობითი";
const Manage = "მართვა";
const March = "მარტი";
...
const MBR = "";
const MCP = "MCP";
const Medium = "საშუალო";
const members = "";
const Members = "";
const Memories = "";
const Memory = "მეხსიერება";
const Message = "";
const messages = "";
const Messages = "";
const min = "";
...
const Muted = "";
const Name = "სახელი";
const Native = "საკუთარი";
const Never = "";
const New = "";
const None = "არცერთი";
const Note = "შენიშვნა";
const Notes = "შენიშვნები";
const Notifications = "გაფრთხილებები";
const November = "ნოემბერი";
const OAuth = "OAuth";
const October = "ოქტომბერი";
const Off = "გამორთ";
const Ollama = "Ollama";
const On = "ჩართული";
const Once = "";
...
const optional = "";
const Optional = "არასავალდებულო";
const or = "ან";
const Other = "სხვა";
const Output = "";
const OUTPUT = "გამოტანა";
const Overview = "მიმოხილვა";
const page = "პანელი";
const Page = "";
const Paginate = "გვერდებად დაყოფა";
const Parameters = "პარამეტრები";
const Password = "პაროლი";
const Paused = "";
const pending = "დარჩენილი";
const Pending = "დარჩენილი";
const Permissions = "ნებართვები";
const Persistent = "";
const Personalization = "პერსონალიზაცია";
const Pin = "მიმაგრება";
const Pinned = "მიმაგრებულია";
const Pipe = "ფაიფი";
const Pipelines = "";
const Playground = "საცდელი ფუნქციები";
const Port = "პორტი";
const Ports = "";
const Preview = "მინიატურა";
const Private = "პირადი";
const Profile = "პროფილი";
const Prompt = "ბრძანების შეყვანის შეხსენება";
const Prompts = "მოთხოვნები";
const Provider = "";
const Public = "საჯარო";
const Querying = "მოთხოვნა";
const Rating = "ხმის მიცემა";
const Read = "წაკითხვა";
const Reason = "მიზეზი";
const Reconnected = "";
const Record = "ჩაწერა";
const Refresh = "";
const Regenerate = "თავიდან გენერაცია";
const Registered = "რეგისტრირებულია";
const Reindex = "რეინდექსი";
const Releases = "რელიზი";
const Relevance = "შესაბამისობა";
const Reminder = "";
const Remove = "წაშლა";
const Rename = "სახელის გადარქმევა";
const Repeats = "";
const Reply = "პასუხი";
const required = "აუცილებელია";
const Reset = "ჩამოყრა";
const Response = "პასუხი";
const Responses = "";
const Restart = "";
const Result = "შედეგი";
const RESULT = "შედეგი";
const Retrieval = "მიღება";
const Role = "როლი";
const RTL = "RTL";
const Run = "გაშვება";
const Running = "გაშვებულია";
const Sa_day_of_week = "";
const Save = "შენახვა";
const Saved = "შენახულია";
const Schedule = "";
const Search = "ძებნა";
const Searching = "ძებნა";
const Seed = "თესლი";
const Select = "არჩევა";
const semantic = "სემანტიკური";
const Send = "გაგზავნა";
const September = "სექტემბერი";
const Session = "სესია";
const Setting = "";
const Settings = "მორგება";
const Share = "გაზიარება";
const Show = "ჩვენება";
const Single = "";
const Skills = "";
const Sonar = "სონარი";
...
const Stop = "გაჩერება";
const Storage = "";
const Strikethrough = "გადახაზული";
const Su_day_of_week = "";
const Subtitle = "";
const Success = "წარმატება";
const Suggested = "შეთავაზებულია";
const Support = "მხარდაჭერა";
const Sync = "";
const System = "სისტემა";
const Tag = "ჭდე";
const Tags = "ჭდეები";
const Tasks = "ამოცანები";
const Temperature = "ტემპერატურა";
const Terminal = "";
...
const tokens = "";
const Tokens = "";
const Tools = "ხელსაწყოები";
const Top = "";
const Transformers = "Transformers";
const Tu_day_of_week = "";
const Type = "ტიპი";
const UI = "UI";
const Underline = "ხაზგასმული";
const Unknown = "უცნობი";
const Unmute = "";
const Unpin = "ჩამოხსნა";
const Untagged = "ჭდის გარეშე";
const Untitled = "უსათაურო";
const Update = "განახლება";
const Updated = "განახლებულია";
const Upload = "ატვირთვა";
const URL = "URL";
const Usage = "გამოყენება";
const Use = "";
const user = "მომხმარებელი";
const User = "მომხმარებელი";
const Username = "მომხმარებლის სახელი";
const users = "";
const Users = "მომხმარებლები";
const Valves = "ონკანები";
const variable = "ცვლადი";
const Version = "ვერსია";
const Visibility = "ხილვადობა";
const Visible = "";
const Vision = "ხედვა";
const Visual = "";
const Voice = "ხმა";
const Warning = "გაფრთხილება";
...
const Wikipedia = "";
const Won = "ვონი";
const Workspace = "სამუშაო სივრცე";
const Write = "ჩაწერა";
const Yahoo = "";
const Yandex = "";
const Yesterday = "გუშინ";
const You = "თქვენ";
...
const translation = {
  ...
  "(e.g. `sh rexpro.sh --api --api-auth username_password`)": "(მაგ: `sh rexpro.sh --api --api-auth username_password`)",
  "(e.g. `sh rexpro.sh --api`)": "(მაგ: `sh rexpro.sh --api`)",
  "(latest)": "(უახლესი)",
  ...
  "{{COUNT}} Available Tools": "{{COUNT}} ხელმისაწვდომი ხელსაწყო",
  "{{COUNT}} characters": "{{COUNT}} სიმბოლო",
  "{{COUNT}} extracted lines": "{{COUNT}} ამოღებული ხაზი",
  "{{COUNT}} files": "",
  ...
  "{{COUNT}} hidden lines": "{{COUNT}} დამალული ხაზი",
  "{{COUNT}} members": "",
  ...
  "{{rexproAIName}} Backend Required": "{{rexproAIName}} საჭიროა უკანაბოლო",
  ...
  "Add a tag": "ჭდის დამატება",
  "Add a tag...": "",
  "Add Access": "",
  "Add Arena Model": "არენის მოდელის დამატება",
  ...
  "Add Reaction": "რეაქციის დამატება",
  "Add tag": "",
  "Add Tag": "ჭდის დამატება",
  "Add Terminal": "",
  ...
  Admin,
  "Admin Contact Email": "",
  "Admin Panel": "ადმინისტრატორის პანელი",
  "Admin Settings": "ადმინისტრატორის მორგება",
  ...
  "All time": "",
  "All Users": "",
  "Allow Call": "გამოძახების დაშვება",
  ...
  "Allow Chat Export": "ჩატის გატანის დაშვება",
  "Allow Chat Params": "ჩატის პარამეტრების დაშვება",
  "Allow Chat Share": "ჩატის გაზიარების დაშვება",
  "Allow Chat System Prompt": "ჩატის სისტემური მოთხოვნის დაშვება",
  "Allow Chat Valves": "ჩატის ონკანების დაშვება",
  "Allow Continue Response": "პასუხის გაგრძელების დაშვება",
  "Allow Delete Messages": "შეტყობინებების წაშლის დაშვება",
  "Allow File Upload": "ფაილის ატვირთვის დაშვება",
  "Allow Multiple Models in Chat": "ერთზე მეტი მოდელის დაშვება ჩატში",
  "Allow non-local voices": "არალოკალური ხმების დაშვება",
  "Allow public write access": "",
  "Allow Rate Response": "პასუხის შეფასების დაშვება",
  "Allow Regenerate Response": "პასუხის რეგენერაციის დაშვება",
  "Allow Sharing With Users": "",
  "Allow Speech to Text": "საუბრის ამოცნობის დაშვება",
  "Allow Temporary Chat": "დროებითი ჩატის დაშვება",
  "Allow Text to Speech": "ტექსტის წარმოთქმის დაშვება",
  "Allow User Location": "მომხმარებლის მდებარეობის დაშვება",
  "Allow Voice Interruption in Call": "",
  "Allow Web Upload": "",
  "Allowed Endpoints": "დაშვებული ბოლოწერტილები",
  "Allowed File Extensions": "დაშვებული ფაილის გაფართოებები",
  ...
  "Always Expand Details": "დეტალების ყოველთვის ჩამოშლა",
  ...
  "archived-chat-export": "დაარქივებული-ჩატის-გატანა",
  ...
  "Attention to detail": "ყურადღებით დეტალებთან",
  "Attribute for Mail": "ატრიბუტი ფოსტისთვის",
  ...
  Away,
  Awful,
  "Azure AI Speech": "Azure AI-ის საუბარი",
  ...
  Beta,
  Bing,
  "Bing Search V7 Endpoint": "Bing Search V7-ის ბოლოწერტილი",
  "Bing Search V7 Subscription Key": "Bing Search V7-ის გამოწერის გასაღები",
  Bio,
  "Birth Date": "დაბადების თარიღი",
  "BM25 Weight": "BM25-ის წონა",
  ...
  "Button Label": "ღილაკის ჭდე",
  "Button Prompt": "ღილაკის მოთხოვნა",
  "by {{name}}": "",
  "By {{name}}": "ავტორი {{name}}",
  ...
  "Chat History": "",
  "Chat ID": "ჩატის ID",
  "Chat moved successfully": "ჩატის გადატანა წარმატებულია",
  ...
  Citation,
  Citations,
  "Clear memory": "მეხსიერების გასუფთავება",
  "Clear Memory": "მეხსიერების გასუფთავება",
  "Clear search": "",
  "Clear status": "",
  ...
  "Click here to": "დააწკაპუნეთ აქ",
  "Click here to download user import template file.": "",
  "Click here to learn more about faster-whisper and see the available models.": "",
  "Click here to see available models.": "დააწკაპუნეთ აქ ხელმისაწვდომი მოდელების სანახავად.",
  "Click here to select": "ასარჩევად დააწკაპუნეთ აქ",
  "Click here to select a csv file.": "დააწკაპუნეთ აქ csv ფაილის ასარჩევად.",
  ...
  "Clone of {{TITLE}}": "{{TITLE}}-ის კლონი",
  Close,
  "Close Banner": "ბანერის დახურვა",
  "Close chat controls": "",
  ...
  "Close Modal": "",
  "Close settings modal": "მორგების დიალოგის დახურვა",
  "Close Sidebar": "გვერდითი ზოლის დახურვა",
  cloud,
  "CMU ARCTIC speaker embedding name": "",
  "Code Block": "კოდის ბლოკი",
  "Code Editor": "",
  "Code execution": "კოდის შესრულება",
  "Code Execution": "",
  "Code Execution Engine": "კოდის შესრულების ძრავა",
  "Code Execution Timeout": "კოდის შესრულების დროის ამოწურვა",
  "Code formatted successfully": "კოდი წარმატებით დაფორმატდა",
  "Code Interpreter": "კოდის ინტერპრეტატორი",
  "Code Interpreter Engine": "კოდის ინტერპრეტატორის ძრავა",
  ...
  Color,
  ComfyUI,
  "ComfyUI API Key": "ComfyUI API-ის გასაღები",
  "ComfyUI Base URL": "ComfyUI საბაზისო URL",
  "ComfyUI Base URL is required.": "ComfyUI საბაზისო URL აუცილებელია.",
  "ComfyUI Workflow": "ComfyUI-ის სამუშაო პროცესი",
  "ComfyUI Workflow Nodes": "ComfyUI-ის სამუსაო პროცესის კვანძები",
  ...
  Completions,
  "Compress Images in Channels": "გამოსახულებების შეკუმშვა არხებში",
  ...
  "Confirm your action": "დაადასტურეთ თქვენი ქმედება",
  "Confirm your new password": "დაადასტურეთ თქვენი ახალი პაროლი",
  ...
  Connections,
  "Connections saved successfully": "შეერთებების წარმატებით იქნა შენახული",
  "Connections settings updated": "კავშირების პარამეტრები განახლდა",
  "Constrains effort on reasoning for reasoning models. Only applicable to reasoning models from specific providers that support reasoning effort.": "",
  "Contact Admin for rexpro Access": "",
  Content,
  "Content Extraction Engine": "",
  "Content lengths (character counts only)": "",
  "Context Tokens": "",
  "Continue Response": "პასუხის გაგრძელება",
  "Continue with {{provider}}": "გაგრძელება {{provider}}-ით",
  "Continue with Email": "გაგრძელება ელფოსტით",
  "Continue with LDAP": "გაგრძელება LDAP-ით",
  ...
  Copied,
  "Copied link to clipboard": "ბმული დაკოპირდა გაცვლის ბუფერში",
  ...
  "Copy API Key": "",
  "Copy content": "",
  "Copy Formatted Text": "დაფორმატებული ტექსტის კოპირება",
  ...
  "Create Image": "",
  "Create Knowledge": "ცოდნის შექმნა",
  "Create Model": "მოდელის შექმნა",
  ...
  "Created At": "შექმნის დრო",
  "Created by": "ავტორი",
  "Created by you": "შექმნილია თქვენს მიერ",
  "Created on {{date}}": "",
  "CSV Import": "CSV-ის შემოტანა",
  "Ctrl+Enter to Send": "Ctrl+Enter გასაგზავნად",
  ...
  "Default description enabled": "ნაგულისხმევი აღწერა ჩართულია",
  "Default Features": "ნაგულისხმევი ფუნქციები",
  "Default Filters": "ნაგულიხმევი ფილტრები",
  "Default Group": "",
  ...
  "Default permissions": "ნაგულისხმები წვდომები",
  ...
  "Delete Model": "მოდელის წაშლა",
  "Delete note?": "წავშალო შენიშვნა?",
  ...
  "Document Intelligence endpoint required.": "დოკუმენტის ანალიზის ბოლოწერტილი აუცილებელია.",
  ...
  "Domain Filter List": "დომენის ფილტრების სია",
  ...
  "Download as JSON": "",
  "Download as SVG": "გადმოწერა SVG-ის სახით",
  ...
  "e.g. pdf, docx, txt": "მაგ: pdf, docx, txt",
  ...
  "Edit Folder": "საქაღალდის ჩასწორება",
  "Edit Image": "",
  "Edit Last Message": "",
  ...
  "Enter Brave Search API Key": "შეიყვანეთ Brave Search API-ის გასაღები",
  "Enter certificate path": "შეიყვანეთ სერტიფიკატის ბილიკი",
  ...
  "Enter SearchApi API Key": "შეიყვანეთ SearchApi API-ის გასაღები",
  "Enter SearchApi Engine": "შეიყვანეთ SearchApi-ის ძრავა",
  "Enter Searxng Query URL": "შეიყვანეთ Searxng Query URL",
  "Enter Searxng search language": "",
  "Enter Seed": "შეიყვანეთ თესლი",
  "Enter SerpApi API Key": "შეიყვანეთ SerpApi API-ის გასაღები",
  "Enter SerpApi Engine": "შეიყვანეთ SerpApi-ის ძრავა",
  "Enter Serper API Key": "შეიყვანეთ Serper API Key",
  "Enter Serply API Key": "შეიყვანეთ Serply API-ის გასაღები",
  "Enter Serpstack API Key": "შეიყვანეთ Serpstack API Key",
  "Enter server host": "შეიყვანეთ სერვერის ჰოსტი",
  "Enter server label": "შეიყვანეთ სერვერის ჭდე",
  "Enter server port": "შეიყვანეთ სერვერის პორტი",
  "Enter skill instructions in markdown...": "",
  "Enter Sougou Search API sID": "შეიყვანეთ Sougou Search API-ის sID",
  "Enter Sougou Search API SK": "შეიყვანეთ Sougou Search API-ის SK",
  ...
  "Enter Tika Server URL": "შეიყვანეთ Tika-ის სერვერის URL",
  "Enter timeout in seconds": "შეიყვანეთ მოლოდინის ვადა წამებში",
  "Enter to Send": "ღილაკი Enter გასაგზავნად",
  ...
  "Enter value (true/false)": "შეიყვანეთ მნიშვნელობა (ჭეშმარიტი/ცრუ)",
  "Enter Yacy Password": "შეიყვანეთ Yacy-ის პაროლი",
  "Enter Yacy URL (e.g. http://yacy.example.com:8090)": "",
  "Enter Yacy Username": "შეიყვანეთ Yacy-ის მომხმარებლის სახელი",
  ...
  "Enter your webhook URL": "შეიყვანეთ თქვენი ვებჰუკის URL",
  "Entra ID": "Entra-ის ID",
  ...
  "Example: mail": "მაგალითი: mail",
  "Example: ou=users,dc=foo,dc=example": "მაგალითი: ou=users,dc=foo,dc=example",
  "Example: sAMAccountName or uid or userPrincipalName": "მაგალითი: sAMAccountName ან uid ან userPrincipalName",
  ...
  "External Task Model": "გარე ამოცანის მოდელი",
  "External Web Loader API Key": "",
  "External Web Loader URL": "",
  "External Web Search API Key": "",
  "External Web Search URL": "გარე ვებძებნის URL",
  ...
  "Failed to fetch models": "მოდელების გამოთხოვა ჩავარდა",
  ...
  "Failed to save connections": "კავშირების შენახვა ჩავარდა",
  ...
  "Feedback Details": "უკუკავშირის დეტალები",
  "Feedback History": "უკუკავშირის ისტორია",
  ...
  "File uploaded successfully": "ფაილი წარმატებით აიტვირთა",
  Filename,
  Files,
  Filter,
  "Filter is now globally disabled": "ფილტრი ახლა გლობალურად გამორთულია",
  "Filter is now globally enabled": "ფილტრი ახლა გლობალურად ჩართულია",
  Filters,
  ...
  "Firecrawl API Base URL": "Firecrawl API-ის საბაზისო URL",
  "Firecrawl API Key": "Firecrawl API-ის გასაღები",
  "Firecrawl Timeout (s)": "",
  ...
  "Folder name cannot be empty.": "საქაღალდის სახელი ცარიელი ვერ იქნება.",
  "Folder name updated successfully": "საქაღალდის სახელი წარმატებით განახლდა",
  "Folder options": "",
  "Folder updated successfully": "საქაღალდე წარმატებით განახლდა",
  Folders,
  "Follow up": "მიდევნება",
  ...
  "Function created successfully": "ფუნქცია წარმატებით შეიქმნა",
  "Function deleted successfully": "ფუნქცია წარმატებით წაიშალა",
  "Function Description": "ფუნქციის აღწერა",
  "Function ID": "ფუნქციის ID",
  "Function imported successfully": "ფუნქციის შემოტანა წარმატებულია",
  ...
  Gemini,
  "Gemini API Key": "",
  "Gemini API Key is required.": "Gemini API-ის გასაღები აუცილებელია.",
  "Gemini Base URL": "",
  ...
  "Generated Image": "გენერირებული გამოსახულება",
  ...
  Hide,
  "Hide All": "",
  "Hide from Sidebar": "დამალვა გვერდითი პანელიდან",
  "Hide Model": "მოდელის დამალვა",
  High,
  "High Contrast Mode": "მაღალი კონტრასტის რეჟიმი",
  History,
  Home,
  Host,
  Hourly,
  ...
  "Ignite curiosity": "",
  Image,
  "Image Compression": "გამოსახულების შეკუმშვა",
  "Image Compression Height": "გამოსახულების შეკუმშვის სიმაღლე",
  "Image Compression Width": "გამოსახულების შეკუმშვის სიგანე",
  "Image Edit": "",
  "Image Edit Engine": "",
  "Image Generation": "გამოსახულების გენერაცია",
  "Image Generation Engine": "გამოსახულებების გენერაციის ძრავა",
  "Image Max Compression Size": "სურათის მაქსიმალური შეკუმშვის ზომა",
  "Image Max Compression Size height": "სურათი მაქსიმალური შეკუმშვის ზომის სიმაღლე",
  "Image Max Compression Size width": "სურათი მაქსიმალური შეკუმშვის ზომის სიგანე",
  ...
  "Include `--api` flag when running stable-diffusion-rexpro": "`--api` ალმის ჩასმა stable-diffusion-rexpro-ის გამოყენებისას",
  ...
  "Input Variables": "შეყვანის ცვლადები",
  Insert,
  ...
  "Invalid file content": "არასწორი ფაილის შემცველობა",
  "Invalid file format.": "არასწორი ფაილის ფორმატი.",
  "Invalid JSON file": "არასწორი JSON ფაილი",
  ...
  July,
  June,
  "Jupyter Auth": "Jupyter-ში ავთენტიკაცია",
  "Jupyter URL": "Jupyter-ის URL",
  "JWT Expiration": "JWT-ის ვადა",
  "JWT Token": "JWT ტოკენი",
  "Kagi Search API Key": "",
  "Keep Follow-Up Prompts in Chat": "",
  "Keep in Sidebar": "დატოვება გვერდით პანელზე",
  Key,
  "Key is required": "გასაღები აუცილებელია",
  "Keyboard shortcuts": "კლავიატურის მალსახმობები",
  "Keyboard Shortcuts": "",
  Knowledge,
  "Knowledge Access": "წვდომა ცოდნასთან",
  "Knowledge Base": "ცოდნის ბაზა",
  "Knowledge base has been reset": "",
  "Knowledge created successfully.": "ცოდნა წარმატებით შეიქმნა.",
  "Knowledge deleted successfully.": "ცოდნა წარმატებით წაიშალა.",
  "Knowledge Description": "ცოდნის აღწერა",
  "Knowledge exported successfully": "",
  "Knowledge Name": "ცოდნის სახელი",
  "Knowledge Public Sharing": "ცოდნის საჯარო გაზიარება",
  "Knowledge Sharing": "",
  "Knowledge updated successfully": "ცოდნა წარმატებით განახლდა",
  "Kokoro.js (Browser)": "Kokoro.js (ბრაუზერი)",
  "Kokoro.js Dtype": "Kokoro.js Dtype",
  Label,
  "Landing Page Mode": "პირველი გვერდის რეჟიმი",
  Language,
  "Language Locales": "ენის ლოკალები",
  "Last 24 hours": "",
  "Last 30 days": "",
  "Last 7 days": "",
  "Last 90 days": "",
  ...
  "Leave empty for unlimited": "დატოვეთ ცარიელი ულიმიტოსთვის",
  ...
  Loaded,
  Loader,
  "Loading Kokoro.js...": "იტვირთება Kokoro.js...",
  "Loading...": "იტვირთება...",
  local,
  Local,
  ...
  Low,
  LTR,
  "Made by rexpro-ai Community": "შექმნილია rexpro-ai საზოგადოების მიერ",
  ...
  "Manage Ollama": "Ollama-ის მართვა",
  "Manage Ollama API Connections": "",
  "Manage OpenAI API Connections": "",
  "Manage Pipelines": "მილსადენების მართვა",
  "Manage Tool Servers": "ხელსაწყოს სერვერების მართვა",
  "Manage your account information.": "მართეთ თქვენი ანგარიშის ინფორმაცია.",
  March,
  Markdown,
  "Markdown Header Text Splitter": "",
  "Max Speakers": "დინამიკების მაქს. რაოდენობა",
  "Max tokens to retrieve (1024-32768, default 8192)": "",
  "Max Upload Count": "მაქს. ატვირთვების რაოდენობა",
  "Max Upload Size": "მაქს. ატვირთვის ზომა",
  ...
  "Microsoft OneDrive (personal)": "Microsoft OneDrive (პირადი)",
  "Microsoft OneDrive (work/school)": "Microsoft OneDrive (სამსახური/სკოლა)",
  min,
  MinerU,
  ...
  "Model ID": "მოდელის ID",
  "Model ID is required.": "მოდელის ID აუცილებელია.",
  ...
  "No Notes": "შენიშვნების გარეშე",
  "No notes found": "სანიშნების გარეშე",
  "No one": "",
  "No output items": "",
  "No pinned messages": "",
  "No prompts found": "შეყვანები აღმოჩენილი არაა",
  ...
  "No tools accessible": "",
  "No tools found": "ხელსაწყოები აღმოჩენილი არაა",
  "No users were found.": "მომხმარებლები აღმოჩენილი არაა.",
  "No valves": "ონკანები აღმოჩენილი არაა",
  "No valves to update": "გასაახლებელი ონკანების გარეშე",
  "No webhooks yet": "",
  "Node Ids": "კვანძის ID-ები",
  None,
  ...
  Notes,
  "Notes Public Sharing": "შენიშვნების საჯარო გაზიარება",
  "Notes Sharing": "",
  "Notification Sound": "გაფრთხილების ხმა",
  "Notification Webhook": "გაფრთხილების ვებჰუკი",
  Notifications,
  November,
  OAuth,
  "OAuth 2.1": "OAuth 2.1",
  ...
  "Ollama API settings updated": "Ollama API-ის პარამეტრები განახლდა",
  ...
  "Oops! You're using an unsupported method (frontend only). Please serve the rexpro from the backend.": "ვაი! იყენებთ მხარდაუჭერელ მეთოდს (მხოლოდ წინაბოლო). შედით rexpro-ზე უკანაბოლოდან.",
  ...
  "OpenAI API settings updated": "OpenAI API-ის პარამეტრები განახლდა",
  "OpenAI API Version": "",
  ...
  "Prompt Content": "მოთხოვნის შემცველობა",
  ...
  "Redirecting you to rexpro-ai Community": "მიმდინარეობს გადამისამართება rexpro-ai-ის საზოგადოების საიტზე",
  ...
  Regenerate,
  "Regenerate Menu": "მენიუს რეგენერაცია",
  "Regenerate Response": "",
  "Register Again": "თავიდან რეგისტრაცია",
  "Register Client": "კლიენტის რეგისტრაცია",
  Registered,
  "Registration failed": "რეგისტრაცია ჩავარდა",
  "Registration successful": "რეგისტრაცია დასრულდა",
  Reindex,
  ...
  Reset,
  "Reset All Models": "ყველა მოდელის ჩამოყრა",
  "Reset Image": "სურათის აღდგენა",
  "Reset knowledge base?": "",
  "Reset Upload Directory": "ატვირთვის საქაღალდის ჩამოყრა",
  "Reset Vector Storage/Knowledge": "",
  "Reset view": "ხედის ჩამოყრა",
  Response,
  ...
  "search for archived chats": "დაარქივებული ჩატების ძებნა",
  "search for folders": "საქაღალდეების ძებნა",
  "search for pinned chats": "ამაგრებული ჩატების ძებნა",
  "search for shared chats": "გაზიარებული ჩატების ძებნა",
  "search for tags": "ჭდეების ძებნა",
  "Search Functions": "ფუნქციების ძებნა",
  "Search Groups": "",
  "Search In Models": "ძებნა მოდელებში",
  "Search Knowledge": "ცოდნის ძებნა",
  "Search Memories": "",
  "Search Models": "მოდელების ძებნა",
  "Search Notes": "შენიშვნების ძებნა",
  "Search options": "ძებნის მორგება",
  "Search Prompts": "მოთხოვნების ძებნა",
  "Search Result Count": "ძიების შედეგების რაოდენობა",
  "Search Skills": "",
  "Search skills...": "",
  "Search the internet": "ინტერნეტში ძებნა",
  "Search the web and fetch URLs": "",
  "Search Tools": "ძებნის ხელსაწყოები",
  "Search, view, and manage user notes": "",
  "SearchApi API Key": "SearchApi API-ის გასაღები",
  "SearchApi Engine": "ძრავა SearchApi",
  "Searched {{count}} sites": "მოძებნილია {{count}} საიტზე",
  Searching,
  'Searching "{{searchQuery}}"': 'მიმდინარეობს ძებნა "{{searchQuery}}"',
  'Searching Knowledge for "{{searchQuery}}"': 'ძებნა ცოდნაში სტრიქონისთვის "{{searchQuery}}"',
  "Searching the web": "ძებნა ვებში",
  ...
  "Select a base model (e.g. llama3, gpt-4o)": "აირჩიეთ საბაზისო მოდელი (მაგ: llama3, gpt-4o)",
  "Select a conversation to preview": "აირჩიეთ საუბარი გადასახედად",
  "Select a engine": "აირჩიეთ ძრავა",
  "Select a function": "აირჩიეთ ფუნქცია",
  "Select a group": "აირჩიეთ ჯგუფი",
  "Select a language": "აირჩიეთ ენა",
  "Select a mode": "აირჩიეთ რეჟიმი",
  "Select a model": "აირჩიეთ მოდელი",
  "Select a model (optional)": "აირჩიეთ მოდელი (არასავალდებული)",
  "Select a pipeline": "აირჩიეთ მილსადენი",
  "Select a pipeline url": "აირჩიეთ მილსადენის url",
  "Select a reranking model engine": "აირჩიეთ reranking-ის მოდელის ძრავა",
  "Select a role": "აირჩიეთ როლი",
  "Select a theme": "აირჩიეთ თემა",
  "Select a tool": "აირჩიეთ ხელსაწყო",
  "Select a voice": "აირჩიეთ ხმა",
  "Select All": "",
  "Select an auth method": "აირჩიეთ ავთენტიკაციის მეთოდი",
  "Select an embedding model engine": "აირჩიეთ ჩაშენებული მოდელის ძრავა",
  "Select an engine": "აირჩიეთ ძრავა",
  "Select an Ollama instance": "აირჩიეთ Ollama-ის გაშვებული ასლი",
  "Select an option": "",
  "Select an output format": "აირჩიეთ გამოტანის ფორმატი",
  "Select dtype": "აირჩიეთ dtype",
  "Select Engine": "აირჩიეთ ძრავა",
  ...
  September,
  "SerpApi API Key": "SerpApi API-ის გასაღები",
  "SerpApi Engine": "ძრავა SerpApi",
  "Serper API Key": "Serper API-ის გასაღები",
  "Serply API Key": "Serply API-ის გასაღები",
  ...
  "Set embedding model (e.g. {{model}})": "ჩვენება ჩაშენებული მოდელის დაყენება (მაგ. {{model}})",
  "Set reranking model (e.g. {{model}})": "Reranking მოდელის დაყენება (მაგ. {{model}})",
  ...
  "Set whisper model": "Whisper-ის მოდელის დაყენება",
  "Set your status": "",
  ...
  "Share to rexpro-ai Community": "გაზიარება rexpro-ai-ის საზოგადოებასთან",
  ...
  "Sign in": "შესვლა",
  "Sign in to {{REXPRO_NAME}}": "{{REXPRO_NAME}}-ში შესვლა",
  "Sign in to {{REXPRO_NAME}} with LDAP": "{{REXPRO_NAME}}-ში შესვლა LDAP-ით",
  "Sign Out": "გასვლა",
  "Sign up": "რეგისტრაცია",
  "Sign up to {{REXPRO_NAME}}": "რეგისტრაცია {{REXPRO_NAME}}-ზე",
  ...
  "Signing in to {{REXPRO_NAME}}": "მიმდინარეობს შესვლა {{REXPRO_NAME}}-ში",
  Single,
  "Sink List": "",
  "sk-1234": "sk-1234",
  ...
  "Status Updates": "სტატუსის განახლებები",
  ...
  "Streamable HTTP": "დასტრიმვადი HTTP",
  Strikethrough,
  "Strip Existing OCR": "",
  ...
  "Suggest a change": "შეცვლის შეთავაზება",
  Suggested,
  Support,
  ...
  "Sync Complete!": "",
  "Sync directory": "სინქრონიზაციის საქაღალდე",
  "Sync Failed": "",
  "Sync Usage Stats": "",
  "Syncing stats...": "",
  "Syncing...": "",
  ...
  Temperature,
  "Temporary Chat": "დროებითი ჩატი",
  "Temporary Chat by Default": "დროებითი ჩატი ნაგულისხმევად",
  Terminal,
  ...
  Timeout,
  Title,
  "Title Auto-Generation": "სათაურის ავტოგენერაცია",
  ...
  "Tool deleted successfully": "ხელსაწყო წარმატებით წაიშალა",
  "Tool Description": "ხელსაწყოს აღწერა",
  "Tool ID": "ხელსაწყოს ID",
  "Tool imported successfully": "ხელსაწყოს შემოტანა წარმატებულია",
  "Tool Name": "ხელსაწყოს სახელი",
  "Tool Servers": "ხელსაწყოს სერვერები",
  "Tool updated successfully": "ხელსაწყო წარმატებით განახლდა",
  Tools,
  "Tools Access": "წვდომა ხელსაწყოსთან",
  ...
  "Use LLM": "LLM-ის გამოყენება",
  "Use no proxy to fetch page contents.": "",
  "Use proxy designated by http_proxy and https_proxy environment variables to fetch page contents.": "",
  user,
  User,
  "User Activity": "",
  "User Groups": "მომხმარებლის ჯგუფები",
  ...
  "Using Entire Document": "მთელი დოკუმენტის გამოყენებით",
  "Using Focused Retrieval": "",
  "Using the default arena model with all models. Click the plus button to add custom models.": "",
  "Valid time units:": "სწორი დროის ერთეულები:",
  "Validate certificate": "სერტიფიკატის გადამოწმება",
  Valves,
  "Valves updated": "ონკანების განახლდა",
  "Valves updated successfully": "ონკანები წარმატებით განახლდა",
  variable,
  "Verify Connection": "კავშირის გადამოწმება",
  "Verify SSL Certificate": "SSL სერტიფიკატის გადამოწმება",
  Version,
  "Version {{selectedVersion}} of {{totalVersions}}": "",
  "Version deleted": "",
  "View Replies": "პასუხების ნახვა",
  ...
  Webhooks,
  "Webpage URLs": "",
  "rexpro Settings": "rexpro პარამეტრები",
  "rexpro URL": "rexpro URL",
  'rexpro will make requests to "{{url}}"': "",
  'rexpro will make requests to "{{url}}/api/chat"': "",
  ...
  "Whisper (Local)": "Whisper (ლოკალური)",
  "Who can share to this group": "",
  "Why?": "რატომ?",
  "Widescreen Mode": "ფართოეკრანიანი რეჟიმი",
  Width,
  Wikipedia,
  Won,
  "Working Directory": "",
  ...
  Write,
  "Write a summary in 50 words that summarizes {{topic}}.": "დაწერეთ რეზიუმე 50 სიტყვით, რომელიც აჯამებს [თემას ან საკვანძო სიტყვას].",
  ...
  "Yacy Instance URL": "Yacy-ის გაშვებული ასლის URL",
  "Yacy Password": "Yacy-ის პაროლი",
  "Yacy Username": "Yacy-ის მომხმარებლის სახელი",
  Yahoo,
  Yandex,
  ...
  Yesterday,
  "Yesterday at {{LOCALIZED_TIME}}": "გუშინ, {{LOCALIZED_TIME}}",
  You,
  "You are currently using a trial license. Please contact support to upgrade your license.": "",
  "You can only chat with a maximum of {{maxCount}} file(s) at a time.": "",
  "You can personalize your interactions with LLMs by adding memories through the 'Manage' button below, making them more helpful and tailored to you.": "",
  "You cannot upload an empty file.": "ცარიელ ფაილს ვერ ატვირთავთ.",
  ...
  "You do not have permission to send messages in this channel.": "ამ არხზე შეტყობინების გაგზავნის უფლება არ გაქვთ.",
  "You do not have permission to send messages in this thread.": "ამ ნაკადში შეტყობინების გაგზავნის უფლება არ გაქვთ.",
  "You do not have permission to upload files to this knowledge base.": "",
  "You do not have permission to upload files.": "ფაილების ატვირთვის უფლება არ გაქვთ.",
