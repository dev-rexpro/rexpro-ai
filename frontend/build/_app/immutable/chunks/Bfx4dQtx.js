...
const All = "Tutti";
const Always = "Sempre";
const Amazing = "Fantastico";
const Analytics = "";
const Analyzed = "Analizzato";
const Android = "Android";
const Anyone = "";
const April = "Aprile";
const Archive = "Archivio";
const Artifacts = "Artefatti";
const Asc = "";
const Ask = "Chiedi";
...
const Authentication = "Autenticazione";
const Auto = "Automatico";
const Automatic1111 = "";
const Automation = "";
const Automations = "";
const Away = "Assente";
const Awful = "Terribile";
const Back = "Indietro";
...
const Calendars = "";
const Call = "Chiamata";
const Camera = "Fotocamera";
const Cancel = "Annulla";
const Capabilities = "Funzionalità";
const Capture = "Cattura";
const Channel = "";
const Channels = "Canali";
const Character = "Carattere";
const Chat = "Chat";
const chats = "";
const Chats = "Chat";
const Ciphers = "Cifrari";
const Citation = "Citazione";
const Citations = "Citazioni";
const Clone = "Clone";
const Close = "Chiudi";
const cloud = "";
const Collapse = "Riduci";
const Collection = "Collezione";
const Collections = "";
const Color = "Colore";
...
const Comment = "";
const Completions = "Completamenti";
const Config = "";
const Configuration = "";
const Configure = "Configura";
const Confirm = "Conferma";
const Connections = "Connessioni";
const Content = "Contenuto";
const Controls = "Controlli";
...
const Day = "";
const December = "Dicembre";
const Deepgram = "";
const Default = "Predefinito";
const Defaults = "";
...
const Enhance = "Migliora";
const Ephemeral = "";
const ERROR = "ERRORE";
const Evaluations = "Valutazioni";
const Exclude = "Escludi";
const Expand = "Espandi";
const Experimental = "Sperimentale";
const Explain = "Spiega";
const Explored = "";
const Exploring = "";
const Export = "Esportazione";
const External = "Esterno";
const Features = "Caratteristiche";
const February = "Febbraio";
const Feedback = "";
const Female = "";
const File = "File";
const Filename = "";
...
const Functions = "Funzioni";
const Gemini = "Gemini";
const Gender = "";
const General = "Generale";
const Generate = "Genera";
const Global = "Globale";
const Google = "";
const Gravatar = "";
const Grid = "";
const Grokipedia = "";
...
const Images = "";
const Import = "Importa";
const Inactive = "";
const Include = "Includi";
const Info = "Informazioni";
const Initials = "";
const Input = "";
const Insert = "";
const Instructions = "";
const Integration = "Integrazione";
const Integrations = "";
const Interface = "Interfaccia";
const Italic = "";
const January = "Gennaio";
const July = "Luglio";
const June = "Giugno";
const Key = "Chiave";
const Knowledge = "Conoscenza";
const Label = "Etichetta";
const Language = "Lingua";
const LDAP = "LDAP";
const Leaderboard = "Classifica";
const Legacy = "";
const lexical = "";
const License = "Licenza";
const Light = "Chiaro";
const List = "";
const Live = "";
const Loaded = "";
const Loader = "Caricatore";
const local = "";
const Local = "Locale";
const Location = "";
const Lost = "Perso";
...
const Note = "";
const Notes = "Note";
const Notifications = "Notifiche desktop";
const November = "Novembre";
const OAuth = "";
const October = "Ottobre";
const Off = "Disattivato";
const Ollama = "Ollama";
const On = "Attivato";
const Once = "";
...
const Output = "";
const OUTPUT = "OUTPUT";
const Overview = "Panoramica";
const page = "pagina";
const Page = "";
const Paginate = "Paginazione";
const Parameters = "Parametri";
const Password = "Password";
const Paused = "";
const pending = "in sospeso";
const Pending = "In Attesa";
const Permissions = "Permessi";
const Persistent = "";
const Personalization = "Personalizzazione";
const Pin = "Appunta";
const Pinned = "Appuntato";
const Pipe = "";
const Pipelines = "";
...
const Private = "Privato";
const Profile = "Profilo";
const Prompt = "Prompt";
const Prompts = "Prompt";
const Provider = "";
const Public = "Pubblico";
const Querying = "";
const Rating = "Valutazione";
const Read = "Leggi";
const Reason = "";
const Reconnected = "";
const Record = "Registra";
const Refresh = "";
const Regenerate = "Rigenera";
const Registered = "";
const Reindex = "Reindicizza";
const Releases = "Rilasci";
const Relevance = "Rilevanza";
const Reminder = "";
const Remove = "Rimuovi";
...
const RESULT = "Risultato";
const Retrieval = "Recupero ricordo";
const Role = "Ruolo";
const RTL = "RTL";
const Run = "Esegui";
const Running = "In esecuzione";
...
const Suggested = "Suggerito";
const Support = "Supporto";
const Sync = "";
const System = "Sistema";
const Tag = "";
const Tags = "Tag";
const Tasks = "Attività";
const Temperature = "Temperatura";
const Terminal = "";
const Th_day_of_week = "";
const Theme = "Tema";
const Thought = "";
const Thread = "Discussione";
const Tika = "Tika";
...
const Unknown = "";
const Unmute = "";
const Unpin = "Rimuovi fissato";
const Untagged = "Non taggato";
const Untitled = "Senza titolo";
const Update = "Aggiorna";
const Updated = "Aggiornato";
const Upload = "Carica";
const URL = "URL";
const Usage = "Utilizzo";
const Use = "";
const user = "utente";
const User = "Utente";
...
const users = "";
const Users = "Utenti";
const Valves = "Valvole";
const variable = "variabile";
const Version = "Versione";
const Visibility = "Visibilità";
const Visible = "";
const Vision = "";
const Visual = "";
const Voice = "Voce";
const Warning = "Attenzione";
...
const Wikipedia = "";
const Won = "Vinto";
const Workspace = "Spazio di lavoro";
const Write = "Scrivi";
const Yahoo = "";
const Yandex = "";
const Yesterday = "Ieri";
const You = "Tu";
...
const translation = {
  ...
  "(e.g. `sh rexpro.sh --api --api-auth username_password`)": "(p.e. `sh rexpro.sh --api --api-auth username_password`)",
  "(e.g. `sh rexpro.sh --api`)": "(p.e. `sh rexpro.sh --api`)",
  "(latest)": "(ultima)",
  ...
  "{{rexproAIName}} Backend Required": "{{rexproAIName}} Richiesta Backend",
  ...
  "Allow Chat Controls": "Consenti controlli chat",
  "Allow Chat Delete": "Consenti eliminazione chat",
  "Allow Chat Edit": "Consenti modifica chat",
  "Allow Chat Export": "Consenti esportazione chat",
  "Allow Chat Params": "",
  ...
  Always,
  "Always Collapse Code Blocks": "Riduci sempre i blocchi di codice",
  "Always Expand Details": "Espandi sempre i dettagli",
  ...
  "archived-chat-export": "chat-archiviata-esportazione",
  ...
  "Attribute for Mail": "Attributo per la posta",
  "Attribute for Username": "Attributo per il nome utente",
  Audio,
  August,
  Auth,
  Authenticate,
  ...
  "Click here for filter guides.": "Clicca qui per le guide ai filtri.",
  "Click here for help.": "Clicca qui per aiuto.",
  "Click here to": "Clicca qui per",
  "Click here to download user import template file.": "Clicca qui per scaricare il file modello di importazione utente.",
  "Click here to learn more about faster-whisper and see the available models.": "Clicca qui per saperne di più su faster-whisper e vedere i modelli disponibili.",
  "Click here to see available models.": "Clicca qui per vedere i modelli disponibili.",
  "Click here to select": "Clicca qui per selezionare",
  "Click here to select a csv file.": "Clicca qui per selezionare un file csv.",
  "Click here to select a py file.": "Clicca qui per selezionare un file py.",
  ...
  "Code Execution Timeout": "Timeout esecuzione codice",
  ...
  Color,
  ComfyUI,
  "ComfyUI API Key": "Chiave API ComfyUI",
  ...
  "Contact Admin for rexpro Access": "Contatta l'amministratore per l'accesso al servizio rexpro",
  Content,
  ...
  "CORS must be properly configured by the provider to allow requests from rexpro-ai.": "CORS deve essere configurato correttamente dal fornitore per consentire le richieste da rexpro-ai.",
  "Could not read file.": "",
  CPU,
  Create,
  ...
  "Default permissions updated successfully": "Permessi predefiniti aggiornati con successo",
  "Default Prompt Suggestions": "Suggerimenti prompt predefiniti",
  "Default to 389 or 636 if TLS is enabled": "Predefinito a 389 o 636 se TLS è ab",
  "Default to ALL": "Predefinito su TUTTI",
  ...
  "Discover how to use rexpro-ai and seek support from the community.": "Scopri come utilizzare rexpro-ai e cerca supporto dalla community.",
  ...
  "Enable Community Sharing": "Abilita Condivisione Community",
  "Enable Memory Locking (mlock) to prevent model data from being swapped out of RAM. This option locks the model's working set of pages into RAM, ensuring that they will not be swapped out to disk. This can help maintain performance by avoiding page faults and ensuring fast data access.": "Abilita il blocco della memoria (mlock) per impedire che i dati del modello vengano scambiati dalla RAM. Questa opzione blocca l'insieme di pagine di lavoro del modello nella RAM, assicurando che non vengano scambiate su disco. Questo può aiutare a mantenere le prestazioni evitando errori di pagina e garantendo un accesso rapido ai dati.",
  ...
  "Enter External Web Loader API Key": "Inserisci Chiave API del Caricatore Web Esterno",
  "Enter External Web Loader URL": "Inserisci l'URL del Caricatore Web Esterno",
  "Enter External Web Search API Key": "Inserisci Chiave API di Ricerca Web Esterna",
  ...
  "Enter Jupyter URL": "Inserisci URL Jupyter",
  ...
  "Enter SearchApi API Key": "Inserisci Chiave API SearchApi",
  "Enter SearchApi Engine": "Inserisci Motore SearchApi",
  "Enter Searxng Query URL": "Immettere l'URL della Query Searxng",
  "Enter Searxng search language": "",
  "Enter Seed": "Inserisci il Seme",
  "Enter SerpApi API Key": "Inserisci Chiave API SerpApi",
  "Enter SerpApi Engine": "Inserisci Motore SerpApi",
  "Enter Serper API Key": "Inserisci Chiave API Serper",
  "Enter Serply API Key": "Inserisci Chiave API Serply",
  "Enter Serpstack API Key": "Inserisci Chiave API Serpstack",
  "Enter server host": "Inserisci l'host del server",
  "Enter server label": "Inserisci l'etichetta del server",
  "Enter server port": "Inserisci la porta del server",
  "Enter skill instructions in markdown...": "",
  "Enter Sougou Search API sID": "Inserisci sID dell'API Sougou Search",
  "Enter Sougou Search API SK": "Inserisci SK dell'API Sougou Search",
  "Enter stop sequence": "Inserisci la sequenza di arresto",
  "Enter system prompt": "Inserisci il prompt di sistema",
  ...
  "Enter the public URL of your rexpro. This URL will be used to generate links in the notifications.": "Inserisci l'URL pubblico del tuo rexpro. Questo URL verrà utilizzato per generare collegamenti nelle notifiche.",
  ...
  "Example: mail": "Esempio: mail",
  "Example: ou=users,dc=foo,dc=example": "Esempio: ou=users,dc=foo,dc=example",
  "Example: sAMAccountName or uid or userPrincipalName": "Esempio: sAMAccountName o uid o userPrincipalName",
  "Exceeded the number of seats in your license. Please contact support to increase the number of seats.": "Superato il numero di posti nella tua licenza. Contatta il supporto per aumentare il numero di posti.",
  Exclude,
  "Execute code": "",
  ...
  "Firecrawl API Base URL": "URL base dell'API Firecrawl",
  ...
  "Function created successfully": "Funzione creata con successo",
  ...
  "Functions imported successfully": "Funzioni importate con successo",
  Gemini,
  "Gemini API Key": "",
  ...
  "Get started": "Inizia",
  "Get started with {{REXPRO_NAME}}": "Inizia con {{REXPRO_NAME}}",
  Global,
  ...
  "Idle Timeout": "",
  "iframe Sandbox Allow Forms": "iframe Sandbox Consenti moduli",
  "iframe Sandbox Allow Same Origin": "iframe Sandbox Consenti stessa origine",
  ...
  Inactive,
  Include,
  "Include `--api-auth` flag when running stable-diffusion-rexpro": "Includi il flag `--api-auth` quando esegui stable-diffusion-rexpro",
  "Include `--api` flag when running stable-diffusion-rexpro": "Includi il flag `--api` quando esegui stable-diffusion-rexpro",
  ...
  Low,
  LTR,
  "Made by rexpro-ai Community": "Realizzato dalla Comunità rexpro-ai",
  ...
  "Manage Ollama": "Gestisci Ollama",
  "Manage Ollama API Connections": "Gestisci le connessioni API Ollama",
  ...
  "Message rating should be enabled to use this feature": "La valutazione dei messaggi deve essere abilitata per utilizzare questa funzionalità",
  "Message text...": "",
  messages,
  Messages,
  ...
  "Ollama API settings updated": "Impostazioni API Ollama aggiornate",
  ...
  "Oops! There are files still uploading. Please wait for the upload to complete.": "Ops! Ci sono file ancora in fase di caricamento. Si prega di attendere il completamento del caricamento.",
  "Oops! There was an error in the previous response.": "Ops! Si è verificato un errore nella risposta precedente.",
  "Oops! You're using an unsupported method (frontend only). Please serve the rexpro from the backend.": "Ops! Stai utilizzando un metodo non supportato (solo frontend). Si prega di servire la rexpro dal backend.",
  "Open file": "Apri file",
  ...
  "rexpro-ai can use tools provided by any OpenAPI server.": "rexpro-ai può utilizzare tool forniti da qualsiasi server OpenAPI.",
  "rexpro-ai uses faster-whisper internally.": "rexpro-ai utilizza faster-whisper internamente.",
  "rexpro-ai uses SpeechT5 and CMU Arctic speaker embeddings.": "rexpro-ai utilizza le incorporazioni vocali di SpeechT5 e CMU Arctic.",
  "rexpro-ai version": "",
  "rexpro-ai version (v{{OPEN_REXPRO_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "La versione di rexpro-ai (v{{OPEN_REXPRO_VERSION}}) è inferiore alla versione richiesta (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "Prompt created successfully": "Prompt creato con successo",
  "Prompt Name": "",
  "Prompt Suggestions": "",
  "Prompt Template": "",
  "Prompt updated successfully": "Prompt aggiornato con successo",
  Prompts,
  "Prompts Access": "Accesso ai Prompt",
  "Prompts Public Sharing": "Condivisione Pubblica dei Prompt",
  "Prompts Sharing": "",
  Provider,
  Public,
  ...
  "Redirecting you to rexpro-ai Community": "Reindirizzamento alla comunità rexpro-ai",
  ...
  "Set as Production": "",
  "Set embedding model": "Imposta modello di embedding",
  ...
  "Set whisper model": "Imposta modello whisper",
  "Set your status": "",
  ...
  "Sets how far back for the model to look back to prevent repetition.": "Imposta quanto lontano il modello deve guardare indietro per prevenire la ripetizione.",
  ...
  "Sets the size of the context window used to generate the next token.": "Imposta la dimensione della finestra di contesto utilizzata per generare il token successivo.",
  ...
  "Share to rexpro-ai Community": "Condividi con la comunità rexpro-ai",
  ...
  "Sign in": "Accedi",
  "Sign in to {{REXPRO_NAME}}": "Accedi a {{REXPRO_NAME}}",
  "Sign in to {{REXPRO_NAME}} with LDAP": "Accedi a {{REXPRO_NAME}} con LDAP",
  "Sign Out": "Esci",
  "Sign up": "Registrati",
  "Sign up to {{REXPRO_NAME}}": "Registrati a {{REXPRO_NAME}}",
  ...
  "Signing in to {{REXPRO_NAME}}": "Accedi a {{REXPRO_NAME}}",
  Single,
  "Sink List": "",
  "sk-1234": "sk-1234",
  ...
  Source,
  "Speech Playback Speed": "Velocità di riproduzione vocale",
  ...
  "To access the rexpro, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.": "Per accedere a rexpro, contatta l'amministratore. Gli amministratori possono gestire gli stati degli utenti dal pannello di amministrazione.",
  ...
  Version,
  "Version {{selectedVersion}} of {{totalVersions}}": "Versione {{selectedVersion}} di {{totalVersions}}",
  "Version deleted": "",
  "View Replies": "Visualizza Risposte",
  ...
  "Web Search in Chat": "Ricerca Web in chat",
  "Web Search Query Generation": "Generazione di query di ricerca Web",
  "Webhook Name": "",
  "Webhook URL": "URL webhook",
  Webhooks,
  "Webpage URLs": "",
  "rexpro Settings": "Impostazioni rexpro",
  "rexpro URL": "URL rexpro",
  'rexpro will make requests to "{{url}}"': 'rexpro farà richieste a "{{url}}"',
  'rexpro will make requests to "{{url}}/api/chat"': 'rexpro farà richieste a "{{url}}/api/chat"',
  'rexpro will make requests to "{{url}}/chat/completions"': 'rexpro farà richieste a "{{url}}/chat/completions"',
  Week,
  Weekly,
  ...
  Write,
  "Write a summary in 50 words that summarizes {{topic}}.": "Scrivi un riassunto in 50 parole che riassume [argomento o parola chiave].",
  ...
  "You can personalize your interactions with LLMs by adding memories through the 'Manage' button below, making them more helpful and tailored to you.": "Puoi personalizzare le tue interazioni con LLM aggiungendo memorie tramite il pulsante 'Gestisci' qui sotto, rendendole più utili e su misura per te.",
  "You cannot upload an empty file.": "Non puoi caricare un file vuoto.",
  ...
  "You do not have permission to upload files.": "Non hai il permesso di caricare file.",
