import { s as styleTags, t as tags, n as Prec, o as keymap, L as LanguageSupport, c as LRLanguage, i as indentNodeProp, q as flatIndent, g as continuedIndent, d as delimitedIndent, f as foldNodeProp, e as foldInside, k as syntaxTree, r as getIndentUnit, u as getIndentation, v as indentString, l as EditorSelection } from "./CVo5GJDq.js";
import { L as LRParser, E as ExternalTokenizer } from "./D_9GNG2C.js";
const notIn = 189, doubleSlash = 190, docAt = 191, beforeUnaryOp = 192, newlineTerminator = 193, newlineBeforeBinaryOperator = 194, newlineBeforeDo = 195, immediateParenOpen = 1, immediateSquareOpen = 2, immediateColonWhitespace = 196, atomWord = 197, keywordWord = 198, quotedContentIDouble = 3, quotedContentISingle = 4, quotedContentIHeredocDouble = 5, quotedContentIHeredocSingle = 6, quotedContentIParenthesis = 7, quotedContentICurly = 8, quotedContentISquare = 9, quotedContentIAngle = 10, quotedContentIBar = 11, quotedContentISlash = 12, quotedContentDouble = 13, quotedContentSingle = 14, quotedContentHeredocDouble = 15, quotedContentHeredocSingle = 16, quotedContentParenthesis = 17, quotedContentCurly = 18, quotedContentSquare = 19, quotedContentAngle = 20, quotedContentBar = 21, quotedContentSlash = 22, SigilModifiers = 23, identifier = 199, underscoredIdentifier = 200;
const CP_TAB = 9, CP_NEWLINE = 10, CP_CR = 13, CP_SPACE = 32, CP_EXCLAMATION_MARK = 33, CP_DOUBLE_QUOTE = 34, CP_HASH = 35, CP_PERCENT = 37, CP_AMPERSAND = 38, CP_SINGLE_QUOTE = 39, CP_PAREN_OPEN = 40, CP_PAREN_CLOSE = 41, CP_STAR = 42, CP_PLUS = 43, CP_COMMA = 44, CP_MINUS = 45, CP_DOT = 46, CP_SLASH = 47, CP_ZERO = 48, CP_NINE = 57, CP_COLON = 58, CP_SEMICOLON = 59, CP_ANGLE_OPEN = 60, CP_EQUALS = 61, CP_ANGLE_CLOSE = 62, CP_QUESTION_MARK = 63, CP_AT = 64, CP_A_UPPER = 65, CP_Z_UPPER = 90, CP_SQUARE_OPEN = 91, CP_BACKSLASH = 92, CP_SQUARE_CLOSE = 93, CP_CARET = 94, CP_A_LOWER = 97, CP_C_LOWER = 99, CP_D_LOWER = 100, CP_E_LOWER = 101, CP_H_LOWER = 104, CP_I_LOWER = 105, CP_L_LOWER = 108, CP_M_LOWER = 109, CP_N_LOWER = 110, CP_O_LOWER = 111, CP_P_LOWER = 112, CP_R_LOWER = 114, CP_T_LOWER = 116, CP_U_LOWER = 117, CP_W_LOWER = 119, CP_Y_LOWER = 121, CP_Z_LOWER = 122, CP_CURLY_OPEN = 123, CP_BAR = 124, CP_CURLY_CLOSE = 125, CP_TILDE = 126;
...
const IDENTIFIER_START = /[_\p{Ll}\p{Lm}\p{Lo}\p{Nl}\u1885\u1886\u2118\u212E\u309B\u309C]/u;
...
const TOKEN_TERMINATORS = /* @__PURE__ */ new Set([
  // Operator starts
  CP_AT,
  CP_DOT,
  CP_PLUS,
