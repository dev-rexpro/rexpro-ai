import { aP as adjustChannel, s as setAccDescription, g as getAccDescription, o as getDiagramTitle, n as setDiagramTitle, a as getAccTitle, b as setAccTitle, _ as __name, y as getConfig, E as selectSvgElement, a2 as at, Q as isDark, R as lighten, S as darken, d as configureSvgSize, p as clear, A as cleanAndMerge, B as defaultConfig_default } from "./DQxPuqmE.js";
import "./BeGenu0j.js";
...
function scaleSolution(solution, width, height, padding, scaleToFit) {
  ...
  if (xRange.max === xRange.min || yRange.max === yRange.min) {
    /* @__PURE__ */ console.log("not scaling solution: zero size detected");
    return solution;
  }
  let xScaling;
  let yScaling;
...
function computeTextCentres(circles, areas, symmetricalTextCentre) {
  ...
  for (let i = 0; i < areas.length; ++i) {
    ...
    if (centre.disjoint && areas[i].size > 0) {
      /* @__PURE__ */ console.log("WARNING: area " + area + " not represented on screen");
    }
  }
  return ret;
}
