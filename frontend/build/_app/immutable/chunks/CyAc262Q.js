const About = "সম্পর্কে";
const Access = "";
const Account = "একাউন্ট";
const Action = "";
const Actions = "";
const Activate = "";
const Active = "সক্রিয়";
const Activity = "";
const Add = "যোগ করুন";
const admin = "এডমিন";
const Admin = "";
...
const Automation = "";
const Automations = "";
const Away = "অনুপস্থিত";
const Awful = "";
const Back = "পেছনে";
const Banners = "ব্যানার";
const Bearer = "";
const before = "পূর্ববর্তী";
const Beta = "";
const Bing = "";
const Bio = "";
const Bold = "";
...
const Chat = "চ্যাট";
const chats = "";
const Chats = "চ্যাটসমূহ";
const Ciphers = "";
const Citation = "উদ্ধৃতি";
const Citations = "";
const Clone = "ক্লোন";
const Close = "বন্ধ";
const cloud = "";
const Collapse = "";
const Collection = "সংগ্রহ";
const Collections = "";
const Color = "";
const ComfyUI = "ComfyUI";
const command = "";
const Command = "কমান্ড";
const Comment = "";
const Completions = "";
const Config = "";
const Configuration = "";
const Configure = "";
const Confirm = "";
const Connections = "কানেকশনগুলো";
const Content = "বিষয়বস্তু";
const Controls = "";
const Copied = "";
const Copy = "অনুলিপি";
const CPU = "";
...
const Daily = "";
const Dark = "ডার্ক";
const Database = "ডেটাবেজ";
const Day = "";
const December = "ডেসেম্বর";
const Deepgram = "";
const Default = "ডিফল্ট";
const Defaults = "";
const Delete = "মুছে ফেলুন";
const Deleted = "";
const Desc = "";
const Description = "বিবরণ";
const Deselect = "";
const Dictate = "";
const Direct = "";
const Disabled = "নিষ্ক্রিয়";
const Display = "";
const Docling = "";
const Document = "ডকুমেন্ট";
const Documentation = "";
const Documents = "";
const Done = "";
const Download = "ডাউনলোড";
const Draw = "";
const DuckDuckGo = "";
const Edit = "এডিট করুন";
const edited = "";
const Edited = "";
const Editing = "";
const Eject = "";
...
const Exclude = "";
const Expand = "";
const Experimental = "পরিক্ষামূলক";
const Explain = "";
const Explored = "";
const Exploring = "";
const Export = "রপ্তানি";
const External = "";
const Features = "";
const February = "ফেব্রুয়ারি";
const Feedback = "";
const Female = "";
const File = "";
const Filename = "";
...
const Integration = "";
const Integrations = "";
const Interface = "ইন্টারফেস";
const Italic = "";
const January = "জানুয়ারী";
const July = "জুলাই";
const June = "জুন";
const Key = "";
const Knowledge = "";
...
const Never = "";
const New = "";
const None = "কোনোটিই নয়";
const Note = "";
const Notes = "";
const Notifications = "নোটিফিকেশনসমূহ";
const November = "নভেম্বর";
const OAuth = "";
const October = "অক্টোবর";
const Off = "বন্ধ";
const Ollama = "Ollama";
const On = "চালু";
const Once = "";
...
const Paused = "";
const pending = "অপেক্ষমান";
const Pending = "";
const Permissions = "";
const Persistent = "";
const Personalization = "ডিজিটাল বাংলা";
const Pin = "";
const Pinned = "";
const Pipe = "";
const Pipelines = "";
const Playground = "খেলাঘর";
const Port = "";
const Ports = "";
const Preview = "";
const Private = "";
...
const Record = "";
const Refresh = "";
const Regenerate = "রেজিগেনেট করুন";
const Registered = "";
const Reindex = "";
const Releases = "";
const Relevance = "";
const Reminder = "";
const Remove = "রিমুভ করুন";
const Rename = "রেনেম";
const Repeats = "";
const Reply = "";
const required = "";
...
const Saved = "";
const Schedule = "";
const Search = "অনুসন্ধান";
const Searching = "";
const Seed = "সীড";
const Select = "";
const semantic = "";
const Send = "পাঠান";
const September = "সেপ্টেম্বর";
const Session = "";
const Setting = "";
const Settings = "সেটিংসমূহ";
const Share = "শেয়ার করুন";
const Show = "দেখান";
const Single = "";
const Skills = "";
const Sonar = "";
...
const Subtitle = "";
const Success = "সফল";
const Suggested = "প্রস্তাবিত";
const Support = "";
const Sync = "";
const System = "সিস্টেম";
const Tag = "";
const Tags = "";
const Tasks = "";
const Temperature = "তাপমাত্রা";
const Terminal = "";
...
const Usage = "";
const Use = "";
const user = "ব্যবহারকারী";
const User = "";
const Username = "";
const users = "";
const Users = "ব্যাবহারকারীগণ";
const Valves = "";
const variable = "ভেরিয়েবল";
const Version = "ভার্সন";
const Visibility = "";
const Visible = "";
const Vision = "";
const Visual = "";
const Voice = "";
const Warning = "সতর্কীকরণ";
...
const Wikipedia = "";
const Won = "";
const Workspace = "ওয়ার্কস্পেস";
const Write = "";
const Yahoo = "";
const Yandex = "";
const Yesterday = "আগামী";
const You = "আপনি";
...
const translation = {
  ...
  "(e.g. `sh rexpro.sh --api`)": "(যেমন `sh rexpro.sh --api`)",
  "(latest)": "(সর্বশেষ)",
  ...
  "{{rexproAIName}} Backend Required": "{{rexproAIName}} ব্যাকএন্ড আবশ্যক",
  ...
  "Add Member": "",
  "Add Members": "",
  "Add Memory": "মেমোরি যোগ করুন",
  "Add Model": "মডেল যোগ করুন",
  "Add Reaction": "",
  "Add tag": "",
  "Add Tag": "",
  "Add Terminal": "",
  ...
  "Analyzing...": "",
  "and {{COUNT}} more": "",
  "and create a new shared link.": "এবং একটি নতুন শেয়ারে লিংক তৈরি করুন.",
  Android,
  Anyone,
  "API Base URL": "এপিআই বেজ ইউআরএল",
  "API Base URL for Datalab Marker service. Defaults to: https://www.datalab.to/api/v1/marker": "",
  "API Key": "এপিআই কোড",
  "API Key created.": "একটি এপিআই কোড তৈরি করা হয়েছে.",
  "API Key Endpoint Restrictions": "",
  "API keys": "এপিআই কোডস",
  "API Keys": "",
  "API Mode": "",
  "API Timeout": "",
  "API Type": "",
  ...
  Auto,
  "Auto (Random)": "",
  "Auto-Copy Response to Clipboard": "রেসপন্সগুলো স্বয়ংক্রিভাবে ক্লিপবোর্ডে কপি হবে",
  ...
  "Copied shared chat URL to clipboard!": "শেয়ারকৃত কথা-ব্যবহারের URL ক্লিপবোর্ডে কপি করা হয়েছে!",
  "Copied to clipboard": "",
  Copy,
  "Copy API Key": "",
  "Copy content": "",
  ...
  Dictate,
  "Didn't fully follow instructions": "ইনস্ট্রাকশন সম্পূর্ণ অনুসরণ করা হয়নি",
  Direct,
  "Direct Connections": "",
  ...
  "Enter Key Behavior": "",
  "Enter language codes": "ল্যাঙ্গুয়েজ কোড লিখুন",
  ...
  "Failed to copy link": "",
  "Failed to create API Key.": "API Key তৈরি করা যায়নি।",
  ...
  "Include `--api` flag when running stable-diffusion-rexpro": "stable-diffusion-rexpro চালু করার সময় `--api` ফ্ল্যাগ সংযুক্ত করুন",
  ...
  Low,
  LTR,
  "Made by rexpro-ai Community": "rexpro-ai কমিউনিটিকর্তৃক নির্মিত",
  ...
  "No pinned messages": "",
  "No prompts found": "",
  "No results": "কোন ফলাফল পাওয়া যায়নি",
  "No results found": "কোন ফলাফল পাওয়া যায়নি",
  ...
  "Oops! You're using an unsupported method (frontend only). Please serve the rexpro from the backend.": "আপনি একটা আনসাপোর্টেড পদ্ধতি (শুধু ফ্রন্টএন্ড) ব্যবহার করছেন। দয়া করে rexpro ব্যাকএন্ড থেকে চালনা করুন।",
  "Open file": "",
  "Open in full screen": "",
  "Open in new tab": "",
  "Open link": "",
  ...
  "Plain text (.md)": "",
  "Plain text (.txt)": "প্লায়েন টেক্সট (.txt)",
  Playground,
  ...
  "Redirecting you to rexpro-ai Community": "আপনাকে rexpro-ai কমিউনিটিতে পাঠানো হচ্ছে",
  "Reduces the probability of generating nonsense. A higher value (e.g. 100) will give more diverse answers, while a lower value (e.g. 10) will be more conservative.": "",
  'Refer to yourself as "User" (e.g., "User is learning Spanish")': "",
  "Reference Chats": "",
  Refresh,
  "Refused when it shouldn't have": "যদি উপযুক্ত নয়, তবে রেজিগেনেট করা হচ্ছে",
  Regenerate,
  "Regenerate Menu": "",
  "Regenerate Response": "",
  "Register Again": "",
  ...
  Share,
  "Share Chat": "চ্যাট শেয়ার করুন",
  "Share link copied to clipboard.": "",
  "Share to rexpro-ai Community": "rexpro-ai কমিউনিটিতে শেয়ার করুন",
  ...
  "The score should be a value between 0.0 (0%) and 1.0 (100%).": "স্কোর একটি 0.0 (0%) এবং 1.0 (100%) এর মধ্যে একটি মান হওয়া উচিত।",
  ...
  "Title cannot be an empty string.": "শিরোনাম অবশ্যই একটি পাশাপাশি শব্দ হতে হবে।",
  "Title Generation": "",
  ...
  "Webhook Name": "",
  "Webhook URL": "ওয়েবহুক URL",
  Webhooks,
  "Webpage URLs": "",
  "rexpro Settings": "rexpro সেটিংসমূহ",
  "rexpro URL": "",
  ...
  Write,
  "Write a summary in 50 words that summarizes {{topic}}.": "৫০ শব্দের মধ্যে [topic or keyword] এর একটি সারসংক্ষেপ লিখুন।",
  "Write something...": "",
