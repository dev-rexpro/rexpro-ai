const About = "О нама";
const Access = "Приступ";
const Account = "Налог";
const Action = "";
const Actions = "Радње";
const Activate = "";
const Active = "Активан";
const Activity = "";
const Add = "Додај";
const admin = "админ";
const Admin = "Админ";
...
const All = "";
const Always = "";
const Amazing = "Невероватно";
const Analytics = "";
const Analyzed = "";
const Android = "";
const Anyone = "";
const April = "Април";
const Archive = "Архивирај";
const Artifacts = "Артефакти";
const Asc = "";
const Ask = "";
const Assistant = "Помоћник";
const Audio = "Звук";
const August = "Август";
const Auth = "";
const Authenticate = "Идентификација";
...
const Camera = "Камера";
const Cancel = "Откажи";
const Capabilities = "Могућности";
const Capture = "Ухвати";
const Channel = "";
const Channels = "Канали";
const Character = "Знак";
const Chat = "Ћаскање";
const chats = "";
const Chats = "Ћаскања";
const Ciphers = "Шифре";
...
const Citations = "";
const Clone = "Клонирај";
const Close = "Затвори";
const cloud = "";
const Collapse = "";
const Collection = "Колекција";
const Collections = "";
const Color = "Боја";
const ComfyUI = "ComfyUI";
const command = "";
const Command = "Наредба";
const Comment = "";
const Completions = "Допуне";
const Config = "";
const Configuration = "";
const Configure = "Подеси";
const Confirm = "Потврди";
const Connections = "Везе";
const Content = "Садржај";
const Controls = "Контроле";
const Copied = "Копирано";
const Copy = "Копирај";
const CPU = "";
const Create = "Направи";
const Custom = "Прилагођено";
const Daily = "";
const Dark = "Тамна";
const Database = "База података";
const Day = "";
const December = "Децембар";
const Deepgram = "";
const Default = "Подразумевано";
const Defaults = "";
const Delete = "Обриши";
const Deleted = "";
const Desc = "";
...
const Dictate = "";
const Direct = "";
const Disabled = "Онемогућено";
const Display = "Приказ";
const Docling = "";
const Document = "Документ";
const Documentation = "Документација";
const Documents = "";
const Done = "Готово";
const Download = "Преузми";
const Draw = "Нацртај";
const DuckDuckGo = "";
const Edit = "Измени";
const edited = "";
...
const Emoji = "";
const Emojis = "";
const Enabled = "Омогућено";
const Enhance = "";
const Ephemeral = "";
const ERROR = "ГРЕШКА";
const Evaluations = "Процењивања";
const Exclude = "";
const Expand = "";
...
const External = "";
const Features = "";
const February = "Фебруар";
const Feedback = "";
const Female = "";
const File = "Датотека";
const Filename = "";
const Files = "Датотеке";
const Filter = "";
const Filters = "";
const Folder = "";
const Folders = "";
...
const Integration = "";
const Integrations = "";
const Interface = "Изглед";
const Italic = "";
const January = "Јануар";
const July = "Јул";
const June = "Јун";
const Key = "Кључ";
const Knowledge = "Знање";
const Label = "Етикета";
const Language = "Језик";
const LDAP = "ЛДАП";
const Leaderboard = "Ранг листа";
const Legacy = "";
const lexical = "";
const License = "";
const Light = "Светла";
...
const Note = "";
const Notes = "Белешке";
const Notifications = "Обавештења";
const November = "Новембар";
const OAuth = "";
const October = "Октобар";
const Off = "Искључено";
const Ollama = "Ollama";
const On = "Укључено";
const Once = "";
...
const Paginate = "";
const Parameters = "";
const Password = "Лозинка";
const Paused = "";
const pending = "на чекању";
const Pending = "";
const Permissions = "";
const Persistent = "";
const Personalization = "Прилагођавање";
const Pin = "Закачи";
const Pinned = "Закачено";
const Pipe = "";
const Pipelines = "";
const Playground = "Игралиште";
const Port = "";
const Ports = "";
const Preview = "";
const Private = "";
...
const Record = "";
const Refresh = "";
const Regenerate = "Поново створи";
const Registered = "";
const Reindex = "";
const Releases = "";
const Relevance = "Примењивост";
const Reminder = "";
const Remove = "Уклони";
const Rename = "Преименуј";
const Repeats = "";
const Reply = "";
const required = "";
const Reset = "Поврати";
...
const RTL = "ДНЛ";
const Run = "Покрени";
const Running = "Покрећем";
const Sa_day_of_week = "";
const Save = "Сачувај";
const Saved = "Сачувано";
const Schedule = "";
const Search = "Претражи";
const Searching = "";
const Seed = "Семе";
const Select = "";
const semantic = "";
const Send = "Пошаљи";
const September = "Септембар";
const Session = "";
const Setting = "";
const Settings = "Подешавања";
const Share = "Подели";
const Show = "Прикажи";
const Single = "";
const Skills = "";
...
const Unmute = "";
const Unpin = "Откачи";
const Untagged = "Неозначено";
const Untitled = "";
const Update = "Ажурирај";
const Updated = "Ажурирано";
const Upload = "Отпреми";
const URL = "УРЛ";
const Usage = "";
const Use = "";
const user = "корисник";
const User = "Корисник";
const Username = "Корисничко име";
const users = "";
const Users = "Корисници";
const Valves = "Вентили";
const variable = "променљива";
const Version = "Издање";
const Visibility = "Видљивост";
const Visible = "";
const Vision = "";
const Visual = "";
const Voice = "Глас";
const Warning = "Упозорење";
...
const Wikipedia = "";
const Won = "Победа";
const Workspace = "Радни простор";
const Write = "Пиши";
const Yahoo = "";
const Yandex = "";
const Yesterday = "Јуче";
const You = "Ти";
const YouTube = "Јутјуб";
const translation = {
  ...
  "(e.g. `sh rexpro.sh --api --api-auth username_password`)": "(нпр. `sh rexpro.sh --api --api-auth username_password`)",
  "(e.g. `sh rexpro.sh --api`)": "(нпр. `sh rexpro.sh --api`)",
  "(latest)": "(најновије)",
  ...
  "{{rexproAIName}} Backend Required": "Захтева се {{rexproAIName}} позадинац",
  ...
  "Contact Admin for rexpro Access": "Пишите админима за приступ на rexpro",
  Content,
  ...
  "Include `--api` flag when running stable-diffusion-rexpro": "Укључи `--api` заставицу при покретању stable-diffusion-rexpro",
  ...
  Low,
  LTR,
  "Made by rexpro-ai Community": "Израдила rexpro-ai заједница",
  ...
  "Oops! You're using an unsupported method (frontend only). Please serve the rexpro from the backend.": "Упс! Користите неподржани метод (само фронтенд). Молимо вас да покренете rexpro са бекенда.",
  "Open file": "",
  "Open in full screen": "",
  "Open in new tab": "",
  "Open link": "",
  ...
  "Redirecting you to rexpro-ai Community": "Преусмеравање на rexpro-ai заједницу",
  ...
  "Share to rexpro-ai Community": "Подели са rexpro-ai заједницом",
  ...
  Webhooks,
  "Webpage URLs": "",
  "rexpro Settings": "Подешавања веб интерфејса",
  "rexpro URL": "rexpro адреса",
  ...
  Write,
  "Write a summary in 50 words that summarizes {{topic}}.": "Напишите сажетак у 50 речи који резимира [тему или кључну реч].",
