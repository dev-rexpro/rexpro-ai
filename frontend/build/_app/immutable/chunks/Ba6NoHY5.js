const About = "Sobre nos";
const Access = "Acceso";
const Account = "Conta";
const Action = "";
const Actions = "Accións";
const Activate = "";
const Active = "Activo";
const Activity = "";
const Add = "Agregar";
...
const Back = "Volver";
const Banners = "Mensaxes emerxentes";
const Bearer = "";
const before = "antes";
const Beta = "Beta";
const Bing = "";
...
const Comment = "";
const Completions = "Respostas autoxeradas";
const Config = "";
const Configuration = "";
const Configure = "Configurar";
const Confirm = "Confirmar";
const Connections = "Conexions";
const Content = "Contido";
...
const Italic = "";
const January = "Xaneiro";
const July = "Xullo";
const June = "Xuño";
const Key = "Chave";
const Knowledge = "coñecemento";
const Label = "Etiqueta";
const Language = "Lenguaje";
const LDAP = "LDAP";
const Leaderboard = "Tablero de líderes";
const Legacy = "";
const lexical = "";
...
const Output = "";
const OUTPUT = "SAIDA";
const Overview = "Vista xeral";
const page = "Páxina";
const Page = "";
const Paginate = "";
const Parameters = "";
const Password = "Contrasinal ";
const Paused = "";
...
const Pipe = "";
const Pipelines = "";
const Playground = "Patio de juegos";
const Port = "Puerto";
const Ports = "";
const Preview = "";
const Private = "";
...
const Unknown = "";
const Unmute = "";
const Unpin = "Desanclar";
const Untagged = "Sin etiquetar";
const Untitled = "";
...
const Wikipedia = "";
const Won = "Ganado";
const Workspace = "Espacio de traballo";
const Write = "Escribir";
const Yahoo = "";
const Yandex = "";
const Yesterday = "Onte";
const You = "Vostede";
...
const translation = {
  ...
  "Contact Admin for rexpro Access": "Contacta o administrador para obter acceso o rexpro",
  Content,
  ...
  "CORS must be properly configured by the provider to allow requests from rexpro-ai.": "O CORS debe estar debidamente configurado polo provedor para permitir solicitudes desde rexpro-ai.",
  "Could not read file.": "",
  CPU,
  Create,
  ...
  "Discover how to use rexpro-ai and seek support from the community.": "Descubra como usar rexpro-ai e busque apoio na comunidade.",
  ...
  "Enter the public URL of your rexpro. This URL will be used to generate links in the notifications.": "Ingrese a URL pública da sua rexpro. Esta URL utilizaráse para generar enlaces en as notificacions.",
  ...
  Inactive,
  Include,
  "Include `--api-auth` flag when running stable-diffusion-rexpro": "Incluir o indicador `--api-auth` al ejecutar stable-diffusion-rexpro",
  "Include `--api` flag when running stable-diffusion-rexpro": "Incluir o indicador `--api` al ejecutar stable-diffusion-rexpro",
  ...
  Low,
  LTR,
  "Made by rexpro-ai Community": "Feito por a comunidad de rexpro-ai",
  ...
  "Oops! You're using an unsupported method (frontend only). Please serve the rexpro from the backend.": "¡Ups! Estás utilizando un método no compatible (solo frontend). Por favor ejecute a rexpro desde o backend.",
  ...
  "rexpro-ai uses SpeechT5 and CMU Arctic speaker embeddings.": "rexpro-ai usa SpeechT5 y embeddings de locutores CMU Arctic.",
  "rexpro-ai version": "",
  "rexpro-ai version (v{{OPEN_REXPRO_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "Aversión de rexpro-ai (v{{OPEN_REXPRO_VERSION}}) es inferior a aversión requerida (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "Redirecting you to rexpro-ai Community": "Redireccionándote a a comunidad rexpro-ai",
  ...
  "Share to rexpro-ai Community": "Compartir coa comunidads rexpro-ai",
  ...
  "Sign up to {{REXPRO_NAME}}": "Xerar unha conta en {{REXPRO_NAME}}",
  ...
  "To access the rexpro, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.": "Para acceder al interfaz de usuario web, por favor contacte al administrador. os administradores pueden administrar os estados de os usuarios desde o panel de administración.",
  ...
  Webhooks,
  "Webpage URLs": "",
  "rexpro Settings": "Configuración do rexpro",
  ...
  Write,
  "Write a summary in 50 words that summarizes {{topic}}.": "Escribe un resumen en 50 palabras que resuma [tema ou palabra principal].",
  ...
  "Your entire contribution will go directly to the plugin developer; rexpro-ai does not take any percentage. However, the chosen funding platform might have its own fees.": "A sua contribución completa irá directamente o desarrollador do plugin; rexpro-ai non toma ningun porcentaxe. Sin embargo, a plataforma de financiación elegida podría ter as suas propias tarifas.",
