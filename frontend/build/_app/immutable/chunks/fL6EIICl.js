import { i as interpolate$1, d as array$4, e as date, n as numberArray, o as object$1, f as interpolateRound, g as ascending$2, h as numbers$2, j as number$4, k as number$5, m as linearish, p as transformer$3, a as copy$2, q as ticks, r as identity$5, s as bisectRight$1, b as bisector, t as tickStep, u as precisionFixed, v as precisionRound, w as precisionPrefix, l as linear$1, x as tickFormat$1, y as bisectLeft$1 } from "./gBiMFpD9.js";
import { q as degrees$1, r as radians$1, u as lab$1, i as interpolateHcl, v as hclLong, m as min$1, a as max$1, w as nice, x as calendar, y as utcFormat$1, s as second, z as utcMinute, A as utcHour, B as utcDay, C as utcSunday, D as utcMonth, E as utcYear, F as utcTickInterval, G as utcTicks, p as millisecond, o as timeMinute, n as timeHour, l as timeDay, d as timeSunday, c as timeMonth, H as timeYear, I as formatLocale$1, b as timeFormat$1, J as utcParse$1, K as timeParse$1, t as time$1, L as hcl } from "./DmFXC6sK.js";
import { a as formatSpecifier, f as format$3, c as formatLocale, b as formatPrefix } from "./olplAo2_.js";
import { r as range$3 } from "./Bs5oKbOs.js";
import { R as Rgb, r as rgbConvert, e as define, f as extend$1, m as darker, o as brighter, C as Color, h as hue$1, p as hsl$1, n as nogamma, q as basis, s as basisClosed, i as interpolateNumber, b as interpolateRgb, u as rgbBasis, v as rgbBasisClosed, d as interpolateString, k as interpolateTransformCss, j as interpolateTransformSvg, T as Timer$1, l as now, t as timer$1, g as dispatch, w as rgb } from "./BKSIeq3V.js";
import { i as interpolateZoom } from "./7WfxZx5Q.js";
import { i as initRange, a as initInterpolator } from "./CTO7spbL.js";
import { I as InternSet, o as ordinal, i as implicit } from "./CzSFdLC4.js";
import { c as colors$1 } from "./DAbZ0KZY.js";
import { w as withPath, n as array$5, a as constant$4, z as curveLinear, J as x$3, K as y$3, l as line$3, t as tau$2, b as sqrt$3, p as pi$2, o as stepBefore, q as stepAfter, r as curveStep, u as curveNatural, x as monotoneX, v as monotoneY, y as curveLinearClosed, B as curveCatmullRomOpen, C as curveCatmullRomClosed, A as curveCatmullRom, F as curveCardinalClosed, E as curveCardinalOpen, D as curveCardinal, G as curveBundle, H as curveBasisOpen, I as curveBasisClosed, k as curveBasis, L as path$3 } from "./Xp5qcr6b.js";
import { d as d3arc } from "./CQKzBGK9.js";
import { o as optional, c as constantZero, a as constant$3, r as roundNode, b as treemapDice, N as Node$1, d as computeHeight, e as treemapSlice, s as squarifyRatio, p as phi, h as hierarchy, t as treemap, f as treemapSquarify } from "./C7WVfQCl.js";
...
define(Cubehelix, cubehelix$1, extend$1(Color, {
  ...
  rgb() {
    var h2 = isNaN(this.h) ? 0 : (this.h + 120) * radians$1, l = +this.l, a2 = isNaN(this.s) ? 0 : this.s * l * (1 - l), cosh = Math.cos(h2), sinh = Math.sin(h2);
    return new Rgb(
      255 * (l + a2 * (A * cosh + B$1 * sinh)),
      255 * (l + a2 * (C$1 * cosh + D$1 * sinh)),
      255 * (l + a2 * (E * cosh)),
      this.opacity
    );
  }
...
class Delaunator {
  ...
  update() {
    ...
    for (let k = 0, xp = 0, yp = 0; k < this._ids.length; k++) {
      ...
      const x2 = coords[2 * i];
      const y2 = coords[2 * i + 1];
      if (k > 0 && Math.abs(x2 - xp) <= EPSILON$2 && Math.abs(y2 - yp) <= EPSILON$2) continue;
      xp = x2;
      yp = y2;
...
class Path {
  ...
  arc(x2, y2, r) {
    ...
    else if (Math.abs(this._x1 - x02) > epsilon$3 || Math.abs(this._y1 - y02) > epsilon$3) this._ += "L" + x02 + "," + y02;
    if (!r) return;
  ...
  _step(i, x2, y2) {
    ...
    do {
      ...
      if (e === -1) {
        ...
        if (e !== t) {
          if (pow$4(x2 - points2[e * 2], 2) + pow$4(y2 - points2[e * 2 + 1], 2) < dc) return e;
        }
        break;
      }
    } while (e !== e0);
...
function formatDate(date2) {
  ...
  return isNaN(date2) ? "Invalid Date" : formatYear(date2.getUTCFullYear()) + "-" + pad$1(date2.getUTCMonth() + 1, 2) + "-" + pad$1(date2.getUTCDate(), 2) + (milliseconds ? "T" + pad$1(hours, 2) + ":" + pad$1(minutes, 2) + ":" + pad$1(seconds, 2) + "." + pad$1(milliseconds, 3) + "Z" : seconds ? "T" + pad$1(hours, 2) + ":" + pad$1(minutes, 2) + ":" + pad$1(seconds, 2) + "Z" : minutes || hours ? "T" + pad$1(hours, 2) + ":" + pad$1(minutes, 2) + "Z" : "");
}
...
function forceLink(links) {
  var id2 = index$1, strength = defaultStrength, strengths, distance = constant$2(30), distances, nodes, count, bias, random2, iterations2 = 1;
  if (links == null) links = [];
...
function geoCentroid$1(object2) {
  ...
  if (m2 < epsilon2) {
    ...
    if (W1 < epsilon$2) x2 = X0$1, y2 = Y0$1, z = Z0$1;
    m2 = hypot(x2, y2, z);
...
function circleStream(stream2, radius2, delta, direction, t02, t1) {
  ...
  if (t02 == null) {
    ...
    if (direction > 0 ? t02 < t1 : t02 > t1) t02 += direction * tau;
  }
...
function polygonContains(polygon, point2) {
  ...
  var sum2 = new Adder();
  if (sinPhi === 1) phi2 = halfPi$1 + epsilon$2;
  else if (sinPhi === -1) phi2 = -halfPi$1 - epsilon$2;
  ...
  return {
    ...
    point: function(lambda12, phi12) {
      ...
      if (abs$1(delta - pi$1) < epsilon$2) {
        ...
        if (abs$1(lambda02 - sign0) < epsilon$2) lambda02 -= sign0 * epsilon$2;
        if (abs$1(lambda12 - sign1) < epsilon$2) lambda12 -= sign1 * epsilon$2;
...
function clipCircle(radius2) {
  var cr2 = cos$1(radius2), delta = 2 * radians, smallRadius = cr2 > 0, notHemisphere = abs$1(cr2) > epsilon$2;
...
function graticuleX(y02, y12, dy) {
  var y2 = range$3(y02, y12 - epsilon$2, dy).concat(y12);
  return function(x2) {
...
function graticuleY(x02, x12, dx) {
  var x2 = range$3(x02, x12 - epsilon$2, dx).concat(x12);
  return function(y2) {
...
function conicEqualAreaRaw(y02, y12) {
  ...
  if (abs$1(n) < epsilon$2) return cylindricalEqualAreaRaw(y02);
...
function conicConformalRaw(y02, y12) {
  ...
  function project2(x2, y2) {
    if (f > 0) {
      if (y2 < -halfPi$1 + epsilon$2) y2 = -halfPi$1 + epsilon$2;
    } else {
      if (y2 > halfPi$1 - epsilon$2) y2 = halfPi$1 - epsilon$2;
    }
...
function identity$3(domain2) {
  ...
  scale2.copy = function() {
    return identity$3(domain2).unknown(unknown);
  };
...
function powish(transform2) {
  var scale2 = transform2(identity$5, identity$5), exponent = 1;
  function rescale() {
    return exponent === 1 ? transform2(identity$5, identity$5) : exponent === 0.5 ? transform2(transformSqrt, transformSquare) : transform2(transformPow(exponent), transformPow(1 / exponent));
  }
...
function transformer$1() {
  var x02 = 0, x12 = 1, t02, t1, k10, transform2, interpolator = identity$5, clamp2 = false, unknown;
  function scale2(x2) {
...
function transformer() {
  var x02 = 0, x12 = 0.5, x2 = 1, s = 1, t02, t1, t2, k10, k21, interpolator = identity$5, transform2, clamp2 = false, unknown;
  function scale2(x3) {
...
function area$2$1(x02, y02, y12) {
  var x12 = null, defined = constant$4(true), context2 = null, curve2 = curveLinear, output2 = null, path2 = withPath(area2);
...
function field$1(field2, name, opt) {
  ...
  const fieldName = path2.length === 1 ? path2[0] : field2;
  return accessor((opt && opt.get || getter$1)(path2), [fieldName], name || fieldName);
}
const id = field$1("id");
...
const Info = 3;
const Debug = 4;
function logger(_, method2, handler = log$3) {
  let level = _ || None$2;
  return {
    level(_2) {
      if (arguments.length) {
    ...
    error(...args) {
      if (level >= Error$1)
        handler(method2 || "error", "ERROR", args);
      return this;
    },
    warn(...args) {
      if (level >= Warn)
        handler(method2 || "warn", "WARN", args);
      return this;
    },
    info(...args) {
      if (level >= Info)
        handler(method2 || "log", "INFO", args);
      return this;
    },
    debug(...args) {
      if (level >= Debug)
        handler(method2 || "log", "DEBUG", args);
      return this;
    }
  };
}
...
const isLegalKey = (key2) => key2 !== "__proto__" && key2 !== "constructor" && key2 !== "prototype";
  ...
  return configs.reduce((out, source2) => {
    for (const key2 in source2) {
      if (key2 === "signals") {
        ...
        const r = key2 === "legend" ? { layout: 1 } : key2 === "style" ? true : null;
...
const coerceNumber = (x2) => toNumber(x2) ?? 0;
const identity$1 = (x2) => x2;
function pan(domain2, delta, lift, ground) {
  if (!isNonEmpty(domain2))
    error("Domain array must not be empty");
...
function panLinear(domain2, delta) {
  return pan(domain2, delta, coerceNumber, identity$1);
}
...
function zoom(domain2, anchor, scale2, lift, ground) {
  ...
  return [
    ground(da + (d0 - da) * scale2),
    ground(da + (d1 - da) * scale2)
  ];
}
function zoomLinear(domain2, anchor, scale2) {
  return zoom(domain2, anchor, scale2, coerceNumber, identity$1);
}
function zoomLog(domain2, anchor, scale2) {
  const sign2 = Math.sign(domain2[0]);
  return zoom(domain2, anchor, scale2, log$2(sign2), exp$1(sign2));
}
...
function clampRange(range2, min2, max2) {
  ...
  span2 = hi - lo;
  return span2 >= max2 - min2 ? [min2, max2] : [
    lo = Math.min(Math.max(lo, min2), max2 - span2),
    lo + span2
  ];
}
...
function compare$1(inputFields, inputOrders, inputOpt) {
  ...
  array$2(inputFields).forEach((f, i) => {
    ...
    const accessor2 = isFunction(f) ? f : field$1(f, void 0, opt);
    get2.push(accessor2);
    (accessorFields(accessor2) || []).forEach((_) => fmap[_] = 1);
  });
...
const ascending$1 = (_u, _v) => {
  let u2 = _u;
  let v = _v;
  return (u2 < v || u2 == null) && v != null ? -1 : (u2 > v || v == null) && u2 != null ? 1 : (v = v instanceof Date ? +v : v, u2 = u2 instanceof Date ? +u2 : u2) !== u2 && v === v ? -1 : v !== v && u2 === u2 ? 1 : 0;
};
...
function hasOwnProperty(object2, property2) {
...
function fastmap(input) {
  let obj = {}, test2;
  function has2(key2) {
    return hasOwnProperty(obj, key2) && obj[key2] !== NULL;
  }
  const map2 = {
    size: 0,
    empty: 0,
    ...
    has: has2,
    get(key2) {
      return has2(key2) ? obj[key2] : void 0;
    },
    set(key2, value2) {
      if (!has2(key2)) {
        ++map2.size;
...
function isDate$1(value2) {
  return Object.prototype.toString.call(value2) === "[object Date]";
}
function isIterable(value2) {
  return value2 != null && isFunction(value2[Symbol.iterator]);
}
...
function key(fields, flat, opt) {
  const processedFields = fields ? flat ? array$2(fields).map((f) => f.replace(/\\(.)/g, "$1")) : array$2(fields) : void 0;
  const len = processedFields == null ? void 0 : processedFields.length, gen = opt && opt.get || getter$1, map2 = (f) => gen(flat ? [f] : splitAccessPath(f));
  let fn;
  if (!len || !processedFields) {
    ...
    const get2 = map2(processedFields[0]);
    fn = function(_) {
      return "" + get2(_);
    };
  } else {
    const get2 = processedFields.map(map2);
    fn = function(_) {
      let s = "" + get2[0](_), i = 0;
      while (++i < len)
        s += "|" + get2[i](_);
...
function lruCache(maxsize) {
  ...
  return {
    clear,
    has: (key2) => hasOwnProperty(curr, key2) || hasOwnProperty(prev, key2),
    get: (key2) => hasOwnProperty(curr, key2) ? curr[key2] : hasOwnProperty(prev, key2) ? update2(key2, prev[key2]) : void 0,
    set: (key2, value2) => hasOwnProperty(curr, key2) ? curr[key2] = value2 : update2(key2, value2)
  };
}
...
function merge$2(compare2, array0, array1, output2) {
  ...
  const merged = output2 || (isArrayConstructor(ctor) ? new ctor(n0 + n1) : new Array(n0 + n1));
  let i0 = 0, i1 = 0, i = 0;
  for (; i0 < n0 && i1 < n1; ++i) {
...
function stringValue(x2) {
  return isArray(x2) ? `[${x2.map((v) => v === null ? "null" : stringValue(v))}]` : isObject(x2) || isString(x2) ? (
...
function floor(units, step, get2, inv, newDate) {
  const s = step || 1, b2 = peek$1(units), _ = (unit, p, key2) => {
    key2 = key2 || unit;
    return getUnit(get2[key2], inv[key2], unit === b2 && s, p);
  };
  const t = /* @__PURE__ */ new Date(), u2 = toSet(units), y2 = u2[YEAR] ? _(YEAR) : constant$1(2012), m2 = u2[MONTH] ? _(MONTH) : u2[QUARTER] ? _(QUARTER) : zero$1, d = u2[WEEK] && u2[DAY] ? _(DAY, 1, WEEK + DAY) : u2[WEEK] ? _(WEEK, 1) : u2[DAY] ? _(DAY, 1) : u2[DATE] ? _(DATE, 1) : u2[DAYOFYEAR] ? _(DAYOFYEAR, 1) : one$1, H = u2[HOURS] ? _(HOURS) : zero$1, M2 = u2[MINUTES] ? _(MINUTES) : zero$1, S = u2[SECONDS] ? _(SECONDS) : zero$1, L = u2[MILLISECONDS] ? _(MILLISECONDS) : zero$1;
  return function(v) {
    t.setTime(+v);
    const year = y2(t);
...
function timeSequence(unit, start, stop2, step) {
  return sequence$1(timeInterval(unit), start, stop2, step);
}
function utcSequence(unit, start, stop2, step) {
  return sequence$1(utcInterval(unit), start, stop2, step);
}
...
function numberLocale(locale2) {
  ...
  return {
    ...
    formatSpan(start, stop2, count, specifier) {
      ...
      const step = tickStep(start, stop2, count), value2 = Math.max(Math.abs(start), Math.abs(stop2));
      let precision;
...
function dsv(data2, format2) {
  if (format2.header) {
    data2 = format2.header.map(stringValue).join(format2.delimiter) + "\n" + data2;
  }
...
function read(data2, schema, timeParser, utcParser) {
  ...
  if (hasOwnProperty(data2, "columns")) delete data2.columns;
  return data2;
}
...
function UniqueList(idFunc) {
  const $ = idFunc || identity$2, list = [], ids = {};
  list.add = (_) => {
    const id2 = $(_);
    if (!ids[id2]) {
      ids[id2] = 1;
...
function changeset() {
  ...
  return {
    ...
    insert(t) {
      const d = array$2(t), n = d.length;
      for (let i = 0; i < n; ++i) add2.push(d[i]);
      return this;
    },
    remove(t) {
      const a2 = isFunction(t) ? remp : rem2, d = array$2(t), n = d.length;
...
function onStream(df, stream2, target2, update2, params2, options) {
  ...
  let func, op;
  if (!isFunction(target2)) target2 = constant$1(target2);
  if (update2 === void 0) {
...
function transform$2(type2) {
  ...
  return hasOwnProperty(transforms, type2) ? transforms[type2] : null;
}
...
function poly(data2, x2, y2, order) {
  if (order === 0) return constant(data2, x2, y2);
...
inherits(Facet$1, Transform, {
  ...
  subflow(key2, flow, pulse2, parent) {
    ...
    let sf = hasOwnProperty(flows, key2) && flows[key2], df, p;
    if (!sf) {
...
inherits(Quantile$1, Transform, {
  transform(_, pulse2) {
    ...
    const source2 = pulse2.materialize(pulse2.SOURCE).source, groups = partition$1$1(source2, _.groupby, _.field), names = (_.groupby || []).map(accessorName), values2 = [], step = _.step || 0.01, p = _.probs || range$3(step / 2, 1 - EPSILON, step), n = p.length;
    groups.forEach((g) => {
...
function scaleBinOrdinal() {
  ...
  scale2.tickFormat = function(count, specifier) {
    return tickFormat$1(domain2[0], peek$1(domain2), count == null ? 10 : count, specifier);
  };
  scale2.copy = function() {
...
function tickCount(scale2, count, minStep) {
  let step;
  if (isNumber$1(count)) {
    if (scale2.bins) {
      count = Math.max(count, scale2.bins.length);
    }
    if (minStep != null) {
      count = Math.min(count, Math.floor(span(scale2.domain()) / minStep || 1) + 1);
    }
  }
  if (isObject(count)) {
    step = count.step;
  ...
  if (isString(count)) {
    count = scale2.type === Time ? timeInterval(count) : scale2.type == UTC ? utcInterval(count) : error("Only time and utc scales accept interval strings.");
    if (step) count = count.every(step);
  }
  return count;
}
function validTicks(scale2, ticks2, count) {
  ...
  if (count > 0 && ticks2.length > 1) {
    const endpoints = [ticks2[0], peek$1(ticks2)];
    while (ticks2.length > count && ticks2.length >= 3) {
...
function tickValues(scale2, count) {
  return scale2.bins ? validTicks(scale2, scale2.bins, count) : scale2.ticks ? scale2.ticks(count) : scale2.domain();
}
function tickFormat(locale2, scale2, count, specifier, formatType, noSkip) {
  ...
  if (type2 === Time || formatType === Time) {
    ...
    if (noSkip || scale2.bins) {
      ...
      const test2 = tickLog(scale2, count, false);
      format2 = (_) => test2(_) ? varfmt(_) : "";
    }
  } else if (scale2.tickFormat) {
    const d = scale2.domain();
    format2 = locale2.formatSpan(d[0], d[d.length - 1], count, specifier);
  } else if (specifier) {
    format2 = locale2.format(specifier);
  }
  return format2;
}
function tickLog(scale2, count, values2) {
  const ticks2 = tickValues(scale2, count), base = scale2.base(), logb = Math.log(base), k = Math.max(1, base * count / ticks2.length);
  const test2 = (d) => {
...
function labelValues(scale2, count) {
  return scale2.bins ? binValues(scale2.bins) : scale2.type === Log ? tickLog(scale2, count, true) : symbols$1[scale2.type] ? thresholdValues(scale2[symbols$1[scale2.type]]()) : tickValues(scale2, count);
}
...
function labelFormat(locale2, scale2, count, type2, specifier, formatType, noSkip) {
  const format2 = formats[scale2.type] && formatType !== Time && formatType !== UTC ? thresholdFormat(locale2, scale2, specifier) : tickFormat(locale2, scale2, count, specifier, formatType, noSkip);
...
function labelFraction(scale2) {
  const domain2 = scale2.domain(), count = domain2.length - 1;
...
function curves(type2, orientation, tension) {
  var entry2 = hasOwnProperty(lookup$4, type2) && lookup$4[type2], curve2 = null;
  if (entry2) {
...
function customSymbol(path2) {
  if (!hasOwnProperty(custom2, path2)) {
...
function legendGroupLayout(view, item, entry2) {
  ...
  if (!item.datum.title) {
    ...
    if (tx2 || ty) translate(view, title, tx2, ty);
...
inherits(AxisTicks$1, Transform, {
  transform(_, pulse2) {
    ...
    var locale2 = pulse2.dataflow.locale(), out = pulse2.fork(pulse2.NO_SOURCE | pulse2.NO_FIELDS), ticks2 = this.value, scale2 = _.scale, tally = _.count == null ? _.values ? _.values.length : 10 : _.count, count = tickCount(scale2, tally, _.minstep), format2 = _.format || tickFormat(locale2, scale2, count, _.formatSpecifier, _.formatType, !!_.values), values2 = _.values ? validTicks(scale2, _.values, count) : tickValues(scale2, count);
...
inherits(LegendEntries$1, Transform, {
  transform(_, pulse2) {
    ...
    var locale2 = pulse2.dataflow.locale(), out = pulse2.fork(pulse2.NO_SOURCE | pulse2.NO_FIELDS), items = this.value, type2 = _.type || SymbolLegend, scale2 = _.scale, limit = +_.limit, count = tickCount(scale2, _.count == null ? 5 : _.count, _.minstep), lskip = !!_.values || type2 === SymbolLegend, format2 = _.format || labelFormat(locale2, scale2, count, type2, _.formatSpecifier, _.formatType, lskip), values2 = _.values || labelValues(scale2, count), domain2, fraction, size, offset2, ellipsis;
    ...
    if (type2 === SymbolLegend) {
      ...
      if (isFunction(size = _.size)) {
        ...
        size = constant$1(offset2 = size || 8);
      }
...
function padDomain(type2, domain2, range2, pad2, exponent, constant2) {
  var span2 = Math.abs(peek$1(range2) - range2[0]), frac = span2 / (span2 - 2 * pad2), d = type2 === Log ? zoomLog(domain2, null, frac) : type2 === Sqrt ? zoomPow(domain2, null, frac, 0.5) : type2 === Pow ? zoomPow(domain2, null, frac, exponent || 1) : type2 === Symlog ? zoomSymlog(domain2, null, frac, constant2 || 1) : zoomLinear(domain2, null, frac);
...
function domainCheck(type2, domain2, df) {
  if (isLogarithmic(type2)) {
    ...
    if (s !== domain2.length) {
      df.warn("Log scale domain includes zero: " + stringValue(domain2));
    }
  }
  return domain2;
}
function configureBins(scale2, _, count) {
  let bins = _.bins;
...
function configureRange(scale2, _, count) {
  var type2 = scale2.type, round = _.round || false, range2 = _.range;
  if (_.rangeStep != null) {
    range2 = configureRangeStep(type2, _, count);
  } else if (_.scheme) {
    range2 = configureScheme(type2, _, count);
...
function configureScheme(type2, _, count) {
  ...
  count = type2 === Threshold ? count + 1 : type2 === BinOrdinal ? count - 1 : type2 === Quantile || type2 === Quantize ? +_.schemeCount || DEFAULT_COUNT : count;
...
inherits(Heatmap, Transform, {
  transform(_, pulse2) {
    ...
    var source2 = pulse2.materialize(pulse2.SOURCE).source, shared = _.resolve === "shared", field2 = _.field || identity$2, opacity = opacity_(_.opacity, _), color2 = color_(_.color, _), as = _.as || "image", obj = {
      $x: 0,
      $y: 0,
      $value: 0,
    ...
    source2.forEach((t) => {
      ...
      if (!shared) o.$max = max$1(v.values || []);
      t[as] = toCanvas(v, o, color2.dep ? color2 : constant$1(color2(o)), opacity.dep ? opacity : constant$1(opacity(o)));
    });
    return pulse2.reflow(true).modifies(as);
  }
});
...
function setup(sim, _, init2, pulse2) {
  var f = array$2(_.forces), i, n, p, name;
...
inherits(Tree, HierarchyLayout, {
  ...
  layout(method2) {
    ...
    if (hasOwnProperty(Layouts, m2)) return Layouts[m2]();
...
inherits(Treemap, HierarchyLayout, {
  ...
  layout() {
    ...
    x2.method = (_) => {
      if (hasOwnProperty(Tiles, _)) x2.tile(Tiles[_]);
...
function baseBitmaps($, data2) {
  const bitmap = $.bitmap();
  (data2 || []).forEach((d) => bitmap.set($(d.boundary[0]), $(d.boundary[3])));
  return [bitmap, void 0];
}
function markBitmaps($, baseMark, avoidMarks, labelInside, isGroupArea) {
  const width2 = $.width, height2 = $.height, border = labelInside || isGroupArea, context2 = domCanvas(width2, height2).getContext("2d"), baseMarkContext = domCanvas(width2, height2).getContext("2d"), strokeContext = border && domCanvas(width2, height2).getContext("2d");
  avoidMarks.forEach((items) => draw(context2, items, false));
  draw(baseMarkContext, baseMark, false);
  if (border) {
    draw(strokeContext, baseMark, true);
  }
  const buffer = getBuffer(context2, width2, height2), baseMarkBuffer = getBuffer(baseMarkContext, width2, height2), strokeBuffer = border && getBuffer(strokeContext, width2, height2), layer1 = $.bitmap(), layer2 = border && $.bitmap();
...
function collision($, x2, y2, textHeight, textWidth, h2, bm0, bm1) {
  const w2 = textWidth * h2 / (textHeight * 2), x12 = $(x2 - w2), x22 = $(x2 + w2), y12 = $(y2 - (h2 = h2 / 2)), y22 = $(y2 + h2);
...
function placeAreaLabelReducedSearch($, bitmaps, avoidBaseMark, markIndex) {
  const width2 = $.width, height2 = $.height, bm0 = bitmaps[0], bm1 = bitmaps[1];
  function tryLabel(_x, _y, maxSize, textWidth, textHeight) {
    const x2 = $.invert(_x), y2 = $.invert(_y);
    let lo = maxSize, hi = height2, mid;
    if (!outOfBounds(x2, y2, textWidth, textHeight, width2, height2) && !collision($, x2, y2, textHeight, textWidth, lo, bm0, bm1) && !collision($, x2, y2, textHeight, textWidth, textHeight, bm0, null)) {
      while (hi - lo >= 1) {
        mid = (lo + hi) / 2;
        if (collision($, x2, y2, textHeight, textWidth, mid, bm0, bm1)) {
          hi = mid;
        } else {
          lo = mid;
        }
  ...
  return function(d) {
    ...
    for (let i = 0; i < n; ++i) {
      ...
      if (!labelPlaced && !avoidBaseMark) {
        ...
        x3 = (x12 + x2) / 2;
        y3 = (y12 + y2) / 2;
        if (areaWidth >= maxAreaWidth && !outOfBounds(x3, y3, textWidth, textHeight, width2, height2) && !collision($, x3, y3, textHeight, textWidth, textHeight, bm0, null)) {
          maxAreaWidth = areaWidth;
          d.x = x3;
          d.y = y3;
          labelPlaced2 = true;
    ...
    if (labelPlaced || labelPlaced2) {
      x3 = textWidth / 2;
      y3 = textHeight / 2;
      bm0.setRange($(d.x - x3), $(d.y - y3), $(d.x + x3), $(d.y + y3));
      d.align = "center";
      d.baseline = "middle";
      return true;
    } else {
...
function placeAreaLabelFloodFill($, bitmaps, avoidBaseMark, markIndex) {
  const width2 = $.width, height2 = $.height, bm0 = bitmaps[0], bm1 = bitmaps[1], bm2 = $.bitmap();
  return function(d) {
    ...
    for (let i = 0; i < n; ++i) {
      ...
      while (stack.length) {
        ...
        lo = maxSize;
        hi = height2;
        if (!outOfBounds(x3, y3, textWidth, textHeight, width2, height2) && !collision($, x3, y3, textHeight, textWidth, lo, bm0, bm1) && !collision($, x3, y3, textHeight, textWidth, textHeight, bm0, null)) {
          while (hi - lo >= 1) {
            mid = (lo + hi) / 2;
            if (collision($, x3, y3, textHeight, textWidth, mid, bm0, bm1)) {
              hi = mid;
            } else {
              lo = mid;
            }
...
function placeMarkLabel($, bitmaps, anchors, offsets2) {
  const width2 = $.width, height2 = $.height, bm0 = bitmaps[0], bm1 = bitmaps[1], n = offsets2.length;
  return function(d) {
...
function labelLayout(texts, size, compare2, offset2, anchor, avoidMarks, avoidBaseMark, lineAnchor, markIndex, padding2, method2) {
  ...
  const $ = scaler(size[0], size[1], padding2);
  let bitmaps;
  if (!isNaiveGroupArea) {
    if (compare2) {
    ...
    bitmaps = avoidMarks.length || baseMark ? markBitmaps($, baseMark || [], avoidMarks, labelInside, isGroupArea) : baseBitmaps($, avoidBaseMark && data2);
  }
  const place2 = isGroupArea ? placeAreaLabel[method2]($, bitmaps, avoidBaseMark, markIndex) : placeMarkLabel($, bitmaps, anchors, offsets2);
...
inherits(Regression, Transform, {
  transform(_, pulse2) {
    ...
    if (!this.value || pulse2.changed() || _.modified()) {
      ...
      if (!hasOwnProperty(Methods, method2)) {
...
function codegen(opt) {
  ...
  const Generators = {
    ...
    Identifier: (n) => {
      ...
      if (memberDepth > 0) {
        return id2;
      } else if (hasOwnProperty(forbidden, id2)) {
        return error("Illegal identifier: " + id2);
      } else if (hasOwnProperty(constants, id2)) {
        return constants[id2];
      } else if (hasOwnProperty(allowed, id2)) {
        return id2;
      } else {
        globals[id2] = 1;
    ...
    CallExpression: (n) => {
      ...
      const callee = n.callee.name, args = n.arguments, fn = hasOwnProperty(functions, callee) && functions[callee];
...
function selectionTest(name, datum2, op) {
  var data2 = this.context.data[name], entries = data2 ? data2.values.value : [], unitIdx = data2 ? data2[UNIT_INDEX] && data2[UNIT_INDEX].value : void 0, intersect2 = op === Intersect, n = entries.length, i = 0, entry2, miss, count, unit, b2;
  for (; i < n; ++i) {
    entry2 = entries[i];
...
function selectionTuples(array2, base) {
  ...
  return array2.map((x2) => extend(base.fields ? {
  ...
  for (; i < n; ++i) {
    ...
    if (fields && values2) {
      for (j = 0, m2 = fields.length; j < m2; ++j) {
        ...
        res[unit] = union2(resUnit, array$2(values2[j]));
      }
      if (isMulti) {
...
function selectionVisitor(name, args, scope, params2) {
  ...
  if (op === Intersect && !hasOwnProperty(params2, indexName)) {
    params2[indexName] = scope.getData(data2).indataRef(scope, field2);
  }
  if (!hasOwnProperty(params2, dataName)) {
...
function dataVisitor(name, args, scope, params2) {
  ...
  if (!hasOwnProperty(dataName, params2)) {
    try {
      params2[dataName] = scope.getData(data2).tuplesRef();
    } catch (err) {
    }
...
function indataVisitor(name, args, scope, params2) {
  ...
  if (!hasOwnProperty(indexName, params2)) {
    params2[indexName] = scope.getData(data2).indataRef(scope, field2);
  }
}
...
function addScaleDependency(scope, params2, name) {
  ...
  if (!hasOwnProperty(params2, scaleName)) {
    try {
...
function internalScaleFunctions(codegen2, fnctx, visitors) {
  ...
  const ref2 = (arg) => "_[" + (arg.type === Literal ? stringValue(ScalePrefix + arg.value) : stringValue(ScalePrefix) + "+" + codegen2(arg)) + "]";
  return {
...
function scaleGradient(scale2, p02, p1, count, group2) {
...
function filter(opt) {
  let p = null;
  if (opt) {
    const types = array$2(opt.marktype), names = array$2(opt.markname);
...
function lassoPath(lasso) {
  return array$2(lasso).reduce((svg, [x2, y2], i) => {
...
const codegenParams = {
  ...
  fieldvar: "datum",
  globalvar: (id2) => `_[${stringValue(SignalPrefix + id2)}]`,
...
function parser(expr2, scope) {
  ...
  let ast;
  try {
    expr2 = isString(expr2) ? expr2 : stringValue(expr2) + "";
    ast = parser$1(expr2);
  } catch (err) {
  ...
  gen.globals.forEach((name) => {
    ...
    if (!hasOwnProperty(params2, signalName) && scope.getSignal(name)) {
...
var expressionCodegen = {
  ...
  codegen: {
    get(path2) {
      const ref2 = `[${path2.map(stringValue).join("][")}]`;
...
function scale$1(name) {
  ...
  if (!hasOwnProperty(scales2, name)) {
...
function find(s, i, endChar, pushChar, popChar) {
  ...
  for (; i < n; ++i) {
    c2 = s[i];
    if (!count && c2 === endChar) return i;
    else if (popChar && popChar.includes(c2)) --count;
    else if (pushChar && pushChar.includes(c2)) ++count;
  }
  return i;
}
...
const scaleRef = (scale2) => isString(scale2) ? stringValue(scale2) : scale2.signal ? `(${scale2.signal})` : field(scale2);
function entry$1(enc) {
  if (enc.gradient != null) {
    return gradient(enc);
  }
  let value2 = enc.signal ? `(${enc.signal})` : enc.color ? color(enc.color) : enc.field != null ? field(enc.field) : enc.value !== void 0 ? stringValue(enc.value) : void 0;
  if (enc.scale != null) {
...
function resolveField(ref2) {
  ...
  if (ref2.signal) {
    ...
    error("Invalid field reference: " + stringValue(ref2));
  }
  if (!ref2.signal) {
    field2 = isString(field2) ? splitAccessPath(field2).map(stringValue).join("][") : resolveField(field2);
  }
...
function parseStream(stream2, scope) {
  const method2 = stream2.merge ? mergeStream : stream2.stream ? nestedStream : stream2.type ? eventStream : error("Invalid stream specification: " + stringValue(stream2));
...
function streamParameters(entry2, stream2, scope) {
  ...
  if (param2) {
    if (param2.length !== 2) {
      error('Stream "between" parameter must have 2 entries: ' + stringValue(stream2));
    }
...
function parseUpdate(spec, scope, target2) {
  ...
  if (encode2 != null) {
    ...
    update2 = "encode(item()," + stringValue(encode2) + ")";
  }
...
function initScale(spec, scope) {
  ...
  if (!isValidScaleType(type2)) {
    error("Unrecognized scale type: " + stringValue(type2));
  }
...
function parseScale(spec, scope) {
  ...
  for (key2 in spec) {
    if (hasOwnProperty(params2, key2) || key2 === "name") continue;
...
function fieldRef(data2, scope) {
  ...
  if (isArray(data2)) {
    ...
    const code = "setdata(" + stringValue(name) + "," + data2.signal + ")";
...
function parseScaleRange(spec, scope, params2) {
  ...
  if (range2.signal) {
    ...
    if (config && hasOwnProperty(config, range2)) {
      spec = extend({}, spec, {
        range: config[range2]
      });
      ...
      error("Unrecognized scale range value: " + stringValue(range2));
    }
    ...
    error("Unsupported range type: " + stringValue(range2));
  }
...
function parseParameter$1(_, name, scope) {
  return isArray(_) ? _.map((_2) => parseParameter$1(_2, name, scope)) : !isObject(_) ? _ : _.signal ? scope.signalRef(_.signal) : name === "fit" ? _ : error("Unsupported parameter object: " + stringValue(_));
}
const Top = "top";
const Left = "left";
const Right = "right";
...
function param(value2) {
  return isObject(value2) && value2.signal ? value2.signal : stringValue(value2);
}
...
function parseTransform(spec, scope) {
  ...
  if (!def2) error("Unrecognized transform type: " + stringValue(spec.type));
...
function parseParameter(def2, spec, scope) {
  ...
  if (type2 === "index") {
    ...
    if (def2.required) {
      error("Missing required " + stringValue(spec.type) + " parameter: " + stringValue(def2.name));
    }
    return;
  } else if (type2 === "param") {
...
function parseSubParameters(def2, spec, scope) {
  ...
  if (def2.array) {
    if (!isArray(value2)) {
      error("Expected an array of sub-parameters. Instead: " + stringValue(value2));
    }
...
function parseSubParameter(def2, value2, scope) {
  ...
  if (!pdef) error("Unsupported parameter: " + stringValue(value2));
...
const ifEnc = (test2, a2, b2) => {
  ...
  if (isSimple(a2) && isSimple(b2)) {
    a2 = a2 ? a2.signal || stringValue(a2.value) : null;
    b2 = b2 ? b2.signal || stringValue(b2.value) : null;
    return {
      signal: `${test2} ? (${a2}) : (${b2})`
    };
  } else {
...
function fallback(prop, config, axisConfig2, style2) {
  ...
  if (config && hasOwnProperty(config, prop)) {
    return config[prop];
  } else if (hasOwnProperty(axisConfig2, prop)) {
...
function collectSignals(spec, config) {
  ...
  array$2(config.signals).forEach((s) => {
    if (!hasOwnProperty(map2, s.name) && !hasOwnProperty(pre, s.name)) {
      signals.push(s);
    }
  });
  return signals;
...
Scope.prototype = Subscope.prototype = {
  ...
  fieldRef(field2, name) {
    ...
    if (!field2.signal) {
      error("Unsupported field reference: " + stringValue(field2));
    }
  ...
  compareRef(cmp) {
    ...
    const fields = array$2(cmp.field).map(check), orders = array$2(cmp.order).map(check);
...
function arrayLambda(array2) {
  ...
  for (let i = 0; i < n; ++i) {
    ...
    code += (i > 0 ? "," : "") + (isObject(value2) ? value2.signal || propertyLambda(value2) : stringValue(value2));
  }
  return code + "]";
}
function objectLambda(obj) {
  ...
  for (key2 in obj) {
    value2 = obj[key2];
    code += (++i > 1 ? "," : "") + stringValue(key2) + ":" + (isObject(value2) ? value2.signal || propertyLambda(value2) : stringValue(value2));
  }
  return code + "}";
}
function defaults() {
...
export {
  ...
  accessorName,
  array$2 as array,
  ascending$1 as ascending,
  estimateBandwidth as bandwidthNRD,
  bin,
  bootstrapCI,
  boundClip,
  boundContext,
  boundItem$1 as boundItem,
  boundMark,
  boundStroke,
  changeset,
  clampRange,
  ...
  formats$1 as formats,
  hasOwnProperty,
  id,
  identity$2 as identity,
  inferType,
  inferTypes,
  ingest$1 as ingest,
  inherits,
  ...
  interpolateColors,
  interpolateRange,
  intersect$2 as intersect,
  intersectBoxLine,
  intersectPath,
  intersectPoint,
  intersectRule,
  isArray,
  isBoolean$1 as isBoolean,
  isDate$1 as isDate,
  isFunction,
  isIterable,
