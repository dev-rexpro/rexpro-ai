const About = "Apie";
const Access = "";
const Account = "Paskyra";
const Action = "";
const Actions = "Veiksmai";
const Activate = "";
const Active = "Aktyvus";
const Activity = "";
const Add = "Pridėti";
const admin = "Administratorius";
const Admin = "Administratorius";
const Advanced = "";
const AI = "";
const All = "";
...
const Android = "";
const Anyone = "";
const April = "Balandis";
const Archive = "Archyvai";
const Artifacts = "";
const Asc = "";
const Ask = "";
const Assistant = "";
const Audio = "Audio įrašas";
const August = "Rugpjūtis";
const Auth = "";
const Authenticate = "";
...
const Calendar = "";
const Calendars = "";
const Call = "Skambinti";
const Camera = "Kamera";
const Cancel = "Atšaukti";
const Capabilities = "Gebėjimai";
const Capture = "";
const Channel = "";
const Channels = "";
const Character = "";
const Chat = "Pokalbis";
const chats = "";
const Chats = "Pokalbiai";
const Ciphers = "";
const Citation = "Citata";
const Citations = "";
const Clone = "Klonuoti";
...
const Configuration = "";
const Configure = "";
const Confirm = "Patvrtinti";
const Connections = "Ryšiai";
const Content = "Turinys";
const Controls = "Valdymas";
const Copied = "Nukopijuota";
const Copy = "Kopijuoti";
const CPU = "";
const Create = "";
const Custom = "Personalizuota";
const Daily = "";
const Dark = "Tamsus";
const Database = "Duomenų bazė";
const Day = "";
const December = "Gruodis";
const Deepgram = "";
const Default = "Numatytasis";
const Defaults = "";
const Delete = "ištrinti";
const Deleted = "";
const Desc = "";
...
const Dictate = "";
const Direct = "";
const Disabled = "Išjungta";
const Display = "";
const Docling = "";
const Document = "Dokumentas";
const Documentation = "Dokumentacija";
const Documents = "";
const Done = "Atlikta";
const Download = "Parsisiųsti";
const Draw = "";
const DuckDuckGo = "";
const Edit = "Redaguoti";
const edited = "";
const Edited = "";
const Editing = "";
const Eject = "";
...
const Exclude = "";
const Expand = "";
const Experimental = "Eksperimentinis";
const Explain = "";
const Explored = "";
const Exploring = "";
const Export = "Eksportuoti";
const External = "";
const Features = "";
const February = "Vasaris";
const Feedback = "";
const Female = "";
const File = "Rinkmena";
const Filename = "";
const Files = "Rinkmenos";
const Filter = "";
const Filters = "Filtrai";
const Folder = "";
const Folders = "";
const Form = "Forma";
const Forward = "";
...
const Gemini = "";
const Gender = "";
const General = "Bendri";
const Generate = "";
const Global = "Globalu";
const Google = "";
const Gravatar = "";
const Grid = "";
const Grokipedia = "";
...
const Integration = "";
const Integrations = "";
const Interface = "Sąsaja";
const Italic = "";
const January = "Sausis";
const July = "liepa";
const June = "birželis";
const Key = "";
const Knowledge = "Žinios";
const Label = "";
const Language = "Kalba";
const LDAP = "";
const Leaderboard = "";
const Legacy = "";
const lexical = "";
...
const Note = "";
const Notes = "";
const Notifications = "Pranešimai";
const November = "lapkritis";
const OAuth = "";
const October = "spalis";
const Off = "Išjungta";
const Ollama = "Ollama";
const On = "Aktyvuota";
const Once = "";
...
const Paginate = "";
const Parameters = "";
const Password = "Slaptažodis";
const Paused = "";
const pending = "laukiama";
const Pending = "";
const Permissions = "";
const Persistent = "";
const Personalization = "Personalizacija";
const Pin = "Smeigtukas";
const Pinned = "Įsmeigta";
const Pipe = "";
const Pipelines = "";
const Playground = "Eksperimentavimo erdvė";
const Port = "";
const Ports = "";
const Preview = "";
const Private = "";
const Profile = "Profilis";
const Prompt = "";
const Prompts = "Užklausos";
const Provider = "";
const Public = "";
const Querying = "";
const Rating = "";
...
const Record = "";
const Refresh = "";
const Regenerate = "Generuoti iš naujo";
const Registered = "";
const Reindex = "";
const Releases = "";
const Relevance = "";
const Reminder = "";
const Remove = "Pašalinti";
const Rename = "Pervadinti";
const Repeats = "";
const Reply = "";
const required = "";
const Reset = "Atkurti";
...
const Restart = "";
const Result = "";
const RESULT = "REZULTATAS";
const Retrieval = "";
const Role = "Rolė";
const RTL = "RTL";
const Run = "";
const Running = "Veikia";
const Sa_day_of_week = "";
const Save = "Išsaugoti";
const Saved = "";
const Schedule = "";
const Search = "Ieškoti";
const Searching = "";
const Seed = "Sėkla";
const Select = "";
const semantic = "";
const Send = "Siųsti";
const September = "rugsėjis";
const Session = "";
const Setting = "";
const Settings = "Nustatymai";
const Share = "Dalintis";
const Show = "Rodyti";
const Single = "";
const Skills = "";
const Sonar = "";
const Sort = "";
const Source = "Šaltinis";
const State = "";
const Status = "";
const Steps = "";
const Stop = "";
...
const Subtitle = "";
const Success = "Sėkmingai";
const Suggested = "Siūloma";
const Support = "Palaikyti";
const Sync = "";
...
const Unknown = "";
const Unmute = "";
const Unpin = "Atsemigti";
const Untagged = "";
const Untitled = "";
const Update = "Atnaujinti";
const Updated = "";
const Upload = "Atnaujinti";
const URL = "";
const Usage = "";
const Use = "";
const user = "naudotojas";
const User = "";
const Username = "";
const users = "";
const Users = "Naudotojai";
const Valves = "Įeitys";
const variable = "kintamasis";
...
const translation = {
  ...
  "(e.g. `sh rexpro.sh --api --api-auth username_password`)": "(pvz. `sh rexpro.sh --api --api-auth username_password`)",
  "(e.g. `sh rexpro.sh --api`)": "(pvz. `sh rexpro.sh --api`)",
  "(latest)": "(naujausias)",
  ...
  "{{rexproAIName}} Backend Required": "{{rexproAIName}} būtinas serveris",
  ...
  "Contact Admin for rexpro Access": "Susisiekite su administratoriumi dėl prieigos",
  Content,
  ...
  Inactive,
  Include,
  "Include `--api-auth` flag when running stable-diffusion-rexpro": "Įtraukti `--api-auth` flag when running stable-diffusion-rexpro",
  "Include `--api` flag when running stable-diffusion-rexpro": "Pridėti `--api` kai vykdomas stable-diffusion-rexpro",
  ...
  Low,
  LTR,
  "Made by rexpro-ai Community": "Sukurta rexpro-ai bendruomenės",
  ...
  "Oops! You're using an unsupported method (frontend only). Please serve the rexpro from the backend.": "Naudojate nepalaikomą (front-end) web ui rėžimą. Prašau serviruokite rexpro iš back-end",
  "Open file": "",
  "Open in full screen": "",
  "Open in new tab": "",
  "Open link": "",
  ...
  "rexpro-ai version": "",
  "rexpro-ai version (v{{OPEN_REXPRO_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "Tortue Chat versija per sena. Reikalinga (v{{REQUIRED_VERSION}}) versija.",
  OpenAI,
  ...
  "Redirecting you to rexpro-ai Community": "Perkeliam Jus į rexpro-ai bendruomenę",
  ...
  "Share to rexpro-ai Community": "Dalintis su rexpro-ai bendruomene",
  ...
  "To access the rexpro, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.": "Norėdami prieiti prie programos, susisiekite su administratoriumi, kuris Jus patvirtins.",
  ...
  Webhooks,
  "Webpage URLs": "",
  "rexpro Settings": "rexpro parametrai",
  "rexpro URL": "",
  ...
  Write,
  "Write a summary in 50 words that summarizes {{topic}}.": "Parašyk santrumpą trumpesnę nei 50 žodžių šiam tekstui: [tekstas]",
  "Write something...": "",
  ...
  "Your entire contribution will go directly to the plugin developer; rexpro-ai does not take any percentage. However, the chosen funding platform might have its own fees.": "Jūsų finansinis prisidėjimas tiesiogiai keliaus modulio kūrėjui.",
