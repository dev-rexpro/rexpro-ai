...
function mergeScaleConfig(config, options) {
  ...
  Object.keys(configScales).forEach((id) => {
    ...
    if (!isObject(scaleConf)) {
      return /* @__PURE__ */ console.error(`Invalid scale configuration for scale: ${id}`);
    }
    if (scaleConf._proxy) {
...
class Chart {
  ...
  constructor(item, userConfig) {
    ...
    if (!context || !canvas) {
      /* @__PURE__ */ console.error("Failed to create chart: can't acquire context from the given item");
      return;
    }
