...
const Action = "";
const Actions = "الإجراءات";
const Activate = "تفعيل";
const Active = "نشط";
const Activity = "";
const Add = "إضافة";
const admin = "المسؤول";
...
const Amazing = "رائع";
const Analytics = "";
const Analyzed = "تم التحليل";
const Android = "";
const Anyone = "";
const April = "أبريل";
const Archive = "أرشيف";
const Artifacts = "القطع الأثرية";
const Asc = "";
const Ask = "اسأل";
...
const August = "أغسطس";
const Auth = "";
const Authenticate = "توثيق";
const Authentication = "المصادقة";
const Auto = "";
const Automatic1111 = "Automatic1111 (أوتوماتيك 1111)";
const Automation = "";
const Automations = "";
const Away = "بعيد";
const Awful = "فظيع";
const Back = "عودة";
const Banners = "لافتات";
const Bearer = "";
const before = "قبل";
const Beta = "بيتا";
const Bing = "";
...
const Bold = "";
const Brave = "";
const Calendar = "التقويم";
const Calendars = "";
const Call = "مكالمة";
const Camera = "الكاميرا";
const Cancel = "إلغاء";
const Capabilities = "القدرات";
const Capture = "التقاط";
const Channel = "";
const Channels = "القنوات";
const Character = "الشخصية";
const Chat = "محادثة";
const chats = "";
const Chats = "المحادثات";
const Ciphers = "التشفيرات";
const Citation = "اقتباس";
const Citations = "";
const Clone = "استنساخ";
const Close = "إغلاق";
const cloud = "";
const Collapse = "طي";
const Collection = "المجموعة";
const Collections = "";
const Color = "اللون";
...
const Command = "الأمر";
const Comment = "";
const Completions = "الإكمالات";
const Config = "";
const Configuration = "";
const Configure = "تكوين";
const Confirm = "تأكيد";
const Connections = "الاتصالات";
const Content = "المحتوى";
const Controls = "الضوابط";
...
const Daily = "";
const Dark = "داكن";
const Database = "قاعدة البيانات";
const Day = "";
const December = "ديسمبر";
const Deepgram = "";
const Default = "افتراضي";
const Defaults = "";
const Delete = "حذف";
const Deleted = "";
const Desc = "";
const Description = "وصف";
const Deselect = "";
const Dictate = "";
const Direct = "";
const Disabled = "معطّل";
const Display = "العرض";
const Docling = "";
const Document = "المستند";
const Documentation = "التوثيق";
const Documents = "";
const Done = "تم";
...
const Ephemeral = "";
const ERROR = "خطأ";
const Evaluations = "التقييمات";
const Exclude = "استبعاد";
const Expand = "توسيع";
const Experimental = "تجريبي";
const Explain = "شرح";
const Explored = "";
const Exploring = "";
const Export = "تصدير";
const External = "";
const Features = "الميزات";
...
const Files = "الملفات";
const Filter = "";
const Filters = "الفلاتر";
const Folder = "";
const Folders = "";
const Form = "نموذج";
const Forward = "";
const Fr_day_of_week = "";
const Functions = "الوظائف";
const Gemini = "Gemini";
const Gender = "";
const General = "عام";
const Generate = "";
...
const Insert = "";
const Instructions = "";
const Integration = "التكامل";
const Integrations = "";
const Interface = "واجهه المستخدم";
const Italic = "";
const January = "يناير";
const July = "يوليو";
const June = "يونيو";
const Key = "المفتاح";
const Knowledge = "المعرفة";
const Label = "التسمية";
const Language = "اللغة";
const LDAP = "LDAP";
const Leaderboard = "لوحة المتصدرين";
const Legacy = "";
const lexical = "";
const License = "الترخيص";
const Light = "فاتح";
const List = "";
const Live = "";
const Loaded = "";
const Loader = "المحمّل";
const local = "";
const Local = "محلي";
const Location = "";
const Lost = "ضائع";
const Low = "";
const LTR = "من جهة اليسار إلى اليمين";
const Male = "";
const Manage = "إدارة";
const March = "مارس";
const Markdown = "";
...
const Note = "";
const Notes = "ملاحظات";
const Notifications = "إشعارات";
const November = "نوفمبر";
const OAuth = "";
const October = "اكتوبر";
const Off = "أغلاق";
const Ollama = "Ollama";
const On = "تشغيل";
const Once = "";
...
const Other = "آخر";
const Output = "";
const OUTPUT = "الإخراج";
const Overview = "نظرة عامة";
const page = "صفحة";
const Page = "";
const Paginate = "";
const Parameters = "";
const Password = "الباسورد";
const Paused = "";
const pending = "قيد الانتظار";
const Pending = "";
const Permissions = "الأذونات";
const Persistent = "";
const Personalization = "التخصيص";
const Pin = "تثبيت";
const Pinned = "مثبت";
const Pipe = "";
const Pipelines = "";
const Playground = "مكان التجربة";
const Port = "المنفذ";
const Ports = "";
const Preview = "";
const Private = "";
...
const Prompts = "مطالبات";
const Provider = "";
const Public = "";
const Querying = "";
const Rating = "التقييم";
const Read = "قراءة";
const Reason = "";
const Reconnected = "";
const Record = "";
const Refresh = "";
const Regenerate = "تجديد";
const Registered = "";
const Reindex = "";
const Releases = "";
const Relevance = "الصلة";
const Reminder = "";
const Remove = "إزالة";
...
const Responses = "";
const Restart = "";
const Result = "النتيجة";
const RESULT = "النتيجة";
const Retrieval = "الاسترجاع";
const Role = "منصب";
const RTL = "من اليمين إلى اليسار";
const Run = "تنفيذ";
const Running = "جارٍ التنفيذ";
...
const Tags = "";
const Tasks = "المهام";
const Temperature = "درجة حرارة";
const Terminal = "";
const Th_day_of_week = "";
const Theme = "الثيم";
const Thought = "";
const Thread = "سلسلة الرسائل";
const Tika = "Tika";
...
const Type = "نوع";
const UI = "واجهة المستخدم";
const Underline = "";
const Unknown = "";
const Unmute = "";
const Unpin = "إزالة التثبيت";
const Untagged = "بدون وسوم";
const Untitled = "";
const Update = "تحديث";
...
const Valves = "الصمامات";
const variable = "المتغير";
const Version = "إصدار";
const Visibility = "مستوى الظهور";
const Visible = "";
const Vision = "";
const Visual = "";
const Voice = "الصوت";
...
const translation = {
  ...
  "'s', 'm', 'h', 'd', 'w' or '-1' for no expiration.": "الحروف 's'، 'm'، 'h'، 'd'، 'w' أو '-1' لعدم انتهاء الصلاحية.",
  "(e.g. `sh rexpro.sh --api --api-auth username_password`)": "(مثال: `sh rexpro.sh --api --api-auth اسم_المستخدم_كلمة_المرور`)",
  "(e.g. `sh rexpro.sh --api`)": "(مثال: تشغيل الأمر: `sh rexpro.sh --api`)",
  "(latest)": "(أحدث)",
  ...
  "{{rexproAIName}} Backend Required": "يتطلب الخلفية الخاصة بـ {{rexproAIName}}",
  ...
  "A task model is used when performing tasks such as generating titles for chats and web search queries": "يُستخدم نموذج المهام عند تنفيذ مهام مثل توليد عناوين المحادثات واستعلامات البحث على الويب",
  "a user": "مستخدم",
  About,
  ...
  "Add a tag...": "",
  "Add Access": "",
  "Add Arena Model": "إضافة نموذج الساحة",
  ...
  Archive,
  "Archive All": "",
  "Archive All Chats": "أرشفة جميع المحادثات",
  "Archived Chats": "المحادثات المؤرشفة",
  "archived-chat-export": "تصدير المحادثات المؤرشفة",
  ...
  Automatic1111,
  "AUTOMATIC1111 Api Auth String": "سلسلة توثيق API لـ AUTOMATIC1111",
  ...
  "Clear status": "",
  "click here": "انقر هنا",
  "Click here for filter guides.": "انقر هنا للحصول على أدلة الفلاتر.",
  "Click here for help.": "انقر هنا للمساعدة.",
  "Click here to": "انقر هنا لـ",
  "Click here to download user import template file.": "انقر هنا لتنزيل ملف قالب استيراد المستخدم.",
  "Click here to learn more about faster-whisper and see the available models.": "انقر هنا لمعرفة المزيد عن faster-whisper ورؤية النماذج المتاحة.",
  "Click here to see available models.": "انقر هنا لرؤية النماذج المتاحة.",
  "Click here to select": "انقر هنا للاختيار",
  "Click here to select a csv file.": "انقر هنا لاختيار ملف CSV.",
  "Click here to select a py file.": "انقر هنا لاختيار ملف PY.",
  ...
  "Code Execution Timeout": "مهلة تنفيذ الشيفرة",
  "Code formatted successfully": "تم تنسيق الشيفرة بنجاح",
  "Code Interpreter": "مفسر الشيفرة",
  "Code Interpreter Engine": "محرك مفسر الشيفرة",
  "Code Interpreter Prompt Template": "قالب موجه مفسر الشيفرة",
  ...
  Color,
  ComfyUI,
  "ComfyUI API Key": "مفتاح API لـ ComfyUI",
  "ComfyUI Base URL": "عنوان الأساس لـ ComfyUI",
  ...
  "Contact Admin for rexpro Access": "اتصل بالمسؤول للوصول إلى واجهة الويب",
  Content,
  ...
  "CORS must be properly configured by the provider to allow requests from rexpro-ai.": "يجب أن يتم تكوين CORS بشكل صحيح من قبل المزود للسماح بالطلبات من rexpro-ai.",
  "Could not read file.": "",
  CPU,
  Create,
  ...
  "Default permissions updated successfully": "تم تحديث الأذونات الافتراضية بنجاح",
  ...
  "Discover how to use rexpro-ai and seek support from the community.": "اكتشف كيفية استخدام rexpro-ai واطلب الدعم من المجتمع.",
  ...
  ElevenLabs,
  Email,
  "Embark on adventures": "انطلق في مغامرات",
  Embedding,
  ...
  "Enter Bing Search V7 Endpoint": "أدخل نقطة نهاية Bing Search V7",
  "Enter Bing Search V7 Subscription Key": "أدخل مفتاح اشتراك Bing Search V7",
  "Enter Bocha Search API Key": "أدخل مفتاح API لـ Bocha Search",
  "Enter Brave Search API Key": "أدخل مفتاح واجهة برمجة تطبيقات البحث الشجاع",
  "Enter certificate path": "أدخل مسار الشهادة",
  ...
  "Enter Jupyter URL": "أدخل عنوان Jupyter",
  ...
  "Enter SearchApi API Key": "أدخل مفتاح API لـ SearchApi",
  "Enter SearchApi Engine": "أدخل محرك SearchApi",
  "Enter Searxng Query URL": "أدخل عنوان URL لاستعلام Searxng",
  "Enter Searxng search language": "",
  "Enter Seed": "أدخل القيمة الابتدائية (Seed)",
  "Enter SerpApi API Key": "أدخل مفتاح API لـ SerpApi",
  "Enter SerpApi Engine": "أدخل محرك SerpApi",
  "Enter Serper API Key": "أدخل مفتاح واجهة برمجة تطبيقات Serper",
  "Enter Serply API Key": "أدخل مفتاح API لـ Serply",
  ...
  "Enter the public URL of your rexpro. This URL will be used to generate links in the notifications.": "أدخل الرابط العلني لـ rexpro الخاص بك. سيتم استخدام هذا الرابط لإنشاء روابط داخل الإشعارات.",
  ...
  "Example: sAMAccountName or uid or userPrincipalName": "مثال: sAMAccountName أو uid أو userPrincipalName",
  ...
  "Function created successfully": "تم إنشاء الوظيفة بنجاح",
  ...
  "Get started with {{REXPRO_NAME}}": "ابدأ باستخدام {{REXPRO_NAME}}",
  Global,
  ...
  Inactive,
  Include,
  "Include `--api-auth` flag when running stable-diffusion-rexpro": "أضف الخيار `--api-auth` عند تشغيل stable-diffusion-rexpro",
  "Include `--api` flag when running stable-diffusion-rexpro": "قم بتضمين علامة `-api` عند تشغيل Stable-diffusion-rexpro",
  ...
  "Kokoro.js Dtype": "نوع بيانات Kokoro.js",
  Label,
  ...
  Low,
  LTR,
  "Made by rexpro-ai Community": "rexpro-ai تم إنشاؤه بواسطة مجتمع ",
  ...
  "Ollama API settings updated": "تم تحديث إعدادات واجهة Ollama API",
  ...
  "Oops! There are files still uploading. Please wait for the upload to complete.": "عذرًا! لا تزال بعض الملفات قيد الرفع. يرجى الانتظار حتى يكتمل الرفع.",
  "Oops! There was an error in the previous response.": "عذرًا! حدث خطأ في الرد السابق.",
  "Oops! You're using an unsupported method (frontend only). Please serve the rexpro from the backend.": "خطاء! أنت تستخدم طريقة غير مدعومة (الواجهة الأمامية فقط). يرجى تقديم واجهة rexpro من الواجهة الخلفية.",
  "Open file": "فتح الملف",
  ...
  "rexpro-ai uses faster-whisper internally.": "تستخدم واجهة rexpro أداة faster-whisper داخليًا.",
  "rexpro-ai uses SpeechT5 and CMU Arctic speaker embeddings.": "تستخدم rexpro نموذج SpeechT5 وتضمينات صوتية من CMU Arctic.",
  "rexpro-ai version": "",
  "rexpro-ai version (v{{OPEN_REXPRO_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "إصدار rexpro الحالي (v{{OPEN_REXPRO_VERSION}}) أقل من الإصدار المطلوب (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "Redirecting you to rexpro-ai Community": "rexpro-ai إعادة توجيهك إلى مجتمع ",
  ...
  "SearchApi API Key": "مفتاح API لـ SearchApi",
  "SearchApi Engine": "محرك SearchApi",
  ...
  "Send now": "",
  "Sends `stream_options: { include_usage: true }` in the request.\nSupported providers will return token usage information in the response when set.": "يرسل `stream_options: { include_usage: true }` في الطلب.\nالمزودون المدعومون سيُرجعون معلومات استخدام الرموز في الاستجابة عند التفعيل.",
  September,
  "SerpApi API Key": "مفتاح API لـ SerpApi",
  "SerpApi Engine": "محرك SerpApi",
  ...
  "Set as Production": "",
  "Set embedding model": "تعيين نموذج التضمين",
  ...
  "Set the number of layers, which will be off-loaded to GPU. Increasing this value can significantly improve performance for models that are optimized for GPU acceleration but may also consume more power and GPU resources.": "تعيين عدد الطبقات التي سيتم تفريغها إلى وحدة معالجة الرسومات (GPU). زيادتها قد تحسن الأداء بشكل كبير، لكنها تستهلك طاقة وموارد GPU أكثر.",
  ...
  "Set Voice": "ضبط الصوت",
  "Set whisper model": "تعيين نموذج Whisper",
  "Set your status": "",
  ...
  "Sets how far back for the model to look back to prevent repetition.": "يحدد مدى رجوع النموذج إلى الوراء لتجنب التكرار.",
  "Sets the random number seed to use for generation. Setting this to a specific number will make the model generate the same text for the same prompt.": "يحدد البذرة العشوائية لاستخدامها في التوليد. تعيين قيمة معينة يجعل النموذج ينتج نفس النص لنفس التوجيه.",
  "Sets the size of the context window used to generate the next token.": "يحدد حجم نافذة السياق المستخدمة لتوليد الرمز التالي.",
  ...
  "Share to rexpro-ai Community": "rexpro-ai شارك في مجتمع",
  ...
  "Sign in to {{REXPRO_NAME}}": "سجّل الدخول إلى {{REXPRO_NAME}}",
  "Sign in to {{REXPRO_NAME}} with LDAP": "سجّل الدخول إلى {{REXPRO_NAME}} باستخدام LDAP",
  "Sign Out": "تسجيل الخروج",
  "Sign up": "تسجيل",
  "Sign up to {{REXPRO_NAME}}": "سجّل في {{REXPRO_NAME}}",
  ...
  "Signing in to {{REXPRO_NAME}}": "جارٍ تسجيل الدخول إلى {{REXPRO_NAME}}",
  Single,
  "Sink List": "",
  "sk-1234": "sk-1234",
  ...
  "To access the rexpro, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.": "للوصول إلى واجهة rexpro، يُرجى التواصل مع المسؤول. يمكن للمسؤولين إدارة حالة المستخدمين من لوحة الإدارة.",
  ...
  "Tool deleted successfully": "تم حذف الأداة بنجاح",
  ...
  "Updated At": "تم التحديث في",
  "Upgrade to a licensed plan for enhanced capabilities, including custom theming and branding, and dedicated support.": "قم بالترقية إلى خطة مرخصة للحصول على ميزات إضافية، مثل التخصيص والدعم المخصص.",
  Upload,
  ...
  "Web Search Query Generation": "توليد استعلام بحث الويب",
  "Webhook Name": "",
  "Webhook URL": "Webhook الرابط",
  Webhooks,
  "Webpage URLs": "",
  "rexpro Settings": "rexpro اعدادات",
  "rexpro URL": "رابط rexpro",
  'rexpro will make requests to "{{url}}"': "",
  'rexpro will make requests to "{{url}}/api/chat"': 'ستقوم rexpro بإرسال الطلبات إلى "{{url}}/api/chat"',
  'rexpro will make requests to "{{url}}/chat/completions"': 'ستقوم rexpro بإرسال الطلبات إلى "{{url}}/chat/completions"',
  Week,
  Weekly,
  ...
  Write,
  "Write a summary in 50 words that summarizes {{topic}}.": "اكتب ملخصًا في 50 كلمة يلخص [الموضوع أو الكلمة الرئيسية]",
  ...
  "Your entire contribution will go directly to the plugin developer; rexpro-ai does not take any percentage. However, the chosen funding platform might have its own fees.": "سيتم توجيه كامل مساهمتك مباشرة إلى مطور المكون الإضافي؛ لا تأخذ rexpro-ai أي نسبة. ومع ذلك، قد تفرض منصة التمويل المختارة رسومًا خاصة بها.",
