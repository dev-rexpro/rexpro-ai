const About = "ھەققىدە";
const Access = "زىيارەت";
const Account = "ھېسابات";
const Action = "";
const Actions = "ھەرىكەتلەر";
const Activate = "ئاكتىپلاش";
const Active = "ئاكتىپ";
const Activity = "";
const Add = "قوشۇش";
const admin = "باشقۇرغۇچى";
const Admin = "باشقۇرغۇچى";
const Advanced = "";
const AI = "";
const All = "ھەممىسى";
const Always = "ھەمىشە";
const Amazing = "ئاجايىپ";
const Analytics = "";
const Analyzed = "تەھلىل قىلىندى";
const Android = "Android";
const Anyone = "";
const April = "ئاپرىل";
const Archive = "ئارخىپلاش";
const Artifacts = "ئۇزۇقلار";
const Asc = "";
const Ask = "سوراڭ";
const Assistant = "ياردەمچى";
const Audio = "ئاۋاز";
const August = "ئاۋغۇست";
const Auth = "تەستىقلاش";
const Authenticate = "دەلىللەش";
const Authentication = "كىرىش دەلىللەش";
const Auto = "ئاپتوماتىك";
...
const Bold = "";
const Brave = "";
const Calendar = "كالىندار";
const Calendars = "";
const Call = "چاقىرىش";
const Camera = "كامېرا";
const Cancel = "بىكار قىلىش";
const Capabilities = "ئىقتىدارلار";
const Capture = "رەسىم تارتقۇزۇش";
const Channel = "";
const Channels = "قاناللار";
const Character = "ھەرپ";
const Chat = "سۆھبەت";
const chats = "";
const Chats = "سۆھبەتلەر";
const Ciphers = "شىفىرلار";
const Citation = "نەقىل";
const Citations = "نەقىللەر";
const Clone = "كۆچۈرۈش";
const Close = "يېپىش";
const cloud = "";
const Collapse = "يىغىش";
const Collection = "توپلام";
const Collections = "";
const Color = "رەڭ";
const ComfyUI = "ComfyUI";
const command = "";
const Command = "بۇيرۇق";
const Comment = "";
const Completions = "تولۇقلىنىشلار";
const Config = "";
const Configuration = "";
const Configure = "تەڭشەك";
const Confirm = "جەزملەش";
const Connections = "ئۇلىنىشلەر";
const Content = "مەزمۇن";
const Controls = "باشقۇرۇش";
const Copied = "كۆچۈرۈلدى";
const Copy = "كۆچۈرۈش";
const CPU = "";
const Create = "قۇرۇش";
const Custom = "ئۆزلۈك";
const Daily = "";
const Dark = "قاراڭغۇ";
const Database = "ساندان";
const Day = "";
const December = "دېكابىر";
const Deepgram = "";
const Default = "كۆڭۈلدىكى";
const Defaults = "";
const Delete = "ئۆچۈرۈش";
const Deleted = "";
const Desc = "";
const Description = "چۈشەندۈرۈش";
const Deselect = "";
const Dictate = "سۆزلەش";
const Direct = "بىۋاسىتە";
const Disabled = "چەكلەنگەن";
const Display = "كۆرسىتىش";
const Docling = "Docling";
const Document = "ھۆججەت";
const Documentation = "ئىشلەتكۈچى قوللانمىسى";
const Documents = "";
const Done = "تامام";
const Download = "چۈشۈرۈش";
const Draw = "سىزىش";
const DuckDuckGo = "";
const Edit = "تەھرىرلەش";
const edited = "";
const Edited = "";
const Editing = "";
const Eject = "چىقىرىش";
...
const Email = "ئېلخەت";
const Embedding = "سىڭدۈرۈش";
const Emoji = "";
const Emojis = "";
const Enabled = "قوزغىتىلغان";
const Enhance = "ياخشىلا";
const Ephemeral = "";
const ERROR = "خاتالىق";
const Evaluations = "باھالاشلار";
const Exclude = "چىقىرىۋېتىش";
const Expand = "كېڭەيتىش";
const Experimental = "تەجىربىلىك";
const Explain = "چۈشەندۈرۈش";
const Explored = "";
const Exploring = "";
const Export = "چىقىرىش";
const External = "سىرتقى";
const Features = "ئىقتىدارلار";
const February = "فېۋرال";
const Feedback = "";
const Female = "";
const File = "ھۆججەت";
const Filename = "";
const Files = "ھۆججەتلەر";
const Filter = "";
const Filters = "سۈزگۈچلەر";
const Folder = "";
const Folders = "";
const Form = "جەدۋەل";
const Forward = "";
const Fr_day_of_week = "";
const Functions = "فۇنكسىيەلەر";
const Gemini = "Gemini";
const Gender = "";
const General = "ئادەتتىكى";
const Generate = "ھاسىل قىلىش";
const Global = "ئۇمۇمىي";
const Google = "";
const Gravatar = "";
const Grid = "";
const Grokipedia = "";
const groups = "";
const Groups = "گۇرۇپپىلار";
const H1 = "";
const H2 = "";
const H3 = "";
const Headers = "";
...
const History = "";
const Home = "باش بەت";
const Host = "مۇلازىمېتىر";
const Hourly = "";
const HTML = "HTML";
const ID = "ID";
const Image = "رەسىم";
const Images = "";
const Import = "ئىمپورت قىلىش";
const Inactive = "";
const Include = "ئىچكىرى قىل";
const Info = "ئۇچۇر";
const Initials = "";
const Input = "";
const Insert = "";
const Instructions = "";
const Integration = "بىرىكتۈرۈش";
const Integrations = "";
const Interface = "يۈز";
const Italic = "";
const January = "يانۋار";
const July = "ئىيۇل";
const June = "ئىيۇن";
const Key = "ئاچقۇچ";
const Knowledge = "بىلىم";
const Label = "بەلگە";
const Language = "تىل";
const LDAP = "LDAP";
const Leaderboard = "توردىكى رېتىڭ";
const Legacy = "";
const lexical = "";
const License = "كېنىشكا";
const Light = "نۇر";
const List = "";
const Live = "";
const Loaded = "";
const Loader = "يۈكلىگۈچ";
const local = "";
const Local = "يەرلىك";
const Location = "";
const Lost = "يوقاپ كەتتى";
const Low = "";
const LTR = "LTR (سولدىن ئوڭغا)";
const Male = "";
const Manage = "باشقۇرۇش";
const March = "مارت";
...
const Model = "مودېل";
const Models = "مودېللار";
const Mojeek = "";
const Month = "";
const Monthly = "";
const More = "تېخىمۇ كۆپ";
const Move = "";
const Mute = "";
const Muted = "";
const Name = "ئات";
...
const Note = "";
const Notes = "خاتىرە";
const Notifications = "ئۇقتۇرۇشلار";
const November = "نويابىر";
const OAuth = "";
const October = "ئۆكتەبىر";
const Off = "تاقالغان";
const Ollama = "Ollama";
const On = "قوزغىتىلغان";
const Once = "";
...
const Other = "باشقا";
const Output = "";
const OUTPUT = "چىقىرىش";
const Overview = "قىسقىچە تونۇشتۇرۇش";
const page = "بەت";
const Page = "";
const Paginate = "بەتلەش";
const Parameters = "پارامېتىرلار";
const Password = "پارول";
const Paused = "";
const pending = "كۈتۈۋاتىدۇ";
const Pending = "كۈتۈۋاتىدۇ";
const Permissions = "ھوقۇق";
const Persistent = "";
const Personalization = "شەخسىيلاشتۇرۇش";
const Pin = "مۇقىملا";
const Pinned = "مۇقىملاندى";
const Pipe = "";
const Pipelines = "";
const Playground = "تەجربىخانا";
const Port = "ئېغىز";
const Ports = "";
const Preview = "ئالدىن كۆرۈش";
const Private = "شەخسىي";
const Profile = "پروفايل";
const Prompt = "تۈرتكە";
const Prompts = "تۈرتكەلەر";
const Provider = "";
const Public = "ئاممىۋى";
const Querying = "";
const Rating = "باھا";
const Read = "ئوقۇش";
const Reason = "سەۋەب";
const Reconnected = "";
const Record = "خاتىرىلەش";
const Refresh = "";
const Regenerate = "قايتا ھاسىل قىلىش";
const Registered = "";
const Reindex = "قايتا ئىندېكسلاش";
const Releases = "نەشرلەر";
const Relevance = "مۇناسىۋەتلىكلىك";
const Reminder = "";
const Remove = "چىقىرىۋېتىش";
const Rename = "ئات ئۆزگەرتىش";
const Repeats = "";
const Reply = "";
const required = "";
const Reset = "قايتا تەڭشەش";
const Response = "";
const Responses = "";
const Restart = "";
const Result = "نەتىجە";
const RESULT = "نەتىجە";
const Retrieval = "قايتۇرۇش";
const Role = "رول";
const RTL = "RTL (ئوڭدىن سولغا)";
const Run = "ئىجرا قىلىش";
const Running = "ئىجرا قىلىنىۋاتىدۇ";
const Sa_day_of_week = "";
const Save = "ساقلاش";
const Saved = "ساقلاندى";
const Schedule = "";
const Search = "ئىزدەش";
const Searching = "";
const Seed = "ئۇرۇق";
...
const semantic = "";
const Send = "يوللاش";
const September = "سېنتەبىر";
const Session = "";
const Setting = "";
const Settings = "تەڭشەك";
const Share = "ھەمبەھىرلەش";
const Show = "كۆرسىتىش";
const Single = "";
const Skills = "";
const Sonar = "";
...
const Subtitle = "";
const Success = "مۇۋەپپەقىيەت";
const Suggested = "تەكلىپلەر";
const Support = "ياردەم";
const Sync = "";
const System = "سىستېما";
const Tag = "";
const Tags = "تەغلەر";
const Tasks = "ۋەزىپىلەر";
const Temperature = "تېمپېراتۇرا";
const Terminal = "";
...
const tokens = "";
const Tokens = "";
const Tools = "قوراللار";
const Top = "";
const Transformers = "Transformers";
const Tu_day_of_week = "";
const Type = "تىپى";
const UI = "UI (كۆرۈنمە يۈز)";
const Underline = "";
const Unknown = "";
const Unmute = "";
const Unpin = "مۇقىملانمىغان قىلىش";
const Untagged = "تەغسىز";
const Untitled = "تېماسىز";
const Update = "يېڭىلاش";
const Updated = "يېڭىلاندى";
const Upload = "چىقىرىش";
const URL = "URL";
const Usage = "ئىشلىتىش";
const Use = "";
const user = "ئىشلەتكۈچى";
const User = "ئىشلەتكۈچى";
const Username = "ئىشلەتكۈچى نامى";
const users = "";
const Users = "ئىشلەتكۈچىلەر";
const Valves = "كرانلار";
const variable = "ئۆزگەرگۈچ";
const Version = "نەشر";
const Visibility = "كۆرۈنۈشچانلىق";
const Visible = "";
const Vision = "كۆرۈش";
const Visual = "";
const Voice = "ئاۋاز";
const Warning = "ئاگاھلاندۇرۇش";
...
const Wikipedia = "";
const Won = "ئۇتتى";
const Workspace = "ئىشخانا";
const Write = "يېزىش";
const Yahoo = "";
const Yandex = "";
const Yesterday = "تۈنۈگۈن";
const You = "سىز";
...
const translation = {
  ...
  "(e.g. `sh rexpro.sh --api --api-auth username_password`)": "(مەسىلەن: `sh rexpro.sh --api --api-auth username_password`)",
  "(e.g. `sh rexpro.sh --api`)": "(مەسىلەن: `sh rexpro.sh --api`)",
  "(latest)": "(ئەڭ يېڭىسى)",
  ...
  "{{rexproAIName}} Backend Required": "{{rexproAIName}} ئارقا سۇپا زۆرۈر",
  ...
  "Contact Admin for rexpro Access": "rexpro كىرىش ئۈچۈن باشقۇرغۇچى بىلەن ئالاقىلىشىڭ",
  Content,
  ...
  "CORS must be properly configured by the provider to allow requests from rexpro-ai.": "rexpro-aiنىڭ تەلىپكە ئىجازەت بېرىش ئۈچۈن CORS توغرا تەڭشىلىشى كېرەك.",
  "Could not read file.": "",
  CPU,
  Create,
  ...
  "Discover how to use rexpro-ai and seek support from the community.": "rexpro-ai ئىشلىتىشنى ئۈگىنڭ ۋە جەمئىيەتتىن ياردەم سوراڭ.",
  ...
  "Enter the public URL of your rexpro. This URL will be used to generate links in the notifications.": "rexpro نىڭ ئاممىۋى URL نى كىرگۈزۈڭ. بۇ URL ئۇقتۇرۇشتىكى ئۇلانما قۇرۇشقا ئىشلىتىلىدۇ.",
  ...
  "Get started": "باشلاڭ",
  "Get started with {{REXPRO_NAME}}": "{{REXPRO_NAME}} بىلەن باشلاڭ",
  Global,
  ...
  Inactive,
  Include,
  "Include `--api-auth` flag when running stable-diffusion-rexpro": "stable-diffusion-rexpro قوزغىتىشتا `--api-auth` بەلگىسىنى ئىشلىتىڭ",
  "Include `--api` flag when running stable-diffusion-rexpro": "stable-diffusion-rexpro قوزغىتىشتا `--api` بەلگىسىنى ئىشلىتىڭ",
  ...
  Low,
  LTR,
  "Made by rexpro-ai Community": "rexpro-ai جەمئىيىتى تەرىپىدىن قۇرۇلغان",
  ...
  "Oops! You're using an unsupported method (frontend only). Please serve the rexpro from the backend.": "قوللىمايدىغان ئۇسۇل ئىشلىتىلدى (پەقەت ئالدى كۆرۈنۈش). rexpro نى ئارقا سۇپىدىن قوزغىتىڭ.",
  ...
  "rexpro-ai can use tools provided by any OpenAPI server.": "rexpro-ai ھەر قانداق OpenAPI مۇلازىمېتىرلىرىدىكى قوراللارنى ئىشلىتەلىدۇ.",
  "rexpro-ai uses faster-whisper internally.": "rexpro-ai ئىچىدە faster-whisper ئىشلىتىدۇ.",
  "rexpro-ai uses SpeechT5 and CMU Arctic speaker embeddings.": "rexpro-ai SpeechT5 ۋە CMU Arctic ئاۋاز سىڭدۈرۈش ئىشلىتىدۇ.",
  "rexpro-ai version": "",
  "rexpro-ai version (v{{OPEN_REXPRO_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "rexpro-ai نەشرى (v{{OPEN_REXPRO_VERSION}}) تەلەپ قىلىنغان نەشردىن (v{{REQUIRED_VERSION}}) تۆۋەن.",
  OpenAI,
  ...
  "Redirecting you to rexpro-ai Community": "rexpro-ai جەمئىيىتىگە يوللاندى",
  ...
  "Share to rexpro-ai Community": "rexpro-ai جەمئىيىتىگە ھەمبەھىرلەش",
  ...
  "Sign in": "كىرىش",
  "Sign in to {{REXPRO_NAME}}": "{{REXPRO_NAME}} غا كىرىش",
  "Sign in to {{REXPRO_NAME}} with LDAP": "LDAP ئارقىلىق {{REXPRO_NAME}} غا كىرىش",
  "Sign Out": "چىقىش",
  "Sign up": "تىزىملىتىش",
  "Sign up to {{REXPRO_NAME}}": "{{REXPRO_NAME}} غا تىزىملىتىش",
  ...
  "Signing in to {{REXPRO_NAME}}": "{{REXPRO_NAME}} غا كىرىۋاتىدۇ",
  Single,
  "Sink List": "",
  "sk-1234": "sk-1234",
  ...
  "To access the rexpro, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.": "rexpro زىيارىتى ئۈچۈن باشقۇرغۇچى بىلەن ئالاقىلىشىڭ. باشقۇرغۇچى باشقۇرغۇچى تاختىسىدىن ئىشلەتكۈچى ھالىتىنى باشقۇرالايدۇ.",
  ...
  Webhooks,
  "Webpage URLs": "",
  "rexpro Settings": "rexpro تەڭشەكلىرى",
  "rexpro URL": "rexpro URL",
  'rexpro will make requests to "{{url}}"': 'rexpro "{{url}}" غا تەلەپ يوللايدۇ',
  'rexpro will make requests to "{{url}}/api/chat"': 'rexpro "{{url}}/api/chat" غا تەلەپ يوللايدۇ',
  'rexpro will make requests to "{{url}}/chat/completions"': 'rexpro "{{url}}/chat/completions" غا تەلەپ يوللايدۇ',
  Week,
  Weekly,
  ...
  Write,
  "Write a summary in 50 words that summarizes {{topic}}.": "50 سۆز بىلەن [تېما ياكى ئاچقۇچلۇق سۆز] نى خاتىرىلەڭ.",
