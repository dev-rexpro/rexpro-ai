import "./DKem_M_z.js";
import "./DwLkIEu4.js";
import { t as template_effect, a as append, B as from_svg, p as push, o as onMount, k as get, w as set, l as legacy_pre_effect, m as deep_read_state, n as legacy_pre_effect_reset, c as child, u as untrack, r as reset, y as event, b as pop, q as mutable_source, A as tick, f as from_html, aW as text, i as getContext, z as sibling, g as comment, h as first_child, d as set_text, bc as invalid_default_snippet, x as derived_safe_equal, e as store_get, s as setup_stores } from "./B-Kw_l3V.js";
import { s as set_attribute, a as set_class, c as clsx, d as set_style, r as remove_input_defaults } from "./B9yCN616.js";
...
import { j as emojiShortCodes, s as settings } from "./yPwV6Diw.js";
import { u as updateUserSettings } from "./kcGva0gj.js";
...
var root$1 = from_html(`<svelte-virtual-list-row><!></svelte-virtual-list-row>`, 2);
var root_1$1 = from_html(`<svelte-virtual-list-viewport><svelte-virtual-list-contents></svelte-virtual-list-contents></svelte-virtual-list-viewport>`, 2);
function VirtualList($$anchor, $$props) {
  ...
  init();
  var svelte_virtual_list_viewport = root_1$1();
  ...
  each(svelte_virtual_list_contents, 5, () => get(visible), (row) => row.index, ($$anchor2, row) => {
    var svelte_virtual_list_row = root$1();
...
var root = from_html(`<div class="text-center text-xs text-gray-500 dark:text-gray-400"> </div>`);
var root_1 = from_html(`<div class="text-xs font-medium -mb-1 text-gray-500 dark:text-gray-400"> </div>`);
var root_2 = from_html(`<button><img class="size-5" loading="lazy"/></button>`);
var root_3 = from_html(`<div class="flex items-center gap-1.5 w-full"></div>`);
var root_4 = from_html(`<div class="w-full mb-2.5"><!></div>`);
var root_5 = from_html(`<div class="w-full flex ml-0.5"><!></div>`);
var root_6 = from_html(`<div slot="content"><div class="max-w-full w-80 border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-850 rounded-3xl z-9999 shadow-lg dark:text-white"><div class="mb-1 px-4 pt-2.5 pb-2"><input type="text" class="w-full text-sm bg-transparent outline-hidden"/></div> <div class="w-full flex justify-start h-96 overflow-y-auto px-3 pb-3 text-sm"><!></div></div></div>`);
function EmojiPicker($$anchor, $$props) {
  push($$props, false);
  const $settings = () => store_get(settings, "$settings", $$stores);
  const $i18n = () => store_get(i18n, "$i18n", $$stores);
  const [$$stores, $$cleanup] = setup_stores();
  const recentEmojiNames = mutable_source();
  const i18n = getContext("i18n");
  let onClose = prop($$props, "onClose", 8, () => {
  });
  let onSubmit = prop($$props, "onSubmit", 8, (name) => {
  });
  prop($$props, "side", 8, "top");
  ...
  function saveRecentEmoji(emojiName) {
    const updated = [
      emojiName,
      ...get(recentEmojiNames).filter((n) => n !== emojiName)
    ].slice(0, MAX_RECENT);
  ...
  legacy_pre_effect(() => ($settings(), emojiShortCodes), () => {
    var _a;
    set(recentEmojiNames, (((_a = $settings()) == null ? void 0 : _a.recentEmojis) ?? []).filter((name) => emojiShortCodes[name]).slice(0, MAX_RECENT));
  });
  ...
  legacy_pre_effect(
    () => (get(flattenedEmojis), get(search), get(recentEmojiNames), $i18n(), get(emojis), get(emojiRows)),
    () => {
      set(flattenedEmojis, []);
      if (!get(search) && get(recentEmojiNames).length > 0) {
        get(flattenedEmojis).push({ type: "group", label: $i18n().t("Recently Used") });
        get(flattenedEmojis).push(...get(recentEmojiNames).map((emoji) => ({
          type: "emoji",
          name: emoji,
                ...
                default: ($$anchor4, $$slotProps2) => {
                  ...
                  var node_3 = child(div_6);
                  {
                    ...
                    var alternate = ($$anchor5) => {
                      var div_8 = root_3();
                      each(div_8, 5, () => get(item), index, ($$anchor6, emojiItem) => {
                        {
                          ...
                          Tooltip($$anchor6, {
                            ...
                            children: ($$anchor7, $$slotProps3) => {
                              ...
                              template_effect(
                                ($02) => {
                                  set_class(button, 1, `p-1.5 rounded-lg cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-700 transition ${(deep_read_state(selected()), get(emojiItem), untrack(() => selected() === get(emojiItem).shortCodes[0] ? "bg-gray-200 dark:bg-gray-700" : "")) ?? ""}`);
                                  set_attribute(img, "src", `${REXPRO_BASE_URL}/assets/emojis/${$02 ?? ""}.svg`);
