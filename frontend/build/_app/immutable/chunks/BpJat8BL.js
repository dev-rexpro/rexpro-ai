const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./DzbHtpBg.js","./BeGenu0j.js","../assets/leaflet.DvTUgzRd.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./CQrtv1eE.js";
import "./DKem_M_z.js";
import "./DwLkIEu4.js";
import { p as push, o as onMount, k as get, j as onDestroy, c as child, w as set, r as reset, a as append, b as pop, q as mutable_source, f as from_html } from "./B-Kw_l3V.js";
...
function MapSelector($$anchor, $$props) {
  ...
  onMount(async () => {
    const [{ default: L }] = await Promise.all([__vitePreload(() => import("./DzbHtpBg.js").then((n) => n.l), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url), __vitePreload(() => Promise.resolve({}), true ? __vite__mapDeps([2]) : void 0, import.meta.url)]);
  ...
  onDestroy(async () => {
    if (map) {
      /* @__PURE__ */ console.log("Unloading Leaflet map.");
      map.remove();
    }
  });
  init();
