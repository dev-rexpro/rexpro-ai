...
const Access = "Adgang";
const Account = "Profil";
const Action = "Handling";
const Actions = "Handlinger";
const Activate = "Aktiver";
const Active = "Aktiv";
const Activity = "";
const Add = "Tilføj";
...
const All = "Alle";
const Always = "Altid";
const Amazing = "Fantastisk";
const Analytics = "Analytics";
const Analyzed = "Analyseret";
const Android = "Android";
const Anyone = "";
const April = "April";
const Archive = "Arkiv";
const Artifacts = "Artifakter";
const Asc = "";
const Ask = "Spørg";
...
const August = "august";
const Auth = "Auth";
const Authenticate = "Autentificer";
const Authentication = "Autentifikation";
const Auto = "Auto";
const Automatic1111 = "Automatic1111";
const Automation = "";
const Automations = "";
const Away = "Fraværende";
const Awful = "Forfærdeligt";
const Back = "Tilbage";
const Banners = "Bannere";
const Bearer = "Bearer";
const before = "før";
const Beta = "Beta";
const Bing = "";
...
const Capture = "Tag billede eller screendump";
const Channel = "Kanal";
const Channels = "Kanaler";
const Character = "Karakterer";
const Chat = "Chat";
const chats = "";
const Chats = "Chats";
const Ciphers = "Ciphers";
const Citation = "Citat";
const Citations = "Citater";
const Clone = "Klon";
const Close = "Luk";
const cloud = "cloud";
const Collapse = "Kollapse";
...
const Config = "";
const Configuration = "";
const Configure = "Konfigurer";
const Confirm = "Bekræft";
const Connections = "Forbindelser";
const Content = "Indhold";
const Controls = "Indstillinger";
const Copied = "Kopieret";
const Copy = "Kopier";
const CPU = "";
const Create = "Opret";
const Custom = "Brugerdefineret";
const Daily = "";
const Dark = "Mørk";
...
const Deselect = "";
const Dictate = "Dikter";
const Direct = "Direkte";
const Disabled = "Deaktiveret";
const Display = "Vis";
...
const DuckDuckGo = "";
const Edit = "Rediger";
const edited = "redigeret";
const Edited = "Redigeret";
const Editing = "Redigerer";
const Eject = "Skub ud";
...
const Emoji = "";
const Emojis = "";
const Enabled = "Aktiveret";
const Enhance = "Forbedre";
const Ephemeral = "";
const ERROR = "FEJL";
const Evaluations = "Evalueringer";
const Exclude = "Ekskluder";
const Expand = "Udvid";
const Experimental = "Eksperimentel";
const Explain = "Forklar";
const Explored = "";
const Exploring = "";
const Export = "Eksportér";
const External = "Ekstern";
...
const Interface = "Grænseflade";
const Italic = "Kursiv";
const January = "Januar";
const July = "Juli";
const June = "Juni";
const Key = "Nøgle";
const Knowledge = "Viden";
const Label = "Label";
const Language = "Sprog";
const LDAP = "LDAP";
const Leaderboard = "Lederboard";
const Legacy = "Legacy";
const lexical = "leksikalsk";
...
const Medium = "Medium";
const members = "";
const Members = "Medlemmer";
const Memories = "";
const Memory = "Hukommelse";
const Message = "Besked";
const messages = "";
const Messages = "";
const min = "";
const MinerU = "MinerU";
...
const optional = "";
const Optional = "Valgfri";
const or = "eller";
const Other = "Andet";
const Output = "";
const OUTPUT = "OUTPUT";
const Overview = "Oversigt";
const page = "side";
const Page = "";
const Paginate = "Paginering";
const Parameters = "Parametre";
const Password = "Adgangskode";
const Paused = "";
const pending = "afventer";
const Pending = "Afventer";
const Permissions = "Tilladelser";
const Persistent = "";
const Personalization = "Personalisering";
const Pin = "Fastgør";
const Pinned = "Fastgjort";
const Pipe = "Pipe";
const Pipelines = "";
const Playground = "Legeplads";
const Port = "Port";
const Ports = "";
const Preview = "Forhåndsvisning";
...
const Record = "Optag";
const Refresh = "";
const Regenerate = "Regenerer";
const Registered = "Registreret";
const Reindex = "Genindekser";
const Releases = "Udgivelser";
...
const Setting = "Indstilling";
const Settings = "Indstillinger";
const Share = "Del";
const Show = "Vis";
const Single = "";
const Skills = "";
...
const Stop = "Stop";
const Storage = "";
const Strikethrough = "Gennemstreget";
const Su_day_of_week = "";
const Subtitle = "Undertekst";
const Success = "Succes";
const Suggested = "Foreslået";
...
const tokens = "";
const Tokens = "";
const Tools = "Værktøjer";
const Top = "";
const Transformers = "Transformers";
const Tu_day_of_week = "";
const Type = "Type";
const UI = "UI";
const Underline = "Understreget";
const Unknown = "Ukendt";
const Unmute = "";
const Unpin = "Frigør";
const Untagged = "Uden mærker";
const Untitled = "Unavngivet";
const Update = "Opdater";
const Updated = "Opdateret";
const Upload = "Upload";
const URL = "URL";
const Usage = "Forbrug";
const Use = "";
...
const Wikipedia = "";
const Won = "Vandt";
const Workspace = "Arbejdsområde";
const Write = "Skriv";
const Yahoo = "";
const Yandex = "";
const Yesterday = "I går";
const You = "Du";
...
const translation = {
  ...
  "(e.g. `sh rexpro.sh --api --api-auth username_password`)": "(f.eks. `sh rexpro.sh --api --api-auth username_password`)",
  "(e.g. `sh rexpro.sh --api`)": "(f.eks. `sh rexpro.sh --api`)",
  "(latest)": "(seneste)",
  ...
  "{{rexproAIName}} Backend Required": "{{rexproAIName}} Backend kræves",
  ...
  "Advanced parameters for MinerU parsing (enable_ocr, enable_formula, enable_table, language, model_version, page_ranges)": "Avancerede parametre for MinerU parsing (enable_ocr, enable_formula, enable_table, language, model_version, page_ranges)",
  "Advanced Params": "Avancerede indstillinger",
  'After updating or changing the embedding model, you must reindex the knowledge base for the changes to take effect. You can do this using the "Reindex" button below.': 'Efter opdatering eller ændring af embedding modellen skal du genindeksere vidensbanken for at ændringer tager effekt. Du kan gøre dette ved at benytte "Genindekser"-knappen nedenfor.',
  AI,
  All,
  ...
  "Contact Admin for rexpro Access": "Kontakt din administrator for adgang til rexpro",
  Content,
  ...
  "CORS must be properly configured by the provider to allow requests from rexpro-ai.": "CORS skal være korrekt konfigureret af udbyderen for at tillade anmodninger fra rexpro-ai.",
  "Could not read file.": "",
  CPU,
  Create,
  ...
  "Discover how to use rexpro-ai and seek support from the community.": "Opdag hvordan du bruger rexpro-ai og søg støtte fra fællesskabet.",
  ...
  "Enter the public URL of your rexpro. This URL will be used to generate links in the notifications.": "Indtast den offentlige URL til dit rexpro. Denne URL vil blive brugt til at generere links i notifikationerne.",
  ...
  "Format the lines in the output. Defaults to False. If set to True, the lines will be formatted to detect inline math and styles.": "Formatér linjerne i outputtet. Standardværdi er False. Hvis denne er sat til True vil linjerne blive formateret til at opdage inline matematik og styling.",
  ...
  "Get started with {{REXPRO_NAME}}": "Kom i gang med {{REXPRO_NAME}}",
  Global,
  ...
  Inactive,
  Include,
  "Include `--api-auth` flag when running stable-diffusion-rexpro": "Inkluder `--api-auth` flag, når du kører stable-diffusion-rexpro",
  "Include `--api` flag when running stable-diffusion-rexpro": "Inkluder `--api` flag, når du kører stable-diffusion-rexpro",
  ...
  "Leave empty to use the default model (voxtral-mini-latest).": "Lad stå tomt for at bruge standardmodel (voxtral-mini-latest).",
  ...
  Low,
  LTR,
  "Made by rexpro-ai Community": "Lavet af rexpro-ai Community",
  ...
  MBR,
  MCP,
  "MCP support is experimental and its specification changes often, which can lead to incompatibilities. OpenAPI specification support is directly maintained by the rexpro-ai team, making it the more reliable option for compatibility.": "MCP understøttelse er eksperimentel og dens specifikationer ændres ofte hvilket kan medføre inkompatibilitet. OpenAI specifikationsunderstøttelse er vedligeholdt af rexpro-ai-teamet hvilket gør det til den mest pålidelige mulighed for understøttelse.",
  Medium,
  ...
  min,
  MinerU,
  "MinerU API Key required for Cloud API mode.": "MinerU API nøgle påkrævet for Cloud API tilstand.",
  ...
  "Model name already exists, please choose a different one": "Modelnavn findes allerede, vælg venligst et andet",
  ...
  "Oops! You're using an unsupported method (frontend only). Please serve the rexpro from the backend.": "Ups! Du bruger en metode, der ikke understøttes (kun frontend). Kør rexpro fra backend.",
  "Open file": "Åbn fil",
  "Open in full screen": "Åbn i fuld skærm",
  "Open in new tab": "",
  "Open link": "Åbn link",
  "Open modal to configure connection": "Åbn modal for at konfigurere forbindelse",
  "Open Modal To Manage Floating Quick Actions": "Åbn modal for at styre flydende hurtig-handlinger",
  ...
  "rexpro-ai can use tools provided by any OpenAPI server.": "rexpro-ai kan bruge værktøjer leveret af enhver OpenAPI server.",
  "rexpro-ai uses faster-whisper internally.": "rexpro-ai bruger faster-whisper internt.",
  "rexpro-ai uses SpeechT5 and CMU Arctic speaker embeddings.": "rexpro-ai bruger SpeechT5 og CMU Arctic taler embeddings.",
  "rexpro-ai version": "",
  "rexpro-ai version (v{{OPEN_REXPRO_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "rexpro-ai-version (v{{OPEN_REXPRO_VERSION}}) er lavere end den krævede version (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "Redirecting you to rexpro-ai Community": "Omdirigerer dig til rexpro-ai Community",
  ...
  "Share to rexpro-ai Community": "Del til rexpro-ai Community",
  ...
  "Sign in": "Log ind",
  "Sign in to {{REXPRO_NAME}}": "Log ind på {{REXPRO_NAME}}",
  "Sign in to {{REXPRO_NAME}} with LDAP": "Log ind på {{REXPRO_NAME}} med LDAP",
  "Sign Out": "Log ud",
  "Sign up": "Tilmeld dig",
  "Sign up to {{REXPRO_NAME}}": "Tilmeld dig {{REXPRO_NAME}}",
  "Significantly improves accuracy by using an LLM to enhance tables, forms, inline math, and layout detection. Will increase latency. Defaults to False.": "Forbedrer nøjagtigheden signifikant ved at bruge en LLM til at forbedre tabeller, formularer, indlejret matematik og layoutdetektion. Vil øje ventetid. Standard er False.",
  "Signing in to {{REXPRO_NAME}}": "Logger ind på {{REXPRO_NAME}}",
  Single,
  ...
  "The passwords you entered don't quite match. Please double-check and try again.": "De indtastede passwords du har angivet stemmer ikke overens. Dobbeltjek og prøv igen.",
  "The score should be a value between 0.0 (0%) and 1.0 (100%).": "Scoren skal være en værdi mellem 0,0 (0%) og 1,0 (100%).",
  "The stream delta chunk size for the model. Increasing the chunk size will make the model respond with larger pieces of text at once.": "Stream delta chunk størrelsen for modellen. Hvis du øger denne vil modellen svare med større tekstsvar af gangen.",
  ...
  "The Weight of BM25 Hybrid Search. 0 more semantic, 1 more lexical. Default 0.5": "Vægten af BM25 Hybrid Search. 0 er mere semantisk, 1 mere leksikalt. Standard er 0.5",
  ...
  "To access the rexpro, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.": "For at få adgang til rexpro skal du kontakte administratoren. Administratorer kan administrere brugerstatus fra administrationspanelet.",
  ...
  "Try adjusting your search or filter to find what you are looking for.": "Prøv at justere din søgning eller dit filter for at finde det du leder efter.",
  "Try Again": "Prøv igen",
  "TTS Model": "TTS-model",
  ...
  "Use /v1/chat/completions endpoint instead of /v1/audio/transcriptions for potentially better accuracy.": "Brug /v1/chat/completions endpointet i stedet for /v1/audio/transcriptions for potentielt øget nøjagtighed.",
  ...
  Webhooks,
  "Webpage URLs": "",
  "rexpro Settings": "rexpro-indstillinger",
  "rexpro URL": "rexpro URL",
  'rexpro will make requests to "{{url}}"': 'rexpro vil lave forespørgsler til "{{url}}"',
  'rexpro will make requests to "{{url}}/api/chat"': 'rexpro vil lave forespørgsler til "{{url}}/api/chat"',
  'rexpro will make requests to "{{url}}/chat/completions"': 'rexpro vil lave forespørgsler til "{{url}}/chat/completions"',
  Week,
  Weekly,
  ...
  Write,
  "Write a summary in 50 words that summarizes {{topic}}.": "Skriv en opsummering på 50 ord, der opsummerer [emne eller søgeord].",
  ...
  "You do not have permission to send messages in this channel.": "Du har ikke tilladelse til at sende beskeder i denne kanal.",
  "You do not have permission to send messages in this thread.": "Du har ikke tilladelse til at sende beskeder i denne tråd.",
