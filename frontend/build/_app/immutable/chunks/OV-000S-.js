const About = "درباره";
const Access = "دسترسی";
const Account = "حساب کاربری";
const Action = "عملیات";
const Actions = "کنش‌ها";
const Activate = "فعال کردن";
const Active = "فعال";
const Activity = "";
...
const All = "همه";
const Always = "همیشه";
const Amazing = "شگفت‌انگیز";
const Analytics = "تحلیل و بررسی";
const Analyzed = "تحلیل شده";
const Android = "اندروید";
const Anyone = "";
const April = "آوریل";
const Archive = "بایگانی";
const Artifacts = "مصنوعات";
const Asc = "";
const Ask = "بپرس";
const Assistant = "دستیار";
const Audio = "صدا";
const August = "آگوست";
const Auth = "احراز هویت";
const Authenticate = "احراز هویت";
const Authentication = "احراز هویت";
const Auto = "خودکار";
const Automatic1111 = "اتوماتیک1111";
const Automation = "";
const Automations = "";
const Away = "غایب";
const Awful = "وحشتناک";
...
const Bold = "ضخیم";
const Brave = "";
const Calendar = "تقویم";
const Calendars = "";
const Call = "تماس";
const Camera = "دوربین";
const Cancel = "لغو";
const Capabilities = "قابلیت";
const Capture = "ضبط";
const Channel = "کانال";
const Channels = "کانال‌ها";
const Character = "شخصیت";
const Chat = "گفتگو";
const chats = "";
const Chats = "گفتگو‌ها";
const Ciphers = "رمزها";
const Citation = "استناد";
const Citations = "ارجاعات";
const Clone = "کلون";
const Close = "بسته";
const cloud = "ابری";
const Collapse = "جمع کردن";
const Collection = "مجموعه";
const Collections = "";
const Color = "رنگ";
const ComfyUI = "کومیوآی";
const command = "";
const Command = "دستور";
const Comment = "نظر";
const Completions = "تکمیل‌ها";
const Config = "";
const Configuration = "";
const Configure = "پیکربندی";
const Confirm = "تایید";
const Connections = "ارتباطات";
const Content = "محتوا";
const Controls = "کنترل‌ها";
const Copied = "کپی شد";
const Copy = "کپی";
const CPU = "";
const Create = "ایجاد";
...
const Daily = "";
const Dark = "تیره";
const Database = "پایگاه داده";
const Day = "";
const December = "دسامبر";
const Deepgram = "دیپ‌گرام";
const Default = "پیشفرض";
const Defaults = "";
const Delete = "حذف";
const Deleted = "";
const Desc = "";
...
const Deselect = "";
const Dictate = "دیکته کردن";
const Direct = "مستقیم";
const Disabled = "غیرفعال";
const Display = "نمایش";
const Docling = "داکلینگ";
const Document = "سند";
const Documentation = "مستندات";
const Documents = "";
const Done = "انجام شد";
const Download = "دانلود کن";
const Draw = "رسم کردن";
const DuckDuckGo = "";
const Edit = "ویرایش";
const edited = "ویرایش شد";
const Edited = "ویرایش شده";
const Editing = "در حال ویرایش";
const Eject = "خارج کردن";
const ElevenLabs = "الون‌لبز";
const Email = "ایمیل";
const Embedding = "پیدائش";
const Emoji = "";
const Emojis = "";
const Enabled = "فعال شده";
const Enhance = "بهبود";
const Ephemeral = "";
const ERROR = "خطا";
const Evaluations = "ارزیابی‌ها";
const Exclude = "مستثنی کردن";
const Expand = "گسترش";
const Experimental = "آزمایشی";
const Explain = "توضیح";
const Explored = "";
const Exploring = "";
const Export = "خروجی گرفتن";
const External = "خارجی";
const Features = "ویژگی‌ها";
const February = "فوریه";
const Feedback = "";
const Female = "زن";
const File = "پرونده";
const Filename = "";
const Files = "پرونده‌ها";
const Filter = "فیلتر";
const Filters = "فیلترها";
const Folder = "پوشه";
const Folders = "پوشه‌ها";
const Form = "فرم";
const Forward = "";
const Fr_day_of_week = "";
const Functions = "توابع";
const Gemini = "جمینی";
const Gender = "جنسیت";
const General = "عمومی";
const Generate = "تولید";
const Global = "سراسری";
const Google = "";
const Gravatar = "گراواتار";
const Grid = "";
const Grokipedia = "";
const groups = "";
const Groups = "گروه‌ها";
const H1 = "H1";
const H2 = "H2";
const H3 = "H3";
const Headers = "هدرها";
...
const Image = "تصویر";
const Images = "";
const Import = "وارد کردن";
const Inactive = "";
const Include = "شامل";
const Info = "اطلاعات";
const Initials = "حروف اول";
const Input = "ورودی";
const Insert = "درج";
const Instructions = "";
const Integration = "یکپارچه‌سازی";
const Integrations = "یکپارچه‌سازی‌ها";
const Interface = "رابط";
const Italic = "ایتالیک";
const January = "ژانویه";
const July = "ژوئن";
const June = "جولای";
const Key = "کلید";
const Knowledge = "دانش";
const Label = "برچسب";
const Language = "زبان";
const LDAP = "LDAP";
const Leaderboard = "تابلوی امتیازات";
const Legacy = "قدیمی";
const lexical = "لغوی";
const License = "مجوز";
const Light = "روشن";
...
const None = "هیچ کدام";
const Note = "یادداشت";
const Notes = "یادداشت‌ها";
const Notifications = "اعلان";
const November = "نوامبر";
const OAuth = "OAuth";
const October = "اکتبر";
const Off = "خاموش";
const Ollama = "Ollama";
...
const Output = "";
const OUTPUT = "خروجی";
const Overview = "نمای کلی";
const page = "صفحه";
const Page = "";
const Paginate = "صفحه‌بندی";
const Parameters = "پارامترها";
const Password = "رمز عبور";
const Paused = "";
const pending = "در انتظار";
const Pending = "در انتظار";
const Permissions = "مجوزها";
const Persistent = "";
const Personalization = "شخصی سازی";
const Pin = "پین کردن";
const Pinned = "پین شده";
const Pipe = "خط لوله";
const Pipelines = "";
const Playground = "زمین بازی";
const Port = "پورت";
const Ports = "";
const Preview = "پیش‌نمایش";
const Private = "خصوصی";
const Profile = "پروفایل";
const Prompt = "پرامپت";
const Prompts = "پرامپت‌ها";
const Provider = "";
const Public = "عمومی";
const Querying = "در حال پرس‌وجو";
const Rating = "امتیازدهی";
const Read = "خواندن";
const Reason = "دلیل";
const Reconnected = "";
const Record = "ضبط";
const Refresh = "";
const Regenerate = "تولید مجدد";
const Registered = "ثبت شده";
const Reindex = "فهرست‌بندی مجدد";
const Releases = "انتشارها";
const Relevance = "ارتباط";
const Reminder = "";
const Remove = "حذف";
const Rename = "تغییر نام";
const Repeats = "";
const Reply = "پاسخ";
const required = "مورد نیاز";
const Reset = "بازنشانی";
const Response = "پاسخ";
const Responses = "";
const Restart = "";
const Result = "نتیجه";
const RESULT = "نتیجه";
const Retrieval = "بازیابی";
const Role = "نقش";
const RTL = "RTL";
const Run = "اجرا";
const Running = "در حال اجرا";
const Sa_day_of_week = "";
const Save = "ذخیره";
const Saved = "ذخیره شد";
const Schedule = "";
const Search = "جستجو";
const Searching = "در حال جستجو";
const Seed = "هسته";
const Select = "انتخاب";
const semantic = "معنایی";
const Send = "ارسال";
const September = "سپتامبر";
const Session = "جلسه";
const Setting = "";
const Settings = "تنظیمات";
const Share = "اشتراک‌گذاری";
const Show = "نمایش";
const Single = "";
const Skills = "";
const Sonar = "سونار";
...
const Stop = "توقف";
const Storage = "";
const Strikethrough = "خط خورده";
const Su_day_of_week = "";
const Subtitle = "";
const Success = "موفقیت";
const Suggested = "پیشنهادی";
const Support = "حمایت";
const Sync = "";
const System = "سیستم";
const Tag = "تگ";
...
const Tools = "ابزارها";
const Top = "";
const Transformers = "ترنسفورمرها";
const Tu_day_of_week = "";
const Type = "نوع";
const UI = "رابط کاربری";
const Underline = "زیر خط";
const Unknown = "ناشناخته";
const Unmute = "";
const Unpin = "برداشتن پین";
const Untagged = "بدون برچسب";
const Untitled = "بدون عنوان";
const Update = "به‌روزرسانی";
const Updated = "بارگذاری شد";
const Upload = "بارگذاری";
const URL = "آدرس اینترنتی";
const Usage = "استفاده";
const Use = "";
const user = "کاربر";
const User = "کاربر";
...
const Users = "کاربران";
const Valves = "شیرها";
const variable = "متغیر";
const Version = "نسخه";
const Visibility = "قابلیت مشاهده";
const Visible = "";
const Vision = "بینایی";
const Visual = "";
const Voice = "صوت";
...
const Wikipedia = "";
const Won = "برنده شد";
const Workspace = "محیط کار";
const Write = "نوشتن";
const Yahoo = "";
const Yandex = "";
const Yesterday = "دیروز";
const You = "شما";
const YouTube = "یوتیوب";
const translation = {
  ...
  "(e.g. `sh rexpro.sh --api --api-auth username_password`)": "(مثال: `sh rexpro.sh --api --api-auth username_password`)",
  "(e.g. `sh rexpro.sh --api`)": "(e.g. `sh rexpro.sh --api`)",
  "(latest)": "(آخرین)",
  ...
  "{{rexproAIName}} Backend Required": "بکند {{rexproAIName}} نیاز است.",
  ...
  "Allow Chat Export": "مجاز کردن خروجی گرفتن از چت",
  "Allow Chat Params": "مجاز کردن پارامترهای چت",
  "Allow Chat Share": "مجاز کردن اشتراک‌گذاری چت",
  "Allow Chat System Prompt": "مجاز کردن پرامپت سیستمی چت",
  "Allow Chat Valves": "مجاز کردن دریچه‌های چت",
  "Allow Continue Response": "مجاز کردن ادامه پاسخ",
  "Allow Delete Messages": "مجاز کردن حذف پیام‌ها",
  ...
  "Allow Rate Response": "مجاز کردن امتیازدهی به پاسخ",
  "Allow Regenerate Response": "مجاز کردن بازتولید پاسخ",
  ...
  "Allowed file extensions for upload. Separate multiple extensions with commas. Leave empty for all file types.": "پسوندهای فایل مجاز برای آپلود. چندین پسوند را با کاما از هم جدا کنید. برای همه انواع فایل‌ها خالی بگذارید.",
  ...
  "Chat History": "",
  "Chat ID": "شناسه چت",
  "Chat moved successfully": "چت با موفقیت منتقل شد",
  ...
  "Close Configure Connection Modal": "بستن مودال پیکربندی اتصال",
  "Close feedback": "",
  "Close modal": "بستن مودال",
  "Close Modal": "بستن مودال",
  "Close settings modal": "بستن مودال تنظیمات",
  "Close Sidebar": "بستن نوار کناری",
  cloud,
  "CMU ARCTIC speaker embedding name": "نام جاسازی بلندگوی CMU ARCTIC",
  "Code Block": "بلاک کد",
  ...
  "Confirm Your Password": "تأیید رمز عبور",
  ...
  "Connections settings updated": "تنظیمات اتصال به‌روز شد",
  ...
  "Contact Admin for rexpro Access": "برای دسترسی به rexpro با مدیر تماس بگیرید",
  Content,
  ...
  "Conversation saved successfully": "مکالمه با موفقیت ذخیره شد",
  Copied,
  "Copied link to clipboard": "لینک در کلیپ‌بورد کپی شد",
  "Copied shared chat URL to clipboard!": "URL چت به کلیپ بورد کپی شد!",
  "Copied to clipboard": "به بریده‌دان کپی‌شد",
  Copy,
  "Copy API Key": "",
  "Copy content": "",
  "Copy Formatted Text": "کپی متن قالب‌بندی شده",
  "Copy Last Code Block": "کپی آخرین بلاک کد",
  ...
  "CORS must be properly configured by the provider to allow requests from rexpro-ai.": "CORS باید توسط ارائه‌دهنده به درستی پیکربندی شود تا درخواست‌ها از rexpro-ai مجاز باشند.",
  "Could not read file.": "",
  CPU,
  Create,
  ...
  "Created by you": "ایجاد شده توسط شما",
  "Created on {{date}}": "",
  ...
  Custom,
  "Custom color": "",
  "Custom description enabled": "توضیحات سفارشی فعال شد",
  "Custom Gender": "",
  ...
  "Default action buttons will be used.": "دکمه‌های اقدام پیش‌فرض استفاده خواهند شد.",
  "Default description enabled": "توضیحات پیش‌فرض فعال شد",
  "Default Features": "ویژگی‌های پیش‌فرض",
  "Default Filters": "فیلترهای پیش‌فرض",
  "Default Group": "",
  ...
  "Discover how to use rexpro-ai and seek support from the community.": "نحوه استفاده از rexpro-ai را کشف کنید و از انجمن پشتیبانی بگیرید.",
  ...
  "Document Intelligence endpoint required.": "نقطه پایانی هوش سند مورد نیاز است.",
  ...
  "e.g. pdf, docx, txt": "مثلاً pdf, docx, txt",
  ...
  "e.g., 3, 4, 5 (leave blank for default)": "مثلاً ۳، ۴، ۵ (برای پیش‌فرض خالی بگذارید)",
  "e.g., audio/wav,audio/mpeg,video/* (leave blank for defaults)": "مثلاً audio/wav,audio/mpeg,video/* (برای پیش‌فرض‌ها خالی بگذارید)",
  "e.g., en-US,ja-JP (leave blank for auto-detect)": "مثلا en-US,ja-JP (برای تشخیص خودکار خالی بگذارید)",
  "e.g., westus (leave blank for eastus)": "مثلاً westus (برای eastus خالی بگذارید)",
  Edit,
  ...
  "Edit Last Message": "ویرایش آخرین پیام",
  "Edit Memory": "ویرایش حافظه",
  "Edit Prompt": "",
  "Edit Terminal Connection": "",
  "Edit User": "ویرایش کاربر",
  "Edit User Group": "ویرایش گروه کاربری",
  "Edit workflow.json content": "ویرایش محتوای workflow.json",
  edited,
  Edited,
  Editing,
  Eject,
  ...
  "Enter a title for the pending user info overlay. Leave empty for default.": "یک عنوان برای پوشش اطلاعات کاربر در حال انتظار وارد کنید. برای پیش‌فرض خالی بگذارید.",
  "Enter a watermark for the response. Leave empty for none.": "یک واترمارک برای پاسخ وارد کنید. برای هیچ‌کدام خالی بگذارید.",
  "Enter additional headers in JSON format": "هدرهای اضافی را در قالب JSON وارد کنید",
  'Enter additional headers in JSON format (e.g. {"X-Custom-Header": "value"}': "",
  "Enter additional parameters in JSON format": "پارامترهای اضافی را در قالب JSON وارد کنید",
  ...
  "Enter External Web Loader API Key": "کلید API بارگذار وب خارجی را وارد کنید",
  "Enter External Web Loader URL": "آدرس URL بارگذار وب خارجی را وارد کنید",
  "Enter External Web Search API Key": "کلید API جستجوی وب خارجی را وارد کنید",
  "Enter External Web Search URL": "آدرس URL جستجوی وب خارجی را وارد کنید",
  ...
  "Enter hex color (e.g. #FF0000)": "رنگ هگزادسیمال را وارد کنید (مثلاً #FF0000)",
  ...
  "Enter the public URL of your rexpro. This URL will be used to generate links in the notifications.": "آدرس عمومی رابط کاربری وب خود را وارد کنید. این آدرس برای تولید پیوندها در اعلان‌ها استفاده خواهد شد.",
  ...
  "Enter value (true/false)": "مقدار را وارد کنید (true/false)",
  "Enter Yacy Password": "رمز عبور Yacy را وارد کنید",
  "Enter Yacy URL (e.g. http://yacy.example.com:8090)": "آدرس URL یاسی (Yacy) را وارد کنید (مثلاً http://yacy.example.com:8090)",
  "Enter Yacy Username": "نام کاربری Yacy را وارد کنید",
  ...
  "Enter your gender": "جنسیت خود را وارد کنید",
  ...
  "External Task Model": "مدل وظیفه خارجی",
  "External Web Loader API Key": "کلید API بارگذار وب خارجی",
  "External Web Loader URL": "آدرس URL بارگذار وب خارجی",
  "External Web Search API Key": "کلید API جستجوی وب خارجی",
  "External Web Search URL": "آدرس URL جستجوی وب خارجی",
  ...
  "Failed to render diagram": "رندر دیاگرام ناموفق بود",
  "Failed to render visualization": "رندر بصری‌سازی ناموفق بود",
  ...
  "Feedback Details": "جزئیات بازخورد",
  ...
  "Firecrawl Timeout (s)": "",
  "Floating Quick Actions": "اقدامات سریع شناور",
  ...
  "Folder options": "",
  "Folder updated successfully": "پوشه با موفقیت به‌روز شد",
  Folders,
  "Follow up": "پیگیری",
  "Follow Up Generation": "تولید پیگیری",
  "Follow Up Generation Prompt": "پرامپت تولید پیگیری",
  "Follow up: {{question}}": "",
  "Follow-Up Auto-Generation": "تولید خودکار پیگیری",
  "Followed instructions perfectly": "دستورالعمل ها را کاملا دنبال کرد",
  "for placeholders": "",
  "Force OCR": "اجبار به OCR",
  "Force OCR on all pages of the PDF. This can lead to worse results if you have good text in your PDFs. Defaults to False.": "اجبار به OCR در تمام صفحات PDF. این ممکن است در صورت داشتن متن خوب در PDFها منجر به نتایج بدتری شود. پیش‌فرض: False.",
  "Forge new paths": "مسیرهای جدید بسازید",
  Form,
  "Format Lines": "قالب‌بندی خطوط",
  "Format the lines in the output. Defaults to False. If set to True, the lines will be formatted to detect inline math and styles.": "قالب‌بندی خطوط در خروجی. پیش‌فرض: False. اگر روی True تنظیم شود، خطوط برای تشخیص ریاضیات و استایل‌های درون‌خطی قالب‌بندی خواهند شد.",
  "Formatting may be inconsistent from source.": "قالب‌بندی ممکن است با منبع ناسازگار باشد.",
  Forward,
  ...
  "Function imported successfully": "تابع با موفقیت وارد شد",
  ...
  Gemini,
  "Gemini API Key": "کلید API جیمنای",
  "Gemini API Key is required.": "کلید API جمینی مورد نیاز است.",
  "Gemini Base URL": "آدرس پایه جیمنای",
  "Gemini Endpoint Method": "روش نقطه پایانی جیمنای",
  Gender,
  General,
  Generate,
  ...
  "Get information on {{name}} in the UI": "دریافت اطلاعات درباره {{name}} در رابط کاربری",
  "Get started": "شروع کنید",
  "Get started with {{REXPRO_NAME}}": "شروع کار با {{REXPRO_NAME}}",
  Global,
  ...
  Headers,
  "Headers must be a valid JSON object": "هدرها باید یک شیء JSON معتبر باشند",
  Height,
  ...
  Hide,
  "Hide All": "",
  "Hide from Sidebar": "پنهان کردن از نوار کناری",
  ...
  ID,
  'ID cannot contain ":" or "|" characters': 'شناسه نمی‌تواند حاوی کاراکترهای ":" یا "|" باشد',
  ...
  "Image Compression Height": "ارتفاع فشرده‌سازی تصویر",
  "Image Compression Width": "عرض فشرده‌سازی تصویر",
  "Image Edit": "",
  "Image Edit Engine": "موتور ویرایش تصویر",
  ...
  "Image Max Compression Size height": "حداکثر ارتفاع اندازه فشرده‌سازی تصویر",
  "Image Max Compression Size width": "حداکثر عرض اندازه فشرده‌سازی تصویر",
  ...
  Inactive,
  Include,
  "Include `--api-auth` flag when running stable-diffusion-rexpro": "هنگام اجرای stable-diffusion-rexpro پرچم `--api-auth` را اضافه کنید",
  "Include `--api` flag when running stable-diffusion-rexpro": "فلگ `--api` را هنکام اجرای stable-diffusion-rexpro استفاده کنید.",
  ...
  "Input Variables": "متغیرهای ورودی",
  Insert,
  "Insert Follow-Up Prompt to Input": "درج پرامپت پیگیری در ورودی",
  "Insert Prompt as Rich Text": "درج پرامپت به عنوان متن غنی",
  ...
  "Invalid file content": "محتوای فایل نامعتبر است",
  "Invalid file format.": "قالب فایل نامعتبر است.",
  "Invalid JSON file": "فایل JSON نامعتبر است",
  "Invalid JSON format for ComfyUI Edit Workflow.": "قالب JSON برای گردش کار ویرایش ComfyUI نامعتبر است.",
  "Invalid JSON format for ComfyUI Workflow.": "قالب JSON برای گردش کار ComfyUI نامعتبر است.",
  "Invalid JSON format for Parameters": "قالب JSON برای پارامترها نامعتبر است",
  "Invalid JSON format in {{NAME}}": "",
  "Invalid JSON format in Additional Config": "قالب JSON در تنظیمات اضافی نامعتبر است",
  "Invalid JSON format in MinerU Parameters": "قالب JSON در پارامترهای MinerU نامعتبر است",
  ...
  "Keep Follow-Up Prompts in Chat": "نگه داشتن پرامپت‌های پیگیری در چت",
  "Keep in Sidebar": "نگه داشتن در نوار کناری",
  Key,
  ...
  "Learn more about Voxtral transcription.": "درباره رونویسی واکسترال بیشتر بدانید.",
  "Leave a public review for {{modelName}}": "",
  "Leave empty for no compression": "برای عدم فشرده‌سازی خالی بگذارید",
  "Leave empty for unlimited": "برای نامحدود خالی بگذارید",
  'Leave empty to include all models from "{{url}}" endpoint': 'برای گنجاندن همه مدل‌ها از نقطه پایانی "{{url}}" خالی بگذارید',
  ...
  "Leave empty to use the default model (voxtral-mini-latest).": "برای استفاده از مدل پیش‌فرض (voxtral-mini-latest) خالی بگذارید.",
  ...
  Low,
  LTR,
  "Made by rexpro-ai Community": "ساخته شده توسط rexpro-ai Community",
  "Make password visible in the user interface": "رمز عبور را در رابط کاربری قابل مشاهده کنید",
  ...
  "Manage your account information.": "اطلاعات حساب خود را مدیریت کنید.",
  March,
  Markdown,
  "Markdown Header Text Splitter": "",
  "Max Speakers": "حداکثر تعداد بلندگوها",
  ...
  MBR,
  MCP,
  "MCP support is experimental and its specification changes often, which can lead to incompatibilities. OpenAPI specification support is directly maintained by the rexpro-ai team, making it the more reliable option for compatibility.": "پشتیبانی MCP آزمایشی است و مشخصات آن اغلب تغییر می‌کند، که می‌تواند منجر به ناسازگاری شود. پشتیبانی از مشخصات OpenAPI مستقیماً توسط تیم rexpro-ai نگهداری می‌شود و آن را به گزینه قابل اعتماد‌تری برای سازگاری تبدیل می‌کند.",
  Medium,
  ...
  "Microsoft OneDrive": "وان‌درایو مایکروسافت",
  "Microsoft OneDrive (personal)": "وان‌درایو مایکروسافت (شخصی)",
  "Microsoft OneDrive (work/school)": "وان‌درایو مایکروسافت (کار/مدرسه)",
  min,
  MinerU,
  "MinerU API Key required for Cloud API mode.": "کلید API MinerU برای حالت Cloud API مورد نیاز است.",
  ...
  "Model ID": "شناسه مدل",
  "Model ID is required.": "شناسه مدل مورد نیاز است.",
  "Model IDs": "شناسه‌های مدل",
  "Model Name": "نام مدل",
  "Model name already exists, please choose a different one": "نام مدل قبلاً وجود دارد، لطفاً یک نام دیگر انتخاب کنید",
  "Model Name is required.": "نام مدل مورد نیاز است.",
  ...
  "Model Usage": "",
  "Model(s) do not support file upload": "مدل(ها) از بارگذاری فایل پشتیبانی نمی‌کنند",
  ...
  "Models imported successfully": "مدل‌ها با موفقیت وارد شدند",
  ...
  "No Notes": "هیچ یادداشتی وجود ندارد",
  "No notes found": "هیچ یادداشتی یافت نشد",
  "No one": "",
  "No output items": "",
  "No pinned messages": "",
  "No prompts found": "هیچ پرامپتی یافت نشد",
  ...
  Notes,
  "Notes Public Sharing": "اشتراک‌گذاری عمومی یادداشت‌ها",
  "Notes Sharing": "",
  ...
  "Only can be triggered when the chat input is in focus.": "فقط زمانی قابل اجرا است که ورودی چت در فوکوس باشد.",
  ...
  "Only markdown files are allowed": "فقط فایل‌های مارک‌داون مجاز هستند",
  ...
  "Oops! You're using an unsupported method (frontend only). Please serve the rexpro from the backend.": "اوه! شما از یک روش پشتیبانی نشده (فقط frontend) استفاده می کنید. لطفاً rexpro را از بکند اجرا کنید.",
  "Open file": "باز کردن فایل",
  "Open in full screen": "باز کردن در تمام صفحه",
  "Open in new tab": "",
  "Open link": "باز کردن لینک",
  "Open modal to configure connection": "باز کردن مودال برای پیکربندی اتصال",
  "Open Modal To Manage Floating Quick Actions": "باز کردن مودال برای مدیریت اقدامات سریع شناور",
  "Open Modal To Manage Image Compression": "باز کردن مودال برای مدیریت فشرده‌سازی تصویر",
  "Open Model Selector": "",
  "Open Settings": "باز کردن تنظیمات",
  "Open Sidebar": "باز کردن نوار کناری",
  "Open Terminal": "",
  "Open User Profile Menu": "باز کردن منوی پروفایل کاربر",
  "rexpro-ai can use tools provided by any OpenAPI server.": "rexpro-ai می‌تواند از ابزارهای ارائه شده توسط هر سرور OpenAPI استفاده کند.",
  "rexpro-ai uses faster-whisper internally.": "rexpro-ai به صورت داخلی از faster-whisper استفاده می‌کند.",
  "rexpro-ai uses SpeechT5 and CMU Arctic speaker embeddings.": "rexpro-ai از SpeechT5 و جاسازی‌های گوینده CMU Arctic استفاده می‌کند.",
  "rexpro-ai version": "",
  "rexpro-ai version (v{{OPEN_REXPRO_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "نسخه rexpro-ai (v{{OPEN_REXPRO_VERSION}}) پایین‌تر از نسخه مورد نیاز (v{{REQUIRED_VERSION}}) است",
  OpenAI,
  "OpenAI API": "OpenAI API",
  "OpenAI API Base URL": "آدرس پایه API اوپن‌ای‌آی",
  ...
  "OpenAI API Version": "نسخه API اوپن‌ای‌آی",
  ...
  "Perplexity Model": "مدل پرپلکسیتی",
  ...
  "Please enter a valid ID": "لطفاً یک شناسه معتبر وارد کنید",
  "Please enter a valid JSON spec": "لطفاً یک مشخصات JSON معتبر وارد کنید",
  ...
  "Redirecting you to rexpro-ai Community": "در حال هدایت به rexpro-ai Community",
  ...
  "Reference Chats": "چت‌های مرجع",
  Refresh,
  "Refused when it shouldn't have": "رد شده زمانی که باید نباشد",
  Regenerate,
  "Regenerate Menu": "منوی بازتولید",
  "Regenerate Response": "بازتولید پاسخ",
  "Register Again": "دوباره ثبت نام کنید",
  "Register Client": "ثبت کلاینت",
  Registered,
  ...
  "Retrieved {{count}} sources": "{{count}} منبع بازیابی شد",
  ...
  "search for archived chats": "جستجو برای چت‌های بایگانی شده",
  "search for folders": "جستجو برای پوشه‌ها",
  "search for pinned chats": "جستجو برای چت‌های پین شده",
  "search for shared chats": "جستجو برای چت‌های اشتراک‌گذاری شده",
  "search for tags": "جستجو برای برچسب‌ها",
  "Search Functions": "جستجوی توابع",
  "Search Groups": "",
  "Search In Models": "جستجو در مدل‌ها",
  ...
  "Searching the web": "در حال جستجوی وب",
  ...
  "Select a base model (e.g. llama3, gpt-4o)": "یک مدل پایه انتخاب کنید (مثلاً llama3, gpt-4o)",
  "Select a conversation to preview": "یک مکالمه برای پیش‌نمایش انتخاب کنید",
  ...
  "Select a model (optional)": "یک مدل انتخاب کنید (اختیاری)",
  "Select a pipeline": "انتخاب یک خط لوله",
  "Select a pipeline url": "یک ادرس خط لوله را انتخاب کنید",
  "Select a reranking model engine": "یک موتور مدل رتبه‌بندی مجدد انتخاب کنید",
  "Select a role": "یک نقش انتخاب کنید",
  "Select a theme": "یک تم انتخاب کنید",
  "Select a tool": "انتخاب یک ابقزار",
  "Select a voice": "یک صدا انتخاب کنید",
  "Select All": "",
  "Select an auth method": "یک روش احراز هویت را انتخاب کنید",
  "Select an embedding model engine": "یک موتور مدل جاسازی انتخاب کنید",
  "Select an engine": "یک موتور انتخاب کنید",
  "Select an Ollama instance": "یک نمونه ollama را انتخاب کنید",
  "Select an option": "",
  "Select an output format": "یک قالب خروجی انتخاب کنید",
  "Select dtype": "dtype را انتخاب کنید",
  ...
  "Share to rexpro-ai Community": "اشتراک گذاری با rexpro-ai Community",
  "Share your background and interests": "پیشینه و علایق خود را به اشتراک بگذارید",
  "Shared Chats": "",
  ...
  "Sign in": "ورود",
  "Sign in to {{REXPRO_NAME}}": "ورود به {{REXPRO_NAME}}",
  "Sign in to {{REXPRO_NAME}} with LDAP": "ورود به {{REXPRO_NAME}} با LDAP",
  "Sign Out": "خروج",
  "Sign up": "ثبت نام",
  "Sign up to {{REXPRO_NAME}}": "ثبت نام در {{REXPRO_NAME}}",
  "Significantly improves accuracy by using an LLM to enhance tables, forms, inline math, and layout detection. Will increase latency. Defaults to False.": "با استفاده از یک LLM برای بهبود جداول، فرم‌ها، ریاضیات درون‌خطی و تشخیص چیدمان، دقت را به طور قابل توجهی افزایش می‌دهد. باعث افزایش تأخیر خواهد شد. پیش‌فرض: False.",
  "Signing in to {{REXPRO_NAME}}": "در حال ورود به {{REXPRO_NAME}}",
  Single,
  "Sink List": "لیست سینک",
  "sk-1234": "sk-1234",
  ...
  "Sonar Pro": "سونار پرو",
  "Sonar Reasoning": "استدلال سونار",
  "Sonar Reasoning Pro": "استدلال سونار پرو",
  Sort,
  "Sort by": "",
  ...
  "Status Updates": "به‌روزرسانی‌های وضعیت",
  "STDOUT/STDERR": "STDOUT/STDERR",
  Steps,
  Stop,
  "Stop Download": "",
  "Stop Generating": "توقف تولید",
  "Stop Sequence": "توقف توالی",
  Storage,
  "Stream Chat Response": "پاسخ چت جریانی",
  "Stream Delta Chunk Size": "اندازه دلتا تکه جریانی",
  "Streamable HTTP": "HTTP قابل جریان",
  Strikethrough,
  "Strip Existing OCR": "حذف OCR موجود",
  "Strip existing OCR text from the PDF and re-run OCR. Ignored if Force OCR is enabled. Defaults to False.": "حذف متن OCR موجود از PDF و اجرای مجدد OCR. اگر «اجبار به OCR» فعال باشد نادیده گرفته می‌شود. پیش‌فرض: False.",
  ...
  Subtitle,
  Success,
  "Successfully imported {{userCount}} users.": "{{userCount}} کاربر با موفقیت وارد شدند.",
  "Successfully updated.": "با موفقیت به‌روز شد",
  "Suggest a change": "پیشنهاد یک تغییر",
  Suggested,
  Support,
  ...
  "Temporary Chat by Default": "چت موقت به صورت پیش‌فرض",
  Terminal,
  ...
  "The format to return a response in. Format can be json or a JSON schema.": "قالبی که باید پاسخ در آن برگردانده شود. قالب می‌تواند json یا یک شمای JSON باشد.",
  "The height in pixels to compress images to. Leave empty for no compression.": "ارتفاع بر حسب پیکسل برای فشرده‌سازی تصاویر. برای عدم فشرده‌سازی خالی بگذارید.",
  "The language of the input audio. Supplying the input language in ISO-639-1 (e.g. en) format will improve accuracy and latency. Leave blank to automatically detect the language.": "زبان صدای ورودی. ارائه زبان ورودی در قالب ISO-639-1 (مثلاً en) دقت و تأخیر را بهبود می‌بخشد. برای تشخیص خودکار زبان، خالی بگذارید.",
  ...
  "The output format for the text. Can be 'json', 'markdown', or 'html'. Defaults to 'markdown'.": "قالب خروجی برای متن. می‌تواند 'json'، 'markdown' یا 'html' باشد. پیش‌فرض: 'markdown'.",
  "The passwords you entered don't quite match. Please double-check and try again.": "رمزهای عبوری که وارد کردید کاملاً مطابقت ندارند. لطفاً دوباره بررسی کرده و تلاش کنید.",
  "The score should be a value between 0.0 (0%) and 1.0 (100%).": "امتیاز باید مقداری بین 0.0 (0%) و 1.0 (100%) باشد.",
  "The stream delta chunk size for the model. Increasing the chunk size will make the model respond with larger pieces of text at once.": "اندازه دلتا تکه جریانی برای مدل. افزایش اندازه تکه باعث می‌شود مدل با قطعات بزرگ‌تری از متن به یکباره پاسخ دهد.",
  ...
  "The Weight of BM25 Hybrid Search. 0 more semantic, 1 more lexical. Default 0.5": "وزن جستجوی ترکیبی BM25. ۰ معنایی‌تر، ۱ لغوی‌تر. پیش‌فرض ۰.۵",
  "The width in pixels to compress images to. Leave empty for no compression.": "عرض بر حسب پیکسل برای فشرده‌سازی تصاویر. برای عدم فشرده‌سازی خالی بگذارید.",
  Theme,
  ...
  "This feature is experimental and may be modified or discontinued without notice.": "این ویژگی آزمایشی است و ممکن است بدون اطلاع قبلی تغییر یا متوقف شود.",
  ...
  "This model is not publicly available. Please select another model.": "این مدل به صورت عمومی در دسترس نیست. لطفاً مدل دیگری انتخاب کنید.",
  "This option controls how long the model will stay loaded into memory following the request (default: 5m)": "این گزینه مدت زمانی را کنترل می‌کند که مدل پس از درخواست در حافظه بارگذاری شده باقی می‌ماند (پیش‌فرض: ۵ دقیقه)",
  ...
  "To access the rexpro, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.": "برای دسترسی به رابط کاربری وب، لطفاً با مدیر تماس بگیرید. مدیران می‌توانند وضعیت کاربران را از پنل مدیریت مدیریت کنند.",
  ...
  "Try adjusting your search or filter to find what you are looking for.": "برای یافتن آنچه به دنبالش هستید، سعی کنید جستجو یا فیلتر خود را تنظیم کنید.",
  ...
  "Use /v1/chat/completions endpoint instead of /v1/audio/transcriptions for potentially better accuracy.": "از نقطه پایانی /v1/chat/completions به جای /v1/audio/transcriptions برای دقت بالقوه بهتر استفاده کنید.",
  "Use Chat Completions API": "استفاده از API تکمیل چت",
  "Use groups to organize your users and assign permissions.": "",
  "Use LLM": "استفاده از LLM",
  ...
  "Using Entire Document": "استفاده از کل سند",
  "Using Focused Retrieval": "استفاده از بازیابی متمرکز",
  ...
  "Validate certificate": "اعتبارسنجی گواهی",
  Valves,
  ...
  Webhooks,
  "Webpage URLs": "",
  "rexpro Settings": "تنظیمات rexpro",
  "rexpro URL": "آدرس rexpro",
  'rexpro will make requests to "{{url}}"': 'rexpro به "{{url}}" درخواست خواهد داد',
  'rexpro will make requests to "{{url}}/api/chat"': 'rexpro به "{{url}}/api/chat" درخواست خواهد داد',
  'rexpro will make requests to "{{url}}/chat/completions"': 'rexpro به "{{url}}/chat/completions" درخواست خواهد داد',
  Week,
  Weekly,
  ...
  Write,
  "Write a summary in 50 words that summarizes {{topic}}.": "خلاصه ای در 50 کلمه بنویسید که [موضوع یا کلمه کلیدی] را خلاصه کند.",
  ...
  "Yacy Instance URL": "آدرس URL نمونه Yacy",
  "Yacy Password": "رمز عبور Yacy",
  "Yacy Username": "نام کاربری Yacy",
  Yahoo,
  Yandex,
  ...
  Yesterday,
  "Yesterday at {{LOCALIZED_TIME}}": "دیروز در {{LOCALIZED_TIME}}",
  You,
  ...
  "You do not have permission to send messages in this channel.": "شما اجازه ارسال پیام در این کانال را ندارید.",
  "You do not have permission to send messages in this thread.": "شما اجازه ارسال پیام در این رشته را ندارید.",
