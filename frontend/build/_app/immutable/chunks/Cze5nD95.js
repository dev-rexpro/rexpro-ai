const About = "Awal ɣef";
const Access = "Addaf";
const Account = "Amiḍan";
const Action = "Tigawt";
const Actions = "Tigawin";
const Activate = "Sermed";
const Active = "Urmid";
const Activity = "";
const Add = "Rnu";
const admin = "anedbal";
...
const AI = "TT";
const All = "Akk";
const Always = "Yal tikkelt";
const Amazing = "Igerrez";
const Analytics = "Tasleḍt";
const Analyzed = "Yettwasekyed";
const Android = "Android";
const Anyone = "";
const April = "Yebrir";
const Archive = "Seɣber";
const Artifacts = "Tarkisant";
const Asc = "";
const Ask = "Suter";
const Assistant = "Amallal";
const Audio = "Ameslaw";
const August = "Ɣuct";
const Auth = "Asesteb";
const Authenticate = "Sesteb";
const Authentication = "Asesteb";
const Auto = "Awurman";
const Automatic1111 = "Automatic1111";
const Automation = "";
const Automations = "";
const Away = "Ulac";
const Awful = "D tawaɣit";
const Back = "Tuɣalin";
const Banners = "Iɣerracen";
const Bearer = "";
const before = "send";
const Beta = "Biṭa";
const Bing = "";
...
const Bold = "Azuran";
const Brave = "";
const Calendar = "Awitay";
const Calendars = "";
const Call = "Siwel";
const Camera = "Takamiṛatt";
const Cancel = "Semmet";
const Capabilities = "Tizemmar";
const Capture = "Tuṭṭfa";
const Channel = "Abadu";
const Channels = "Ibuda";
const Character = "Asekkil";
const Chat = "Asqerdec";
const chats = "";
const Chats = "Idiwenniyen";
const Ciphers = "Izwilen";
const Citation = "Tanebdurt";
const Citations = "Tinebdurin";
const Clone = "Sleg";
const Close = "Mdel";
const cloud = "";
const Collapse = "Sneḍfes";
const Collection = "Tagrumma";
const Collections = "";
const Color = "Ini";
const ComfyUI = "ComfyUI";
const command = "";
const Command = "Anezḍay";
const Comment = "Awennit";
const Completions = "Tisemdiyin";
const Config = "";
const Configuration = "";
const Configure = "Swel";
const Confirm = "Sentem";
const Connections = "Tuqqniwin";
const Content = "Agbur";
const Controls = "Isenqaden";
const Copied = "Yettwanɣel";
const Copy = "Nɣel";
const CPU = "";
const Create = "Snulfu-d";
const Custom = "Udmawan";
const Daily = "";
const Dark = "Aberkan";
const Database = "Taffa n isefka";
const Day = "";
const December = "Duǧambeṛ";
const Deepgram = "Deepgram";
const Default = "Amezwer";
const Defaults = "";
const Delete = "Kkes";
const Deleted = "";
const Desc = "";
const Description = "Aglam";
const Deselect = "";
const Dictate = "Zubet";
const Direct = "Srid";
const Disabled = "Yensa";
const Display = "Beqqeḍ";
const Docling = "Docling";
const Document = "Imesli";
const Documentation = "Tasemlit";
const Documents = "";
const Done = "Immed";
const Download = "Azdam";
const Draw = "Suneɣ";
const DuckDuckGo = "";
const Edit = "Ẓreg";
const edited = "yettwaẓreg";
const Edited = "Yettwaẓrag";
const Editing = "Asiẓreg";
const Eject = "Ḍeqqer-d";
const ElevenLabs = "ElevenLabs";
const Email = "Imayl";
const Embedding = "Ajmak";
const Emoji = "";
const Emojis = "";
const Enabled = "D urmid";
const Enhance = "Yesnernay";
const Ephemeral = "";
const ERROR = "TUCCḌA";
const Evaluations = "Iktazalen";
const Exclude = "Sisled";
const Expand = "Simɣur";
const Experimental = "Armitan";
const Explain = "Segzi";
const Explored = "";
const Exploring = "";
const Export = "Asifeḍ";
const External = "Azɣaray";
const Features = "Timahilin";
const February = "Fuṛaṛ";
const Feedback = "";
const Female = "Tawtemt";
const File = "Afaylu";
const Filename = "";
const Files = "Ifuyla";
const Filter = "Imsizdeg";
const Filters = "Imsizdigen";
const Folder = "Akaram";
const Folders = "Ikaramen";
const Form = "Tiferkit";
const Forward = "";
const Fr_day_of_week = "";
const Functions = "Tisɣunin";
const Gemini = "Gemini";
const Gender = "Tazzuft";
const General = "Amatu";
const Generate = "Sirew";
const Global = "Amatu";
const Google = "";
...
const Grokipedia = "";
const groups = "";
const Groups = "Igrawen";
const H1 = "H1";
const H2 = "H2";
const H3 = "H3";
const Headers = "Iqeṛṛa";
const Height = "Teɣzi";
const Help = "Tallalt";
const Hidden = "";
const Hide = "Seggelmes";
const High = "";
const History = "";
const Home = "Agejdan";
const Host = "Asneftaɣ";
...
const Include = "Seddu";
const Info = "Talɣut";
const Initials = "Isekkilen imezwura";
const Input = "Anekcum";
const Insert = "Ger";
const Instructions = "";
const Integration = "Tamsideft";
const Integrations = "Timsidaf";
const Interface = "Agrudem";
const Italic = "Uknan";
const January = "Yennayer";
const July = "Yulyu";
const June = "Yunyu";
const Key = "Tasarutt";
const Knowledge = "Tamusni";
const Label = "Tabzimt";
const Language = "Tutlayt";
const LDAP = "LDAP";
const Leaderboard = "Asismel";
const Legacy = "Aqbur";
const lexical = "Amawal";
const License = "Turagt";
const Light = "Aceɛlal";
const List = "";
const Live = "";
const Loaded = "";
...
const Model = "Tamudemt";
const Models = "Timudmiwin";
const Mojeek = "";
const Month = "";
const Monthly = "";
const More = "Ugar";
...
const Never = "";
const New = "";
const None = "Ula d yiwen";
const Note = "Tazmilt";
const Notes = "Tizmilin";
const Notifications = "Tilɣa";
const November = "Wambeṛ";
const OAuth = "OAuth";
const October = "Tubeṛ";
const Off = "Yensa";
const Ollama = "Ollama";
...
const optional = "";
const Optional = "D afrayan";
const or = "neɣ";
const Other = "Wayeḍ";
const Output = "";
const OUTPUT = "TUFFƔA";
const Overview = "Tamuɣli s umata";
const page = "asebter";
const Page = "";
const Paginate = "Smiḍen";
const Parameters = "Isefranen";
const Password = "Awal n uɛeddi";
const Paused = "";
const pending = "yettṛaǧu";
const Pending = "Yegguni";
const Permissions = "Tisirag";
const Persistent = "";
const Personalization = "Asagen";
const Pin = "Senteḍ";
const Pinned = "Yettwasenteḍ";
const Pipe = "Aselda";
const Pipelines = "";
const Playground = "Adeg n tarimt";
const Port = "Tawwurt";
const Ports = "";
const Preview = "Taskant";
const Private = "Uslig";
const Profile = "Amaɣnu";
const Prompt = "Aneftaɣ";
const Prompts = "Ineftaɣen";
const Provider = "";
const Public = "Azayaz";
const Querying = "";
const Rating = "Asezmel";
const Read = "Ɣeṛ";
const Reason = "Ssebba";
const Reconnected = "";
const Record = "Aklas";
const Refresh = "";
const Regenerate = "Asirew";
const Registered = "";
const Reindex = "Alus n usmiter";
const Releases = "Ileqman";
const Relevance = "Tawatit";
const Reminder = "";
const Remove = "Kkes";
const Rename = "Snifel isem";
const Repeats = "";
const Reply = "Tiririt";
const required = "yettwasra";
const Reset = "Wennez";
const Response = "Tiririt";
const Responses = "";
const Restart = "";
const Result = "Agmuḍ";
const RESULT = "Agmuḍ";
const Retrieval = "Anadi";
const Role = "Tamlilt";
const RTL = "RTL";
const Run = "Selkem";
const Running = "Aselkem";
const Sa_day_of_week = "";
const Save = "Sekles";
const Saved = "Yettwasekles";
const Schedule = "";
const Search = "Anadi";
const Searching = "Anadi";
const Seed = "Seed";
const Select = "Fren";
const semantic = "tasnamekt";
const Send = "Ceyyeɛ";
const September = "Ctembeṛ";
const Session = "Tiɣimit";
const Setting = "";
const Settings = "Iɣewwaren";
const Share = "Bḍu";
const Show = "Sken-d";
const Single = "";
const Skills = "";
...
const Stop = "Seḥbes";
const Storage = "";
const Strikethrough = "Yettujerreḍ";
const Su_day_of_week = "";
const Subtitle = "";
const Success = "Yedda";
const Suggested = "Yettwasumer-d";
const Support = "Tallalt";
const Sync = "";
const System = "Anagraw";
const Tag = "Tabzimt";
const Tags = "Tibzimin";
const Tasks = "Timsekra";
const Temperature = "Tazɣelt";
const Terminal = "";
...
const Type = "Anaw";
const UI = "Agrudem n useqdac";
const Underline = "Derrer";
const Unknown = "D arussin";
const Unmute = "";
const Unpin = "Kkes asenteḍ";
const Untagged = "Tekkes-as tebzimt";
const Untitled = "War azwel";
const Update = "Muceḍ";
const Updated = "Yettuleqqmen";
const Upload = "Sali";
const URL = "URL";
const Usage = "Aseqdec";
const Use = "";
const user = "aseqdac";
const User = "Aseqdac";
const Username = "Isem n useqdac";
const users = "";
const Users = "Iseqdacen";
const Valves = "Isegganen";
const variable = "tamattayt";
const Version = "Lqem";
const Visibility = "Tametwalant";
const Visible = "";
const Vision = "Vision";
const Visual = "";
const Voice = "Taɣect";
...
const Wikipedia = "";
const Won = "Yerbaḥ";
const Workspace = "Tamnaḍṭ n umahil";
const Write = "Aru";
const Yahoo = "";
const Yandex = "";
const Yesterday = "Iḍelli";
const You = "Kečč·mm";
const YouTube = "YouTube";
const translation = {
  "-1 for no limit, or a positive integer for a specific limit": "-1 war talast, neɣ aɣerwaḍ ilaw i talast tusdidt",
  "'s', 'm', 'h', 'd', 'w' or '-1' for no expiration.": "'s', 'm', 'h', 'd', 'w' neɣ '-1' i wakud war tilas.",
  "(e.g. `sh rexpro.sh --api --api-auth username_password`)": "(amedya. `sh rexpro.sh --api --api-auth username_password`)",
  "(e.g. `sh rexpro.sh --api`)": "(amedya `sh rexpro.sh --api`)",
  ...
  "Allow Chat Controls": "Sireg isenqaden n usqerdec",
  "Allow Chat Delete": "Sireg tukksa n yidiwenniyen",
  "Allow Chat Edit": "Sireg asenfel n usqerdec",
  "Allow Chat Export": "Sireg asifeḍ n usqerdec",
  ...
  "Allow User Location": "Sireg adig n useqdac",
  "Allow Voice Interruption in Call": "Sireg anegzum n tavuct lawan n usiwel",
  "Allow Web Upload": "",
  "Allowed Endpoints": "",
  "Allowed File Extensions": "Isiɣzaf n ufaylu i yettwasirgen",
  ...
  Always,
  "Always Collapse Code Blocks": "Fneẓ yal tikkelt iḥedren n tengalt",
  ...
  Archive,
  "Archive All": "",
  "Archive All Chats": "Ḥrez akk idiwenniyen",
  "Archived Chats": "Idiwenniyen i yettwaḥerzen",
  "archived-chat-export": "asifeḍ n yidiwenniyen i yettwaḥerzen",
  ...
  "Button Label": "Tabzimt n tqeffalt",
  "Button Prompt": "Taqeffalt Aneftaɣ",
  "by {{name}}": "",
  "By {{name}}": "S-ɣur {{name}}",
  "Bypass Embedding and Retrieval": "Zgel ajmak akked tririt",
  ...
  "Chat moved successfully": "Yettwankez udiwenni akken iwata",
  ...
  "Click here for help.": "Sit da i wawway n tallalt.",
  "Click here to": "Sit da akken",
  ...
  "Click here to see available models.": "Sit da akken ad twaliḍ timudmiwin i yellan.",
  "Click here to select": "Sit da akken ad tferneḍ",
  "Click here to select a csv file.": "Sit da akken ad tferneḍ afaylu csv.",
  "Click here to select a py file.": "Sit da akken ad tferneḍ afaylu n py.",
  ...
  "Clone of {{TITLE}}": "Aslag n {{TITLE}}",
  Close,
  "Close Banner": "",
  "Close chat controls": "",
  "Close citation modal": "",
  "Close Configure Connection Modal": "Mdel asfaylu n tawila n tuqqna",
  "Close feedback": "",
  ...
  "Code Execution": "",
  "Code Execution Engine": "Amsadday n uselkem n tengalt",
  "Code Execution Timeout": "Tanzagt n uselkem n tengalt, tɛedda",
  "Code formatted successfully": "Tangalt tettwamsel akken iwata",
  "Code Interpreter": "Asegzay n tengalt",
  "Code Interpreter Engine": "Amsedday n usegzay n tengalt",
  "Code Interpreter Prompt Template": "Tamudemt n uneftaɣ n usegzay n tengalt",
  ...
  Color,
  ComfyUI,
  "ComfyUI API Key": "Tasarut API n ComfyUI",
  ...
  "Confirm your action": "Sergeg tigawt-a",
  "Confirm your new password": "Sentem awal-ik·im n uɛeddi amaynut",
  "Confirm Your Password": "Sentem awal-ik⋅im uffir",
  ...
  "Connections settings updated": "Iɣewwaren n tuqqna ttwaleqqmen",
  ...
  "Contact Admin for rexpro Access": "Admin n unermis i rexpro",
  Content,
  "Content Extraction Engine": "Amsedday n uselkem n ugbur",
  ...
  "Continue with LDAP": "Kemmel s LDAP",
  ...
  "Conversation saved successfully": "Yettwasekles udiwenni akken iwata",
  Copied,
  ...
  "Copy API Key": "",
  "Copy content": "",
  "Copy Formatted Text": "Nɣel aḍris akken yella",
  ...
  "CORS must be properly configured by the provider to allow requests from rexpro-ai.": "CORS ilaq ad yeswel akken iwata sɣur usaǧǧaw akken ad yeǧǧ issutren seg rexpro yeldin.",
  "Could not read file.": "",
  CPU,
  Create,
  ...
  "Default permissions updated successfully": "Tisirag timezwar ttwaleqqment akken iwata",
  "Default Prompt Suggestions": "Isumar n yineftaɣen s wudem amezwar",
  "Default to 389 or 636 if TLS is enabled": "Amezwer 389 neɣ 636 ma yella TLS yettwarmed",
  "Default to ALL": "S wudem amezwar i meṛṛa",
  ...
  "Discover how to use rexpro-ai and seek support from the community.": "Wali amek ara tesqedceḍ rexpro-ai udiɣ amek ara ad tnadiḍ tallelt ar temɣiwant.",
  ...
  "e.g. 'low', 'medium', 'high'": "",
  'e.g. "json" or a JSON schema': 'amedya: "json" neɣ azenziɣ JSON',
  "e.g. 60": "amedya. 60",
  ...
  "e.g. pdf, docx, txt": "amedya: pdf, docx, txt",
  ...
  "e.g., audio/wav,audio/mpeg,video/* (leave blank for defaults)": "amedya, audio/wav,audio/mpeg,video/* (anef-as d ilem i yimezwura)",
  "e.g., en-US,ja-JP (leave blank for auto-detect)": "e.g",
  "e.g., westus (leave blank for eastus)": "lɣeṛb, lɣeṛb (iɣes n temtunt ) ilem i cceṛq",
  Edit,
  "Edit Arena Model": "Ẓreg tamudemt n Arena",
  "Edit Channel": "Ẓreg abadu",
  "Edit Connection": "Ẓreg tuqqna",
  "Edit Default Permissions": "Senfel tisirag timezwar",
  ...
  ElevenLabs,
  Email,
  "Embark on adventures": "Kcem deg tmseksalin",
  Embedding,
  ...
  "Enable Community Sharing": "Rmed beṭṭu n temɣiwent",
  ...
  "Enter Bing Search V7 Endpoint": "Sekcem agaz n taggara n Bing Search V7",
  "Enter Bing Search V7 Subscription Key": "Sekcem tasarut n umultaɣ Bing Search V7",
  "Enter Bocha Search API Key": "Sekcem tasarut API n Bocha Search",
  "Enter Brave Search API Key": "Sekcem-d tasarut n API Brave Search",
  ...
  "Enter Jupyter URL": "Sekcem URL n Jupyter",
  ...
  "Enter Mojeek Search API Key": "Sekcem-d tasarut API n Mojeek Search",
  ...
  "Enter SearchApi API Key": "Sekcem-d tasarut API n SearchApi",
  "Enter SearchApi Engine": "Sekcem-d amsadday SearchApi",
  "Enter Searxng Query URL": "Sekcem tansa URL n Searxng Query",
  "Enter Searxng search language": "",
  "Enter Seed": "Sekcem-d Seed",
  "Enter SerpApi API Key": "Kcem ar Serp Tasarut API",
  "Enter SerpApi Engine": "Sekcem-d amsedday n SerpApi",
  "Enter Serper API Key": "Sekcem API n uqeddac Tasarut",
  "Enter Serply API Key": "Sekcem API Tasarut",
  "Enter Serpstack API Key": "Sekcem tasarut API n Serpstack",
  "Enter server host": "Sekcem asenneftaɣ n uqeddac",
  "Enter server label": "Sekcem tabzimt n uqeddac",
  "Enter server port": "Sekcem-d tawwurt n uqeddac",
  "Enter skill instructions in markdown...": "",
  "Enter Sougou Search API sID": "Sekcem-d asulay sID n API n unadi n Sougou",
  "Enter Sougou Search API SK": "Sekcem-d SK n API n unadi n Sougou",
  "Enter stop sequence": "Sekcem tagzemt n uneḥbus",
  "Enter system prompt": "Sekcem-d aneftaɣ n unagraw",
  ...
  "Enter the public URL of your rexpro. This URL will be used to generate links in the notifications.": "Sekcem tansa URL tazayezt n rexpro-inek. Tansa-a URL ad tettwaseqdec i usuffeɣ n iseɣwan deg ilɣa.",
  ...
  "Enter to Send": "Sit ɣer Enter i tuzna",
  "Enter Top K": "Sekcem-d azal n Top K",
  ...
  "Example: sAMAccountName or uid or userPrincipalName": "Amedya: sAMAccountName neɣ uid neɣ userPrincipalName",
  ...
  "External Task Model": "Tamudemt n temsekrit tazɣarayt",
  "External Web Loader API Key": "API n isebtar web imeṛṛa Tasarut",
  "External Web Loader URL": "Tansa URL tuffiɣt",
  "External Web Search API Key": "Tasarut API n unadi yeffɣen ɣef Web",
  "External Web Search URL": "Tansa URL yeffɣen n unadi deg Web",
  ...
  "Feedback Details": "Talqayt n tamawin",
  ...
  "File Upload": "Asali n ufaylu",
  "File uploaded successfully": "Afaylu-nni yuli akken iwata",
  Filename,
  Files,
  Filter,
  ...
  "Followed instructions perfectly": "Yeḍfeṛ iwellihen akken iwatan",
  "for placeholders": "",
  "Force OCR": "Ḥettem OCR",
  "Force OCR on all pages of the PDF. This can lead to worse results if you have good text in your PDFs. Defaults to False.": "",
  "Forge new paths": "Ldi iberdan imaynuten",
  Form,
  ...
  "Function Description": "Aglam n tesɣent",
  "Function ID": "Asulay n tesɣent",
  "Function imported successfully": "Tawuri tettwaktar akken iwata",
  ...
  "Functions imported successfully": "Tisɣunin ttwaketren akken iwata",
  Gemini,
  "Gemini API Key": "",
  ...
  "Generating search query": "Asirew n tuttra n unadi",
  "Generating...": "Asirew…",
  ...
  "Get started with {{REXPRO_NAME}}": "Bdu s {{REXPRO_NAME}}",
  Global,
  ...
  "Ignite curiosity": "Sker lḥir",
  Image,
  "Image Compression": "Tussda n tugna",
  "Image Compression Height": "Askussel n teɣzi n tugna",
  "Image Compression Width": "Askussem n tehri n tugna",
  "Image Edit": "",
  "Image Edit Engine": "",
  "Image Generation": "Asirew n tugniwin",
  "Image Generation Engine": "Amsedday n usirew n tugniwin",
  ...
  Inactive,
  Include,
  "Include `--api-auth` flag when running stable-diffusion-rexpro": "Seddu annay `--api-auth` lawan n uselkem n stable-diffusion-rexpro",
  "Include `--api` flag when running stable-diffusion-rexpro": "Seddu takbabt ''-api' mi ara teslekmeḍ stable-diffusion-rexpro",
  ...
  "Jupyter URL": "Tansa URL n Jupyter",
  "JWT Expiration": "Afakki n JWT",
  "JWT Token": "Token JWT",
  "Kagi Search API Key": "Tasarut API n Kagi Search",
  "Keep Follow-Up Prompts in Chat": "Kemmel tiwsatin n uḍfaṛ-Up deg Chat",
  "Keep in Sidebar": "Senṭeḍ-it deg ufeggag n yidis",
  Key,
  "Key is required": "Tlaq tsarut",
  ...
  "Knowledge Description": "Aglam n tmessunt",
  "Knowledge exported successfully": "",
  "Knowledge Name": "Isem n tmessunt",
  "Knowledge Public Sharing": "Beṭṭu azayaz n tmussniwin",
  "Knowledge Sharing": "",
  "Knowledge updated successfully": "Timussniwin ttwaleqqment akken iwata",
  "Kokoro.js (Browser)": "Kokoro.js (Iminig)",
  "Kokoro.js Dtype": "Kokoro.js Dtype",
  Label,
  "Landing Page Mode": "Askar n usebter agejdan",
  Language,
  "Language Locales": "Iɣewwaren n usideg n tutlayt",
  "Last 24 hours": "",
  "Last 30 days": "",
  "Last 7 days": "",
  "Last 90 days": "",
  ...
  "Leave empty for no compression": "Eǧǧ-it d ilem i wakken ur tettili ara tussda",
  ...
  Low,
  LTR,
  "Made by rexpro-ai Community": "Texdem-it-id temɣiwant n rexpro-ai",
  ...
  "Manage Ollama API Connections": "Sefrek tuqqniwin API Ollama",
  ...
  "Manage your account information.": "Sefrek ilɣa-inek·inem n umiḍan.",
  March,
  Markdown,
  "Markdown Header Text Splitter": "",
  "Max Speakers": "Amḍan afellay n wid d-yemmseslayen",
  "Max tokens to retrieve (1024-32768, default 8192)": "",
  "Max Upload Count": "Amḍan afellay n uzdam",
  ...
  "Merged Response": "Tiririyin mmezdint",
  Message,
  ...
  "Model name already exists, please choose a different one": "Yella yakan yisem n tmudemt, ma ulac aɣilif fren wayeḍ yemwalafen",
  ...
  "Modelfile Content": "Agbur n ufaylu n timudemt",
  Models,
  ...
  "Oops! You're using an unsupported method (frontend only). Please serve the rexpro from the backend.": "Ayhuh! Aql-ik tesseqdaceḍ tarrayt ur yettwasefraken ara (mazwar kan). Ma ulac aɣilif, mudd-d rexpro seg uɛrur.",
  ...
  "rexpro-ai can use tools provided by any OpenAPI server.": "rexpro-ai yezmer ad yesseqdec ifecka i d-yettak yal aqeddac OpenAPI.",
  "rexpro-ai uses faster-whisper internally.": "rexpro-ai yesseqdac faster-whisper sdaxel-is.",
  "rexpro-ai uses SpeechT5 and CMU Arctic speaker embeddings.": "Ldi rexpro yesseqdac SpeechT5 akked CMU Arktik.",
  "rexpro-ai version": "",
  ...
  "Prompt Content": "Agbur n uneftaɣ",
  "Prompt created successfully": "Aneftaɣ yettwarna akken iwata",
  "Prompt Name": "",
  "Prompt Suggestions": "",
  "Prompt Template": "",
  "Prompt updated successfully": "Aneftaɣ yettwaleqqem akken iwata",
  Prompts,
  "Prompts Access": "Anekcum ɣer yineftaɣen",
  "Prompts Public Sharing": "Beṭṭu azayaz n yineftaɣen",
  "Prompts Sharing": "",
  Provider,
  Public,
  ...
  "Redirecting you to rexpro-ai Community": "Aseḍfeṛ ar Temɣiwant n rexpro-ai",
  ...
  "Retrieved {{count}} sources": "Yufa-d {{count}} n yiɣbula",
  ...
  "Search Files": "",
  "Search Filters": "Imsizedgen n unadi",
  "search for archived chats": "",
  "search for folders": "anadi ɣef yikaramen",
  "search for pinned chats": "",
  "search for shared chats": "",
  "search for tags": "nadi ɣef tebzimin",
  "Search Functions": "Anadi ɣef tesɣunin",
  "Search Groups": "",
  "Search In Models": "Nadi deg tmudmiwin",
  "Search Knowledge": "Anadi ɣef tmessunin",
  "Search Memories": "",
  "Search Models": "Nadi timudmiwin",
  "Search Notes": "Nadi tizmilin",
  "Search options": "Tixtiṛiyin n unadi",
  "Search Prompts": "Anadi ɣef yineftaɣen",
  "Search Result Count": "Amḍan n yigmaḍ n unadi",
  "Search Skills": "",
  "Search skills...": "",
  "Search the internet": "Anadi deg Internet",
  "Search the web and fetch URLs": "",
  "Search Tools": "Nadi ifecka",
  "Search, view, and manage user notes": "",
  "SearchApi API Key": "Tasarut API n SearchApi",
  "SearchApi Engine": "Amsadday n unadi SearchApi",
  ...
  "Select a base model (e.g. llama3, gpt-4o)": "Fren tamudemt n taffa (amedya, llama3, gpt-4o)",
  ...
  September,
  "SerpApi API Key": "Tasarut API n SerpApi",
  "SerpApi Engine": "Amsedday SerpApi",
  "Serper API Key": "Tasarut API n Serper",
  ...
  "Set as Production": "",
  "Set embedding model": "Sbadu tamudemt n ujmak",
  "Set embedding model (e.g. {{model}})": "Sbadu tamudemt n ujmak (amedya. {{model}})",
  ...
  "Set Voice": "Fren taɣect",
  "Set whisper model": "Fren tamudemt Whisper",
  "Set your status": "",
  ...
  "Share to rexpro-ai Community": "Bḍu i tkebbanit rexpro yeldin",
  ...
  "Sign in": "Qqen",
  "Sign in to {{REXPRO_NAME}}": "Kcem ɣer {{REXPRO_NAME}}",
  "Sign in to {{REXPRO_NAME}} with LDAP": "Qqen ɣer {{REXPRO_NAME}} s LDAP",
  "Sign Out": "Tuffɣa",
  "Sign up": "Jerred",
  "Sign up to {{REXPRO_NAME}}": "Jerred ɣer {{REXPRO_NAME}}",
  ...
  "Signing in to {{REXPRO_NAME}}": "Azmul ɣer {{REXPRO_NAME}}",
  Single,
  "Sink List": "",
  "sk-1234": "sk-1234",
  ...
  Source,
  "Speech Playback Speed": "Arured n tɣuri n umeslay",
  ...
  Storage,
  "Stream Chat Response": "Suddem tiririt n udiwenni",
  ...
  "The format to return a response in. Format can be json or a JSON schema.": "Amasal ideg ilaq ad d-tettwarr tririt. Amasal yezmer ad yili d json neɣ d azenziɣ n JSON.",
  ...
  "The passwords you entered don't quite match. Please double-check and try again.": "Awalen uffiren i teskecmeḍ ur mwatan ara mliḥ. Ttxil-k·m, ssefqed snat n tikkal yernu ɛreḍ tikkelt nniḍen.",
  ...
  "To access the rexpro, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.": "Akken ad tkecmeḍ ɣer rexpro, ttxil-k, nermes anedbal. Imedminen zemren ad sselḥun addaden n useqdac seg ugalis Admin.",
  ...
  "Tool deleted successfully": "Afecku yettwakkes akken iwata",
  "Tool Description": "Aglam n ufecku",
  "Tool ID": "Asulay n ufecku",
  "Tool imported successfully": "Afecku yettwakter akken iwata",
  "Tool Name": "Isem n ufecku",
  "Tool Servers": "Iqeddacen n ifecka",
  "Tool updated successfully": "Afecku yettwaleqqem akken iwata",
  Tools,
  "Tools Access": "Addaf ar ifecka",
  "Tools are a function calling system with arbitrary code execution": "",
  "Tools Function Calling Prompt": "",
  "Tools have a function calling system that allows arbitrary code execution.": "",
  "Tools Public Sharing": "Beṭṭu azayaz n yifecka",
  "Tools Sharing": "",
  Top,
  "Top K": "Top K",
  ...
  "Web Search": "Anadi deg Web",
  "Web Search Engine": "Amsadday n unadi Web",
  ...
  Webhooks,
  "Webpage URLs": "",
  "rexpro Settings": "Iɣewwaṛen n rexpro",
  "rexpro URL": "Tansa URL rexpro",
  'rexpro will make requests to "{{url}}"': 'rexpro ad ssutreɣ "{url}}"',
  'rexpro will make requests to "{{url}}/api/chat"': 'rexpro ad ssutreɣ i "{url}}/api/chat"',
  'rexpro will make requests to "{{url}}/chat/completions"': 'rexpro ad ssutreɣ i "{url}}/chat/completions"',
  Week,
  Weekly,
  ...
  Write,
  "Write a summary in 50 words that summarizes {{topic}}.": "Aru agzul s 50 n wawalen i yessewzalen [asefru neɣ tasarut].",
  ...
  "You do not have permission to upload files.": "Ur tesɛiḍ ara turagt i uceggeɛ n yifuyla.",
