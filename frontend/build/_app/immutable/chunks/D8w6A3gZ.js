const About = "Honi buruz";
const Access = "Sarbidea";
const Account = "Kontua";
const Action = "";
const Actions = "Ekintzak";
const Activate = "";
const Active = "Aktibo";
const Activity = "";
const Add = "Gehitu";
const admin = "administratzailea";
const Admin = "Administratzailea";
const Advanced = "";
const AI = "";
const All = "";
const Always = "";
const Amazing = "Harrigarria";
const Analytics = "";
const Analyzed = "";
const Android = "";
const Anyone = "";
const April = "Apirila";
const Archive = "Artxibatu";
const Artifacts = "Artefaktuak";
const Asc = "";
const Ask = "";
const Assistant = "Laguntzailea";
const Audio = "Audioa";
const August = "Abuztua";
const Auth = "";
const Authenticate = "Autentifikatu";
...
const Automations = "";
const Away = "Kanpoan";
const Awful = "Penagarria";
const Back = "Atzera";
const Banners = "Bannerrak";
const Bearer = "";
const before = "aurretik";
const Beta = "";
const Bing = "";
const Bio = "";
const Bold = "";
...
const Camera = "Kamera";
const Cancel = "Utzi";
const Capabilities = "Gaitasunak";
const Capture = "";
const Channel = "";
const Channels = "";
const Character = "Karakterea";
const Chat = "Txata";
const chats = "";
const Chats = "Txatak";
const Ciphers = "Zifratuak";
const Citation = "Aipamena";
const Citations = "";
const Clone = "Klonatu";
const Close = "Itxi";
const cloud = "";
const Collapse = "";
const Collection = "Bilduma";
const Collections = "";
const Color = "Kolorea";
const ComfyUI = "ComfyUI";
const command = "";
const Command = "Komandoa";
const Comment = "";
const Completions = "Osatzeak";
const Config = "";
const Configuration = "";
const Configure = "Konfiguratu";
const Confirm = "Berretsi";
const Connections = "Konexioak";
const Content = "Edukia";
const Controls = "Kontrolak";
const Copied = "Kopiatuta";
const Copy = "Kopiatu";
const CPU = "";
const Create = "Sortu";
const Custom = "Pertsonalizatua";
const Daily = "";
const Dark = "Iluna";
const Database = "Datu-basea";
const Day = "";
const December = "Abendua";
const Deepgram = "";
const Default = "Lehenetsia";
const Defaults = "";
const Delete = "Ezabatu";
const Deleted = "";
const Desc = "";
const Description = "Deskribapena";
const Deselect = "";
const Dictate = "";
const Direct = "";
const Disabled = "Desgaituta";
const Display = "Bistaratu";
const Docling = "";
const Document = "Dokumentua";
const Documentation = "Dokumentazioa";
const Documents = "";
const Done = "Eginda";
const Download = "Deskargatu";
const Draw = "Marraztu";
const DuckDuckGo = "";
const Edit = "Editatu";
const edited = "";
...
const Emoji = "";
const Emojis = "";
const Enabled = "Gaituta";
const Enhance = "";
const Ephemeral = "";
const ERROR = "ERROREA";
const Evaluations = "Ebaluazioak";
const Exclude = "Baztertu";
const Expand = "";
const Experimental = "Esperimentala";
const Explain = "";
const Explored = "";
const Exploring = "";
const Export = "Esportatu";
const External = "";
const Features = "";
const February = "Otsaila";
const Feedback = "";
const Female = "";
const File = "Fitxategia";
const Filename = "";
const Files = "Fitxategiak";
const Filter = "";
const Filters = "Iragazkiak";
const Folder = "";
const Folders = "";
const Form = "Inprimakia";
const Forward = "";
const Fr_day_of_week = "";
const Functions = "Funtzioak";
const Gemini = "";
const Gender = "";
const General = "Orokorra";
const Generate = "";
...
const Integration = "";
const Integrations = "";
const Interface = "Interfazea";
const Italic = "";
const January = "Urtarrila";
const July = "Uztaila";
const June = "Ekaina";
const Key = "Gakoa";
const Knowledge = "Ezagutza";
const Label = "Etiketa";
const Language = "Hizkuntza";
const LDAP = "LDAP";
const Leaderboard = "Sailkapena";
const Legacy = "";
const lexical = "";
const License = "";
const Light = "Argia";
...
const Never = "";
const New = "";
const None = "Bat ere ez";
const Note = "";
const Notes = "Oharrak";
const Notifications = "Jakinarazpenak";
const November = "Azaroa";
const OAuth = "";
const October = "Urria";
const Off = "Itzalita";
const Ollama = "Ollama";
...
const Optional = "";
const or = "edo";
const Other = "Bestelakoa";
const Output = "";
const OUTPUT = "IRTEERA";
const Overview = "Ikuspegi orokorra";
const page = "orria";
const Page = "";
const Paginate = "";
const Parameters = "";
...
const pending = "zain";
const Pending = "";
const Permissions = "Baimenak";
const Persistent = "";
const Personalization = "Pertsonalizazioa";
const Pin = "Ainguratu";
const Pinned = "Ainguratuta";
const Pipe = "";
const Pipelines = "";
const Playground = "Jolaslekua";
const Port = "Ataka";
const Ports = "";
const Preview = "";
const Private = "";
const Profile = "Profila";
const Prompt = "";
const Prompts = "Prompt-ak";
const Provider = "";
const Public = "";
const Querying = "";
const Rating = "Balorazioa";
const Read = "";
const Reason = "";
const Reconnected = "";
const Record = "";
const Refresh = "";
const Regenerate = "Bersortu";
const Registered = "";
const Reindex = "";
const Releases = "";
const Relevance = "Garrantzia";
const Reminder = "";
const Remove = "Kendu";
const Rename = "Berrizendatu";
const Repeats = "";
const Reply = "";
const required = "";
const Reset = "Berrezarri";
const Response = "";
const Responses = "";
const Restart = "";
const Result = "Emaitza";
const RESULT = "Emaitza";
const Retrieval = "";
const Role = "Rola";
const RTL = "RTL";
const Run = "Exekutatu";
const Running = "Exekutatzen";
...
const semantic = "";
const Send = "Bidali";
const September = "Iraila";
const Session = "";
const Setting = "";
const Settings = "Ezarpenak";
const Share = "Partekatu";
const Show = "Erakutsi";
const Single = "";
const Skills = "";
const Sonar = "";
const Sort = "";
const Source = "Iturria";
const State = "";
const Status = "";
const Steps = "";
const Stop = "Gelditu";
...
const Subtitle = "";
const Success = "Arrakasta";
const Suggested = "Iradokitua";
const Support = "Laguntza";
const Sync = "";
const System = "Sistema";
const Tag = "";
const Tags = "";
const Tasks = "";
const Temperature = "Tenperatura";
const Terminal = "";
...
const Tools = "Tresnak";
const Top = "";
const Transformers = "Transformatzaileak";
const Tu_day_of_week = "";
const Type = "Mota";
const UI = "Erabiltzaile interfazea";
const Underline = "";
const Unknown = "";
const Unmute = "";
const Unpin = "Kendu aingura";
const Untagged = "Etiketatu gabea";
const Untitled = "";
const Update = "Eguneratu";
const Updated = "Eguneratuta";
const Upload = "Kargatu";
const URL = "URLa";
const Usage = "";
const Use = "";
const user = "erabiltzailea";
const User = "Erabiltzailea";
const Username = "Erabiltzaile-izena";
const users = "";
const Users = "Erabiltzaileak";
const Valves = "Balbulak";
const variable = "aldagaia";
const Version = "Bertsioa";
const Visibility = "Ikusgarritasuna";
const Visible = "";
const Vision = "";
const Visual = "";
const Voice = "Ahotsa";
const Warning = "Abisua";
...
const Width = "";
const Wikipedia = "";
const Won = "Irabazi du";
const Workspace = "Lan-eremua";
const Write = "";
const Yahoo = "";
const Yandex = "";
const Yesterday = "Atzo";
const You = "Zu";
...
const translation = {
  ...
  "(e.g. `sh rexpro.sh --api --api-auth username_password`)": "(adib. `sh rexpro.sh --api --api-auth erabiltzaile_pasahitza`)",
  "(e.g. `sh rexpro.sh --api`)": "(adib. `sh rexpro.sh --api`)",
  "(latest)": "(azkena)",
  ...
  "{{rexproAIName}} Backend Required": "{{rexproAIName}} Backend-a Beharrezkoa",
  ...
  "Contact Admin for rexpro Access": "Jarri harremanetan Administratzailearekin rexpro Sarbiderako",
  Content,
  ...
  "Get started": "Hasi",
  "Get started with {{REXPRO_NAME}}": "Hasi {{REXPRO_NAME}}-rekin",
  Global,
  ...
  Inactive,
  Include,
  "Include `--api-auth` flag when running stable-diffusion-rexpro": "Sartu `--api-auth` bandera stable-diffusion-rexpro exekutatzean",
  "Include `--api` flag when running stable-diffusion-rexpro": "Sartu `--api` bandera stable-diffusion-rexpro exekutatzean",
  ...
  Low,
  LTR,
  "Made by rexpro-ai Community": "rexpro-ai Komunitateak egina",
  ...
  "Oops! You're using an unsupported method (frontend only). Please serve the rexpro from the backend.": "Ui! Onartzen ez den metodo bat erabiltzen ari zara (frontend soilik). Mesedez, zerbitzatu rexpro-a backendetik.",
  ...
  "rexpro-ai uses faster-whisper internally.": "rexpro-ai-k faster-whisper erabiltzen du barnean.",
  "rexpro-ai uses SpeechT5 and CMU Arctic speaker embeddings.": "rexpro-ai-k SpeechT5 eta CMU Arctic hiztun txertaketak erabiltzen ditu.",
  "rexpro-ai version": "",
  "rexpro-ai version (v{{OPEN_REXPRO_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "rexpro-ai bertsioa (v{{OPEN_REXPRO_VERSION}}) beharrezko bertsioa (v{{REQUIRED_VERSION}}) baino baxuagoa da",
  OpenAI,
  ...
  Pipelines,
  "Pipelines are a plugin system with arbitrary code execution —": "Pipelines pluginen sistema bat da, ausazko kode‑exekuzioarekin —",
  ...
  "Redirecting you to rexpro-ai Community": "rexpro-ai Komunitatera berbideratzen",
  ...
  "Share to rexpro-ai Community": "Partekatu rexpro-ai komunitatearekin",
  ...
  "Sign in": "Hasi saioa",
  "Sign in to {{REXPRO_NAME}}": "Hasi saioa {{REXPRO_NAME}}-n",
  "Sign in to {{REXPRO_NAME}} with LDAP": "Hasi saioa {{REXPRO_NAME}}-n LDAP bidez",
  "Sign Out": "Amaitu saioa",
  "Sign up": "Erregistratu",
  "Sign up to {{REXPRO_NAME}}": "Erregistratu {{REXPRO_NAME}}-n",
  ...
  "Signing in to {{REXPRO_NAME}}": "{{REXPRO_NAME}}-n saioa hasten",
  Single,
  "Sink List": "",
  "sk-1234": "",
  ...
  "To access the rexpro, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.": "rexpro-a atzitzeko, mesedez jarri harremanetan administratzailearekin. Administratzaileek erabiltzaileen egoerak kudeatu ditzakete Admin Paneletik.",
  ...
  Webhooks,
  "Webpage URLs": "",
  "rexpro Settings": "rexpro ezarpenak",
  "rexpro URL": "",
  'rexpro will make requests to "{{url}}"': "",
  'rexpro will make requests to "{{url}}/api/chat"': 'rexpro-k eskaerak egingo ditu "{{url}}/api/chat"-era',
  'rexpro will make requests to "{{url}}/chat/completions"': 'rexpro-k eskaerak egingo ditu "{{url}}/chat/completions"-era',
  Week,
  Weekly,
  ...
  Write,
  "Write a summary in 50 words that summarizes {{topic}}.": "Idatzi 50 hitzeko laburpen bat [gaia edo gako-hitza] laburbiltzen duena.",
