const About = "Σχετικά";
const Access = "Πρόσβαση";
const Account = "Λογαριασμός";
const Action = "";
const Actions = "Ενέργειες";
const Activate = "";
const Active = "Ενεργός";
const Activity = "";
const Add = "Προσθήκη";
const admin = "διαχειριστής";
const Admin = "Διαχειριστής";
const Advanced = "";
const AI = "";
const All = "Όλα";
const Always = "Πάντα";
const Amazing = "Καταπληκτικό";
const Analytics = "Αναλυτικά";
const Analyzed = "Αναλυμένα";
const Android = "";
const Anyone = "";
const April = "Απρίλιος";
const Archive = "Αρχείο";
const Artifacts = "Αρχεία";
const Asc = "";
const Ask = "";
const Assistant = "Βοηθός";
const Audio = "Ήχος";
const August = "Αύγουστος";
const Auth = "Ταυτοποίηση";
const Authenticate = "Επαλήθευση";
const Authentication = "Ταυτοποίηση";
const Auto = "Αυτόματο";
...
const Awful = "Ασχημο";
const Back = "Πίσω";
const Banners = "Ανακοινώσεις";
const Bearer = "";
const before = "πριν";
const Beta = "";
const Bing = "";
const Bio = "Βιογραφικό";
const Bold = "";
const Brave = "";
const Calendar = "";
const Calendars = "";
...
const Capabilities = "Δυνατότητες";
const Capture = "Καταγραφή Εικόνας";
const Channel = "Κανάλι";
const Channels = "Κανάλια";
const Character = "Χαρακτήρας";
const Chat = "Συνομιλία";
const chats = "";
const Chats = "Συνομιλίες";
const Ciphers = "Κρυπτογραφήσεις";
const Citation = "Παραπομπή";
const Citations = "Παραπομπές";
const Clone = "Κλώνος";
const Close = "Κλείσιμο";
const cloud = "";
const Collapse = "Σύμπτυξη";
const Collection = "Συλλογή";
const Collections = "";
const Color = "Χρώμα";
const ComfyUI = "";
const command = "";
const Command = "Εντολή";
const Comment = "Σχόλιο";
const Completions = "Ολοκληρώσεις";
const Config = "";
const Configuration = "";
const Configure = "Διαμόρφωση";
const Confirm = "Επιβεβαίωση";
const Connections = "Συνδέσεις";
const Content = "Περιεχόμενο";
const Controls = "Έλεγχοι";
const Copied = "Αντιγράφηκε";
const Copy = "Αντιγραφή";
const CPU = "";
const Create = "Δημιουργία";
const Custom = "Προσαρμοσμένο";
const Daily = "";
const Dark = "Σκούρο";
const Database = "Βάση Δεδομένων";
const Day = "";
const December = "Δεκέμβριος";
const Deepgram = "";
const Default = "Προεπιλογή";
const Defaults = "";
const Delete = "Διαγραφή";
const Deleted = "";
const Desc = "";
const Description = "Περιγραφή";
const Deselect = "";
const Dictate = "Υπαγόρευση";
const Direct = "";
const Disabled = "Απενεργοποιημένο";
const Display = "Εμφάνιση";
const Docling = "";
const Document = "Έγγραφο";
const Documentation = "Τεκμηρίωση";
const Documents = "";
const Done = "Έτοιμο";
const Download = "Λήψη";
const Draw = "Σχεδίαση";
const DuckDuckGo = "";
const Edit = "Επεξεργασία";
const edited = "";
const Edited = "";
const Editing = "";
const Eject = "";
...
const Email = "Email";
const Embedding = "Ενσωμάτωση";
const Emoji = "";
const Emojis = "";
const Enabled = "Ενεργοποιημένο";
const Enhance = "";
const Ephemeral = "";
const ERROR = "ΣΦΑΛΜΑ";
const Evaluations = "Αξιολογήσεις";
const Exclude = "Εξαίρεση";
const Expand = "Επέκταση";
const Experimental = "Πειραματικό";
const Explain = "Επεξήγηση";
const Explored = "";
const Exploring = "";
const Export = "Εξαγωγή";
const External = "Εξωτερική";
const Features = "Λειτουργίες";
const February = "Φεβρουάριος";
const Feedback = "";
...
const Files = "Αρχεία";
const Filter = "Φίλτρο";
const Filters = "Φίλτρα";
const Folder = "Φάκελος";
const Folders = "Φάκελοι";
const Form = "Φόρμα";
const Forward = "";
const Fr_day_of_week = "";
const Functions = "Λειτουργίες";
const Gemini = "";
const Gender = "Φύλο";
const General = "Γενικά";
const Generate = "Δημιουργία";
const Global = "Καθολικό";
const Google = "";
const Gravatar = "";
const Grid = "";
const Grokipedia = "";
...
const History = "";
const Home = "Αρχική";
const Host = "Διακομιστής";
const Hourly = "";
const HTML = "";
const ID = "ID";
const Image = "Εικόνα";
const Images = "";
const Import = "Εισαγωγή";
const Inactive = "";
const Include = "Συμπερίληψη";
const Info = "Πληροφορίες";
const Initials = "";
const Input = "";
const Insert = "";
const Instructions = "";
const Integration = "Ενσωμάτωση";
const Integrations = "Ενσωματώσεις";
const Interface = "Διεπαφή Χρήστη";
const Italic = "";
const January = "Ιανουάριος";
const July = "Ιούλιος";
const June = "Ιούνιος";
const Key = "Κλειδί";
const Knowledge = "";
const Label = "Ετικέτα";
const Language = "Γλώσσα";
const LDAP = "LDAP";
const Leaderboard = "Κατάταξη";
const Legacy = "";
const lexical = "";
const License = "Άδεια";
const Light = "Φως";
...
const Model = "Μοντέλο";
const Models = "Μοντέλα";
const Mojeek = "";
const Month = "";
const Monthly = "";
const More = "Περισσότερα";
const Move = "Μετακίνηση";
const Mute = "";
const Muted = "";
const Name = "Όνομα";
const Native = "";
...
const None = "Κανένα";
const Note = "Σημείωση";
const Notes = "Σημειώσεις";
const Notifications = "Ειδοποιήσεις";
const November = "Νοέμβριος";
const OAuth = "";
const October = "Οκτώβριος";
const Off = "Ανενεργό";
const Ollama = "Ollama";
const On = "Ενεργό";
const Once = "";
...
const OpenAPI = "";
const optional = "";
const Optional = "Προαιρετικό";
const or = "ή";
const Other = "Άλλο";
const Output = "";
const OUTPUT = "ΕΞΟΔΟΣ";
const Overview = "Επισκόπηση";
const page = "σελίδα";
const Page = "";
const Paginate = "Σελιδοποίηση";
const Parameters = "Παράμετροι";
const Password = "Κωδικός";
const Paused = "";
const pending = "εκκρεμεί";
const Pending = "Εκκρεμεί";
const Permissions = "Δικαιώματα";
const Persistent = "";
const Personalization = "Προσωποποίηση";
const Pin = "Καρφίτσωμα";
const Pinned = "Καρφιτσωμένο";
const Pipe = "";
const Pipelines = "";
const Playground = "Γήπεδο παιχνιδιών";
const Port = "Θύρα";
const Ports = "";
const Preview = "Προεπισκόπηση";
const Private = "Ιδιωτικό";
const Profile = "Προφίλ";
const Prompt = "Προτροπή";
const Prompts = "Προτροπές";
const Provider = "";
const Public = "Δημόσιο";
const Querying = "";
const Rating = "Βαθμολογία";
const Read = "";
const Reason = "";
const Reconnected = "";
const Record = "";
const Refresh = "";
const Regenerate = "Επαναδημιουργία";
const Registered = "";
const Reindex = "Επανευρετηρίαση";
const Releases = "Εκδόσεις";
const Relevance = "Σχετικότητα";
const Reminder = "";
const Remove = "Αφαίρεση";
const Rename = "Μετονομασία";
const Repeats = "";
const Reply = "Απάντηση";
const required = "απαιτείται";
const Reset = "Επαναφορά";
const Response = "Απάντηση";
const Responses = "";
const Restart = "";
const Result = "Αποτέλεσμα";
const RESULT = "Αποτέλεσμα";
const Retrieval = "Ανάκτηση";
const Role = "Ρόλος";
const RTL = "RTL";
const Run = "Εκτέλεση";
const Running = "Εκτέλεση";
const Sa_day_of_week = "";
const Save = "Αποθήκευση";
const Saved = "Αποθηκευμένο";
const Schedule = "";
const Search = "Αναζήτηση";
const Searching = "Αναζητώντας";
const Seed = "Seed";
const Select = "Επιλογή";
const semantic = "";
const Send = "Αποστολή";
const September = "Σεπτέμβριος";
const Session = "";
const Setting = "";
const Settings = "Ρυθμίσεις";
const Share = "Κοινή Χρήση";
const Show = "Εμφάνιση";
const Single = "";
const Skills = "";
const Sonar = "";
...
const Status = "";
const Steps = "";
const Stop = "Σταμάτημα";
const Storage = "";
const Strikethrough = "";
const Su_day_of_week = "";
const Subtitle = "";
const Success = "Επιτυχία";
const Suggested = "Προτεινόμενα";
const Support = "Υποστήριξη";
const Sync = "";
const System = "Σύστημα";
const Tag = "Ετικέτα";
const Tags = "Ετικέτες";
const Tasks = "Εργασίες";
const Temperature = "Temperature";
const Terminal = "";
const Th_day_of_week = "";
const Theme = "Θέμα";
const Thought = "";
const Thread = "Συζήτηση";
const Tika = "";
const Tiktoken = "";
const Time = "";
const Timeout = "";
...
const tokens = "";
const Tokens = "";
const Tools = "Εργαλεία";
const Top = "";
const Transformers = "Transformers";
const Tu_day_of_week = "";
const Type = "Τύπος";
const UI = "Διεπαφή Χρήστη (UI)";
const Underline = "";
const Unknown = "";
const Unmute = "";
const Unpin = "Ξεκαρφίτσωμα";
const Untagged = "Χωρίς Ετικέτες";
const Untitled = "";
const Update = "Ενημέρωση";
const Updated = "Ενημερώθηκε";
const Upload = "Ανέβασμα";
const URL = "URL";
const Usage = "Χρήση Τoken";
const Use = "";
const user = "χρήστης";
const User = "Χρήστης";
const Username = "Όνομα Χρήστη";
const users = "";
const Users = "Χρήστες";
const Valves = "Βαλβίδες";
const variable = "μεταβλητή";
const Version = "Έκδοση";
const Visibility = "Ορατότητα";
const Visible = "";
const Vision = "Όραση";
const Visual = "";
const Voice = "Φωνή";
const Warning = "Προειδοποίηση";
...
const Wikipedia = "";
const Won = "Κέρδισε";
const Workspace = "Χώρος Εργασίας";
const Write = "";
const Yahoo = "";
const Yandex = "";
const Yesterday = "Εχθές";
const You = "Εσείς";
...
const translation = {
  ...
  "'s', 'm', 'h', 'd', 'w' or '-1' for no expiration.": "'s', 'm', 'h', 'd', 'w' ή '-1' για απεριόριστο.",
  "(e.g. `sh rexpro.sh --api --api-auth username_password`)": "(π.χ. `sh rexpro.sh --api --api-auth username_password`)",
  "(e.g. `sh rexpro.sh --api`)": "(π.χ. `sh rexpro.sh --api`)",
  "(latest)": "(τελευταία)",
  ...
  "{{rexproAIName}} Backend Required": "{{rexproAIName}} Απαιτείται Backend",
  ...
  "Advanced Params": "Προηγμένες Παράμετροι",
  ...
  "All time": "",
  "All Users": "",
  "Allow Call": "Επιτρέπεται η Κλήση",
  "Allow Chat Controls": "Επιτρέπεται ο Έλεγχος Συνομιλίας",
  "Allow Chat Delete": "Επιτρέπεται η διαγραφή συνομιλίας",
  "Allow Chat Edit": "Επιτρέπεται η Επεξεργασία Συνομιλίας",
  "Allow Chat Export": "Επιτρέπεται η Εξαγωγή Συνομιλίας",
  "Allow Chat Params": "Επιτρέπονται οι Παράμετροι Συνομιλίας",
  "Allow Chat Share": "Επιτρέπεται ο Διαμοιρασμός Συνομιλίας",
  "Allow Chat System Prompt": "Επιτρέπεται η Προτροπή Συστήματος Συνομιλίας",
  "Allow Chat Valves": "Επιτρέπονται οι Βαλβίδες Συνομιλίας",
  "Allow Continue Response": "Επιτρέπεται η Συνέχιση Απάντησης",
  "Allow Delete Messages": "Επιτρέπεται η διαγραφή μηνυμάτων",
  "Allow File Upload": "Επιτρέπεται το Ανέβασμα Αρχείων",
  "Allow Multiple Models in Chat": "Επιτρέπεται η χρήση πολλαπλών μοντέλων στη συνομιλία",
  "Allow non-local voices": "Επιτρέπονται μη τοπικές φωνές",
  "Allow public write access": "",
  "Allow Rate Response": "Επιτρέπεται η Αξιολόγηση Απάντησης",
  "Allow Regenerate Response": "Επιτρέπεται η Επαναδημιουργία Απάντησης",
  "Allow Sharing With Users": "",
  "Allow Speech to Text": "Επιτρέπεται η Μετατροπή Φωνής σε Κείμενο",
  "Allow Temporary Chat": "Επιτρέπεται η Προσωρινή Συνομιλία",
  "Allow Text to Speech": "Επιτρέπεται η Μετατροπή Κειμένου σε Φωνή",
  "Allow User Location": "Επιτρέπεται η Τοποθεσία Χρήστη",
  "Allow Voice Interruption in Call": "Επιτρέπεται η Παύση Φωνής στην Κλήση",
  "Allow Web Upload": "",
  "Allowed Endpoints": "Επιτρεπόμενα Endpoints",
  "Allowed File Extensions": "Επιτρεπόμενες Επεκτάσεις Αρχείων",
  "Allowed file extensions for upload. Separate multiple extensions with commas. Leave empty for all file types.": "Επιτρεπόμενες επεκτάσεις αρχείων για ανέβασμα. Διαχωρίστε πολλαπλές επεκτάσεις με κόμματα. Αφήστε κενό για όλους τους τύπους αρχείων.",
  "Already have an account?": "Έχετε ήδη λογαριασμό;",
  "Alternative to the top_p, and aims to ensure a balance of quality and variety. The parameter p represents the minimum probability for a token to be considered, relative to the probability of the most likely token. For example, with p=0.05 and the most likely token having a probability of 0.9, logits with a value less than 0.045 are filtered out.": "",
  Always,
  "Always Collapse Code Blocks": "Πάντα να συμπτύσσονται τα μπλοκ κώδικα",
  "Always Expand Details": "Πάντα να επεκτείνονται οι λεπτομέρειες",
  ...
  "Attribute for Mail": "Γνώρισμα για Email",
  "Attribute for Username": "Γνώρισμα για Όνομα Χρήστη",
  Audio,
  August,
  Auth,
  Authenticate,
  ...
  "by {{name}}": "",
  "By {{name}}": "Από {{name}}",
  "Bypass Embedding and Retrieval": "Παράκαμψη Ενσωματώσεων και Ανάκτησης",
  ...
  "Chat moved successfully": "Η συνομιλία μετακινήθηκε επιτυχώς",
  ...
  "Clone of {{TITLE}}": "Κλώνος του {{TITLE}}",
  Close,
  "Close Banner": "Κλείσιμο Ανακοίνωσης",
  "Close chat controls": "",
  "Close citation modal": "",
  "Close Configure Connection Modal": "Κλείσιμο παραθύρου διαμόρφωσης σύνδεσης",
  "Close feedback": "",
  "Close modal": "Κλείσιμο παραθύρου διαλόγου",
  "Close Modal": "",
  "Close settings modal": "Κλείσιμο παραθύρου διαμόρφωσης ρυθμίσεων",
  "Close Sidebar": "Κλείσιμο πλευρικής μπάρας",
  cloud,
  "CMU ARCTIC speaker embedding name": "Όνομα μοντέλου ενσωματώσεων ομιλητή CMU ARCTIC",
  "Code Block": "Μπλοκ Κώδικα",
  "Code Editor": "",
  "Code execution": "Εκτέλεση κώδικα",
  "Code Execution": "",
  "Code Execution Engine": "Μηχανή Εκτέλεσης Κώδικα",
  "Code Execution Timeout": "Χρονικό Όριο Εκτέλεσης Κώδικα",
  "Code formatted successfully": "Ο κώδικας μορφοποιήθηκε επιτυχώς",
  "Code Interpreter": "Διερμηνέας Κώδικα",
  "Code Interpreter Engine": "Μηχανή Διερμηνέα Κώδικα",
  "Code Interpreter Prompt Template": "Πρότυπο Προτροπής Διερμηνέα Κώδικα",
  ...
  Color,
  ComfyUI,
  "ComfyUI API Key": "API κλειδί του ComfyUI",
  ...
  "Confirm your new password": "Επιβεβαιώστε τον νέο σας κωδικό",
  "Confirm Your Password": "Επιβεβαιώστε τον Κωδικό σας",
  ...
  Connections,
  "Connections saved successfully": "Οι συνδέσεις αποθηκεύτηκαν επιτυχώς",
  "Connections settings updated": "Οι ρυθμίσεις σύνδεσης ενημερώθηκαν",
  "Constrains effort on reasoning for reasoning models. Only applicable to reasoning models from specific providers that support reasoning effort.": "",
  "Contact Admin for rexpro Access": "Επικοινωνήστε με τον Διαχειριστή για Πρόσβαση στο rexpro",
  Content,
  "Content Extraction Engine": "Μηχανή Εξαγωγής Περιεχομένου",
  ...
  "Conversation saved successfully": "Η συνομιλία αποθηκεύτηκε επιτυχώς",
  Copied,
  "Copied link to clipboard": "Αντιγράφηκε ο σύνδεσμος στο πρόχειρο",
  ...
  "Copy API Key": "",
  "Copy content": "",
  "Copy Formatted Text": "Αντιγραφή μορφοποιημένου κειμένου",
  ...
  "Create Image": "",
  "Create Knowledge": "Δημιουργία Knowledge",
  ...
  "Created by you": "Δημιουργήθηκε από εσάς",
  "Created on {{date}}": "",
  ...
  "Default action buttons will be used.": "Θα χρησιμοποιηθούν οι προεπιλεγμένες ενέργειες των κουμπιών.",
  "Default description enabled": "",
  "Default Features": "Προεπιλεγμένες Λειτουργίες",
  "Default Filters": "Προεπιλεγμένα Φίλτρα",
  "Default Group": "",
  ...
  "Default Prompt Suggestions": "Προεπιλεγμένες Προτεινόμενες Προτροπές",
  ...
  "Discover how to use rexpro-ai and seek support from the community.": "Εξερευνήστε πως να χρησιμοποιήσετε το rexpro-ai και αναζητήστε βοήθεια στην κοινότητα.",
  ...
  "Document Intelligence endpoint required.": "Απαιτείται το endpoint του Document Intelligence.",
  ...
  "Domain Filter List": "Λίστα Φίλτρων Domain",
  ...
  "e.g. 'low', 'medium', 'high'": "",
  'e.g. "json" or a JSON schema': 'π.χ. "json" ή ένα JSON σχήμα',
  "e.g. 60": "π.χ. 60",
  ...
  "e.g. pdf, docx, txt": "π.χ. pdf, docx, txt",
  ...
  "e.g., 3, 4, 5 (leave blank for default)": "π.χ. 3, 4, 5 (αφήστε κενό για προεπιλογή)",
  "e.g., audio/wav,audio/mpeg,video/* (leave blank for defaults)": "π.χ. audio/wav,audio/mpeg,video/* (αφήστε κενό για προεπιλογή)",
  "e.g., en-US,ja-JP (leave blank for auto-detect)": "π.χ. en-US,ja-JP (αφήστε κενό για αυτόματη ανίχνευση)",
  "e.g., westus (leave blank for eastus)": "π.χ. westus (αφήστε κενό για προεπιλογή)",
  Edit,
  ...
  "Enter Jupyter URL": "Εισάγετε Jupyter URL",
  ...
  "Enter SerpApi API Key": "Εισάγετε το Κλειδί API SerpApi",
  "Enter SerpApi Engine": "Εισάγετε τη Μηχανή SerpApi",
  ...
  "Enter Sougou Search API sID": "Εισάγετε το sID του API του Sougou",
  "Enter Sougou Search API SK": "Εισάγετε το SK του API του Sougou",
  ...
  "Enter the public URL of your rexpro. This URL will be used to generate links in the notifications.": "Εισάγετε το δημόσιο URL του rexpro σας. Αυτό το URL θα χρησιμοποιηθεί για να παράξει συνδέσμους στις ειδοποιήσεις.",
  ...
  "Enter timeout in seconds": "Εισάγετε το χρονικό όριο σε δευτερόλεπτα",
  "Enter to Send": "Εισάγετε για Αποστολή",
  "Enter Top K": "Εισάγετε το Top K",
  "Enter Top K Reranker": "Εισάγετε το Top K Reranker",
  ...
  "Enter value (true/false)": "Εισάγετε τιμή (true/false)",
  "Enter Yacy Password": "Εισάγετε τον κωδικό του Yacy",
  "Enter Yacy URL (e.g. http://yacy.example.com:8090)": "Εισάγετε το URL του Yacy (π.χ. http://yacy.example.com:8090)",
  "Enter Yacy Username": "Εισάγετε το όνομα χρήστη του Yacy",
  "Enter Yandex Web Search API Key": "",
  "Enter Yandex Web Search URL": "",
  "Enter You.com API Key": "",
  "Enter your code here...": "Εισάγετε τον κώδικά σας εδώ...",
  ...
  "Enter your gender": "Εισάγετε το φύλο σας",
  "Enter your message": "Εισάγετε το μήνυμά σας",
  "Enter your name": "Εισάγετε το όνομά σας",
  "Enter Your Name": "Εισάγετε το Όνομά σας",
  "Enter your new password": "Εισάγετε τον νέο κωδικό σας",
  ...
  "Enter your webhook URL": "Εισάγετε το URL του webhook σας",
  "Entra ID": "Εισάγετε το ID",
  ...
  "Exceeded the number of seats in your license. Please contact support to increase the number of seats.": "Υπερβαίνετε τον αριθμό των θέσεων στην άδειά σας. Επικοινωνήστε με την υποστήριξη για να αυξήσετε τον αριθμό των θέσεων.",
  Exclude,
  "Execute code": "",
  ...
  "External Task Model": "Εξωτερικό Μοντέλο Εργασιών",
  "External Web Loader API Key": "API κλειδί του εξωτερικού διακομιστή φόρτωσης",
  "External Web Loader URL": "URL του εξωτερικού διακομιστή φόρτωσης",
  "External Web Search API Key": "API κλειδί του εξωτερικού διακομιστή αναζήτησης",
  "External Web Search URL": "URL του εξωτερικού διακομιστή αναζήτησης",
  ...
  "Failed to fetch models": "Αποτυχία ανάκτησης μοντέλων",
  ...
  "Failed to render diagram": "Αποτυχία απεικόνισης διαγράμματος",
  "Failed to render visualization": "",
  "Failed to save connections": "Αποτυχία αποθήκευσης συνδέσεων",
  ...
  "Firecrawl API Base URL": "URL του API του Firecrawl",
  "Firecrawl API Key": "API κλειδί του Firecrawl",
  "Firecrawl Timeout (s)": "",
  ...
  Folders,
  "Follow up": "Συνέχιση",
  "Follow Up Generation": "Δημιουργία Συνέχισης",
  "Follow Up Generation Prompt": "Προτροπή Δημιουργίας Συνέχισης",
  "Follow up: {{question}}": "",
  "Follow-Up Auto-Generation": "Αυτόματη Δημιουργία Συνέχισης",
  ...
  Gemini,
  "Gemini API Key": "",
  "Gemini API Key is required.": "Απαιτείται το API κλειδί του Gemini.",
  "Gemini Base URL": "",
  ...
  "Get started with {{REXPRO_NAME}}": "Ξεκινήστε με {{REXPRO_NAME}}",
  Global,
  ...
  Image,
  "Image Compression": "",
  "Image Compression Height": "Ύψος Συμπίεσης Εικόνας",
  "Image Compression Width": "Πλάτος Συμπίεσης Εικόνας",
  "Image Edit": "",
  "Image Edit Engine": "",
  ...
  Inactive,
  Include,
  "Include `--api-auth` flag when running stable-diffusion-rexpro": "Συμπεριλάβετε το flag `--api-auth` όταν τρέχετε το stable-diffusion-rexpro",
  "Include `--api` flag when running stable-diffusion-rexpro": "Συμπεριλάβετε το flag `--api` όταν τρέχετε το stable-diffusion-rexpro",
  ...
  "Invalid file content": "Μη έγκυρο περιεχόμενο αρχείου",
  ...
  July,
  June,
  "Jupyter Auth": "Ταυτοποίηση Jupyter",
  "Jupyter URL": "",
  "JWT Expiration": "Λήξη JWT",
  "JWT Token": "",
  "Kagi Search API Key": "",
  "Keep Follow-Up Prompts in Chat": "",
  "Keep in Sidebar": "Κρατήστε στην πλευρική μπάρα",
  Key,
  "Key is required": "Το κλειδί είναι απαραίτητο",
  ...
  Language,
  "Language Locales": "Γλωσσική Τοπικοποίηση",
  "Last 24 hours": "",
  "Last 30 days": "",
  "Last 7 days": "",
  "Last 90 days": "",
  ...
  "Learn more about OpenAPI tool servers.": "Μάθετε περισσότερα για τους διακομιστές εργαλείων OpenAPI.",
  "Learn more about Voxtral transcription.": "",
  "Leave a public review for {{modelName}}": "",
  "Leave empty for no compression": "Αφήστε κενό για να μην γίνει συμπίεση",
  "Leave empty for unlimited": "Αφήστε κενό για απεριόριστο",
  'Leave empty to include all models from "{{url}}" endpoint': 'Αφήστε κενό για να χρησιμοποιήσετε όλα τα μοντέλα από το endpoint "{{url}}"',
  'Leave empty to include all models from "{{url}}/api/tags" endpoint': 'Αφήστε κενό για να χρησιμοποιήσετε όλα τα μοντέλα από το endpoint "{{url}}/api/tags"',
  'Leave empty to include all models from "{{url}}/models" endpoint': 'Αφήστε κενό για να χρησιμοποιήσετε όλα τα μοντέλα από το endpoint "{{url}}/models"',
  ...
  Low,
  LTR,
  "Made by rexpro-ai Community": "Δημιουργήθηκε από την Κοινότητα rexpro-ai",
  ...
  "Manage Tool Servers": "Διαχείριση Διακομιστών Εργαλείων",
  "Manage your account information.": "Διαχειριστείτε τις πληροφορίες του λογαριασμού σας.",
  March,
  Markdown,
  "Markdown Header Text Splitter": "",
  "Max Speakers": "Μέγιστο Πλήθος Ομιλητών",
  ...
  "No output items": "",
  "No pinned messages": "",
  "No prompts found": "Δεν βρέθηκαν προτροπές",
  ...
  "Oops! You're using an unsupported method (frontend only). Please serve the rexpro from the backend.": "Ωχ! Χρησιμοποιείτε μια μη υποστηριζόμενη μέθοδο (μόνο frontend). Παρακαλώ σερβίρετε το rexpro από το backend.",
  "Open file": "Άνοιγμα αρχείου",
  "Open in full screen": "Άνοιγμα σε πλήρη οθόνη",
  "Open in new tab": "",
  "Open link": "Άνοιγμα συνδέσμου",
  "Open modal to configure connection": "Άνοιγμα παραθύρου διαλόγου για διαχείριση σύνδεσης",
  "Open Modal To Manage Floating Quick Actions": "",
  "Open Modal To Manage Image Compression": "Άνοιγμα παραθύρου διαλόγου για διαχείριση συμπίεσης εικόνων",
  "Open Model Selector": "",
  "Open Settings": "",
  "Open Sidebar": "Άνοιγμα πλευρικής μπάρας",
  "Open Terminal": "",
  "Open User Profile Menu": "Άνοιγμα μενού προφίλ χρήστη",
  "rexpro-ai can use tools provided by any OpenAPI server.": "",
  "rexpro-ai uses faster-whisper internally.": "Το rexpro-ai χρησιμοποιεί το faster-whisper εσωτερικά.",
  "rexpro-ai uses SpeechT5 and CMU Arctic speaker embeddings.": "Το rexpro-ai χρησιμοποιεί τα SpeechT5 και CMU Arctic ενσωματώσεων ομιλητών.",
  "rexpro-ai version": "",
  "rexpro-ai version (v{{OPEN_REXPRO_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "Η έκδοση rexpro-ai (v{{OPEN_REXPRO_VERSION}}) είναι χαμηλότερη από την απαιτούμενη έκδοση (v{{REQUIRED_VERSION}})",
  OpenAI,
  "OpenAI API": "",
  "OpenAI API Base URL": "",
  "OpenAI API Key": "",
  ...
  "Pipelines Not Detected": "Δεν Εντοπίστηκαν Αγωγοί",
  "Pipelines Valves": "Βαλβίδες Αγωγών",
  "Plain text (.md)": "",
  ...
  Profile,
  Prompt,
  "Prompt Autocompletion": "Αυτόματη συμπλήρωση προτροπής",
  ...
  "Redirecting you to rexpro-ai Community": "Μετακατεύθυνση στην Κοινότητα rexpro-ai",
  ...
  "Reference Chats": "Αναφορά σε Συνομιλίες",
  Refresh,
  "Refused when it shouldn't have": "Αρνήθηκε όταν δεν έπρεπε",
  Regenerate,
  "Regenerate Menu": "Επαναδημιουργία Μενού",
  "Regenerate Response": "",
  "Register Again": "",
  "Register Client": "",
  Registered,
  ...
  Reindex,
  "Reindex Knowledge Base Vectors": "Επανευρετηρίαση Διανυσμάτων Βάσεις Γνώσεων",
  ...
  RESULT,
  Retrieval,
  "Retrieval Query Generation": "Δημιουργία Ερωτήματος Ανάκτησης",
  ...
  "search for archived chats": "αναζήτηση για αρχειοθετημένες συνομιλίες",
  "search for folders": "αναζήτηση για φακέλους",
  ...
  "Search Groups": "",
  "Search In Models": "Αναζήτηση στα Μοντέλα",
  "Search Knowledge": "Αναζήτηση Knowledge",
  "Search Memories": "",
  "Search Models": "Αναζήτηση Μοντέλων",
  "Search Notes": "Αναζήτηση Σημειώσεων",
  ...
  "Searched {{count}} sites": "Αναζητήθηκαν {{count}} ιστοσελίδες",
  Searching,
  'Searching "{{searchQuery}}"': 'Αναζήτηση "{{searchQuery}}"',
  'Searching Knowledge for "{{searchQuery}}"': 'Αναζήτηση Knowledge για "{{searchQuery}}"',
  "Searching the web": "Αναζητώντας στο διαδίκτυο",
  ...
  "Select a model (optional)": "Επιλέξτε ένα μοντέλο (προαιρετικό)",
  ...
  "Select a voice": "Επιλέξτε μια φωνή",
  "Select All": "",
  "Select an auth method": "Επιλέξτε μια μέθοδο ταυτοποίησης",
  "Select an embedding model engine": "",
  "Select an engine": "Επιλέξτε μια μηχανή",
  "Select an Ollama instance": "Επιλέξτε ένα στιγμιότυπο Ollama",
  "Select an option": "",
  "Select an output format": "Επιλέξτε τη μορφή της εξόδου",
  "Select dtype": "Επιλέξτε dtype",
  ...
  "Share to rexpro-ai Community": "Κοινή Χρήση στην Κοινότητα rexpro-ai",
  "Share your background and interests": "Μοιραστείτε μερικά λόγια για εσάς, όπως τα ενδιαφέροντά σας",
  "Shared Chats": "",
  ...
  "Sign in": "Σύνδεση",
  "Sign in to {{REXPRO_NAME}}": "Σύνδεση στο {{REXPRO_NAME}}",
  "Sign in to {{REXPRO_NAME}} with LDAP": "Σύνδεση στο {{REXPRO_NAME}} με LDAP",
  "Sign Out": "Αποσύνδεση",
  "Sign up": "Εγγραφή",
  "Sign up to {{REXPRO_NAME}}": "Εγγραφή στο {{REXPRO_NAME}}",
  ...
  "Signing in to {{REXPRO_NAME}}": "Σύνδεση στο {{REXPRO_NAME}}",
  Single,
  "Sink List": "",
  "sk-1234": "",
  ...
  Storage,
  "Stream Chat Response": "Ροή Δεδομένων Απαντήσεων",
  "Stream Delta Chunk Size": "Δέλτα Μεγέθους Τμήματος Ροής",
  "Streamable HTTP": "",
  Strikethrough,
  "Strip Existing OCR": "",
  ...
  "Tags Generation Prompt": "Προτροπή Δημιουργίας Ετικετών",
  ...
  "The evaluation leaderboard is based on the Elo rating system and is updated in real-time.": "Η κατάταξη αξιολόγησης βασίζεται στο σύστημα αξιολόγησης Elo και ενημερώνεται σε πραγματικό χρόνο.",
  "The format to return a response in. Format can be json or a JSON schema.": "",
  "The height in pixels to compress images to. Leave empty for no compression.": "Το ύψος σε pixel για συμπίεση εικόνων. Αφήστε κενό για να μην υπάρχει συμπίεση.",
  ...
  "The leaderboard is currently in beta, and we may adjust the rating calculations as we refine the algorithm.": "Η κατάταξη είναι αυτή τη στιγμή σε δοκιμαστική φάση, και ενδέχεται να προσαρμόσουμε τους υπολογισμούς βαθμολογίας καθώς βελτιώνουμε τον αλγόριθμο.",
  ...
  "The width in pixels to compress images to. Leave empty for no compression.": "Το πλάτος σε πίξελ για συμπίεση εικόνων. Αφήστε κενό για να μην υπάρχει συμπίεση.",
  Theme,
  ...
  "This model is not publicly available. Please select another model.": "Αυτό το μοντέλο δεν είναι δημόσια διαθέσιμο. Επιλέξτε ένα άλλο μοντέλο.",
  ...
  "To access the rexpro, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.": "Για να αποκτήσετε πρόσβαση στο rexpro, παρακαλώ επικοινωνήστε με τον διαχειριστή. Οι διαχειριστές μπορούν να διαχειριστούν τις καταστάσεις των χρηστών από τον Πίνακα Διαχειριστή.",
  'To attach knowledge base here, add them to the "Knowledge" workspace first.': 'Για να επισυνάψετε τη βάση γνώσης εδώ, προσθέστε τα πρώτα στον χώρο εργασίας "Γνώση".',
  ...
  "Tool Servers": "Διακομιστές Εργαλείων",
  ...
  "Tools Function Calling Prompt": "Προτροπή Κλήσης Εργαλείων Λειτουργιών",
  ...
  "Trust Proxy Environment": "Εμπιστοσύνη Διακομιστή Μεσολάβησης Περιβάλλοντος",
  "Try adjusting your search or filter to find what you are looking for.": "Δοκιμάστε να προσαρμόσετε την αναζήτηση ή το φίλτρο για να βρείτε αυτό που ψάχνετε.",
  "Try Again": "",
  ...
  "Update for the latest features and improvements.": "Ενημερωθείτε για τις τελευταίες λειτουργίες και βελτιώσεις.",
  "Update password": "Ενημέρωση κωδικού",
  "Update your status": "",
  Updated,
  "Updated at": "Ενημερώθηκε στις",
  "Updated At": "Ενημερώθηκε στις",
  "Upgrade to a licensed plan for enhanced capabilities, including custom theming and branding, and dedicated support.": "Αναβαθμίστε σε ένα πακέτο με άδεια χρήσης για βελτιωμένες λειτουργίες, συμπεριλαμβανομένων προσαρμοσμένων θεμάτων και branding, και ειδικής υποστήριξης.",
  Upload,
  "Upload a GGUF model": "Ανέβασμα μοντέλου GGUF",
  "Upload Audio": "Ανέβασμα Ήχου",
  "Upload directory": "Κατάλογος ανεβάσματος",
  "Upload files": "Ανέβασμα αρχείων",
  "Upload Files": "Ανέβασμα Αρχείων",
  "Upload Model": "Ανέβασμα Μοντέλου",
  ...
  "Use LLM": "Χρήση LLM",
  "Use no proxy to fetch page contents.": "Μη χρήση διακομιστή μεσολάβησης για λήψη περιεχομένου σελίδων.",
  "Use proxy designated by http_proxy and https_proxy environment variables to fetch page contents.": "Χρήση διακομιστή μεσολάβησης προορισμένο από τις http_proxy και https_proxy μεταβλητές περιβάλλοντος για λήψη περιεχομένου σελίδων.",
  user,
  User,
  "User Activity": "",
  ...
  "Validate certificate": "Επαλήθευση πιστοποιητικού",
  Valves,
  ...
  "Verify SSL Certificate": "Επαλήθευση Πιστοποιητικού SSL",
  Version,
  "Version {{selectedVersion}} of {{totalVersions}}": "Έκδοση {{selectedVersion}} από {{totalVersions}}",
  "Version deleted": "",
  "View Replies": "Προβολή Απαντήσεων",
  ...
  "Web Search in Chat": "",
  "Web Search Query Generation": "Δημιουργία Ερωτήματος Αναζήτησης Διαδικτύου",
  "Webhook Name": "",
  "Webhook URL": "URL Webhook",
  Webhooks,
  "Webpage URLs": "",
  "rexpro Settings": "Ρυθμίσεις rexpro",
  "rexpro URL": "",
  'rexpro will make requests to "{{url}}"': 'Το rexpro θα κάνει αιτήματα στο "{{url}}"',
  'rexpro will make requests to "{{url}}/api/chat"': 'Το rexpro θα κάνει αιτήματα στο "{{url}}/api/chat"',
  'rexpro will make requests to "{{url}}/chat/completions"': 'Το rexpro θα κάνει αιτήματα στο "{{url}}/chat/completions"',
  Week,
  Weekly,
  ...
  Write,
  "Write a summary in 50 words that summarizes {{topic}}.": "Γράψτε μια περίληψη σε 50 λέξεις που συνοψίζει [θέμα ή λέξη-κλειδί].",
  ...
  "Yacy Instance URL": "",
  "Yacy Password": "Κωδικός Yacy",
  "Yacy Username": "Όνομα χρήστη Yacy",
  Yahoo,
  Yandex,
  ...
  Yesterday,
  "Yesterday at {{LOCALIZED_TIME}}": "Εχθές στις {{LOCALIZED_TIME}}",
  You,
  ...
  "Your entire contribution will go directly to the plugin developer; rexpro-ai does not take any percentage. However, the chosen funding platform might have its own fees.": "Η ολόκληρη η συνεισφορά σας θα πάει απευθείας στον προγραμματιστή του plugin· το rexpro-ai δεν παίρνει κανένα ποσοστό. Ωστόσο, η επιλεγμένη πλατφόρμα χρηματοδότησης μπορεί να έχει τα δικά της τέλη.",
  "Your message text or inputs": "",
  "Your usage stats have been successfully synced.": "",
  YouTube,
  "Youtube Language": "Γλώσσα YouTube",
  "Youtube Proxy URL": "URL Διακομιστή Μεσολάβησης YouTube"
};
export {
  AI,
  About,
