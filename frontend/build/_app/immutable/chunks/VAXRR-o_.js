const About = "Относно";
const Access = "Достъп";
const Account = "Акаунт";
const Action = "";
const Actions = "Действия";
const Activate = "Активиране";
...
const All = "";
const Always = "Винаги";
const Amazing = "Невероятно";
const Analytics = "";
const Analyzed = "Анализирано";
const Android = "";
const Anyone = "";
const April = "Април";
const Archive = "Архивирани Чатове";
...
const August = "Август";
const Auth = "";
const Authenticate = "Удостоверяване";
const Authentication = "Автентикация";
const Auto = "Авто";
...
const Camera = "Камера";
const Cancel = "Отказ";
const Capabilities = "Възможности";
const Capture = "Заснемане";
const Channel = "";
const Channels = "Канали";
const Character = "Герой";
const Chat = "Чат";
const chats = "";
const Chats = "Чатове";
const Ciphers = "Шифри";
const Citation = "Цитат";
const Citations = "";
const Clone = "Клонинг";
const Close = "Затвори";
const cloud = "";
const Collapse = "";
const Collection = "Колекция";
const Collections = "";
const Color = "Цвят";
...
const Comment = "";
const Completions = "Довършвания";
const Config = "";
const Configuration = "";
const Configure = "Конфигуриране";
const Confirm = "Потвърди";
const Connections = "Връзки";
const Content = "Съдържание";
const Controls = "Контроли";
const Copied = "Копирано";
const Copy = "Копирай";
const CPU = "";
const Create = "Създай";
const Custom = "Персонализиран";
const Daily = "";
const Dark = "Тъмен";
const Database = "База данни";
const Day = "";
const December = "Декември";
const Deepgram = "";
const Default = "По подразбиране";
const Defaults = "";
...
const Dictate = "";
const Direct = "";
const Disabled = "Деактивирано";
const Display = "Показване";
const Docling = "";
const Document = "Документ";
const Documentation = "Документация";
const Documents = "";
const Done = "Готово";
const Download = "Изтегляне";
const Draw = "Рисуване";
const DuckDuckGo = "";
const Edit = "Редактиране";
const edited = "";
const Edited = "";
const Editing = "";
const Eject = "";
...
const Emoji = "";
const Emojis = "";
const Enabled = "Активирано";
const Enhance = "";
const Ephemeral = "";
const ERROR = "ГРЕШКА";
const Evaluations = "Оценки";
const Exclude = "Изключи";
const Expand = "";
const Experimental = "Експериментално";
const Explain = "";
const Explored = "";
const Exploring = "";
const Export = "Износ";
...
const Gemini = "";
const Gender = "";
const General = "Основни";
const Generate = "";
const Global = "Глобално";
const Google = "";
const Gravatar = "";
const Grid = "";
const Grokipedia = "";
...
const Language = "Език";
const LDAP = "LDAP";
const Leaderboard = "Класация";
const Legacy = "";
const lexical = "";
const License = "Лиценз";
const Light = "Светъл";
const List = "";
const Live = "";
const Loaded = "";
...
const Muted = "";
const Name = "Име";
const Native = "Нативен";
const Never = "";
const New = "";
const None = "Никой";
const Note = "";
const Notes = "Бележки";
const Notifications = "Известия";
const November = "Ноември";
const OAuth = "";
const October = "Октомври";
const Off = "Изкл.";
const Ollama = "Ollama";
const On = "Вкл.";
const Once = "";
...
const Paused = "";
const pending = "в очакване";
const Pending = "";
const Permissions = "Разрешения";
const Persistent = "";
const Personalization = "Персонализация";
const Pin = "Закачи";
const Pinned = "Закачено";
const Pipe = "";
const Pipelines = "";
const Playground = "Плейграунд";
const Port = "Порт";
const Ports = "";
const Preview = "";
const Private = "";
const Profile = "Профил";
const Prompt = "Промпт";
const Prompts = "Промптове";
const Provider = "";
const Public = "Публично";
const Querying = "";
const Rating = "Оценка";
const Read = "Четене";
const Reason = "";
...
const Record = "Запиши";
const Refresh = "";
const Regenerate = "Регенериране";
const Registered = "";
const Reindex = "Реиндексирай";
const Releases = "";
const Relevance = "Релевантност";
const Reminder = "";
const Remove = "Изтриване";
const Rename = "Преименуване";
const Repeats = "";
const Reply = "";
const required = "";
const Reset = "Нулиране";
const Response = "";
const Responses = "";
const Restart = "";
const Result = "Резултат";
const RESULT = "Резултат";
const Retrieval = "Извличане";
const Role = "Роля";
const RTL = "RTL";
const Run = "Изпълни";
const Running = "Изпълнява се";
const Sa_day_of_week = "";
const Save = "Запис";
const Saved = "Запазено";
const Schedule = "";
const Search = "Търси";
const Searching = "";
const Seed = "Начално число";
const Select = "";
const semantic = "";
const Send = "Изпрати";
const September = "Септември";
const Session = "";
const Setting = "";
...
const Subtitle = "";
const Success = "Успех";
const Suggested = "Препоръчано";
const Support = "Поддръжка";
const Sync = "";
...
const tokens = "";
const Tokens = "";
const Tools = "Инструменти";
const Top = "";
const Transformers = "Трансформатори";
const Tu_day_of_week = "";
const Type = "Вид";
const UI = "Потребителски интерфейс";
const Underline = "";
const Unknown = "";
const Unmute = "";
const Unpin = "Откачи";
const Untagged = "Без етикет";
const Untitled = "Неозаглавен";
const Update = "Актуализиране";
const Updated = "Актуализирано";
const Upload = "Качване";
const URL = "URL";
const Usage = "";
const Use = "";
const user = "потребител";
const User = "Потребител";
const Username = "Потребителско име";
const users = "";
const Users = "Потребители";
const Valves = "Клапани";
const variable = "променлива";
const Version = "Версия";
const Visibility = "Видимост";
const Visible = "";
const Vision = "";
const Visual = "";
const Voice = "Глас";
...
const Wikipedia = "";
const Won = "Спечелено";
const Workspace = "Работно пространство";
const Write = "Напиши";
const Yahoo = "";
const Yandex = "";
...
const translation = {
  ...
  "{{rexproAIName}} Backend Required": "{{rexproAIName}} Изисква се Бекенд",
  ...
  "Contact Admin for rexpro Access": "Свържете се с администратор за достъп до rexpro",
  Content,
  ...
  "CORS must be properly configured by the provider to allow requests from rexpro-ai.": "CORS трябва да бъде правилно конфигуриран от доставчика, за да позволи заявки от rexpro-ai.",
  "Could not read file.": "",
  CPU,
  Create,
  ...
  "Discover how to use rexpro-ai and seek support from the community.": "Открийте как да използвате rexpro-ai и потърсете подкрепа от общността.",
  ...
  "Enter the public URL of your rexpro. This URL will be used to generate links in the notifications.": "Въведете публичния URL адрес на вашия rexpro. Този URL адрес ще бъде използван за генериране на връзки в известията.",
  ...
  "Get started with {{REXPRO_NAME}}": "Започнете с {{REXPRO_NAME}}",
  Global,
  ...
  Low,
  LTR,
  "Made by rexpro-ai Community": "Направено от rexpro-ai общността",
  ...
  "Oops! You're using an unsupported method (frontend only). Please serve the rexpro from the backend.": "Упс! Използвате неподдържан метод (само фронтенд). Моля, сервирайте rexpro от бекенда.",
  ...
  "rexpro-ai uses faster-whisper internally.": "rexpro-ai използва вътрешно по-бързо-whisper.",
  "rexpro-ai uses SpeechT5 and CMU Arctic speaker embeddings.": "rexpro-ai използва SpeechT5 и CMU Arctic говорителни вграждания.",
  "rexpro-ai version": "",
  "rexpro-ai version (v{{OPEN_REXPRO_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "Версията на rexpro-ai (v{{OPEN_REXPRO_VERSION}}) е по-ниска от необходимата версия (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "Redirecting you to rexpro-ai Community": "Пренасочване към rexpro-ai общността",
  ...
  "Share to rexpro-ai Community": "Споделете с rexpro-ai Общността",
  ...
  "Sign in": "Вписване",
  "Sign in to {{REXPRO_NAME}}": "Впишете се в {{REXPRO_NAME}}",
  "Sign in to {{REXPRO_NAME}} with LDAP": "Впишете се в {{REXPRO_NAME}} с LDAP",
  "Sign Out": "Изход",
  "Sign up": "Регистрация",
  "Sign up to {{REXPRO_NAME}}": "Регистрирайте се в {{REXPRO_NAME}}",
  ...
  "Signing in to {{REXPRO_NAME}}": "Вписване в {{REXPRO_NAME}}",
  Single,
  "Sink List": "",
  "sk-1234": "sk-1234",
  ...
  "To access the rexpro, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.": "За достъп до уеб интерфейса, моля, свържете се с администратора. Администраторите могат да управляват статусите на потребителите от Административния панел.",
  ...
  Webhooks,
  "Webpage URLs": "",
  "rexpro Settings": "rexpro Настройки",
  "rexpro URL": "URL на rexpro",
  'rexpro will make requests to "{{url}}"': "",
  'rexpro will make requests to "{{url}}/api/chat"': 'rexpro ще прави заявки към "{{url}}/api/chat"',
  'rexpro will make requests to "{{url}}/chat/completions"': 'rexpro ще прави заявки към "{{url}}/chat/completions"',
  Week,
  Weekly,
  ...
  Write,
  "Write a summary in 50 words that summarizes {{topic}}.": "Напиши описание в 50 думи, което обобщава [тема или ключова дума].",
  ...
  "Your entire contribution will go directly to the plugin developer; rexpro-ai does not take any percentage. However, the chosen funding platform might have its own fees.": "Цялата ви вноска ще отиде директно при разработчика на плъгина; rexpro-ai не взима никакъв процент. Въпреки това, избраната платформа за финансиране може да има свои собствени такси.",
