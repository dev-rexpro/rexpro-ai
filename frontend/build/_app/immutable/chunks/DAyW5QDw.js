...
const AI = "";
const All = "Toate";
const Always = "Întotdeauna";
const Amazing = "Uimitor";
const Analytics = "";
const Analyzed = "Analizat";
const Android = "Android";
const Anyone = "";
const April = "Aprilie";
const Archive = "Arhivează";
const Artifacts = "Artefacte";
const Asc = "";
const Ask = "Întreabă";
...
const August = "August";
const Auth = "";
const Authenticate = "Autentifică";
const Authentication = "Autentificare";
const Auto = "";
const Automatic1111 = "Automatic1111 este un proiect popular pentru interfața grafică a utilizatorului a modelelor de difuzie stabilă. Aceasta oferă o interfață web pentru a genera imagini folosind AI și este utilizată pe scară largă pentru a experimenta cu generarea de artă AI.";
const Automation = "";
const Automations = "";
const Away = "Plecat";
const Awful = "";
...
const Call = "Apel";
const Camera = "Cameră";
const Cancel = "Anulează";
const Capabilities = "Capabilități";
const Capture = "";
const Channel = "";
const Channels = "";
const Character = "Caracter";
const Chat = "Conversație";
const chats = "";
const Chats = "Conversații";
const Ciphers = "Cifruri";
const Citation = "Citație";
const Citations = "Citații";
const Clone = "Clonează";
const Close = "Închide";
const cloud = "";
const Collapse = "";
const Collection = "Colecție";
const Collections = "";
const Color = "Culoare";
const ComfyUI = "ComfyUI";
const command = "";
const Command = "Comandă";
const Comment = "";
const Completions = "Completări";
const Config = "";
const Configuration = "";
const Configure = "Configurează";
const Confirm = "Confirmă";
const Connections = "Conexiuni";
const Content = "Conținut";
const Controls = "Controale";
const Copied = "Copiat";
const Copy = "Copiază";
const CPU = "";
const Create = "Creează";
const Custom = "Personalizat";
const Daily = "";
const Dark = "Întunecat";
const Database = "Bază de Date";
const Day = "";
...
const Dictate = "";
const Direct = "";
const Disabled = "Dezactivat";
const Display = "";
const Docling = "";
const Document = "Document";
const Documentation = "Documentație";
const Documents = "";
const Done = "Gata";
const Download = "Descarcă";
const Draw = "Desenează";
const DuckDuckGo = "";
const Edit = "Editează";
const edited = "";
const Edited = "";
...
const Emoji = "";
const Emojis = "";
const Enabled = "Activat";
const Enhance = "";
const Ephemeral = "";
const ERROR = "EROARE";
const Evaluations = "Evaluări";
...
const June = "Iunie";
const Key = "";
const Knowledge = "Cunoștințe";
const Label = "";
const Language = "Limbă";
const LDAP = "";
const Leaderboard = "Tabel de clasament";
const Legacy = "";
const lexical = "";
const License = "";
const Light = "Luminos";
...
const Note = "";
const Notes = "Note";
const Notifications = "Notificări";
const November = "Noiembrie";
const OAuth = "";
const October = "Octombrie";
const Off = "Dezactivat";
const Ollama = "Ollama";
const On = "Activat";
const Once = "";
const OneDrive = "";
...
const Other = "Altele";
const Output = "";
const OUTPUT = "Output rezultatat";
const Overview = "Privire de ansamblu";
const page = "pagina";
const Page = "";
const Paginate = "";
const Parameters = "";
const Password = "Parolă";
const Paused = "";
const pending = "în așteptare";
const Pending = "";
const Permissions = "";
const Persistent = "";
const Personalization = "Personalizare";
const Pin = "Fixează";
const Pinned = "Fixat";
const Pipe = "";
const Pipelines = "";
const Playground = "Teren de Joacă";
const Port = "";
const Ports = "";
const Preview = "";
const Private = "";
...
const Prompt = "";
const Prompts = "Prompturi";
const Provider = "";
const Public = "";
const Querying = "";
const Rating = "Evaluare";
const Read = "Citește";
const Reason = "";
const Reconnected = "";
const Record = "";
const Refresh = "";
const Regenerate = "Regenerare";
const Registered = "";
const Reindex = "";
const Releases = "";
const Relevance = "Relevanță";
const Reminder = "";
const Remove = "Înlătură";
const Rename = "Redenumește";
const Repeats = "";
const Reply = "";
const required = "";
const Reset = "Resetează";
const Response = "";
const Responses = "";
const Restart = "";
const Result = "Rezultat";
const RESULT = "Rezultat";
const Retrieval = "";
const Role = "Rol";
const RTL = "RTL";
const Run = "Execută";
const Running = "Rulează";
...
const tokens = "";
const Tokens = "";
const Tools = "Instrumente";
const Top = "";
const Transformers = "";
const Tu_day_of_week = "";
const Type = "Tip";
const UI = "Interfață Utilizator";
const Underline = "";
const Unknown = "";
const Unmute = "";
const Unpin = "Anulează Fixarea";
const Untagged = "Netichetat";
const Untitled = "";
const Update = "Actualizează";
const Updated = "Actualizat";
const Upload = "Încărcare";
const URL = "";
const Usage = "";
const Use = "";
...
const Username = "";
const users = "";
const Users = "Utilizatori";
const Valves = "Valve";
const variable = "variabilă";
const Version = "Versiune";
const Visibility = "Vizibilitate";
const Visible = "";
const Vision = "";
const Visual = "";
const Voice = "Voce";
...
const Wikipedia = "";
const Won = "Câștigat";
const Workspace = "Spațiu de Lucru";
const Write = "Scrie";
const Yahoo = "";
const Yandex = "";
...
const translation = {
  ...
  "(e.g. `sh rexpro.sh --api --api-auth username_password`)": "(de ex. `sh rexpro.sh --api --api-auth username_password`)",
  "(e.g. `sh rexpro.sh --api`)": "(de ex. `sh rexpro.sh --api`)",
  "(latest)": "(ultimul)",
  ...
  "{{rexproAIName}} Backend Required": "Este necesar backend-ul {{rexproAIName}}",
  ...
  "Contact Admin for rexpro Access": "Contactează administratorul pentru acces rexpro",
  Content,
  ...
  Inactive,
  Include,
  "Include `--api-auth` flag when running stable-diffusion-rexpro": "Includeți flag-ul `--api-auth` când rulați stable-diffusion-rexpro",
  "Include `--api` flag when running stable-diffusion-rexpro": "Includeți flag-ul `--api` când rulați stable-diffusion-rexpro",
  ...
  Low,
  LTR,
  "Made by rexpro-ai Community": "Realizat de Comunitatea rexpro-ai",
  ...
  "Oops! You're using an unsupported method (frontend only). Please serve the rexpro from the backend.": "Oops! Utilizați o metodă nesuportată (doar frontend). Vă rugăm să serviți rexpro din backend.",
  ...
  "rexpro-ai uses faster-whisper internally.": "rexpro-ai folosește faster-whisper intern.",
  "rexpro-ai uses SpeechT5 and CMU Arctic speaker embeddings.": "",
  "rexpro-ai version": "",
  "rexpro-ai version (v{{OPEN_REXPRO_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "Versiunea rexpro-ai (v{{OPEN_REXPRO_VERSION}}) este mai mică decât versiunea necesară (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "Redirecting you to rexpro-ai Community": "Vă redirecționăm către Comunitatea rexpro-ai",
  ...
  "Share to rexpro-ai Community": "Partajează cu Comunitatea rexpro-ai",
  ...
  "Sign in to {{REXPRO_NAME}}": "Conectează-te la {{REXPRO_NAME}}",
  "Sign in to {{REXPRO_NAME}} with LDAP": "",
  "Sign Out": "Deconectare",
  "Sign up": "Înregistrare",
  "Sign up to {{REXPRO_NAME}}": "Înregistrează-te la {{REXPRO_NAME}}",
  ...
  "Signing in to {{REXPRO_NAME}}": "Autentificare în {{REXPRO_NAME}}",
  Single,
  "Sink List": "",
  "sk-1234": "",
  ...
  "To access the rexpro, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.": "Pentru a accesa rexpro, vă rugăm să contactați administratorul. Administratorii pot gestiona statusurile utilizatorilor din Panoul de Administrare.",
  ...
  Write,
  "Write a summary in 50 words that summarizes {{topic}}.": "Scrieți un rezumat în 50 de cuvinte care rezumă [subiect sau cuvânt cheie].",
