const About = "O aplikaci";
const Access = "Přístup";
const Account = "Účet";
const Action = "Akce";
const Actions = "Akce";
const Activate = "Aktivovat";
const Active = "Aktivní";
const Activity = "";
const Add = "Přidat";
...
const All = "Vše";
const Always = "Vždy";
const Amazing = "Úžasné";
const Analytics = "Analytika";
const Analyzed = "Analyzováno";
const Android = "Android";
const Anyone = "";
const April = "Duben";
const Archive = "Archivovat";
...
const August = "Srpen";
const Auth = "Ověření";
const Authenticate = "Ověřit";
const Authentication = "Ověřování";
const Auto = "Auto";
const Automatic1111 = "Automatic1111";
const Automation = "";
const Automations = "";
const Away = "Nepřítomen";
const Awful = "Hrozné";
const Back = "Zpět";
const Banners = "Upozornění";
const Bearer = "Bearer";
const before = "před";
const Beta = "Beta";
const Bing = "";
...
const Bold = "Tučně";
const Brave = "";
const Calendar = "Kalendář";
const Calendars = "";
const Call = "Volání";
const Camera = "Kamera";
const Cancel = "Zrušit";
const Capabilities = "Schopnosti";
const Capture = "Zaznamenat";
const Channel = "";
const Channels = "Kanály";
const Character = "Postava";
const Chat = "Konverzace";
const chats = "";
const Chats = "Konverzace";
const Ciphers = "Šifry";
const Citation = "Citace";
const Citations = "Citace";
const Clone = "Klonovat";
const Close = "Zavřít";
const cloud = "";
const Collapse = "Sbalit";
const Collection = "Kolekce";
const Collections = "";
const Color = "Barva";
const ComfyUI = "ComfyUI";
const command = "";
const Command = "Příkaz";
const Comment = "Komentář";
const Completions = "Dokončení";
const Config = "";
const Configuration = "";
const Configure = "Konfigurovat";
const Confirm = "Potvrdit";
const Connections = "Připojení";
const Content = "Obsah";
const Controls = "Ovládací prvky";
const Copied = "Zkopírováno";
const Copy = "Kopírovat";
const CPU = "";
const Create = "Vytvořit";
const Custom = "Vlastní";
const Daily = "";
const Dark = "Tmavý";
const Database = "Databáze";
const Day = "";
const December = "Prosinec";
const Deepgram = "Deepgram";
const Default = "Výchozí";
const Defaults = "";
const Delete = "Smazat";
const Deleted = "";
const Desc = "";
...
const Deselect = "";
const Dictate = "Diktovat";
const Direct = "Přímé";
const Disabled = "Zakázáno";
const Display = "Zobrazení";
const Docling = "Docling";
const Document = "Dokument";
const Documentation = "Dokumentace";
const Documents = "";
const Done = "Hotovo";
const Download = "Stáhnout";
const Draw = "Kreslit";
const DuckDuckGo = "";
const Edit = "Upravit";
const edited = "";
const Edited = "Upraveno";
const Editing = "Upravuje se";
const Eject = "Vysunout";
const ElevenLabs = "ElevenLabs";
const Email = "E-mail";
const Embedding = "Vektorizace";
const Emoji = "";
const Emojis = "";
const Enabled = "Povoleno";
const Enhance = "Vylepšit";
const Ephemeral = "";
const ERROR = "CHYBA";
const Evaluations = "Hodnocení";
const Exclude = "Vyloučit";
const Expand = "Rozbalit";
const Experimental = "Experimentální";
const Explain = "Vysvětlit";
const Explored = "";
const Exploring = "";
const Export = "Exportovat";
const External = "Externí";
...
const Folder = "Složka";
const Folders = "Složky";
const Form = "Formulář";
const Forward = "";
const Fr_day_of_week = "";
const Functions = "Funkce";
const Gemini = "Gemini";
const Gender = "Pohlaví";
const General = "Obecné";
const Generate = "Generovat";
const Global = "Globální";
const Google = "";
const Gravatar = "";
const Grid = "";
const Grokipedia = "";
...
const Image = "Obrázek";
const Images = "";
const Import = "Importovat";
const Inactive = "";
const Include = "Zahrnout";
const Info = "Info";
const Initials = "";
const Input = "Vstup";
const Insert = "Vložit";
const Instructions = "";
const Integration = "Integrace";
const Integrations = "Integrace";
const Interface = "Rozhraní";
const Italic = "Kurzíva";
const January = "Leden";
const July = "Červenec";
const June = "Červen";
const Key = "Klíč";
...
const LDAP = "LDAP";
const Leaderboard = "Žebříček";
const Legacy = "";
const lexical = "lexikální";
const License = "Licence";
const Light = "Světlý";
const List = "";
const Live = "";
const Loaded = "";
const Loader = "Zavaděč";
const local = "";
const Local = "Lokální";
const Location = "";
const Lost = "Prohrál";
...
const Monthly = "";
const More = "Více";
const Move = "Přesunout";
const Mute = "";
const Muted = "";
const Name = "Jméno";
const Native = "Nativní";
const Never = "";
const New = "";
const None = "Žádný";
const Note = "Poznámka";
const Notes = "Poznámky";
const Notifications = "Oznámení";
...
const Output = "";
const OUTPUT = "VÝSTUP";
const Overview = "Přehled";
const page = "stránka";
const Page = "";
const Paginate = "Stránkovat";
const Parameters = "Parametry";
const Password = "Heslo";
const Paused = "";
const pending = "čeká na vyřízení";
const Pending = "Čeká na vyřízení";
const Permissions = "Oprávnění";
const Persistent = "";
const Personalization = "Personalizace";
const Pin = "Připnout";
const Pinned = "Připnuto";
const Pipe = "Pipe";
const Pipelines = "";
const Playground = "Hřiště";
const Port = "Port";
const Ports = "";
const Preview = "Náhled";
const Private = "Soukromé";
const Profile = "Profil";
const Prompt = "Instrukce";
const Prompts = "Instrukce";
const Provider = "";
const Public = "Veřejné";
const Querying = "";
...
const Record = "Nahrát";
const Refresh = "";
const Regenerate = "Znovu generovat";
const Registered = "";
const Reindex = "Přeindexovat";
const Releases = "Vydání";
const Relevance = "Relevance";
const Reminder = "";
const Remove = "Odebrat";
const Rename = "Přejmenovat";
const Repeats = "";
const Reply = "";
const required = "";
const Reset = "Resetovat";
const Response = "Odpověď";
const Responses = "";
const Restart = "";
const Result = "Výsledek";
const RESULT = "Výsledek";
const Retrieval = "Vyhledávání";
const Role = "Role";
const RTL = "RTL";
const Run = "Spustit";
const Running = "Běží";
...
const Seed = "seed";
const Select = "Vybrat";
const semantic = "sémantický";
const Send = "Odeslat";
const September = "Září";
const Session = "Relace";
const Setting = "";
const Settings = "Nastavení";
const Share = "Sdílet";
const Show = "Zobrazit";
const Single = "";
const Skills = "";
...
const Stop = "Zastavit";
const Storage = "";
const Strikethrough = "Přeškrtnutí";
const Su_day_of_week = "";
const Subtitle = "";
const Success = "Úspěch";
...
const Type = "Typ";
const UI = "UI";
const Underline = "Podtržení";
const Unknown = "";
const Unmute = "";
const Unpin = "Odepnout";
const Untagged = "Bez štítku";
const Untitled = "Bez názvu";
const Update = "Aktualizovat";
const Updated = "Aktualizováno";
const Upload = "Nahrát";
const URL = "URL";
const Usage = "Využití";
const Use = "";
...
const Valves = "Valves";
const variable = "proměnná";
const Version = "Verze";
const Visibility = "Viditelnost";
const Visible = "";
const Vision = "Zpracovávání obrazu";
const Visual = "";
const Voice = "Hlas";
const Warning = "Varování";
...
const Wikipedia = "";
const Won = "Vyhrál";
const Workspace = "Pracovní prostor";
const Write = "Napsat";
const Yahoo = "";
const Yandex = "";
...
const translation = {
  ...
  "(e.g. `sh rexpro.sh --api --api-auth username_password`)": "(např. `sh rexpro.sh --api --api-auth username_password`)",
  "(e.g. `sh rexpro.sh --api`)": "(např. `sh rexpro.sh --api`)",
  "(latest)": "(nejnovější)",
  ...
  "{{rexproAIName}} Backend Required": "Je vyžadován backend {{rexproAIName}}",
  ...
  "A task model is used when performing tasks such as generating titles for chats and web search queries": "Model pro úkoly se používá při provádění úkolů, jako je generování názvů pro konverzace a vyhledávací dotazy na webu.",
  "a user": "uživatel",
  About,
  ...
  "Add a tag...": "",
  "Add Access": "",
  "Add Arena Model": "Přidat model do arény",
  ...
  "Allow Chat Controls": "Povolit ovládací prvky chatu",
  "Allow Chat Delete": "Povolit smazání konverzace",
  "Allow Chat Edit": "Povolit úpravu konverzace",
  "Allow Chat Export": "Povolit export konverzace",
  "Allow Chat Params": "Povolit parametry chatu",
  ...
  "Allow User Location": "Povolit zjištění polohy uživatele",
  "Allow Voice Interruption in Call": "Povolit přerušení hlasu při hovoru",
  "Allow Web Upload": "",
  "Allowed Endpoints": "Povolené koncové body",
  "Allowed File Extensions": "Povolené přípony souborů",
  "Allowed file extensions for upload. Separate multiple extensions with commas. Leave empty for all file types.": "Povolené přípony souborů pro nahrání. Více přípon oddělte čárkami. Ponechte prázdné pro všechny typy souborů.",
  "Already have an account?": "Už máte účet?",
  "Alternative to the top_p, and aims to ensure a balance of quality and variety. The parameter p represents the minimum probability for a token to be considered, relative to the probability of the most likely token. For example, with p=0.05 and the most likely token having a probability of 0.9, logits with a value less than 0.045 are filtered out.": "Alternativa k top_p, jejímž cílem je zajistit rovnováhu mezi kvalitou a rozmanitostí. Parametr p představuje minimální pravděpodobnost, s jakou je token zvažován, vztaženou k pravděpodobnosti nejpravděpodobnějšího tokenu. Například při p=0,05 a nejpravděpodobnějším tokenu s pravděpodobností 0,9 jsou odfiltrovány logity s hodnotou menší než 0,045.",
  Always,
  "Always Collapse Code Blocks": "Vždy sbalit bloky kódu",
  "Always Expand Details": "Vždy rozbalit podrobnosti",
  ...
  "Application DN Password": "Heslo pro Application DN",
  'applies to all users with the "user" role': 'platí pro všechny uživatele s rolí "user"',
  April,
  Archive,
  "Archive All": "",
  ...
  Automatic1111,
  "AUTOMATIC1111 Api Auth String": "Ověřovací řetězec API pro AUTOMATIC1111",
  ...
  Banners,
  "Base Model (From)": "Základní model (ze souboru)",
  ...
  "Button Prompt": "Instrukce tlačítka",
  "by {{name}}": "",
  "By {{name}}": "Od {{name}}",
  "Bypass Embedding and Retrieval": "Obejít vkládání a vyhledávání",
  ...
  "Click here for filter guides.": "Klikněte zde pro průvodce filtry.",
  "Click here for help.": "Klikněte zde pro nápovědu.",
  "Click here to": "Klikněte zde pro",
  "Click here to download user import template file.": "Klikněte zde pro stažení šablony souboru pro import uživatelů.",
  "Click here to learn more about faster-whisper and see the available models.": "Klikněte zde, abyste se dozvěděli více o faster-whisper a prohlédli si dostupné modely.",
  "Click here to see available models.": "Klikněte zde pro zobrazení dostupných modelů.",
  "Click here to select": "Klikněte zde pro výběr",
  "Click here to select a csv file.": "Klikněte zde pro výběr CSV souboru.",
  "Click here to select a py file.": "Klikněte zde pro výběr souboru .py.",
  ...
  "Clone of {{TITLE}}": "Klon konverzace {{TITLE}}",
  Close,
  "Close Banner": "Zavřít upozornění",
  "Close chat controls": "",
  "Close citation modal": "",
  "Close Configure Connection Modal": "Zavřít modální okno konfigurace připojení",
  "Close feedback": "",
  "Close modal": "Zavřít modální okno",
  "Close Modal": "",
  "Close settings modal": "Zavřít modální okno nastavení",
  "Close Sidebar": "Zavřít postranní panel",
  cloud,
  "CMU ARCTIC speaker embedding name": "Název vektorizace mluvčího CMU ARCTIC",
  "Code Block": "Blok kódu",
  "Code Editor": "",
  "Code execution": "Spouštění kódu",
  "Code Execution": "",
  "Code Execution Engine": "Jádro pro spouštění kódu",
  "Code Execution Timeout": "Časový limit pro spuštění kódu",
  "Code formatted successfully": "Kód byl úspěšně naformátován.",
  "Code Interpreter": "Interpret kódu",
  "Code Interpreter Engine": "Jádro interpretu kódu",
  "Code Interpreter Prompt Template": "Šablona instrukce pro interpret kódu",
  ...
  Color,
  ComfyUI,
  "ComfyUI API Key": "API klíč pro ComfyUI",
  "ComfyUI Base URL": "Základní URL pro ComfyUI",
  ...
  "Confirm your action": "Potvrďte svou akci",
  ...
  Connections,
  "Connections saved successfully": "Připojení byla úspěšně uložena",
  "Connections settings updated": "Nastavení připojení aktualizováno",
  "Constrains effort on reasoning for reasoning models. Only applicable to reasoning models from specific providers that support reasoning effort.": "Omezuje úsilí při uvažování u modelů pro uvažování. Platí pouze pro modely pro uvažování od specifických poskytovatelů, kteří podporují úsilí při uvažování.",
  "Contact Admin for rexpro Access": "Pro přístup k webovému rozhraní kontaktujte administrátora.",
  Content,
  "Content Extraction Engine": "Jádro pro extrakci obsahu",
  "Content lengths (character counts only)": "",
  "Context Tokens": "",
  "Continue Response": "Pokračovat v odpovědi",
  "Continue with {{provider}}": "Pokračovat s {{provider}}",
  "Continue with Email": "Pokračovat s e-mailem",
  "Continue with LDAP": "Pokračovat s LDAP",
  "Control how message text is split for TTS requests. 'Punctuation' splits into sentences, 'paragraphs' splits into paragraphs, and 'none' keeps the message as a single string.": "Určuje, jak se text zprávy dělí pro požadavky TTS. 'Punctuation' (interpunkce) dělí na věty, 'paragraphs' (odstavce) na odstavce a 'none' (žádné) ponechá zprávu jako jeden řetězec.",
  ...
  "Copy API Key": "",
  "Copy content": "",
  "Copy Formatted Text": "Kopírovat formátovaný text",
  ...
  "CORS must be properly configured by the provider to allow requests from rexpro-ai.": "CORS musí být správně nakonfigurován poskytovatelem, aby povolil požadavky z rexpro-ai.",
  "Could not read file.": "",
  CPU,
  Create,
  ...
  "Default permissions": "Výchozí oprávnění",
  "Default permissions updated successfully": "Výchozí oprávnění byla úspěšně aktualizována",
  "Default Prompt Suggestions": "Výchozí návrhy instrukce",
  "Default to 389 or 636 if TLS is enabled": "Výchozí hodnota 389, nebo 636, pokud je povoleno TLS",
  "Default to ALL": "Výchozí hodnota VŠE",
  ...
  Dictate,
  "Didn't fully follow instructions": "Nedodržel plně pokyny",
  Direct,
  ...
  "Discover how to use rexpro-ai and seek support from the community.": "Zjistěte, jak používat rexpro-ai, a vyhledejte podporu od komunity.",
  ...
  "e.g. 'low', 'medium', 'high'": "",
  'e.g. "json" or a JSON schema': 'např. "json" nebo JSON schéma',
  "e.g. 60": "např. 60",
  ...
  "e.g. my_filter": "např. muj_filtr",
  "e.g. my_tools": "např. moje_nastroje",
  "e.g. pdf, docx, txt": "např. pdf, docx, txt",
  "e.g. Step-by-step instructions for code reviews": "",
  "e.g. Tell me a fun fact": "",
  "e.g. Tell me a fun fact about the Roman Empire": "",
  "e.g. Tools for performing various operations": "např. Nástroje pro provádění různých operací",
  "e.g., 3, 4, 5 (leave blank for default)": "např. 3, 4, 5 (pro výchozí ponechte prázdné)",
  "e.g., audio/wav,audio/mpeg,video/* (leave blank for defaults)": "např. audio/wav,audio/mpeg,video/* (pro výchozí ponechte prázdné)",
  "e.g., en-US,ja-JP (leave blank for auto-detect)": "např. cs-CZ,en-US (pro automatickou detekci ponechte prázdné)",
  "e.g., westus (leave blank for eastus)": "např. westeurope (pro výchozí ponechte prázdné)",
  Edit,
  "Edit Arena Model": "Upravit model arény",
  "Edit Channel": "Upravit kanál",
  "Edit Connection": "Upravit připojení",
  "Edit Default Permissions": "Upravit výchozí oprávnění",
  "Edit Folder": "Upravit složku",
  "Edit Image": "",
  "Edit Last Message": "",
  "Edit Memory": "Upravit vzpomínku",
  "Edit Prompt": "",
  ...
  ElevenLabs,
  Email,
  "Embark on adventures": "Vydejte se za dobrodružstvím",
  Embedding,
  ...
  "Enter Bing Search V7 Endpoint": "Zadejte koncový bod Bing Search V7",
  "Enter Bing Search V7 Subscription Key": "Zadejte klíč předplatného Bing Search V7",
  "Enter Bocha Search API Key": "Zadejte API klíč pro Bocha Search",
  "Enter Brave Search API Key": "Zadejte API klíč pro Brave Search",
  "Enter certificate path": "Zadejte cestu k certifikátu",
  ...
  "Enter External Web Loader API Key": "Zadejte API klíč pro externí webový zavaděč",
  "Enter External Web Loader URL": "Zadejte URL pro externí webový zavaděč",
  "Enter External Web Search API Key": "Zadejte API klíč pro externí webové vyhledávání",
  "Enter External Web Search URL": "Zadejte URL pro externí webové vyhledávání",
  ...
  "Enter Jupyter URL": "Zadejte URL pro Jupyter",
  ...
  "Enter Mojeek Search API Key": "Zadejte API klíč pro Mojeek Search",
  ...
  "Enter SearchApi Engine": "Zadejte jádro pro SearchApi",
  "Enter Searxng Query URL": "Zadejte URL dotazu pro Searxng",
  "Enter Searxng search language": "",
  "Enter Seed": "Zadejte semínko",
  "Enter SerpApi API Key": "Zadejte API klíč pro SerpApi",
  "Enter SerpApi Engine": "Zadejte jádro pro SerpApi",
  "Enter Serper API Key": "Zadejte API klíč pro Serper",
  "Enter Serply API Key": "Zadejte API klíč pro Serply",
  "Enter Serpstack API Key": "Zadejte API klíč pro Serpstack",
  "Enter server host": "Zadejte hostitele serveru",
  "Enter server label": "Zadejte popisek serveru",
  "Enter server port": "Zadejte port serveru",
  "Enter skill instructions in markdown...": "",
  "Enter Sougou Search API sID": "Zadejte sID API pro Sougou Search",
  "Enter Sougou Search API SK": "Zadejte SK API pro Sougou Search",
  "Enter stop sequence": "Zadejte ukončovací sekvenci",
  "Enter system prompt": "Zadejte systémové instrukce",
  ...
  "Enter the public URL of your rexpro. This URL will be used to generate links in the notifications.": "Zadejte veřejnou URL adresu vašeho rexpro. Tato URL bude použita k generování odkazů v oznámeních.",
  ...
  "Enter timeout in seconds": "Zadejte časový limit v sekundách",
  "Enter to Send": "Enter pro odeslání",
  "Enter Top K": "Zadejte Top K",
  "Enter Top K Reranker": "Zadejte Top K pro přehodnocení",
  ...
  "Enter value (true/false)": "Zadejte hodnotu (true/false)",
  ...
  "Example: mail": "Příklad: mail",
  "Example: ou=users,dc=foo,dc=example": "Příklad: ou=users,dc=foo,dc=example",
  "Example: sAMAccountName or uid or userPrincipalName": "Příklad: sAMAccountName nebo uid nebo userPrincipalName",
  "Exceeded the number of seats in your license. Please contact support to increase the number of seats.": "Překročili jste počet míst ve vaší licenci. Pro navýšení počtu míst prosím kontaktujte podporu.",
  Exclude,
  "Execute code": "",
  ...
  "External Web Search URL": "URL pro externí webové vyhledávání",
  ...
  "Feedback Details": "Podrobnosti zpětné vazby",
  ...
  Filters,
  "Fingerprint spoofing detected: Unable to use initials as avatar. Defaulting to default profile image.": "Detekován spoofing otisku prstu: Nelze použít iniciály jako avatar. Používá se výchozí profilový obrázek.",
  "Firecrawl API Base URL": "Základní URL API pro Firecrawl",
  ...
  "Follow up: {{question}}": "",
  "Follow-Up Auto-Generation": "Automatické generování následných otázek",
  "Followed instructions perfectly": "Dokonale dodržel pokyny",
  "for placeholders": "",
  "Force OCR": "Vynutit OCR",
  "Force OCR on all pages of the PDF. This can lead to worse results if you have good text in your PDFs. Defaults to False.": "Vynutit OCR na všech stránkách PDF. To může vést k horším výsledkům, pokud máte v PDF kvalitní text. Výchozí hodnota je False.",
  "Forge new paths": "Vytvářejte nové cesty",
  Form,
  ...
  "Function ID": "ID funkce",
  "Function imported successfully": "Funkce byla úspěšně importována",
  ...
  "Generating search query": "Generuji vyhledávací dotaz",
  "Generating...": "Generuji...",
  "Get current time and perform date/time calculations": "",
  "Get information on {{name}} in the UI": "Získat informace o {{name}} v uživatelském rozhraní",
  "Get started": "Začít",
  "Get started with {{REXPRO_NAME}}": "Začněte s {{REXPRO_NAME}}",
  Global,
  ...
  "Hex Color": "Hex barva",
  "Hex Color - Leave empty for default color": "Hex barva - pro výchozí barvu ponechte prázdné",
  Hidden,
  Hide,
  "Hide All": "",
  "Hide from Sidebar": "Skrýt z postranního panelu",
  ...
  "Idle Timeout": "",
  "iframe Sandbox Allow Forms": "Povolit formuláře v sandboxu iframe",
  "iframe Sandbox Allow Same Origin": "Povolit stejný původ v sandboxu iframe",
  "Ignite curiosity": "Probuďte zvědavost",
  Image,
  "Image Compression": "Komprese obrázků",
  "Image Compression Height": "Výška komprese obrázku",
  "Image Compression Width": "Šířka komprese obrázku",
  "Image Edit": "",
  "Image Edit Engine": "",
  "Image Generation": "Generování obrázků",
  "Image Generation Engine": "Jádro pro generování obrázků",
  "Image Max Compression Size": "Maximální velikost komprese obrázku",
  "Image Max Compression Size height": "Maximální výška komprese obrázku",
  "Image Max Compression Size width": "Maximální šířka komprese obrázku",
  ...
  Inactive,
  Include,
  "Include `--api-auth` flag when running stable-diffusion-rexpro": "Při spouštění stable-diffusion-rexpro použijte přepínač `--api-auth`.",
  "Include `--api` flag when running stable-diffusion-rexpro": "Při spouštění stable-diffusion-rexpro použijte přepínač `--api`.",
  ...
  Insert,
  "Insert Follow-Up Prompt to Input": "Vložit následné instrukce do vstupu",
  "Insert Prompt as Rich Text": "Vložit instrukce jako formátovaný text",
  ...
  "Jupyter URL": "URL pro Jupyter",
  "JWT Expiration": "Expirace JWT",
  "JWT Token": "JWT Token",
  "Kagi Search API Key": "API klíč pro Kagi Search",
  "Keep Follow-Up Prompts in Chat": "Ponechat následné instrukce v konverzaci",
  "Keep in Sidebar": "Ponechat v postranním panelu",
  Key,
  "Key is required": "Klíč je vyžadován",
  ...
  "Kokoro.js Dtype": "Datový typ Kokoro.js",
  Label,
  "Landing Page Mode": "Režim úvodní stránky",
  Language,
  "Language Locales": "Jazykové mutace",
  "Last 24 hours": "",
  "Last 30 days": "",
  "Last 7 days": "",
  "Last 90 days": "",
  ...
  "Learn more about OpenAPI tool servers.": "Zjistěte více o serverech nástrojů OpenAPI.",
  "Learn more about Voxtral transcription.": "",
  "Leave a public review for {{modelName}}": "",
  "Leave empty for no compression": "Pro žádnou kompresi ponechte prázdné",
  "Leave empty for unlimited": "Pro neomezeně ponechte prázdné",
  'Leave empty to include all models from "{{url}}" endpoint': 'Ponechte prázdné pro zahrnutí všech modelů z koncového bodu "{{url}}"',
  'Leave empty to include all models from "{{url}}/api/tags" endpoint': 'Ponechte prázdné pro zahrnutí všech modelů z koncového bodu "{{url}}/api/tags"',
  'Leave empty to include all models from "{{url}}/models" endpoint': 'Ponechte prázdné pro zahrnutí všech modelů z koncového bodu "{{url}}/models"',
  ...
  Low,
  LTR,
  "Made by rexpro-ai Community": "Vytvořeno komunitou rexpro-ai",
  ...
  "Message rating should be enabled to use this feature": "Pro použití této funkce musí být povoleno hodnocení zpráv.",
  "Message text...": "",
  messages,
  Messages,
  "Messages you send after creating your link won't be shared. Users with the URL will be able to view the shared chat.": "Zprávy, které odešlete po vytvoření odkazu, nebudou sdíleny. Uživatelé s URL adresou budou moci zobrazit sdílenou konverzaci.",
  ...
  "Model ID": "ID modelu",
  "Model ID is required.": "ID modelu je vyžadováno.",
  "Model IDs": "ID modelů",
  "Model Name": "Název modelu",
  "Model name already exists, please choose a different one": "Název modelu již existuje, zvolte prosím jiný",
  "Model Name is required.": "Název modelu je vyžadován.",
  "Model names and usage frequency": "",
  "Model not found": "",
  "Model not selected": "Není vybrán žádný model",
  "Model Parameters": "",
  ...
  "Model Usage": "",
  "Model(s) do not support file upload": "Vybraný model (modely) nepodporuje nahrávání souborů",
  ...
  "OLED Dark": "OLED tmavý",
  Ollama,
  "Ollama API": "Ollama API",
  "Ollama API settings updated": "Nastavení Ollama API byla aktualizována",
  ...
  "Oops! There are files still uploading. Please wait for the upload to complete.": "Jejda! Některé soubory se stále nahrávají. Počkejte prosím na dokončení nahrávání.",
  "Oops! There was an error in the previous response.": "Jejda! V předchozí odpovědi došlo k chybě.",
  "Oops! You're using an unsupported method (frontend only). Please serve the rexpro from the backend.": "Jejda! Používáte nepodporovanou metodu (pouze frontend). Spusťte prosím rexpro z backendu.",
  ...
  "rexpro-ai can use tools provided by any OpenAPI server.": "rexpro-ai může používat nástroje poskytované jakýmkoli serverem OpenAPI.",
  "rexpro-ai uses faster-whisper internally.": "rexpro-ai interně používá faster-whisper.",
  "rexpro-ai uses SpeechT5 and CMU Arctic speaker embeddings.": "rexpro-ai používá SpeechT5 a vektorizaci mluvčích CMU Arctic.",
  "rexpro-ai version": "",
  "rexpro-ai version (v{{OPEN_REXPRO_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "Verze rexpro-ai (v{{OPEN_REXPRO_VERSION}}) je nižší než požadovaná verze (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "Prompt Content": "Obsah instrukce",
  "Prompt created successfully": "Pokyn byl úspěšně vytvořen",
  "Prompt Name": "",
  "Prompt Suggestions": "",
  "Prompt Template": "",
  "Prompt updated successfully": "Instrukce byly úspěšně aktualizovány",
  Prompts,
  "Prompts Access": "Přístup k instrukcím",
  "Prompts Public Sharing": "Veřejné sdílení instrukcí",
  "Prompts Sharing": "",
  Provider,
  Public,
  ...
  "Redirecting you to rexpro-ai Community": "Přesměrovávám vás do komunity rexpro-ai",
  ...
  Reindex,
  "Reindex Knowledge Base Vectors": "Přeindexovat vektory znalostní báze",
  ...
  "Search Collection": "Hledat v kolekci",
  "Search Files": "",
  "Search Filters": "Filtry vyhledávání",
  "search for archived chats": "hledat archivované konverzace",
  "search for folders": "hledat složky",
  "search for pinned chats": "hledat připnuté konverzace",
  "search for shared chats": "hledat sdílené konverzace",
  "search for tags": "hledat štítky",
  "Search Functions": "Hledat funkce",
  "Search Groups": "",
  "Search In Models": "Hledat v modelech",
  "Search Knowledge": "Hledat ve znalostech",
  "Search Memories": "",
  "Search Models": "Hledat modely",
  ...
  "SearchApi API Key": "API klíč pro SearchApi",
  "SearchApi Engine": "Jádro pro SearchApi",
  ...
  "Select a conversation to preview": "Vyberte konverzaci pro náhled",
  "Select a engine": "Vyberte jádro",
  ...
  "Select a voice": "Vyberte hlas",
  "Select All": "",
  "Select an auth method": "Vyberte metodu ověření",
  "Select an embedding model engine": "Vyberte jádro modelu pro vektorizaci",
  "Select an engine": "Vyberte jádro",
  "Select an Ollama instance": "Vyberte instanci Ollama",
  "Select an option": "",
  "Select an output format": "Vyberte formát výstupu",
  "Select dtype": "Vyberte datový typ",
  "Select Engine": "Vyberte jádro",
  ...
  "Send now": "",
  "Sends `stream_options: { include_usage: true }` in the request.\nSupported providers will return token usage information in the response when set.": "Odešle `stream_options: { include_usage: true }` v požadavku.\nPodporovaní poskytovatelé vrátí informace o využití tokenů v odpovědi, pokud je tato možnost nastavena.",
  September,
  "SerpApi API Key": "API klíč pro SerpApi",
  "SerpApi Engine": "Jádro pro SerpApi",
  "Serper API Key": "API klíč pro Serper",
  "Serply API Key": "API klíč pro Serply",
  "Serpstack API Key": "API klíč pro Serpstack",
  "Server connection failed": "",
  "Server connection verified": "Připojení k serveru ověřeno",
  Session,
  "Set as default": "Nastavit jako výchozí",
  "Set as Production": "",
  "Set embedding model": "Nastavit model pro vektorizaci",
  "Set embedding model (e.g. {{model}})": "Nastavit model pro vektorizaci (např. {{model}})",
  "Set reranking model (e.g. {{model}})": "Nastavit model pro přehodnocení (např. {{model}})",
  ...
  "Sets how far back for the model to look back to prevent repetition.": "Nastavuje, jak daleko zpět se má model dívat, aby se zabránilo opakování.",
  "Sets the random number seed to use for generation. Setting this to a specific number will make the model generate the same text for the same prompt.": "Nastavuje semínko náhodných čísel pro generování. Nastavení na konkrétní číslo způsobí, že model bude generovat stejný text pro stejné instrukce.",
  "Sets the size of the context window used to generate the next token.": "Nastavuje velikost kontextového okna použitého k vygenerování dalšího tokenu.",
  ...
  "Share to rexpro-ai Community": "Sdílet s komunitou rexpro-ai",
  ...
  "Sign in to {{REXPRO_NAME}}": "Přihlásit se do {{REXPRO_NAME}}",
  "Sign in to {{REXPRO_NAME}} with LDAP": "Přihlásit se do {{REXPRO_NAME}} pomocí LDAP",
  "Sign Out": "Odhlásit se",
  "Sign up": "Zaregistrovat se",
  "Sign up to {{REXPRO_NAME}}": "Zaregistrovat se do {{REXPRO_NAME}}",
  "Significantly improves accuracy by using an LLM to enhance tables, forms, inline math, and layout detection. Will increase latency. Defaults to False.": "Výrazně zlepšuje přesnost použitím LLM k vylepšení tabulek, formulářů, vložené matematiky a detekce rozvržení. Zvýší latenci. Výchozí hodnota je False.",
  "Signing in to {{REXPRO_NAME}}": "Přihlašování do {{REXPRO_NAME}}",
  Single,
  "Sink List": "Seznam cílů",
  "sk-1234": "sk-1234",
  ...
  Sort,
  "Sort by": "",
  "Sougou Search API sID": "sID API pro Sougou Search",
  "Sougou Search API SK": "SK API pro Sougou Search",
  Source,
  ...
  Subtitle,
  Success,
  "Successfully imported {{userCount}} users.": "Úspěšně importováno {{userCount}} uživatelů.",
  "Successfully updated.": "Úspěšně aktualizováno.",
  "Suggest a change": "Navrhnout změnu",
  Suggested,
  Support,
  ...
  "The batch size determines how many text requests are processed together at once. A higher batch size can increase the performance and speed of the model, but it also requires more memory.": "Velikost dávky určuje, kolik textových požadavků se zpracovává najednou. Větší velikost dávky může zvýšit výkon a rychlost modelu, ale také vyžaduje více paměti.",
  "The developers behind this plugin are passionate volunteers from the community. If you find this plugin helpful, please consider contributing to its development.": "Vývojáři za tímto pluginem jsou nadšení dobrovolníci z komunity. Pokud vám tento plugin přijde užitečný, zvažte prosím příspěvek na jeho vývoj.",
  ...
  "The format to return a response in. Format can be json or a JSON schema.": "Formát, ve kterém se má vrátit odpověď. Formát může být json nebo JSON schéma.",
  "The height in pixels to compress images to. Leave empty for no compression.": "Výška v pixelech, na kterou se mají obrázky komprimovat. Pro žádnou kompresi ponechte prázdné.",
  "The language of the input audio. Supplying the input language in ISO-639-1 (e.g. en) format will improve accuracy and latency. Leave blank to automatically detect the language.": "Jazyk vstupního zvuku. Zadání vstupního jazyka ve formátu ISO-639-1 (např. cs) zlepší přesnost a latenci. Ponechte prázdné pro automatickou detekci jazyka.",
  "The LDAP attribute that maps to the mail that users use to sign in.": "Atribut LDAP, který se mapuje na e-mail, který uživatelé používají k přihlášení.",
  "The LDAP attribute that maps to the username that users use to sign in.": "Atribut LDAP, který se mapuje na uživatelské jméno, které uživatelé používají k přihlášení.",
  ...
  "The maximum number of files that can be used at once in chat. If the number of files exceeds this limit, the files will not be uploaded.": "Maximální počet souborů, které lze použít najednou v konverzaci. Pokud počet souborů překročí tento limit, soubory nebudou nahrány.",
  "The output format for the text. Can be 'json', 'markdown', or 'html'. Defaults to 'markdown'.": "Výstupní formát textu. Může být 'json', 'markdown' nebo 'html'. Výchozí je 'markdown'.",
  "The passwords you entered don't quite match. Please double-check and try again.": "Zadaná hesla se úplně neshodují. Zkontrolujte je prosím a zkuste to znovu.",
  "The score should be a value between 0.0 (0%) and 1.0 (100%).": "Skóre by mělo být hodnota mezi 0,0 (0 %) a 1,0 (100 %).",
  "The stream delta chunk size for the model. Increasing the chunk size will make the model respond with larger pieces of text at once.": "Velikost bloku delta streamu pro model. Zvětšení velikosti bloku způsobí, že model bude odpovídat většími kusy textu najednou.",
  ...
  "The width in pixels to compress images to. Leave empty for no compression.": "Šířka v pixelech, na kterou se mají obrázky komprimovat. Pro žádnou kompresi ponechte prázdné.",
  Theme,
  ...
  "To access the rexpro, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.": "Pro přístup k rexpro se prosím obraťte na administrátora. Administrátoři mohou spravovat stavy uživatelů v panelu administrátora.",
  'To attach knowledge base here, add them to the "Knowledge" workspace first.': 'Pro připojení znalostní báze sem ji nejprve přidejte do pracovního prostoru "Znalosti".',
  ...
  "Tool Servers": "Servery nástrojů",
  "Tool updated successfully": "Nástroj byl úspěšně aktualizován.",
  Tools,
  "Tools Access": "Přístup k nástrojům",
  "Tools are a function calling system with arbitrary code execution": "Nástroje jsou systémem pro volání funkcí se spouštěním libovolného kódu",
  "Tools Function Calling Prompt": "Instrukce pro volání funkcí nástrojů",
  "Tools have a function calling system that allows arbitrary code execution.": "Nástroje mají systém volání funkcí, který umožňuje spouštění libovolného kódu.",
  "Tools Public Sharing": "Veřejné sdílení nástrojů",
  "Tools Sharing": "",
  Top,
  "Top K": "Top K",
  "Top K Reranker": "Top K pro přehodnocení",
  Transformers,
  ...
  "Update for the latest features and improvements.": "Aktualizujte pro nejnovější funkce a vylepšení.",
  "Update password": "Aktualizovat heslo",
  "Update your status": "",
  Updated,
  "Updated at": "Aktualizováno",
  "Updated At": "Aktualizováno",
  "Upgrade to a licensed plan for enhanced capabilities, including custom theming and branding, and dedicated support.": "Upgradujte na licencovaný plán pro rozšířené možnosti, včetně vlastních motivů a brandingu, a dedikované podpory.",
  Upload,
  "Upload a GGUF model": "Nahrát model GGUF",
  ...
  "Version deleted": "",
  "View Replies": "Zobrazit odpovědi",
  ...
  "Web Search in Chat": "Vyhledávání na webu v konverzaci",
  "Web Search Query Generation": "Generování dotazu pro webové vyhledávání",
  "Webhook Name": "",
  "Webhook URL": "URL webhooku",
  Webhooks,
  "Webpage URLs": "",
  "rexpro Settings": "Nastavení rexpro",
  "rexpro URL": "URL rexpro",
  'rexpro will make requests to "{{url}}"': 'rexpro bude odesílat požadavky na "{{url}}"',
  'rexpro will make requests to "{{url}}/api/chat"': 'rexpro bude odesílat požadavky na "{{url}}/api/chat"',
  'rexpro will make requests to "{{url}}/chat/completions"': 'rexpro bude odesílat požadavky na "{{url}}/chat/completions"',
  Week,
  Weekly,
  ...
  "Whisper (Local)": "Whisper (lokální)",
  "Who can share to this group": "",
  "Why?": "Proč?",
  "Widescreen Mode": "Širokoúhlý režim",
  Width,
  Wikipedia,
  Won,
  "Working Directory": "",
  ...
  Write,
  "Write a summary in 50 words that summarizes {{topic}}.": "Napište shrnutí na 50 slov, které shrnuje [téma nebo klíčové slovo].",
  ...
  "Yacy Instance URL": "URL instance Yacy",
  ...
  "You can personalize your interactions with LLMs by adding memories through the 'Manage' button below, making them more helpful and tailored to you.": "Své interakce s LLM si můžete přizpůsobit přidáním vzpomínek pomocí tlačítka 'Spravovat' níže, čímž se stanou užitečnějšími a přizpůsobenými vám.",
  ...
  "You do not have permission to upload files.": "Nemáte oprávnění nahrávat soubory.",
