  ...
  return _createClass(AtlasCollection2, [{
    ...
    value: function gc2() {
      ...
      if (markedKeys.size === 0) {
        /* @__PURE__ */ console.log("nothing to garbage collect");
        return;
      }
      var newAtlases = [];
...
CRp$4.initWebgl = function(opts, fns) {
  ...
  var setGCFlag = debounce(function() {
    /* @__PURE__ */ console.log("garbage collect flag set");
    r.data.gc = true;
  }, 1e4);
...
function renderWebgl(r, options2, renderTarget) {
  ...
  if (r.webglDebug) {
    ...
    if (compact) {
      /* @__PURE__ */ console.log("WebGL (".concat(renderTarget.name, ") - time ").concat(time2, "ms, ").concat(report));
    } else {
      /* @__PURE__ */ console.log("WebGL (".concat(renderTarget.name, ") - frame time ").concat(time2, "ms"));
      /* @__PURE__ */ console.log("Totals:");
      /* @__PURE__ */ console.log("  ".concat(report));
      /* @__PURE__ */ console.log("Texture Atlases Used:");
      var atlasInfo = debugInfo.atlasInfo;
      var _iterator2 = _createForOfIteratorHelper(atlasInfo), _step2;
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
          var info = _step2.value;
          /* @__PURE__ */ console.log("  ".concat(info.type, ": ").concat(info.keyCount, " keys, ").concat(info.atlasCount, " atlases"));
        }
      } catch (err) {
        _iterator2.e(err);
      } finally {
  ...
  if (r.data.gc) {
    /* @__PURE__ */ console.log("Garbage Collect!");
    r.data.gc = false;
    drawing.gc();
  }
}
...
function CanvasRenderer(options2) {
  ...
  if (options2.webgl) {
    ...
    /* @__PURE__ */ console.log("webgl rendering enabled");
  }
  r.data = {
