const About = "སྐོར་ལོ།";
const Access = "འཛུལ་སྤྱོད།";
const Account = "རྩིས་ཁྲ།";
const Action = "";
const Actions = "བྱ་སྤྱོད།";
const Activate = "སྒུལ་བསྐྱོད།";
const Active = "ལས་བྱེད་བཞིན་པ།";
const Activity = "";
const Add = "སྣོན་པ།";
const admin = "དོ་དམ་པ།";
const Admin = "དོ་དམ་པ།";
...
const All = "ཡོངས།";
const Always = "རྟག་ཏུ།";
const Amazing = "ངོ་མཚར་ཆེན།";
const Analytics = "";
const Analyzed = "དབྱེ་ཞིབ་བྱས་པ།";
const Android = "";
const Anyone = "";
const April = "ཟླ་བཞི་པ།";
const Archive = "ཡིག་མཛོད།";
const Artifacts = "རྫས་རྟེན།";
const Asc = "";
const Ask = "འདྲི་བ།";
const Assistant = "ལག་རོགས་པ།";
const Audio = "སྒྲ།";
const August = "ཟླ་བརྒྱད་པ།";
const Auth = "";
const Authenticate = "དངོས་ར་སྤྲོད་པ།";
const Authentication = "དངོས་ར་སྤྲོད་པ།";
const Auto = "";
const Automatic1111 = "Automatic1111";
const Automation = "";
const Automations = "";
const Away = "མི་འདུག";
const Awful = "ཧ་ཅང་སྡུག";
const Back = "རྒྱབ།";
const Banners = "དར་ཆ།";
const Bearer = "";
const before = "སྔོན།";
...
const Bold = "";
const Brave = "";
const Calendar = "ལོ་ཐོ།";
const Calendars = "";
const Call = "སྐད་འབོད།";
const Camera = "པར་ཆས།";
const Cancel = "རྩིས་མེད།";
const Capabilities = "ནུས་པ།";
const Capture = "འཛིན་པ།";
const Channel = "";
const Channels = "བགྲོ་གླེང་།";
const Character = "ཡིག་འབྲུ།";
const Chat = "ཁ་བརྡ།";
const chats = "";
const Chats = "ཁ་བརྡ།";
const Ciphers = "གསང་སྦྱོར།";
const Citation = "ལུང་འདྲེན།";
const Citations = "";
const Clone = "འདྲ་བཟོ།";
const Close = "ཁ་རྒྱག་པ།";
const cloud = "";
const Collapse = "བསྐུམ་པ།";
const Collection = "བསྡུ་གསོག";
const Collections = "";
const Color = "ཚོན་མདོག";
const ComfyUI = "ComfyUI";
const command = "";
const Command = "བཀའ་བརྡ།";
const Comment = "";
const Completions = "འགྲུབ་པ།";
const Config = "";
const Configuration = "";
const Configure = "སྒྲིག་འགོད།";
const Confirm = "གཏན་འཁེལ།";
const Connections = "སྦྲེལ་མཐུད།";
const Content = "ནང་དོན།";
const Controls = "ཚོད་འཛིན།";
const Copied = "འདྲ་བཤུས་བྱས་པ།";
const Copy = "འདྲ་བཤུས།";
const CPU = "";
const Create = "གསར་བཟོ།";
const Custom = "སྲོལ་བཟོས།";
const Daily = "";
const Dark = "ནག་པོ།";
const Database = "གནས་ཚུལ་མཛོད།";
const Day = "";
const December = "ཟླ་བ་བཅུ་གཉིས་པ།";
const Deepgram = "";
const Default = "སྔོན་སྒྲིག";
const Defaults = "";
const Delete = "བསུབ་པ།";
const Deleted = "";
const Desc = "";
const Description = "འགྲེལ་བཤད།";
const Deselect = "";
const Dictate = "";
const Direct = "ཐད་ཀར།";
const Disabled = "ནུས་མེད།";
const Display = "འཆར་སྟོན།";
const Docling = "Docling";
const Document = "ཡིག་ཆ།";
const Documentation = "ཡིག་ཆ།";
const Documents = "";
const Done = "ཚར་སོང་།";
const Download = "ཕབ་ལེན།";
const Draw = "རི་མོ་འབྲི་བ།";
const DuckDuckGo = "";
const Edit = "ཞུ་དག";
const edited = "";
const Edited = "";
...
const Email = "ཡིག་ཟམ།";
const Embedding = "ཚུད་འཇུག";
const Emoji = "";
const Emojis = "";
const Enabled = "སྒུལ་བསྐྱོད་བྱས་ཡོད།";
const Enhance = "";
const Ephemeral = "";
const ERROR = "ནོར་འཁྲུལ།";
const Evaluations = "གདེང་འཇོག";
const Exclude = "ཕུད་པ།";
const Expand = "རྒྱ་བསྐྱེད་པ།";
const Experimental = "ཚོད་ལྟའི་རང་བཞིན།";
const Explain = "འགྲེལ་བཤད།";
const Explored = "";
const Exploring = "";
const Export = "ཕྱིར་གཏོང་།";
const External = "ཕྱི་རོལ།";
const Features = "ཁྱད་ཆོས།";
const February = "ཟླ་བ་གཉིས་པ།";
const Feedback = "";
const Female = "";
const File = "ཡིག་ཆ།";
const Filename = "";
...
const Functions = "ལས་འགན།";
const Gemini = "Gemini";
const Gender = "";
const General = "སྤྱིར་བཏང་།";
const Generate = "";
const Global = "འཛམ་གླིང་ཡོངས་ཀྱི་";
const Google = "";
const Gravatar = "";
const Grid = "";
const Grokipedia = "";
...
const Insert = "";
const Instructions = "";
const Integration = "མཉམ་འདྲེས།";
const Integrations = "";
const Interface = "ངོས་འཛིན།";
const Italic = "";
const January = "ཟླ་བ་དང་པོ།";
const July = "ཟླ་བ་བདུན་པ།";
const June = "ཟླ་བ་དྲུག་པ།";
const Key = "ལྡེ་མིག";
const Knowledge = "ཤེས་བྱ།";
const Label = "བྱང་རྟགས།";
const Language = "སྐད་ཡིག";
const LDAP = "LDAP";
const Leaderboard = "འགྲན་རེས་རེའུ་མིག";
const Legacy = "";
const lexical = "";
const License = "ཆོག་མཆན།";
const Light = "དཀར་པོ།";
const List = "";
const Live = "";
const Loaded = "";
const Loader = "ནང་འཇུག་བྱེད་པོ།";
const local = "";
const Local = "ས་གནས།";
const Location = "";
const Lost = "བརླགས།";
...
const Model = "དཔེ་དབྱིབས།";
const Models = "དཔེ་དབྱིབས།";
const Mojeek = "";
const Month = "";
const Monthly = "";
const More = "མང་བ།";
...
const Muted = "";
const Name = "མིང་།";
const Native = "ས་སྐྱེས།";
const Never = "";
const New = "";
const None = "གཅིག་ཀྱང་མེད།";
const Note = "";
const Notes = "མཆན་བུ།";
const Notifications = "བརྡ་ཁྱབ།";
const November = "ཟླ་བ་བཅུ་གཅིག་པ།";
const OAuth = "";
const October = "ཟླ་བ་བཅུ་པ།";
const Off = "ཁ་རྒྱག་པ།";
const Ollama = "Ollama";
const On = "ཁ་ཕྱེ་བ།";
const Once = "";
...
const Other = "གཞན།";
const Output = "";
const OUTPUT = "ཐོན་འབྲས།";
const Overview = "སྤྱི་མཐོང་།";
const page = "ཤོག་ངོས།";
const Page = "";
const Paginate = "";
const Parameters = "";
const Password = "གསང་གྲངས།";
const Paused = "";
const pending = "སྒུག་བཞིན་པ།";
const Pending = "";
const Permissions = "དབང་ཚད།";
const Persistent = "";
const Personalization = "སྒེར་སྤྱོད་ཅན།";
const Pin = "གདབ་པ།";
const Pinned = "གདབ་ཟིན།";
const Pipe = "";
const Pipelines = "";
const Playground = "རྩེད་ཐང་།";
const Port = "Port";
const Ports = "";
const Preview = "";
const Private = "སྒེར།";
const Profile = "སྤྱི་ཐག";
const Prompt = "འགུལ་སློང་།";
const Prompts = "འགུལ་སློང་།";
const Provider = "";
const Public = "སྤྱི་སྤྱོད།";
const Querying = "";
const Rating = "སྐར་མ།";
const Read = "ཀློག་པ།";
const Reason = "";
...
const Record = "";
const Refresh = "";
const Regenerate = "བསྐྱར་བཟོ།";
const Registered = "";
const Reindex = "";
const Releases = "";
const Relevance = "འབྲེལ་ཡོད་རང་བཞིན།";
const Reminder = "";
const Remove = "འདོར་བ།";
const Rename = "མིང་བསྐྱར་འདོགས།";
const Repeats = "";
const Reply = "";
const required = "";
const Reset = "སླར་སྒྲིག";
const Response = "";
const Responses = "";
const Restart = "";
const Result = "འབྲས་བུ།";
const RESULT = "འབྲས་བུ།";
const Retrieval = "ལེན་ཚུར་སྒྲུབ།";
const Role = "གནས་ཚད།";
const RTL = "RTL";
const Run = "ལག་བསྟར།";
const Running = "ལག་བསྟར་བྱེད་བཞིན་པ།";
const Sa_day_of_week = "";
const Save = "ཉར་ཚགས།";
const Saved = "ཉར་ཚགས་བྱས།";
const Schedule = "";
const Search = "འཚོལ་བཤེར།";
const Searching = "";
const Seed = "Seed";
const Select = "";
const semantic = "";
const Send = "གཏོང་བ།";
const September = "ཟླ་བ་དགུ་པ།";
const Session = "";
const Setting = "";
const Settings = "སྒྲིག་འགོད།";
const Share = "མཉམ་སྤྱོད།";
const Show = "སྟོན་པ།";
const Single = "";
const Skills = "";
const Sonar = "";
const Sort = "";
const Source = "འབྱུང་ཁུངས།";
const State = "";
const Status = "";
const Steps = "";
const Stop = "མཚམས་འཇོག";
const Storage = "";
const Strikethrough = "";
const Su_day_of_week = "";
const Subtitle = "";
const Success = "ལེགས་འགྲུབ།";
const Suggested = "གྲོས་གཞི།";
const Support = "རྒྱབ་སྐྱོར།";
const Sync = "";
const System = "མ་ལག";
const Tag = "";
const Tags = "རྟགས།";
const Tasks = "ལས་འགན།";
const Temperature = "དྲོད་ཚད།";
const Terminal = "";
const Th_day_of_week = "";
const Theme = "བརྗོད་གཞི།";
const Thought = "";
const Thread = "བརྗོད་གཞི";
const Tika = "Tika";
...
const Unknown = "";
const Unmute = "";
const Unpin = "ཕྱིར་འདོན།";
const Untagged = "རྟགས་མེད།";
const Untitled = "";
const Update = "གསར་སྒྱུར།";
const Updated = "གསར་སྒྱུར་བྱས།";
const Upload = "སྤར་བ།";
const URL = "URL";
const Usage = "";
const Use = "";
const user = "བེད་སྤྱོད་མཁན།";
const User = "བེད་སྤྱོད་མཁན།";
const Username = "བེད་སྤྱོད་མིང་།";
const users = "";
const Users = "བེད་སྤྱོད་མཁན།";
const Valves = "Valves";
const variable = "འགྱུར་ཚད།";
const Version = "པར་གཞི།";
const Visibility = "མཐོང་ཐུབ་རང་བཞིན།";
const Visible = "";
const Vision = "";
const Visual = "";
const Voice = "སྐད།";
const Warning = "ཉེན་བརྡ།";
...
const translation = {
  ...
  "'s', 'm', 'h', 'd', 'w' or '-1' for no expiration.": "'s', 'm', 'h', 'd', 'w' ཡང་ན་ '-1' དུས་ཚོད་རྫོགས་མི་དགོས་པའི་ཆེད་དུ།",
  "(e.g. `sh rexpro.sh --api --api-auth username_password`)": "(དཔེར་ན། `sh rexpro.sh --api --api-auth username_password`)",
  "(e.g. `sh rexpro.sh --api`)": "(དཔེར་ན། `sh rexpro.sh --api`)",
  "(latest)": "(ཆེས་གསར།)",
  ...
  "{{rexproAIName}} Backend Required": "{{rexproAIName}} རྒྱབ་སྣེ་དགོས།",
  ...
  "A task model is used when performing tasks such as generating titles for chats and web search queries": "ལས་ཀའི་དཔེ་དབྱིབས་ནི་ཁ་བརྡའི་ཁ་བྱང་བཟོ་བ་དང་དྲ་བའི་འཚོལ་བཤེར་འདྲི་བ་ལྟ་བུའི་ལས་འགན་སྒྲུབ་སྐབས་སྤྱོད་ཀྱི་ཡོད།",
  "a user": "བེད་སྤྱོད་མཁན་ཞིག",
  About,
  ...
  "Add a tag": "རྟགས་ཤིག་སྣོན་པ།",
  "Add a tag...": "",
  "Add Access": "",
  "Add Arena Model": "Arena དཔེ་དབྱིབས་སྣོན་པ།",
  ...
  "Add Model": "དཔེ་དབྱིབས་སྣོན་པ།",
  "Add Reaction": "ཡ་ལན་སྣོན་པ།",
  "Add tag": "",
  "Add Tag": "རྟགས་སྣོན་པ།",
  "Add Terminal": "",
  ...
  Admin,
  "Admin Contact Email": "",
  "Admin Panel": "དོ་དམ་པའི་ལྟ་སྟེགས།",
  ...
  Archive,
  "Archive All": "",
  "Archive All Chats": "ཁ་བརྡ་ཡོངས་རྫོགས་ཡིག་མཛོད་དུ་འཇུག་པ།",
  "Archived Chats": "ཡིག་མཛོད་དུ་བཞག་པའི་ཁ་བརྡ།",
  "archived-chat-export": "ཡིག་མཛོད་ཁ་བརྡ་ཕྱིར་གཏོང་།",
  ...
  Automatic1111,
  "AUTOMATIC1111 Api Auth String": "AUTOMATIC1111 Api Auth ཡིག་ཕྲེང་།",
  ...
  "Chunk Overlap": "དུམ་བུ་བསྣོལ་བ།",
  "Chunk Size": "དུམ་བུའི་ཆེ་ཆུང་།",
  "Chunks smaller than this threshold will be merged with neighboring chunks when possible. Set to 0 to disable merging.": "",
  Ciphers,
  Citation,
  Citations,
  "Clear memory": "དྲན་ཤེས་གཙང་སེལ།",
  "Clear Memory": "དྲན་ཤེས་གཙང་སེལ།",
  "Clear search": "",
  "Clear status": "",
  "click here": "འདིར་མནན་པ།",
  "Click here for filter guides.": "འཚག་མ་ལམ་སྟོན་གྱི་ཆེད་དུ་འདིར་མནན་པ།",
  "Click here for help.": "རོགས་རམ་ཆེད་དུ་འདིར་མནན་པ།",
  "Click here to": "འདིར་མནན་ནས།",
  "Click here to download user import template file.": "བེད་སྤྱོད་མཁན་ནང་འདྲེན་མ་དཔེ་ཡིག་ཆ་ཕབ་ལེན་བྱེད་པར་འདིར་མནན་པ།",
  "Click here to learn more about faster-whisper and see the available models.": "faster-whisper སྐོར་མང་ཙམ་ཤེས་པ་དང་ཡོད་པའི་དཔེ་དབྱིབས་ལྟ་བར་འདིར་མནན་པ།",
  "Click here to see available models.": "ཡོད་པའི་དཔེ་དབྱིབས་ལྟ་བར་འདིར་མནན་པ།",
  "Click here to select": "གདམ་ག་བྱེད་པར་འདིར་མནན་པ།",
  "Click here to select a csv file.": "csv ཡིག་ཆ་ཞིག་གདམ་ག་བྱེད་པར་འདིར་མནན་པ།",
  "Click here to select a py file.": "py ཡིག་ཆ་ཞིག་གདམ་ག་བྱེད་པར་འདིར་མནན་པ།",
  ...
  "Code Execution Timeout": "ཀོཌ་ལག་བསྟར་དུས་ཚོད་བཀག་པ།",
  "Code formatted successfully": "ཀོཌ་བཀོད་པ་ལེགས་པར་བཟོས་ཟིན།",
  "Code Interpreter": "ཀོཌ་འགྲེལ་བཤད།",
  "Code Interpreter Engine": "ཀོཌ་འགྲེལ་བཤད་འཕྲུལ་འཁོར།",
  "Code Interpreter Prompt Template": "ཀོཌ་འགྲེལ་བཤད་འགུལ་སློང་མ་དཔེ།",
  ...
  Color,
  ComfyUI,
  "ComfyUI API Key": "ComfyUI API ལྡེ་མིག",
  "ComfyUI Base URL": "ComfyUI གཞི་རྩའི་ URL",
  ...
  "Confirm your action": "ཁྱེད་ཀྱི་བྱ་སྤྱོད་གཏན་འཁེལ།",
  ...
  "Contact Admin for rexpro Access": "rexpro འཛུལ་སྤྱོད་ཆེད་དུ་དོ་དམ་པ་དང་འབྲེལ་གཏུག་བྱེད་པ།",
  Content,
  ...
  "CORS must be properly configured by the provider to allow requests from rexpro-ai.": "rexpro-ai ནས་རེ་ཞུ་གཏོང་བར་གནང་བ་སྤྲོད་ཆེད། CORS ངེས་པར་དུ་མཁོ་སྤྲོད་པས་འགྲིག་པོར་སྒྲིག་འགོད་བྱེད་དགོས།",
  "Could not read file.": "",
  CPU,
  Create,
  ...
  "Default permissions": "སྔོན་སྒྲིག་དབང་ཚད།",
  "Default permissions updated successfully": "སྔོན་སྒྲིག་དབང་ཚད་ལེགས་པར་གསར་སྒྱུར་བྱས།",
  "Default Prompt Suggestions": "སྔོན་སྒྲིག་འགུལ་སློང་གྲོས་གཞི།",
  "Default to 389 or 636 if TLS is enabled": "TLS སྒུལ་བསྐྱོད་བྱས་ན་སྔོན་སྒྲིག་ཏུ་ ༣༨༩ ཡང་ན་ ༦༣༦།",
  "Default to ALL": "སྔོན་སྒྲིག་ཏུ་ཡོངས་རྫོགས།",
  ...
  "Discover how to use rexpro-ai and seek support from the community.": "rexpro-ai ཇི་ལྟར་བེད་སྤྱོད་གཏོང་ཚུལ་རྙེད་པ་དང་སྤྱི་ཚོགས་ནས་རྒྱབ་སྐྱོར་འཚོལ་བ།",
  ...
  ElevenLabs,
  Email,
  "Embark on adventures": "ཉེན་བརྟུལ་གྱི་འགྲུལ་བཞུད་ལ་འཇུག་པ།",
  Embedding,
  ...
  "Enter Bing Search V7 Endpoint": "Bing Search V7 མཇུག་མཐུད་འཇུག་པ།",
  "Enter Bing Search V7 Subscription Key": "Bing Search V7 མངགས་ཉོ་ལྡེ་མིག་འཇུག་པ།",
  "Enter Bocha Search API Key": "Bocha Search API ལྡེ་མིག་འཇུག་པ།",
  "Enter Brave Search API Key": "Brave Search API ལྡེ་མིག་འཇུག་པ།",
  "Enter certificate path": "ལག་ཁྱེར་གྱི་ལམ་བུ་འཇུག་པ།",
  ...
  "Enter Jupyter URL": "Jupyter URL འཇུག་པ།",
  ...
  "Enter SearchApi API Key": "SearchApi API ལྡེ་མིག་འཇུག་པ།",
  "Enter SearchApi Engine": "SearchApi Engine འཇུག་པ།",
  "Enter Searxng Query URL": "Searxng Query URL འཇུག་པ།",
  "Enter Searxng search language": "",
  "Enter Seed": "Seed འཇུག་པ།",
  "Enter SerpApi API Key": "SerpApi API ལྡེ་མིག་འཇུག་པ།",
  "Enter SerpApi Engine": "SerpApi Engine འཇུག་པ།",
  "Enter Serper API Key": "Serper API ལྡེ་མིག་འཇུག་པ།",
  "Enter Serply API Key": "Serply API ལྡེ་མིག་འཇུག་པ།",
  "Enter Serpstack API Key": "Serpstack API ལྡེ་མིག་འཇུག་པ།",
  ...
  "Enter the public URL of your rexpro. This URL will be used to generate links in the notifications.": "ཁྱེད་ཀྱི་ rexpro ཡི་སྤྱི་སྤྱོད་ URL འཇུག་པ། URL འདི་བརྡ་ཁྱབ་ནང་སྦྲེལ་ཐག་བཟོ་བར་བེད་སྤྱོད་བྱེད་ངེས།",
  ...
  "Example: mail": "དཔེར་ན། mail",
  "Example: ou=users,dc=foo,dc=example": "དཔེར་ན། ou=users,dc=foo,dc=example",
  "Example: sAMAccountName or uid or userPrincipalName": "དཔེར་ན། sAMAccountName ཡང་ན་ uid ཡང་ན་ userPrincipalName",
  ...
  "Function created successfully": "ལས་འགན་ལེགས་པར་བཟོས་ཟིན།",
  ...
  "Get started with {{REXPRO_NAME}}": "{{REXPRO_NAME}} དང་མཉམ་དུ་འགོ་འཛུགས་པ།",
  Global,
  "Good Response": "ལན་ཡག་པོ།",
  Google,
  ...
  Inactive,
  Include,
  "Include `--api-auth` flag when running stable-diffusion-rexpro": "stable-diffusion-rexpro ལག་བསྟར་བྱེད་སྐབས་ `--api-auth` དར་ཆ་ཚུད་པ།",
  "Include `--api` flag when running stable-diffusion-rexpro": "stable-diffusion-rexpro ལག་བསྟར་བྱེད་སྐབས་ `--api` དར་ཆ་ཚུད་པ།",
  ...
  Low,
  LTR,
  "Made by rexpro-ai Community": "rexpro-ai སྤྱི་ཚོགས་ཀྱིས་བཟོས།",
  ...
  "Manage Ollama": "Ollama དོ་དམ།",
  "Manage Ollama API Connections": "Ollama API སྦྲེལ་མཐུད་དོ་དམ།",
  ...
  "OLED Dark": "OLED ནག་པོ།",
  Ollama,
  "Ollama API": "Ollama API",
  "Ollama API settings updated": "Ollama API སྒྲིག་འགོད་གསར་སྒྱུར་བྱས།",
  ...
  "Oops! There are files still uploading. Please wait for the upload to complete.": "ཨོའོ། ད་དུང་སྤར་བཞིན་པའི་ཡིག་ཆ་ཡོད། སྤར་ཚར་བར་སྒུག་རོགས།",
  "Oops! There was an error in the previous response.": "ཨོའོ། ལན་སྔ་མར་ནོར་འཁྲུལ་ཞིག་བྱུང་སོང་།",
  "Oops! You're using an unsupported method (frontend only). Please serve the rexpro from the backend.": "ཨོའོ། ཁྱེད་ཀྱིས་རྒྱབ་སྐྱོར་མེད་པའི་ཐབས་ལམ་ཞིག་ (མདུན་ངོས་ཁོ་ན།) བེད་སྤྱོད་གཏོང་བཞིན་འདུག རྒྱབ་སྣེ་ནས་ rexpro མཁོ་སྤྲོད་བྱེད་རོགས།",
  ...
  "rexpro-ai uses faster-whisper internally.": "rexpro-ai ཡིས་ནང་ཁུལ་དུ་ faster-whisper བེད་སྤྱོད་བྱེད།",
  "rexpro-ai uses SpeechT5 and CMU Arctic speaker embeddings.": "rexpro-ai ཡིས་ SpeechT5 དང་ CMU Arctic གཏམ་བཤད་པའི་ཚུད་འཇུག་བེད་སྤྱོད་བྱེད།",
  "rexpro-ai version": "",
  "rexpro-ai version (v{{OPEN_REXPRO_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "rexpro-ai པར་གཞི། (v{{OPEN_REXPRO_VERSION}}) དེ་དགོས་ངེས་ཀྱི་པར་གཞི་ (v{{REQUIRED_VERSION}}) ལས་དམའ་བ།",
  OpenAI,
  ...
  "Prompt Content": "འགུལ་སློང་ནང་དོན།",
  "Prompt created successfully": "འགུལ་སློང་ལེགས་པར་བཟོས་ཟིན།",
  "Prompt Name": "",
  "Prompt Suggestions": "",
  "Prompt Template": "",
  "Prompt updated successfully": "འགུལ་སློང་ལེགས་པར་གསར་སྒྱུར་བྱས།",
  Prompts,
  "Prompts Access": "འགུལ་སློང་འཛུལ་སྤྱོད།",
  "Prompts Public Sharing": "འགུལ་སློང་སྤྱི་སྤྱོད་མཉམ་སྤྱོད།",
  "Prompts Sharing": "",
  Provider,
  Public,
  ...
  "Redirecting you to rexpro-ai Community": "ཁྱེད་ rexpro-ai སྤྱི་ཚོགས་ལ་ཁ་ཕྱོགས་སྒྱུར་བཞིན་པ།",
  ...
  "SearchApi API Key": "SearchApi API ལྡེ་མིག",
  ...
  "Send message": "འཕྲིན་གཏོང་བ།",
  "Send now": "",
  "Sends `stream_options: { include_usage: true }` in the request.\nSupported providers will return token usage information in the response when set.": "རེ་ཞུའི་ནང་ `stream_options: { include_usage: true }` གཏོང་བ།\nབཀོད་སྒྲིག་བྱས་ཚེ། རྒྱབ་སྐྱོར་ཡོད་པའི་མཁོ་སྤྲོད་པས་ལན་ནང་ཊོཀ་ཀེན་བེད་སྤྱོད་ཀྱི་གནས་ཚུལ་ཕྱིར་སློག་བྱེད་ངེས།",
  September,
  "SerpApi API Key": "SerpApi API ལྡེ་མིག",
  "SerpApi Engine": "SerpApi Engine",
  "Serper API Key": "Serper API ལྡེ་མིག",
  ...
  "Set as Production": "",
  "Set embedding model": "ཚུད་འཇུག་དཔེ་དབྱིབས་འཇོག་པ།",
  "Set embedding model (e.g. {{model}})": "ཚུད་འཇུག་དཔེ་དབྱིབས་འཇོག་པ། (དཔེར་ན། {{model}})",
  "Set reranking model (e.g. {{model}})": "བསྐྱར་སྒྲིག་དཔེ་དབྱིབས་འཇོག་པ། (དཔེར་ན། {{model}})",
  ...
  "Set Voice": "སྐད་འཇོག་པ།",
  "Set whisper model": "whisper དཔེ་དབྱིབས་འཇོག་པ།",
  "Set your status": "",
  ...
  "Sets how far back for the model to look back to prevent repetition.": "བསྐྱར་ཟློས་སྔོན་འགོག་བྱེད་པའི་ཆེད་དུ་དཔེ་དབྱིབས་ཀྱིས་ཕྱིར་ག་ཚོད་ལྟ་དགོས་འཇོག་པ།",
  ...
  "Sets the size of the context window used to generate the next token.": "ཊོཀ་ཀེན་རྗེས་མ་བཟོ་བར་བེད་སྤྱོད་གཏོང་བའི་ནང་དོན་སྒེའུ་ཁུང་གི་ཆེ་ཆུང་འཇོག་པ།",
  ...
  "Share to rexpro-ai Community": "rexpro-ai སྤྱི་ཚོགས་ལ་མཉམ་སྤྱོད།",
  ...
  "Sign in": "ནང་འཛུལ།",
  "Sign in to {{REXPRO_NAME}}": "{{REXPRO_NAME}} ལ་ནང་འཛུལ།",
  "Sign in to {{REXPRO_NAME}} with LDAP": "LDAP དང་མཉམ་དུ་ {{REXPRO_NAME}} ལ་ནང་འཛུལ།",
  "Sign Out": "ཕྱིར་ཐོན།",
  "Sign up": "ཐོ་འགོད།",
  "Sign up to {{REXPRO_NAME}}": "{{REXPRO_NAME}} ལ་ཐོ་འགོད།",
  ...
  "Signing in to {{REXPRO_NAME}}": "{{REXPRO_NAME}} ལ་ནང་འཛུལ་བྱེད་བཞིན་པ།",
  Single,
  "Sink List": "",
  "sk-1234": "sk-༡༢༣༤",
  ...
  "To access the rexpro, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.": "rexpro ལ་འཛུལ་སྤྱོད་བྱེད་པར། དོ་དམ་པ་དང་འབྲེལ་གཏུག་བྱེད་རོགས། དོ་དམ་པས་དོ་དམ་པའི་ལྟ་སྟེགས་ནས་བེད་སྤྱོད་མཁན་གྱི་གནས་སྟངས་དོ་དམ་བྱེད་ཐུབ།",
  ...
  "Tool deleted successfully": "ལག་ཆ་ལེགས་པར་བསུབས་ཟིན།",
  "Tool Description": "ལག་ཆའི་འགྲེལ་བཤད།",
  "Tool ID": "ལག་ཆའི་ ID",
  ...
  "Update password": "གསང་གྲངས་གསར་སྒྱུར།",
  "Update your status": "",
  Updated,
  "Updated at": "གསར་སྒྱུར་བྱེད་དུས།",
  "Updated At": "གསར་སྒྱུར་བྱེད་དུས།",
  "Upgrade to a licensed plan for enhanced capabilities, including custom theming and branding, and dedicated support.": "ནུས་པ་ཤུགས་ཆེ་བ། སྲོལ་བཟོས་བརྗོད་གཞི་དང་ཚོང་རྟགས། དམིགས་བསལ་རྒྱབ་སྐྱོར་ཚུད་པའི་ཆོག་མཆན་ཡོད་པའི་འཆར་གཞི་ལ་རིམ་སྤོར་བྱེད་པ།",
  Upload,
  "Upload a GGUF model": "GGUF དཔེ་དབྱིབས་ཤིག་སྤར་བ།",
  "Upload Audio": "",
  ...
  "Web Search Query Generation": "དྲ་བའི་འཚོལ་བཤེར་འདྲི་བ་བཟོ་སྐྲུན།",
  "Webhook Name": "",
  "Webhook URL": "Webhook URL",
  Webhooks,
  "Webpage URLs": "",
  "rexpro Settings": "rexpro སྒྲིག་འགོད།",
  "rexpro URL": "rexpro URL",
  'rexpro will make requests to "{{url}}"': "",
  'rexpro will make requests to "{{url}}/api/chat"': 'rexpro ཡིས་ "{{url}}/api/chat" ལ་རེ་ཞུ་གཏོང་ངེས།',
  'rexpro will make requests to "{{url}}/chat/completions"': 'rexpro ཡིས་ "{{url}}/chat/completions" ལ་རེ་ཞུ་གཏོང་ངེས།',
  Week,
  Weekly,
  ...
  Write,
  "Write a summary in 50 words that summarizes {{topic}}.": "[བརྗོད་གཞི་ཡང་ན་གནད་ཚིག] ཕྱོགས་སྡོམ་བྱེད་པའི་ཚིག་ ༥༠ ནང་གི་སྙིང་བསྡུས་ཤིག་འབྲི་བ།",
