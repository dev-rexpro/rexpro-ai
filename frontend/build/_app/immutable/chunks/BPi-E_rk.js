import { b as REXPRO_BASE_URL, O as OPENAI_API_BASE_URL } from "./CGP7Xb4V.js";
...
const chatCompletion = async (token = "", body, url = `${REXPRO_BASE_URL}/api`) => {
...
const generateOpenAIChatCompletion = async (token = "", body, url = `${REXPRO_BASE_URL}/api`) => {
  let error = null;
  const res = await fetch(`${url}/chat/completions`, {
    method: "POST",
    headers: {
...
export {
  generateOpenAIChatCompletion as a,
  getOpenAIConfig as b,
  chatCompletion as c,
  getOpenAIModels as d,
  getOpenAIModelsDirect as g,
