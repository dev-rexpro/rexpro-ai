const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./bTQFkcjh.js","./DoztLusN.js","./8K_sYeRe.js","./BtaWx737.js","./06Z-izLb.js","./Bnl6BI2h.js","./CQrtv1eE.js","./Bbj_Uq_7.js","./DlfS29dQ.js","./BeGenu0j.js","./CnZe0eLb.js","./BKSIeq3V.js","./Dg5vMFVn.js","./BfDGPyoM.js","./DvjOXlfB.js","./BJlmH8iP.js","./CQbu3Zlu.js","./DaJIxjfn.js","./C5m5pE-D.js","./DDB8FVl-.js","./B-LjFF6F.js","./M-CO_0TX.js","./DrqimdGE.js","./BaQ44vbQ.js","./vdhmJcz2.js","./D8Zdgl1u.js","./S8OYKzZo.js","./DDd3niey.js","./DmFXC6sK.js","./gBiMFpD9.js","./CTO7spbL.js","./olplAo2_.js","./C9AAgR6e.js","./JEPkB1Ly.js","./CQKzBGK9.js","./Xp5qcr6b.js","./CzSFdLC4.js","./CQCPd1JX.js","./D_1wt3s6.js","./Bs5oKbOs.js","./BaMA9QBb.js","./QV2rO2vQ.js","./DroXS8pa.js","./BhnFxgsv.js","./DhyK92V-.js","./DdiaLkrE.js","./DrsVrtkd.js","./CpjbufeE.js","./DhLDerDD.js","./Cw6AYlwt.js","./BG2hDOCK.js","./Sa-IffT_.js","./DfSaKWOt.js","./DAbZ0KZY.js","./zLoGeRie.js","./DI3Gw6Ji.js","./Dh5z7nN6.js","./C6b9yAqE.js","./DyfLsS81.js","./RUmKCaHA.js","./CRniSzfB.js","./BQAvRN_f.js","./Dr1RailG.js","./C7WVfQCl.js","./BiSgESTt.js","./BTkTGw9k.js","./CNvMOd4S.js","./D3BtlpAU.js","./QIkeVQOL.js","./Pvzgx3jr.js","./By6wv6-5.js"])))=>i.map(i=>d[i]);
...
import { s as select } from "./CnZe0eLb.js";
import { o as stepBefore, q as stepAfter, r as curveStep, u as curveNatural, v as monotoneY, x as monotoneX, y as curveLinearClosed, z as curveLinear, A as curveCatmullRom, B as curveCatmullRomOpen, C as curveCatmullRomClosed, D as curveCardinal, E as curveCardinalOpen, F as curveCardinalClosed, G as curveBundle, H as curveBasisOpen, I as curveBasisClosed, k as curveBasis, l as line$1 } from "./Xp5qcr6b.js";
...
const Channel = {
  ...
  rgb2hsl: ({ r: r2, g: g2, b: b2 }, channel) => {
    ...
    if (max === min)
      return 0;
    const d2 = max - min;
    const s2 = l4 > 0.5 ? d2 / (2 - max - min) : d2 / (max + min);
    if (channel === "s")
      return s2 * 100;
    switch (max) {
      case r2:
...
const luminance = (color) => {
  const { r: r2, g: g2, b: b2 } = Color.parse(color);
...
const adjustChannel = (color, channel, amount) => {
  const channels2 = Color.parse(color);
...
var Theme = (_a = class {
  ...
  updateColors() {
    var _a2, _b2, _c2, _d2, _e3, _f2, _g2, _h2, _i2, _j2, _k2, _l2, _m2, _n2, _o2, _p2, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _A, _B, _C, _D, _E, _F, _G, _H, _I, _J, _K, _L, _M, _N, _O, _P, _Q, _R, _S, _T, _U, _V, _W;
...
var Theme11 = (_k = class {
  ...
  updateColors() {
    ...
    this.scaleLabelColor = this.scaleLabelColor || this.labelTextColor;
    for (let i2 = 0; i2 < this.THEME_COLOR_LIMIT; i2++) {
      this["cScaleLabel" + i2] = darken(this["cScale" + i2], 75);
    }
    const multiplier = this.darkMode ? -4 : -1;
    for (let i2 = 0; i2 < 5; i2++) {
      this["surface" + i2] = this["surface" + i2] || adjust(this.mainBkg, { h: 180, s: -15, l: multiplier * (5 + i2 * 3) });
...
var renderKatexUnsanitized = /* @__PURE__ */ __name(async (text2, config2) => {
  ...
  }
  {
    const { default: katex } = await __vitePreload(async () => {
      const { default: katex2 } = await import("./CwWt8wTT.js");
...
var getStyles = /* @__PURE__ */ __name((type2, userStyles, options, svgId) => {
  let diagramStyles = "";
  if (type2 in themes && themes[type2]) {
    diagramStyles = themes[type2]({ ...options, svgId });
  } else {
...
var DiagramNotFoundError = (_m = class extends Error {
  constructor(name) {
    super(`Diagram ${name} not found.`);
  }
}, __name(_m, "DiagramNotFoundError"), _m);
class Bump {
...
function mergeWithDeep(target, source, merge2, stack) {
  ...
  for (let i2 = 0; i2 < sourceKeys.length; i2++) {
    ...
    else if (isObjectLike(targetValue) && isObjectLike(sourceValue) && (isPlainObject(targetValue) || isPlainObject(sourceValue) || isTypedArray(targetValue) || isTypedArray(sourceValue))) target[key] = mergeWithDeep(targetValue, sourceValue, merge2, stack);
...
function isEmpty(value) {
  ...
  if (typeof value === "object" || typeof value === "function") {
    ...
    if (isPrototype(value)) return keys.filter((x2) => x2 !== "constructor").length === 0;
...
var InitIDGenerator = (_n = class {
  constructor(deterministic = false, seed) {
    this.count = 0;
    this.count = seed ? seed.length : 0;
    this.next = deterministic ? () => this.count++ : () => Date.now();
  }
}, __name(_n, "InitIDGenerator"), _n);
var decoder;
...
` + this.renderer.text(a2);
        ...
        default: {
          ...
          if (this.options.silent) return /* @__PURE__ */ console.error(a2), "";
          throw new Error(a2);
        }
      }
    }
...
}, __publicField(_o, "passThroughHooks", /* @__PURE__ */ new Set(["preprocess", "postprocess", "processAllTokens", "emStrongMask"])), __publicField(_o, "passThroughHooksRespectAsync", /* @__PURE__ */ new Set(["preprocess", "postprocess", "processAllTokens"])), _o);
var B$1 = class B {
  constructor(...e2) {
  ...
  values.forEach(function(value, i2) {
    ...
    if (typeof value === "string" && value.includes("\n")) {
      indentedValue = String(value).split("\n").map(function(str2, i3) {
        return i3 === 0 ? str2 : "".concat(endentation).concat(str2);
      }).join("\n");
    }
...
function decodeHTMLEntities(text2) {
  ...
  return text2.replace(regex2, (match, entity) => {
    switch (entity) {
      case "amp":
        return "&";
      case "lt":
...
var createText = /* @__PURE__ */ __name(async (el, text2 = "", {
  ...
  if (useHtmlLabels) {
    ...
    const sanitizeBR = decodeEntities(text2.replace(/<br\s*\/?>/g, "<br/>"));
...
function mergePaths(roughElement) {
  const paths = Array.from(roughElement.childNodes).filter(
    (node2) => node2.tagName === "path"
  );
  const mergedPath = document.createElementNS("http://www.w3.org/2000/svg", "path");
  const combinedPathData = paths.map((path) => path.getAttribute("d")).filter((d2) => d2 !== null).join(" ");
...
var rect = /* @__PURE__ */ __name(async (parent, node2) => {
  ...
  const { clusterBkg, clusterBorder } = themeVariables;
  const { labelStyles, nodeStyles, borderStyles, backgroundStyles } = styles2String(node2);
  const shapeSvg = parent.insert("g").attr("class", "cluster " + node2.cssClasses).attr("id", node2.domId).attr("data-look", node2.look);
...
var noteGroup = /* @__PURE__ */ __name((parent, node2) => {
  const shapeSvg = parent.insert("g").attr("class", "note-cluster").attr("id", node2.domId);
...
var roundedWithTitle = /* @__PURE__ */ __name(async (parent, node2) => {
  ...
  const shapeSvg = parent.insert("g").attr("class", node2.cssClasses).attr("id", node2.domId).attr("data-id", node2.id).attr("data-look", node2.look);
...
var divider = /* @__PURE__ */ __name((parent, node2) => {
  ...
  const shapeSvg = parent.insert("g").attr("class", node2.cssClasses).attr("id", node2.domId).attr("data-look", node2.look);
  const outerRectG = shapeSvg.insert("g", ":first-child");
  const padding = 0 * node2.padding;
...
function calculateArcSagitta(chord, radiusX, radiusY) {
  const [semiMajorAxis, semiMinorAxis] = [radiusX, radiusY].sort((a2, b2) => b2 - a2);
...
async function bowTieRect(parent, node2) {
  ...
  node2.labelStyle = labelStyles;
  const nodePadding = node2.padding ?? 0;
  const labelPaddingX = node2.look === "neo" ? 16 : nodePadding;
  const labelPaddingY = node2.look === "neo" ? 12 : nodePadding;
  ...
  const totalHeight = calcTotalHeight((node2 == null ? void 0 : node2.height) ? node2 == null ? void 0 : node2.height : bbox.height);
  const [rx, ry] = calcEllipseRadius(totalHeight);
  const sagitta = calculateArcSagitta(totalHeight, rx, ry);
  const totalWidth = ((node2 == null ? void 0 : node2.width) ? node2 == null ? void 0 : node2.width : bbox.width) + labelPaddingX * 2 + sagitta;
  const w2 = totalWidth - sagitta;
...
async function card(parent, node2) {
  ...
  node2.labelStyle = labelStyles;
  const nodePadding = node2.padding ?? 0;
  const labelPaddingX = node2.look === "neo" ? 28 : nodePadding;
  const labelPaddingY = node2.look === "neo" ? 24 : nodePadding;
  const { shapeSvg, bbox } = await labelHelper(parent, node2, getNodeClasses(node2));
  const w2 = ((node2 == null ? void 0 : node2.width) ?? bbox.width) + (node2.look === "neo" ? labelPaddingX * 2 : labelPaddingX + NOTCH_SIZE);
  const h2 = ((node2 == null ? void 0 : node2.height) ?? bbox.height) + (node2.look === "neo" ? labelPaddingY * 2 : labelPaddingY);
  const left = 0;
  const right = w2;
  const top = -h2;
  const bottom = 0;
...
async function circle$1(parent, node2, options) {
  ...
  const radius = node2.look === "neo" ? bbox.width / 2 + labelPadding * 2 : bbox.width / 2 + padding;
  let circleElem;
  const { cssStyles } = node2;
  if (node2.look === "handDrawn") {
    const rc = at.svg(shapeSvg);
...
async function curlyBraceLeft(parent, node2) {
  ...
  const paddingX = node2.look === "neo" ? 18 : node2.padding ?? 0;
  const paddingY = node2.look === "neo" ? 12 : node2.padding ?? 0;
  const w2 = bbox.width + paddingX;
  const h2 = bbox.height + paddingY;
...
async function curlyBraceRight(parent, node2) {
  ...
  node2.labelStyle = labelStyles;
  const { shapeSvg, bbox, label } = await labelHelper(parent, node2, getNodeClasses(node2));
  const labelPaddingX = node2.look === "neo" ? 18 : node2.padding ?? 0;
  const labelPaddingY = node2.look === "neo" ? 12 : node2.padding ?? 0;
  const w2 = bbox.width + (node2.look === "neo" ? labelPaddingX * 2 : labelPaddingX);
  const h2 = bbox.height + (node2.look === "neo" ? labelPaddingY * 2 : labelPaddingY);
  const radius = Math.max(5, h2 * 0.1);
  const { cssStyles } = node2;
  const points = [
...
async function curvedTrapezoid(parent, node2) {
  ...
  const { shapeSvg, bbox } = await labelHelper(parent, node2, getNodeClasses(node2));
  const w2 = Math.max(minWidth, (bbox.width + labelPaddingX * 2) * 1.25, (node2 == null ? void 0 : node2.width) ?? 0);
  const h2 = Math.max(minHeight, bbox.height + labelPaddingY * 2, (node2 == null ? void 0 : node2.height) ?? 0);
  const radius = h2 / 2;
  const { cssStyles } = node2;
  const rc = at.svg(shapeSvg);
  const options = userNodeOverrides(node2, {});
...
async function cylinder(parent, node2) {
  ...
  node2.labelStyle = labelStyles;
  const nodePadding = node2.padding ?? 0;
  const labelPaddingX = node2.look === "neo" ? 24 : nodePadding;
  const labelPaddingY = node2.look === "neo" ? 24 : nodePadding;
  if (node2.width || node2.height) {
    const originalWidth = node2.width ?? 0;
    node2.width = (node2.width ?? 0) - labelPaddingY;
    if (node2.width < MIN_WIDTH) {
      node2.width = MIN_WIDTH;
    }
    const rx2 = originalWidth / 2;
    const ry2 = rx2 / (2.5 + originalWidth / 50);
    node2.height = (node2.height ?? 0) - labelPaddingX - ry2 * 3;
    if (node2.height < MIN_HEIGHT) {
      node2.height = MIN_HEIGHT;
    }
  }
  const { shapeSvg, bbox, label } = await labelHelper(parent, node2, getNodeClasses(node2));
  const w2 = (node2.width ? node2.width : bbox.width) + labelPaddingY;
  const rx = w2 / 2;
  const ry = rx / (2.5 + w2 / 50);
  const h2 = (node2.height ? node2.height : bbox.height) + labelPaddingX + ry;
  let cylinder2;
  const { cssStyles } = node2;
  if (node2.look === "handDrawn") {
    const rc = at.svg(shapeSvg);
...
async function datastore(parent, node2) {
  const { cssClasses, labelPaddingX, labelPaddingY, padding, width, height } = node2;
  const rectOptions = {
    rx: 0,
    ry: 0,
  ...
  const rect2 = await drawRect(parent, node2, rectOptions);
  if (node2.look === "handDrawn") {
...
async function dividedRectangle(parent, node2) {
  const { labelStyles, nodeStyles } = styles2String(node2);
  node2.labelStyle = labelStyles;
  const paddingX = node2.look === "neo" ? 16 : node2.padding ?? 0;
  const paddingY = node2.look === "neo" ? 16 : node2.padding ?? 0;
  const { shapeSvg, bbox, label } = await labelHelper(parent, node2, getNodeClasses(node2));
  const w2 = bbox.width + paddingX;
  const h2 = bbox.height + paddingY;
  const rectOffset2 = h2 * 0.2;
  const x2 = -w2 / 2;
  const y3 = -h2 / 2 - rectOffset2 / 2;
  const { cssStyles } = node2;
  const rc = at.svg(shapeSvg);
  const options = userNodeOverrides(node2, {});
  if (node2.look !== "handDrawn") {
  ...
  label.attr(
    "transform",
    `translate(${x2 + (node2.padding ?? 0) / 2 - (bbox.x - (bbox.left ?? 0))}, ${y3 + rectOffset2 + (node2.padding ?? 0) / 2 - (bbox.y - (bbox.top ?? 0))})`
  );
  updateNodeBounds(node2, polygon);
  node2.intersect = function(point2) {
    const pos = intersect_default.rect(node2, point2);
...
async function doublecircle(parent, node2) {
  var _a2, _b2;
  const { labelStyles, nodeStyles } = styles2String(node2);
  const gap = node2.look === "neo" ? 12 : 5;
  node2.labelStyle = labelStyles;
  const padding = node2.padding ?? 0;
  const labelPadding = node2.look === "neo" ? 16 : padding;
  const { shapeSvg, bbox } = await labelHelper(parent, node2, getNodeClasses(node2));
  const outerRadius = ((node2 == null ? void 0 : node2.width) ? (node2 == null ? void 0 : node2.width) / 2 : bbox.width / 2) + (labelPadding ?? 0);
...
async function flippedTriangle(parent, node2) {
  ...
  node2.labelStyle = labelStyles;
  const nodePadding = node2.padding ?? 0;
  const labelPaddingX = node2.look === "neo" ? nodePadding * 2 : nodePadding;
  if (node2.width || node2.height) {
    node2.height = (node2 == null ? void 0 : node2.height) ?? 0;
    if (node2.height < MIN_HEIGHT2) {
      node2.height = MIN_HEIGHT2;
    }
    node2.width = ((node2 == null ? void 0 : node2.width) ?? 0) - labelPaddingX - labelPaddingX / 2;
    if (node2.width < MIN_WIDTH2) {
      node2.width = MIN_WIDTH2;
    }
  }
  const { shapeSvg, bbox, label } = await labelHelper(parent, node2, getNodeClasses(node2));
  const w2 = ((node2 == null ? void 0 : node2.width) ? node2 == null ? void 0 : node2.width : bbox.width) + (labelPaddingX ?? 0);
  const h2 = (node2 == null ? void 0 : node2.height) ? node2 == null ? void 0 : node2.height : w2 + bbox.height;
  const tw = h2;
  const points = [
    { x: 0, y: -h2 },
    { x: tw, y: -h2 },
  ...
  const pathData = createPathFromPoints(points);
  const roughNode = rc.path(pathData, options);
  const flippedTriangle2 = shapeSvg.insert(() => roughNode, ":first-child").attr("transform", `translate(${-h2 / 2}, ${h2 / 2})`).attr("class", "outer-path");
  if (cssStyles && node2.look !== "handDrawn") {
...
async function halfRoundedRectangle(parent, node2) {
  ...
  const paddingY = node2.look === "neo" ? 12 : node2.padding ?? 0;
  if (node2.width || node2.height) {
    node2.height = ((node2 == null ? void 0 : node2.height) ?? 0) - paddingY * 2;
    if (node2.height < minHeight) {
      node2.height = minHeight;
    }
    node2.width = ((node2 == null ? void 0 : node2.width) ?? 0) - paddingX * 2;
    if (node2.width < minWidth) {
      node2.width = minWidth;
    }
  }
  const { shapeSvg, bbox } = await labelHelper(parent, node2, getNodeClasses(node2));
  const w2 = ((node2 == null ? void 0 : node2.width) ? node2 == null ? void 0 : node2.width : Math.max(minWidth, bbox.width)) + paddingX * 2;
  const h2 = ((node2 == null ? void 0 : node2.height) ? node2 == null ? void 0 : node2.height : Math.max(minHeight, bbox.height)) + paddingY * 2;
  const radius = h2 / 2;
  const { cssStyles } = node2;
  const rc = at.svg(shapeSvg);
  const options = userNodeOverrides(node2, {});
...
async function hexagon(parent, node2) {
  const { labelStyles, nodeStyles } = styles2String(node2);
  const f2 = node2.look === "neo" ? 3.5 : 4;
  node2.labelStyle = labelStyles;
  const nodePadding = node2.padding ?? 0;
  const wa = 70;
  const ha = 32;
  const labelPaddingX = node2.look === "neo" ? wa : nodePadding;
  const labelPaddingY = node2.look === "neo" ? ha : nodePadding;
  if (node2.width || node2.height) {
    const originalHeight = node2.height ?? 0;
    const m22 = originalHeight / f2;
    node2.width = ((node2 == null ? void 0 : node2.width) ?? 0) - 2 * m22 - labelPaddingY;
    node2.height = (node2.height ?? 0) - labelPaddingX;
  }
  const { shapeSvg, bbox } = await labelHelper(parent, node2, getNodeClasses(node2));
  const h2 = ((node2 == null ? void 0 : node2.height) ? node2 == null ? void 0 : node2.height : bbox.height) + labelPaddingX;
  const m2 = h2 / f2;
  const w2 = ((node2 == null ? void 0 : node2.width) ? node2 == null ? void 0 : node2.width : bbox.width) + 2 * m2 + labelPaddingY;
  const points = [
    { x: m2, y: 0 },
    { x: w2 - m2, y: 0 },
    { x: w2, y: -h2 / 2 },
...
async function inv_trapezoid(parent, node2) {
  ...
  const labelPaddingX = node2.look === "neo" ? nodePadding * 2 : nodePadding;
  const { shapeSvg, bbox } = await labelHelper(parent, node2, getNodeClasses(node2));
  const w2 = Math.max(bbox.width + (labelPaddingX ?? 0) * 2, (node2 == null ? void 0 : node2.width) ?? 0);
  const h2 = Math.max(bbox.height + (labelPaddingY ?? 0) * 2, (node2 == null ? void 0 : node2.height) ?? 0);
  const points = [
    { x: 0, y: 0 },
    { x: w2, y: 0 },
    { x: w2 + 3 * h2 / 6, y: -h2 },
...
async function lean_left(parent, node2) {
  ...
  const labelPaddingX = node2.look === "neo" ? nodePadding * 2 : nodePadding;
  const { shapeSvg, bbox } = await labelHelper(parent, node2, getNodeClasses(node2));
  const h2 = ((node2 == null ? void 0 : node2.height) ?? bbox.height) + labelPaddingY;
  const w2 = ((node2 == null ? void 0 : node2.width) ?? bbox.width) + labelPaddingX;
  const points = [
    { x: 0, y: 0 },
    { x: w2 + 3 * h2 / 6, y: 0 },
    { x: w2, y: -h2 },
...
async function linedCylinder(parent, node2) {
  ...
  if (node2.width || node2.height) {
    const originalWidth = node2.width ?? 0;
    node2.width = (node2.width ?? 0) - labelPaddingX;
    if (node2.width < MIN_WIDTH3) {
      node2.width = MIN_WIDTH3;
    }
    const rx2 = originalWidth / 2;
    const ry2 = rx2 / (2.5 + originalWidth / 50);
    node2.height = (node2.height ?? 0) - labelPaddingY - ry2 * 3;
    if (node2.height < MIN_HEIGHT3) {
      node2.height = MIN_HEIGHT3;
    }
  }
  const { shapeSvg, bbox, label } = await labelHelper(parent, node2, getNodeClasses(node2));
  const w2 = ((node2 == null ? void 0 : node2.width) ? node2 == null ? void 0 : node2.width : bbox.width) + labelPaddingX * 2;
  const rx = w2 / 2;
  const ry = rx / (2.5 + w2 / 50);
  const h2 = ((node2 == null ? void 0 : node2.height) ? node2 == null ? void 0 : node2.height : bbox.height) + ry + labelPaddingY * 2;
...
async function linedWaveEdgedRect(parent, node2) {
  ...
  const labelPaddingY = node2.look === "neo" ? 12 : nodePadding;
  if (node2.width || node2.height) {
    const originalWidth = node2.width;
    node2.width = (originalWidth ?? 0) * 10 / 11 - labelPaddingX * 2;
    if (node2.width < 10) {
      node2.width = 10;
    }
    node2.height = ((node2 == null ? void 0 : node2.height) ?? 0) - labelPaddingY * 2;
    if (node2.height < 10) {
      node2.height = 10;
    }
  }
  const { shapeSvg, bbox, label } = await labelHelper(parent, node2, getNodeClasses(node2));
  const w2 = ((node2 == null ? void 0 : node2.width) ? node2 == null ? void 0 : node2.width : bbox.width) + (labelPaddingX ?? 0) * 2;
  const h2 = ((node2 == null ? void 0 : node2.height) ? node2 == null ? void 0 : node2.height : bbox.height) + (labelPaddingY ?? 0) * 2;
...
async function multiRect(parent, node2) {
  ...
  const labelPaddingX = node2.look === "neo" ? 16 : nodePadding;
  const labelPaddingY = node2.look === "neo" ? 12 : nodePadding;
  const rectOffset2 = node2.look === "neo" ? 10 : 5;
  if (node2.width || node2.height) {
    node2.width = Math.max(((node2 == null ? void 0 : node2.width) ?? 0) - labelPaddingX * 2 - 2 * rectOffset2, 10);
    node2.height = Math.max(((node2 == null ? void 0 : node2.height) ?? 0) - labelPaddingY * 2 - 2 * rectOffset2, 10);
  }
  const { shapeSvg, bbox, label } = await labelHelper(parent, node2, getNodeClasses(node2));
  const totalWidth = ((node2 == null ? void 0 : node2.width) ? node2 == null ? void 0 : node2.width : bbox.width) + labelPaddingX * 2 + 2 * rectOffset2;
  const totalHeight = ((node2 == null ? void 0 : node2.height) ? node2 == null ? void 0 : node2.height : bbox.height) + labelPaddingY * 2 + 2 * rectOffset2;
  const w2 = totalWidth - 2 * rectOffset2;
  const h2 = totalHeight - 2 * rectOffset2;
  const x2 = -w2 / 2;
  const y3 = -h2 / 2;
  const { cssStyles } = node2;
  const rc = at.svg(shapeSvg);
  ...
  const outerPathPoints = [
    { x: x2 - rectOffset2, y: y3 + rectOffset2 },
    { x: x2 - rectOffset2, y: y3 + h2 + rectOffset2 },
    { x: x2 + w2 - rectOffset2, y: y3 + h2 + rectOffset2 },
    { x: x2 + w2 - rectOffset2, y: y3 + h2 },
    { x: x2 + w2, y: y3 + h2 },
    { x: x2 + w2, y: y3 + h2 - rectOffset2 },
    { x: x2 + w2 + rectOffset2, y: y3 + h2 - rectOffset2 },
    { x: x2 + w2 + rectOffset2, y: y3 - rectOffset2 },
    { x: x2 + rectOffset2, y: y3 - rectOffset2 },
    { x: x2 + rectOffset2, y: y3 },
    { x: x2, y: y3 },
    { x: x2, y: y3 + rectOffset2 }
  ];
...
async function multiWaveEdgedRectangle(parent, node2) {
  ...
  if (node2.width || node2.height) {
    ...
    node2.width = ((node2 == null ? void 0 : node2.width) ?? 0) - labelPaddingX * 2;
    node2.height = ((node2 == null ? void 0 : node2.height) ?? 0) - labelPaddingY * 3;
  }
  const w2 = Math.max(bbox.width, (node2 == null ? void 0 : node2.width) ?? 0) + labelPaddingX * 2;
  const h2 = Math.max(bbox.height, (node2 == null ? void 0 : node2.height) ?? 0) + labelPaddingY * 3;
  const waveAmplitude = node2.look === "neo" ? h2 / 4 : h2 / 8;
  const finalH = h2 + (adjustFinalHeight ? waveAmplitude / 2 : -waveAmplitude / 2);
  const x2 = -w2 / 2;
  const y3 = -finalH / 2;
  ...
  const outerPathPoints = [
    { x: x2 - rectOffset2, y: y3 + rectOffset2 },
    { x: x2 - rectOffset2, y: y3 + finalH + rectOffset2 },
    ...wavePoints,
    { x: x2 + w2 - rectOffset2, y: lastWavePoint.y - rectOffset2 },
    { x: x2 + w2, y: lastWavePoint.y - rectOffset2 },
    { x: x2 + w2, y: lastWavePoint.y - 2 * rectOffset2 },
    { x: x2 + w2 + rectOffset2, y: lastWavePoint.y - 2 * rectOffset2 },
    { x: x2 + w2 + rectOffset2, y: y3 - rectOffset2 },
    { x: x2 + rectOffset2, y: y3 - rectOffset2 },
    { x: x2 + rectOffset2, y: y3 },
    { x: x2, y: y3 },
...
async function rect_left_inv_arrow(parent, node2) {
  ...
  node2.labelStyle = labelStyles;
  const nodePadding = node2.padding ?? 0;
  const labelPaddingX = node2.look === "neo" ? 21 : nodePadding ?? 0;
  const labelPaddingY = node2.look === "neo" ? 12 : nodePadding ?? 0;
  const { shapeSvg, bbox, label } = await labelHelper(parent, node2, getNodeClasses(node2));
  const w2 = ((node2 == null ? void 0 : node2.width) ?? bbox.width) + (node2.look === "neo" ? labelPaddingX * 2 : labelPaddingX);
  const h2 = ((node2 == null ? void 0 : node2.height) ?? bbox.height) + (node2.look === "neo" ? labelPaddingY * 2 : labelPaddingY);
  const x2 = -w2 / 2;
  const y3 = -h2 / 2;
  const notch = y3 / 2;
...
async function roundedRect(parent, node2, { config: { themeVariables } }) {
...
async function shadedProcess(parent, node2) {
  ...
  const paddingY = node2.look === "neo" ? 12 : node2.padding ?? 0;
  const { shapeSvg, bbox, label } = await labelHelper(parent, node2, getNodeClasses(node2));
  const totalWidth = ((node2 == null ? void 0 : node2.width) ?? bbox.width) + paddingX * 2 + (node2.look === "neo" ? FRAME_WIDTH : FRAME_WIDTH * 2);
  const totalHeight = ((node2 == null ? void 0 : node2.height) ?? bbox.height) + paddingY * 2;
  const w2 = totalWidth - FRAME_WIDTH;
  const h2 = totalHeight;
  const x2 = FRAME_WIDTH - totalWidth / 2;
  const y3 = -totalHeight / 2;
  const { cssStyles } = node2;
  const rc = at.svg(shapeSvg);
  const options = userNodeOverrides(node2, {});
  ...
  const points = [
    ...
    { x: x2 + w2, y: y3 },
    { x: x2 + w2, y: y3 + h2 },
    { x: x2 - FRAME_WIDTH, y: y3 + h2 },
    { x: x2 - FRAME_WIDTH, y: y3 },
    { x: x2, y: y3 },
    { x: x2, y: y3 + h2 }
  ];
...
async function slopedRect(parent, node2) {
  ...
  const labelPaddingY = node2.look === "neo" ? 12 : nodePadding;
  if (node2.width || node2.height) {
    node2.width = Math.max(((node2 == null ? void 0 : node2.width) ?? 0) - labelPaddingX * 2, 10);
    node2.height = Math.max(((node2 == null ? void 0 : node2.height) ?? 0) / 1.5 - labelPaddingY * 2, 10);
  }
  const { shapeSvg, bbox, label } = await labelHelper(parent, node2, getNodeClasses(node2));
  const totalWidth = ((node2 == null ? void 0 : node2.width) ? node2 == null ? void 0 : node2.width : bbox.width) + labelPaddingX * 2;
  const totalHeight = (((node2 == null ? void 0 : node2.height) ? node2 == null ? void 0 : node2.height : bbox.height) + labelPaddingY * 2) * 1.5;
  const w2 = totalWidth;
  const h2 = totalHeight / 1.5;
  const x2 = -w2 / 2;
  const y3 = -h2 / 2;
  const { cssStyles } = node2;
  const rc = at.svg(shapeSvg);
...
async function squareRect2(parent, node2) {
  const nodePadding = node2.padding ?? 0;
  const labelPaddingX = node2.look === "neo" ? 16 : nodePadding * 2;
  const labelPaddingY = node2.look === "neo" ? 12 : nodePadding;
  const options = {
    rx: 0,
    ry: 0,
    labelPaddingX: node2.labelPaddingX ?? labelPaddingX,
    labelPaddingY
  };
  return drawRect(parent, node2, options);
}
...
async function stadium(parent, node2) {
  ...
  node2.labelStyle = labelStyles;
  const nodePadding = node2.padding ?? 0;
  const labelPaddingX = node2.look === "neo" ? 20 : nodePadding;
  const labelPaddingY = node2.look === "neo" ? 12 : nodePadding;
  const { shapeSvg, bbox } = await labelHelper(parent, node2, getNodeClasses(node2));
  const h2 = bbox.height + (node2.look === "neo" ? labelPaddingY * 2 : labelPaddingY);
  const w2 = bbox.width + h2 / 4 + (node2.look === "neo" ? labelPaddingX * 2 : labelPaddingX);
  const radius = h2 / 2;
  const { cssStyles } = node2;
  const rc = at.svg(shapeSvg);
  const options = userNodeOverrides(node2, {});
...
async function state(parent, node2) {
  const options = {
    rx: node2.look === "neo" ? 3 : 5,
    ry: node2.look === "neo" ? 3 : 5
  };
  return drawRect(parent, node2, options);
}
__name(state, "state");
function stateEnd(parent, node2, { config: { themeVariables } }) {
  ...
  const roughNode = rc.circle(0, 0, node2.width, {
    ...options,
    stroke: lineColor,
    strokeWidth: 2
  });
  const innerFill = stateBorder ?? nodeBorder;
  const innerNodeRadius = (node2.width ?? 0) * 5 / 14;
  ...
  if (node2.width < 25 && nodeShadow && node2.look !== "handDrawn") {
    const svgId = ((_b2 = (_a2 = parent.node()) == null ? void 0 : _a2.ownerSVGElement) == null ? void 0 : _b2.id) ?? "";
  ...
  node2.intersect = function(point2) {
    return intersect_default.circle(node2, (node2.width ?? 0) / 2, point2);
  };
  return shapeSvg;
}
...
function stateStart(parent, node2, { config: { themeVariables } }) {
  ...
  if (node2.look === "handDrawn") {
    ...
    circle2.attr("class", "state-start").attr("r", (node2.width ?? 7) / 2).attr("width", node2.width ?? 14).attr("height", node2.height ?? 14);
  } else {
  ...
  updateNodeBounds(node2, circle2);
  node2.intersect = function(point2) {
    return intersect_default.circle(node2, (node2.width ?? 7) / 2, point2);
  };
  return shapeSvg;
}
...
async function subroutine(parent, node2) {
  const { labelStyles, nodeStyles } = styles2String(node2);
  node2.labelStyle = labelStyles;
  const nodePadding = (node2 == null ? void 0 : node2.padding) ?? 8;
  const labelPaddingX = node2.look === "neo" ? 28 : nodePadding;
  const labelPaddingY = node2.look === "neo" ? 12 : nodePadding;
  const { shapeSvg, bbox } = await labelHelper(parent, node2, getNodeClasses(node2));
  const totalWidth = ((node2 == null ? void 0 : node2.width) ?? bbox.width) + 2 * FRAME_WIDTH2 + labelPaddingX;
  const totalHeight = ((node2 == null ? void 0 : node2.height) ?? bbox.height) + labelPaddingY;
  const w2 = totalWidth - 2 * FRAME_WIDTH2;
  const h2 = totalHeight;
  const x2 = -totalWidth / 2;
  const y3 = -totalHeight / 2;
  const points = [
  ...
  if (node2.look === "handDrawn") {
    const rc = at.svg(shapeSvg);
    const options = userNodeOverrides(node2, {});
    const roughNode = rc.rectangle(x2, y3, w2 + 16, h2, options);
    const l1 = rc.line(x2 + FRAME_WIDTH2, y3, x2 + FRAME_WIDTH2, y3 + h2, options);
    const l22 = rc.line(x2 + FRAME_WIDTH2 + w2, y3, x2 + FRAME_WIDTH2 + w2, y3 + h2, options);
...
async function taggedRect(parent, node2) {
  ...
  const labelPaddingY = node2.look === "neo" ? 12 : nodePadding;
  if (node2.width || node2.height) {
    node2.height = Math.max(((node2 == null ? void 0 : node2.height) ?? 0) - labelPaddingY * 2, 10);
    node2.width = Math.max(
      ((node2 == null ? void 0 : node2.width) ?? 0) - labelPaddingX * 2 - TAG_RATIO * (node2.height + labelPaddingY * 2),
      10
    );
  }
  const { shapeSvg, bbox } = await labelHelper(parent, node2, getNodeClasses(node2));
  const totalHeight = ((node2 == null ? void 0 : node2.height) ? node2 == null ? void 0 : node2.height : bbox.height) + labelPaddingY * 2;
  const tagWidth = TAG_RATIO * totalHeight;
  const tagHeight = TAG_RATIO * totalHeight;
  const totalWidth = ((node2 == null ? void 0 : node2.width) ? node2 == null ? void 0 : node2.width : bbox.width) + labelPaddingX * 2 + tagWidth;
  const w2 = totalWidth - tagWidth;
  const h2 = totalHeight;
  const x2 = -w2 / 2;
  const y3 = -h2 / 2;
  const { cssStyles } = node2;
...
async function text(parent, node2) {
  ...
  node2.labelStyle = labelStyles;
  const { shapeSvg, bbox } = await labelHelper(parent, node2, getNodeClasses(node2));
  const totalWidth = Math.max(bbox.width + (node2.padding ?? 0), (node2 == null ? void 0 : node2.width) || 0);
  const totalHeight = Math.max(bbox.height + (node2.padding ?? 0), (node2 == null ? void 0 : node2.height) || 0);
  const x2 = -totalWidth / 2;
  const y3 = -totalHeight / 2;
  const rect2 = shapeSvg.insert("rect", ":first-child");
...
async function tiltedCylinder(parent, node2) {
  ...
  node2.labelStyle = labelStyles;
  const nodePadding = node2.padding ?? 0;
  const labelPadding = node2.look === "neo" ? 12 : nodePadding / 2;
  if (node2.width || node2.height) {
    const originalHeight = node2.height ?? 0;
    node2.height = (node2.height ?? 0) - labelPadding;
    if (node2.height < MIN_HEIGHT4) {
      node2.height = MIN_HEIGHT4;
    }
    const ry2 = originalHeight / 2;
    const rx2 = ry2 / (2.5 + originalHeight / 50);
    node2.width = (node2.width ?? 0) - labelPadding - rx2 * 3;
    if (node2.width < MIN_WIDTH4) {
      node2.width = MIN_WIDTH4;
    }
  }
  const { shapeSvg, bbox, label } = await labelHelper(parent, node2, getNodeClasses(node2));
  const h2 = (node2.height ? node2.height : bbox.height) + labelPadding;
  const ry = h2 / 2;
  const rx = ry / (2.5 + h2 / 50);
  const w2 = (node2.width ? node2.width : bbox.width) + rx + labelPadding;
  const { cssStyles } = node2;
  let cylinder2;
  if (node2.look === "handDrawn") {
    const rc = at.svg(shapeSvg);
...
async function trapezoid(parent, node2) {
  ...
  node2.labelStyle = labelStyles;
  const nodePadding = node2.padding ?? 0;
  const labelPaddingY = node2.look === "neo" ? nodePadding : nodePadding;
  const labelPaddingX = node2.look === "neo" ? nodePadding * 2 : nodePadding;
  const { shapeSvg, bbox } = await labelHelper(parent, node2, getNodeClasses(node2));
  const h2 = ((node2 == null ? void 0 : node2.height) ?? bbox.height) + labelPaddingY;
  const w2 = ((node2 == null ? void 0 : node2.width) ?? bbox.width) + labelPaddingX;
...
async function trapezoidalPentagon(parent, node2) {
  ...
  if (node2.width || node2.height) {
    node2.height = (node2.height ?? 0) - labelPaddingY * 2;
    if (node2.height < minHeight) {
      node2.height = minHeight;
    }
    node2.width = (node2.width ?? 0) - labelPaddingX * 2;
    if (node2.width < minWidth) {
      node2.width = minWidth;
    }
  }
  const { shapeSvg, bbox } = await labelHelper(parent, node2, getNodeClasses(node2));
  const w2 = ((node2 == null ? void 0 : node2.width) ? node2 == null ? void 0 : node2.width : bbox.width) + labelPaddingX * 2;
  const h2 = ((node2 == null ? void 0 : node2.height) ? node2 == null ? void 0 : node2.height : bbox.height) + labelPaddingY * 2;
  const { cssStyles } = node2;
  const rc = at.svg(shapeSvg);
  const options = userNodeOverrides(node2, {});
  if (node2.look !== "handDrawn") {
...
async function triangle(parent, node2) {
  ...
  if (node2.width || node2.height) {
    node2.width = (((node2 == null ? void 0 : node2.width) ?? 0) - labelPaddingX) / 2;
    if (node2.width < MIN_WIDTH5) {
      node2.width = MIN_WIDTH5;
    }
    node2.height = (node2 == null ? void 0 : node2.height) ?? 0;
    if (node2.height < MIN_HEIGHT5) {
      node2.height = MIN_HEIGHT5;
    }
  }
  const { shapeSvg, bbox, label } = await labelHelper(parent, node2, getNodeClasses(node2));
  const useHtmlLabels = evaluate((_a2 = getConfig2().flowchart) == null ? void 0 : _a2.htmlLabels);
  const w2 = ((node2 == null ? void 0 : node2.width) ? node2 == null ? void 0 : node2.width : bbox.width) + labelPaddingX;
  const h2 = (node2 == null ? void 0 : node2.height) ? node2 == null ? void 0 : node2.height : w2 + bbox.height;
  const tw = h2;
  const points = [
    { x: 0, y: 0 },
  ...
  const pathData = createPathFromPoints(points);
  const roughNode = rc.path(pathData, options);
  const polygon = shapeSvg.insert(() => roughNode, ":first-child").attr("transform", `translate(${-h2 / 2}, ${h2 / 2})`).attr("class", "outer-path");
  if (cssStyles && node2.look !== "handDrawn") {
    polygon.selectChildren("path").attr("style", cssStyles);
  }
  if (nodeStyles && node2.look !== "handDrawn") {
...
async function waveEdgedRectangle(parent, node2) {
  ...
  const h2 = ((node2 == null ? void 0 : node2.height) ? node2 == null ? void 0 : node2.height : bbox.height) + (labelPaddingY ?? 0) * 2;
  const waveAmplitude = node2.look === "neo" ? h2 / 4 : h2 / 8;
  const finalH = h2 + (adjustFinalHeight ? waveAmplitude : -waveAmplitude);
  const { cssStyles } = node2;
  const minWidth = 14;
...
async function waveRectangle(parent, node2) {
  ...
  const nodePadding = node2.padding ?? 0;
  const labelPaddingX = node2.look === "neo" ? 16 : nodePadding;
  const labelPaddingY = node2.look === "neo" ? 20 : nodePadding;
  if (node2.width || node2.height) {
    node2.width = (node2 == null ? void 0 : node2.width) ?? 0;
    if (node2.width < 20) {
      node2.width = 20;
    }
    node2.height = (node2 == null ? void 0 : node2.height) ?? 0;
    ...
    const waveAmplitude2 = Math.min(node2.height * 0.2, node2.height / 4);
    node2.height = Math.ceil(node2.height - labelPaddingY - waveAmplitude2 * (20 / 9));
    node2.width = node2.width - labelPaddingX * 2;
  }
  const { shapeSvg, bbox } = await labelHelper(parent, node2, getNodeClasses(node2));
  const w2 = ((node2 == null ? void 0 : node2.width) ? node2 == null ? void 0 : node2.width : bbox.width) + labelPaddingX * 2;
  const h2 = ((node2 == null ? void 0 : node2.height) ? node2 == null ? void 0 : node2.height : bbox.height) + labelPaddingY;
  const waveAmplitude = h2 / 8;
...
async function windowPane(parent, node2) {
  ...
  const paddingY = node2.look === "neo" ? 12 : node2.padding ?? 0;
  if (node2.width || node2.height) {
    node2.width = Math.max(((node2 == null ? void 0 : node2.width) ?? 0) - paddingX * 2 - rectOffset, 10);
    node2.height = Math.max(((node2 == null ? void 0 : node2.height) ?? 0) - paddingY * 2 - rectOffset, 10);
  }
  const { shapeSvg, bbox, label } = await labelHelper(parent, node2, getNodeClasses(node2));
  const totalWidth = ((node2 == null ? void 0 : node2.width) ? node2 == null ? void 0 : node2.width : bbox.width) + paddingX * 2 + rectOffset;
  const totalHeight = ((node2 == null ? void 0 : node2.height) ? node2 == null ? void 0 : node2.height : bbox.height) + paddingY * 2 + rectOffset;
  const w2 = totalWidth - rectOffset;
  const h2 = totalHeight - rectOffset;
  const x2 = -w2 / 2;
  const y3 = -h2 / 2;
  const { cssStyles } = node2;
  const rc = at.svg(shapeSvg);
...
async function erBox(parent, node2) {
  ...
  if (node2.look === "handDrawn") {
    ...
    const backgroundNode = {
      ...
      domId: (node2.domId || node2.id) + "-background",
      look: "default",
  ...
  let points = lineToPolygon(x2, nameBBox.height + y3, w2 + x2, nameBBox.height + y3, thickness);
  let roughLine = rc.polygon(
    points.map((p2) => [p2.x, p2.y]),
    options
  );
  shapeSvg.insert(() => roughLine).attr("class", "divider");
  points = lineToPolygon(maxTypeWidth + x2, nameBBox.height + y3, maxTypeWidth + x2, h2 + y3, thickness);
  ...
  shapeSvg.insert(() => roughLine).attr("class", "divider");
  if (keysPresent) {
    const xCoord = maxTypeWidth + maxNameWidth + x2;
    points = lineToPolygon(xCoord, nameBBox.height + y3, xCoord, h2 + y3, thickness);
    roughLine = rc.polygon(
      points.map((p2) => [p2.x, p2.y]),
      options
    );
  ...
  if (commentPresent) {
    const xCoord = maxTypeWidth + maxNameWidth + maxKeysWidth + x2;
    points = lineToPolygon(xCoord, nameBBox.height + y3, xCoord, h2 + y3, thickness);
    roughLine = rc.polygon(
      points.map((p2) => [p2.x, p2.y]),
      options
  ...
  for (const yOffset2 of yOffsets) {
    const yCoord = nameBBox.height + y3 + yOffset2;
    points = lineToPolygon(x2, yCoord, w2 + x2, yCoord, thickness);
    roughLine = rc.polygon(
      points.map((p2) => [p2.x, p2.y]),
      options
    );
...
function lineToPolygon(x1, y1, x2, y22, thickness) {
  if (x1 === x2) {
    return [
      { x: x1 - thickness / 2, y: y1 },
      { x: x1 + thickness / 2, y: y1 },
      { x: x2 + thickness / 2, y: y22 },
      { x: x2 - thickness / 2, y: y22 }
    ];
  }
  return [
...
async function classBox(parent, node2) {
  ...
  const w2 = Math.max(node2.width ?? 0, bbox.width);
  let h2 = Math.max(node2.height ?? 0, bbox.height);
  const nodeHeightGreater = (node2.height ?? 0) > bbox.height;
  ...
  const methodsAreaPlacement = (annotationGroupHeight + labelGroupHeight + y3 + PADDING - (y3 - PADDING - (renderExtraBox ? PADDING : classNode.members.length === 0 && classNode.methods.length === 0 ? -PADDING / 2 : 0))) / 2;
  shapeSvg.selectAll(".text").each((_2, i2, nodes) => {
    ...
    if (text2.attr("class").includes("methods-group")) {
      ...
      if (nodeHeightGreater) {
        newTranslateY = Math.max(
          ...
          annotationGroupHeight + labelGroupHeight + membersGroupHeightForMethods + y3 + GAP * 2 + PADDING
        ) + GAP * 2;
      } else {
        newTranslateY = annotationGroupHeight + labelGroupHeight + membersGroupHeightForMethods + y3 + GAP * 4 + PADDING;
      }
    }
    if (classNode.members.length === 0 && classNode.methods.length === 0 && ((_a3 = config2.class) == null ? void 0 : _a3.hideEmptyMembersBox)) {
    ...
    if (text2.attr("class").includes("label-group") || text2.attr("class").includes("annotation-group")) {
      newTranslateX = -((_b3 = text2.node()) == null ? void 0 : _b3.getBBox().width) / 2 || 0;
  ...
  if (classNode.members.length > 0 || classNode.methods.length > 0 || renderExtraBox) {
    const firstLineY = annotationGroupHeight + labelGroupHeight + y3 + PADDING;
    const roughLine = rc.line(
      rectBBox.x,
      firstLineY,
    ...
    line2.attr("class", `divider${node2.look === "neo" && !useGradient ? " neo-line" : ""}`).attr("style", styles);
  }
  if (renderExtraBox || classNode.members.length > 0 || classNode.methods.length > 0) {
    const secondLineY = annotationGroupHeight + labelGroupHeight + membersGroupHeight + y3 + GAP * 2 + PADDING;
    const roughLine = rc.line(
      rectBBox.x,
...
async function requirementBox(parent, node2) {
  ...
  if (borderColorArray == null ? void 0 : borderColorArray.length) {
    const colorIndex = node2.colorIndex ?? 0;
    shapeSvg.attr("data-color-id", `color-${colorIndex % borderColorArray.length}`);
  }
  ...
  if (accumulativeHeight > typeHeight + nameHeight + gap) {
    const lineY = y3 + typeHeight + nameHeight + gap;
    let roughLine;
    if (node2.look === "neo") {
      ...
      const polygonPoints = [
        [x2, lineY],
        [x2 + totalWidth, lineY],
        [x2 + totalWidth, lineY + thickness],
        [x2, lineY + thickness]
      ];
      roughLine = rc.polygon(polygonPoints, options);
    } else {
      roughLine = rc.line(x2, lineY, x2 + totalWidth, lineY, options);
    }
  ...
  if (nodeStyles && node2.look !== "handDrawn" && (requirementEdgeLabelBackground || (borderColorArray == null ? void 0 : borderColorArray.length))) {
    shapeSvg.selectAll("path").attr("style", nodeStyles);
  }
  return shapeSvg;
}
...
async function defaultMindmapNode(parent, node2) {
  ...
  if (!node2.domId) {
    throw new Error(
      `defaultMindmapNode: node "${node2.id}" is missing a domId — was render.ts domId prefixing skipped?`
    );
  }
  const bg = shapeSvg.append("path").attr("id", node2.domId).attr("class", "node-bkg node-" + node2.type).attr("style", nodeStyles).attr("d", rectPath);
...
async function insertNode(elem, node2, renderOptions) {
  ...
  newEl.attr("data-look", handleUndefinedAttr(node2.look));
  if (node2.tooltip) {
...
var registerDefaultLayoutLoaders = /* @__PURE__ */ __name(() => {
  registerLayoutLoaders([
    {
      name: "dagre",
      loader: /* @__PURE__ */ __name(async () => await __vitePreload(() => import("./bTQFkcjh.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0, import.meta.url), "loader")
    },
    {
      name: "swimlane",
      loader: /* @__PURE__ */ __name(async () => await __vitePreload(() => import("./Bnl6BI2h.js"), true ? __vite__mapDeps([5,6,1,2,3]) : void 0, import.meta.url), "loader")
    },
    ...[
      {
        name: "cose-bilkent",
        loader: /* @__PURE__ */ __name(async () => await __vitePreload(() => import("./Bbj_Uq_7.js"), true ? __vite__mapDeps([7,8,9,10,11]) : void 0, import.meta.url), "loader")
      }
    ]
  ]);
}, "registerDefaultLayoutLoaders");
registerDefaultLayoutLoaders();
var render$1 = /* @__PURE__ */ __name(async (data4Layout, svg, positions) => {
  if (!(data4Layout.layoutAlgorithm in layoutAlgorithms)) {
    throw new Error(`Unknown layout algorithm: ${data4Layout.layoutAlgorithm}`);
  }
  if (data4Layout.diagramId) {
    for (const node2 of data4Layout.nodes) {
      const originalDomId = node2.domId || node2.id;
      node2.domId = `${data4Layout.diagramId}-${originalDomId}`;
    }
  }
          ...
          default:
            ...
            if (character2 === 123)
              if (offset === 0)
                ...
                if (offset) parse$1(value, reference, reference, rule && append(ruleset(value, reference, reference, 0, 0, rules, points, type2, rules, props = [], length2, children), children), rules, children, length2, points, rule ? props : children);
...
var loader = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./Dg5vMFVn.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([12,13,10,11]) : void 0, import.meta.url);
...
var loader2 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./DvjOXlfB.js").then((n2) => n2.f);
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([14,15,16,10,11,17,13,18,19,9]) : void 0, import.meta.url);
...
var loader4 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./B-LjFF6F.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([20,14,15,16,10,11,17,13,18,19,9]) : void 0, import.meta.url);
...
var loader5 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./M-CO_0TX.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([21,16,10,11,17,19]) : void 0, import.meta.url);
...
var loader6 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./DrqimdGE.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([22,23,24,25,6,10,11]) : void 0, import.meta.url);
...
var loader7 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./S8OYKzZo.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([26,9,27,10,11,28,29,30,31]) : void 0, import.meta.url);
...
var loader8 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./C9AAgR6e.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([32,25,6]) : void 0, import.meta.url);
...
var loader9 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./JEPkB1Ly.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([33,24,25,6,10,11,34,35,36,30]) : void 0, import.meta.url);
...
var loader10 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./CQCPd1JX.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([37,10,11,29,30,31]) : void 0, import.meta.url);
...
var loader11 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./D_1wt3s6.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([38,10,11,30,36,39,29,31,35]) : void 0, import.meta.url);
...
var loader12 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./BaMA9QBb.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([40,16,10,11,17]) : void 0, import.meta.url);
...
var loader13 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./QV2rO2vQ.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([41,23,13,10,11]) : void 0, import.meta.url);
...
var loader14 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./DroXS8pa.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([42,43,15,16,10,11,17,13,18,9]) : void 0, import.meta.url);
...
var loader15 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./DhyK92V-.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([44,43,15,16,10,11,17,13,18,9]) : void 0, import.meta.url);
...
var loader16 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./DdiaLkrE.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([45,46,16,10,11,17,13,18,2,4,3,35]) : void 0, import.meta.url);
...
var loader17 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./CpjbufeE.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([47,46,16,10,11,17,13,18,9]) : void 0, import.meta.url);
...
var loader18 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./DhLDerDD.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([48,15,13,10,11,9,34,35]) : void 0, import.meta.url);
...
var loader20 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./Cw6AYlwt.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([49,10,11,34,35]) : void 0, import.meta.url);
...
var loader21 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./BG2hDOCK.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([50,16,10,11,17]) : void 0, import.meta.url);
...
var loader22 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./Sa-IffT_.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([51,15]) : void 0, import.meta.url);
...
var loader23 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./DfSaKWOt.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([52,9,10,11,36,30,53]) : void 0, import.meta.url);
...
var loader24 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./zLoGeRie.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([54,24,25,6]) : void 0, import.meta.url);
...
var loader25 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./DI3Gw6Ji.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([55,24,25,6]) : void 0, import.meta.url);
...
var loader26 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./Dh5z7nN6.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([56,15,10,11,2,19,35]) : void 0, import.meta.url);
...
var loader27 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./C6b9yAqE.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([57,23,24,25,6]) : void 0, import.meta.url);
...
var loader28 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./DyfLsS81.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([58,24,25,6,8,9,10,11]) : void 0, import.meta.url);
...
var loader29 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./RUmKCaHA.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([59,24,25,6,10,11]) : void 0, import.meta.url);
...
var loader30 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./CRniSzfB.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([60,9]) : void 0, import.meta.url);
...
var loader31 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./BQAvRN_f.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([61,9,10,11]) : void 0, import.meta.url);
...
var loader32 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./Dr1RailG.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([62,24,17,25,6,10,11,31,36,30,63]) : void 0, import.meta.url);
...
var loader33 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./BiSgESTt.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([64,24,25,6]) : void 0, import.meta.url);
...
var loader34 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./BTkTGw9k.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([65,24,25,6]) : void 0, import.meta.url);
...
var loader35 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./CNvMOd4S.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([66,67,24,10,11,25,6]) : void 0, import.meta.url);
...
var loader36 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./QIkeVQOL.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([68,67,24,10,11,25,6]) : void 0, import.meta.url);
...
var loader37 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./Pvzgx3jr.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([69,67,24,10,11,25,6]) : void 0, import.meta.url);
...
var loader38 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./By6wv6-5.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([70,67,24,10,11,25,6]) : void 0, import.meta.url);
...
var createUserStyles = /* @__PURE__ */ __name((config2, graphType, classDefs, svgId) => {
  ...
  const allStyles = styles_default(
    graphType,
    userCSSstyles,
    { ...config2.themeVariables, theme: config2.theme, look: config2.look },
    svgId
  );
...
var render = /* @__PURE__ */ __name(async function(id39, text2, svgContainingElement) {
  ...
  try {
    await diag.renderer.draw(text2, id39, "11.16.0", diag);
  } catch (e2) {
    if (config2.suppressErrorRendering) {
      removeTempElements();
    } else {
      errorRenderer_default.draw(text2, id39, "11.16.0");
    }
    throw e2;
  }
...
export {
  ...
  Color as C,
  random as D,
  selectSvgElement as E,
  getThemeVariables3 as F,
  setConfig2 as G,
  load as H,
  hasKatex as I,
  JSON_SCHEMA as J,
  calculateMathMLDimensions as K,
  parseFontSize as L,
  getUrl as M,
  renderKatexSanitized as N,
  ...
  __name as _,
  getAccTitle as a,
  registerIconPacks as a0,
  calculateTextDimensions as a1,
  at as a2,
  styles2String as a3,
  isLabelStyle as a4,
  markers_default as a5,
  clear2 as a6,
  clear as a7,
  clear$1 as a8,
  updateNodeBounds as a9,
  float64ArrayTag as aA,
  float32ArrayTag as aB,
  dateTag as aC,
  booleanTag as aD,
  dataViewTag as aE,
  arrayBufferTag as aF,
  arrayTag as aG,
  argumentsTag as aH,
  ...
  getStylesFromArray as aM,
  decodeEntities as aN,
  configureLabelImages as aO,
  adjustChannel as aP,
  getUserDefinedConfig as aQ,
  unknownIcon as aR,
  defaultConfig2 as aS,
  isValidShape as aT,
  mermaid_core as aU,
  setNodeElem as aa,
  getSubGraphTitleMargins as ab,
  insertEdge as ac,
  positionEdgeLabel as ad,
  insertEdgeLabel as ae,
  edgeLabels as af,
  terminalLabels as ag,
  markerOffsets as ah,
  computeDimensionOfText as ai,
  isPrimitive as aj,
  getTag as ak,
  isTypedArray as al,
  uint32ArrayTag as am,
  uint16ArrayTag as an,
  uint8ClampedArrayTag as ao,
  uint8ArrayTag as ap,
  symbolTag as aq,
  stringTag as ar,
  setTag as as,
  ...
  setAccTitle as b,
  getConfig2 as c,
  configureSvgSize as d,
  assignWithDepth_default as e,
